...
!define COMPANY "Zcoin Core project"
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\zcoin-qt
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Zcoin Core (testnet, -bit).lnk" "$INSTDIR\zcoin-qt" "-testnet" "$INSTDIR\zcoin-qt" 1
    ...
    WriteRegStr HKCR "zcoin" "" "URL:Bitcoin"
    WriteRegStr HKCR "zcoin\DefaultIcon" "" $INSTDIR\zcoin-qt
    WriteRegStr HKCR "zcoin\shell\open\command" "" '"$INSTDIR\zcoin-qt" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\zcoin-qt
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Zcoin Core (testnet, -bit).lnk"
