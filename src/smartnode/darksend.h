...
// A helper object for signing messages from Smartnodes
...
public:
    ...
    bool CheckSignature(const CPubKey& pubKeySmartnode);
...
{
public:
    /// Is the input associated with this public key? (and there is 10000 SMART - checking if valid smartnode)
...
private:
    ...
    std::vector<CTxIn> vecSmartnodesUsed;
    ...
    std::vector<CDarkSendEntry> vecEntries; // Smartnode/clients entries
...
public:
    CSmartnode* pSubmittedToSmartnode;
