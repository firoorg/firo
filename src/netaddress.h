...
class CNetAddr
{
    ...
    private:
         ...
         * @retval false not recognised (from the future?) and should be silently ignored
        ...
        void SerializeV1Array(uint8_t (&arr)[V1_SERIALIZATION_SIZE]) const
        {
            ...
            case NET_ONION:
                if (m_addr.size() == ADDR_TORV3_SIZE) {
                    // TORv3 addresses cannot be serialized in ADDRv1 format.
            ...
            case NET_INTERNAL:
                ...
                return;
            case NET_I2P:
                // I2P addresses cannot be serialized in ADDRv1 format.
                // Serialize as all-zeros.
                memset(arr, 0x0, V1_SERIALIZATION_SIZE);
                return;
            case NET_CJDNS:
                // CJDNS addresses cannot be serialized in ADDRv1 format.
                // Serialize as all-zeros.
                memset(arr, 0x0, V1_SERIALIZATION_SIZE);
                return;
            case NET_UNROUTABLE:
        ...
        /**
         * Serialize in ADDRv2/BIP155 format to a stream.
         */
        template <typename Stream>
        void SerializeV2Stream(Stream& s) const
        {
            if (IsInternal()) {
                ...
                // In ADDRv1 we used to abuse addr.m_net to be NET_IPV6 for these addresses
