...
////////////////////////////////////////////////////////////// // themis
	void setThemisSchedule(EVMSchedule _themisSchedule) const { themisSchedule = _themisSchedule; }

	EVMSchedule& getThemisSchedule() const { return themisSchedule; }
...
private:
	...
	mutable EVMSchedule themisSchedule; // themis
