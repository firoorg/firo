...
#include "genesis/themisMainNetwork.cpp"
#include "genesis/themisTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::themisMainNetwork: return c_genesisInfoThemisMainNetwork;
	case Network::themisTestNetwork: return c_genesisInfoThemisTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::themisMainNetwork: return c_genesisStateRootThemisMainNetwork;
	case Network::themisTestNetwork: return c_genesisStateRootThemisTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
