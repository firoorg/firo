...
bool CDarksendPool::DoAutomaticDenominating(bool fDryRun)
{
    ...
    if(nLiquidityProvider || fUseQueue) {
        ...
        BOOST_FOREACH(CDarksendQueue& dsq, vecDarksendQueue) {
            ...
            CNode* pnode = (pnodeFound && pnodeFound->fZnode) ? pnodeFound : ConnectNodeDash(CAddress(pmn->addr, NODE_NETWORK), NULL, true);
            if(pnode) {
...
std::string CDarksendPool::GetMessageByID(PoolMessage nMessageID)
{
    switch (nMessageID) {
        ...
        case ERR_MN_LIST:               return _("Not in the Znode list.");
        case ERR_MODE:                  return _("Incompatible mode.");
        case ERR_NON_STANDARD_PUBKEY:   return _("Non-standard public key detected.");
        case ERR_NOT_A_MN:              return _("This is not a Znode.");
        case ERR_QUEUE_FULL:            return _("Znode queue is full.");
