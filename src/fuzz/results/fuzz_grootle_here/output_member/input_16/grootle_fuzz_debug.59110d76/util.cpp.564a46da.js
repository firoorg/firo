...
{"lineNum":"  219","line":"{","class":"lineCov","hits":"2","order":"844","possible_hits":"2",},
{"lineNum":"  220","line":"    assert(mutexDebugLog == NULL);","class":"lineCov","hits":"1","order":"845","possible_hits":"1",},
{"lineNum":"  221","line":"    mutexDebugLog = new boost::mutex();","class":"linePartCov","hits":"1","order":"846","possible_hits":"2",},
{"lineNum":"  222","line":"    vMsgsBeforeOpenLog = new std::list<std::string>;","class":"lineCov","hits":"1","order":"847","possible_hits":"1",},
{"lineNum":"  223","line":"}","class":"lineCov","hits":"1","order":"848","possible_hits":"1",},
{"lineNum":"  224","line":""},
...
{"lineNum":"  285","line":"{","class":"lineCov","hits":"2","order":"811","possible_hits":"2",},
{"lineNum":"  286","line":"    std::string strStamped;","class":"lineCov","hits":"1","order":"812","possible_hits":"1",},
{"lineNum":"  287","line":""},
{"lineNum":"  288","line":"    if (!fLogTimestamps)","class":"lineCov","hits":"1","order":"813","possible_hits":"1",},
{"lineNum":"  289","line":"        return str;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  290","line":""},
{"lineNum":"  291","line":"    if (*fStartedNewLine) {","class":"lineCov","hits":"1","order":"814","possible_hits":"1",},
{"lineNum":"  292","line":"        int64_t nTimeMicros = GetLogTimeMicros();","class":"lineCov","hits":"1","order":"815","possible_hits":"1",},
{"lineNum":"  293","line":"        strStamped = DateTimeStrFormat(\"%Y-%m-%d %H:%M:%S\", nTimeMicros/1000000);","class":"lineCov","hits":"1","order":"825","possible_hits":"1",},
{"lineNum":"  294","line":"        if (fLogTimeMicros)","class":"lineCov","hits":"1","order":"834","possible_hits":"1",},
{"lineNum":"  295","line":"            strStamped += strprintf(\".%06d\", nTimeMicros%1000000);","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  296","line":"        strStamped += \' \' + str;","class":"linePartCov","hits":"1","order":"835","possible_hits":"2",},
{"lineNum":"  297","line":"    } else","class":"lineCov","hits":"1","order":"836","possible_hits":"1",},
{"lineNum":"  298","line":"        strStamped = str;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  299","line":""},
{"lineNum":"  300","line":"    if (!str.empty() && str[str.size()-1] == \'\\n\')","class":"lineCov","hits":"1","order":"837","possible_hits":"1",},
{"lineNum":"  301","line":"        *fStartedNewLine = true;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  302","line":"    else"},
{"lineNum":"  303","line":"        *fStartedNewLine = false;","class":"lineCov","hits":"1","order":"838","possible_hits":"1",},
{"lineNum":"  304","line":""},
{"lineNum":"  305","line":"    return strStamped;","class":"lineCov","hits":"1","order":"839","possible_hits":"1",},
{"lineNum":"  306","line":"}","class":"linePartCov","hits":"1","order":"840","possible_hits":"4",},
{"lineNum":"  307","line":""},
{"lineNum":"  308","line":"int LogPrintStr(const std::string &str)"},
{"lineNum":"  309","line":"{","class":"lineCov","hits":"2","order":"807","possible_hits":"2",},
{"lineNum":"  310","line":"    //A temporary fix for https://github.com/firoorg/firo/issues/1011"},
{"lineNum":"  311","line":"    if (fNoDebug && str.compare(0, 6, \"ERROR:\", 0, 6) != 0)","class":"linePartCov","hits":"1","order":"808","possible_hits":"4",},
{"lineNum":"  312","line":"        return 0;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  313","line":""},
{"lineNum":"  314","line":"    int ret = 0; // Returns total number of characters written","class":"lineCov","hits":"1","order":"809","possible_hits":"1",},
{"lineNum":"  315","line":"    static std::atomic_bool fStartedNewLine(true);"},
{"lineNum":"  316","line":""},
{"lineNum":"  317","line":"    std::string strTimestamped = LogTimestampStr(str, &fStartedNewLine);","class":"lineCov","hits":"1","order":"810","possible_hits":"1",},
{"lineNum":"  318","line":""},
{"lineNum":"  319","line":"    if (fPrintToConsole)","class":"lineCov","hits":"1","order":"841","possible_hits":"1",},
{"lineNum":"  320","line":"    {"},
...
{"lineNum":"  325","line":"    else if (fPrintToDebugLog)","class":"lineCov","hits":"1","order":"842","possible_hits":"1",},
{"lineNum":"  326","line":"    {"},
{"lineNum":"  327","line":"        boost::call_once(&DebugPrintInit, debugPrintInitFlag);","class":"lineCov","hits":"1","order":"843","possible_hits":"1",},
{"lineNum":"  328","line":"        boost::mutex::scoped_lock scoped_lock(*mutexDebugLog);","class":"lineCov","hits":"1","order":"849","possible_hits":"1",},
{"lineNum":"  329","line":""},
{"lineNum":"  330","line":"        // buffer if we haven\'t opened the log yet"},
{"lineNum":"  331","line":"        if (fileout == NULL) {","class":"lineCov","hits":"1","order":"850","possible_hits":"1",},
{"lineNum":"  332","line":"            assert(vMsgsBeforeOpenLog);","class":"lineCov","hits":"1","order":"851","possible_hits":"1",},
{"lineNum":"  333","line":"            ret = strTimestamped.length();","class":"lineCov","hits":"1","order":"852","possible_hits":"1",},
{"lineNum":"  334","line":"            vMsgsBeforeOpenLog->push_back(strTimestamped);","class":"lineCov","hits":"1","order":"853","possible_hits":"1",},
{"lineNum":"  335","line":"        }","class":"lineCov","hits":"1","order":"854","possible_hits":"1",},
...
{"lineNum":"  347","line":"        }"},
{"lineNum":"  348","line":"    }","class":"lineCov","hits":"1","order":"855","possible_hits":"1",},
{"lineNum":"  349","line":"    return ret;","class":"lineCov","hits":"1","order":"856","possible_hits":"1",},
{"lineNum":"  350","line":"}","class":"linePartCov","hits":"1","order":"857","possible_hits":"6",},
{"lineNum":"  351","line":""},
...
var header = { "command" : "grootle_fuzz_debug", "date" : "2023-08-17 10:25:23", "instrumented" : 430, "covered" : 51,};
var merged_data = [];
