...
{"lineNum":"   22","line":""},
{"lineNum":"   23","line":"static SECP256K1_INLINE void secp256k1_callback_call(const secp256k1_callback * const cb, const char * const text) {","class":"lineNoCov","hits":"0",},
{"lineNum":"   24","line":"    cb->fn(text, (void*)cb->data);","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   67","line":""},
{"lineNum":"   68","line":"static SECP256K1_INLINE void *checked_malloc(const secp256k1_callback* cb, size_t size) {","class":"lineCov","hits":"1","order":"1074",},
{"lineNum":"   69","line":"    void *ret = malloc(size);","class":"lineCov","hits":"1","order":"1073",},
{"lineNum":"   70","line":"    if (ret == NULL) {","class":"lineCov","hits":"1","order":"1072",},
{"lineNum":"   71","line":"        secp256k1_callback_call(cb, \"Out of memory\");","class":"lineNoCov","hits":"0",},
{"lineNum":"   72","line":"    }"},
{"lineNum":"   73","line":"    return ret;","class":"lineCov","hits":"1","order":"1071",},
{"lineNum":"   74","line":"}"},
{"lineNum":"   75","line":""},
...
var header = { "command" : "", "date" : "2023-08-24 10:21:39", "instrumented" : 8, "covered" : 4,};
var merged_data = [];
