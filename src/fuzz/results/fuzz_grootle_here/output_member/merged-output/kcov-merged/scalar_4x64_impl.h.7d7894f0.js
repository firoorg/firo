...
{"lineNum":"   26","line":""},
{"lineNum":"   27","line":"SECP256K1_INLINE static void secp256k1_scalar_clear(secp256k1_scalar *r) {","class":"lineCov","hits":"1","order":"255",},
{"lineNum":"   28","line":"    r->d[0] = 0;","class":"lineCov","hits":"1","order":"254",},
{"lineNum":"   29","line":"    r->d[1] = 0;","class":"lineCov","hits":"1","order":"253",},
{"lineNum":"   30","line":"    r->d[2] = 0;","class":"lineCov","hits":"1","order":"252",},
{"lineNum":"   31","line":"    r->d[3] = 0;","class":"lineCov","hits":"1","order":"251",},
{"lineNum":"   32","line":"}","class":"lineCov","hits":"1","order":"256",},
{"lineNum":"   33","line":""},
{"lineNum":"   34","line":"SECP256K1_INLINE static void secp256k1_scalar_set_int(secp256k1_scalar *r, unsigned int v) {","class":"lineCov","hits":"1","order":"257",},
{"lineNum":"   35","line":"    r->d[0] = v;","class":"lineCov","hits":"1","order":"258",},
{"lineNum":"   36","line":"    r->d[1] = 0;","class":"lineCov","hits":"1","order":"259",},
{"lineNum":"   37","line":"    r->d[2] = 0;","class":"lineCov","hits":"1","order":"260",},
{"lineNum":"   38","line":"    r->d[3] = 0;","class":"lineCov","hits":"1","order":"261",},
{"lineNum":"   39","line":"}","class":"lineCov","hits":"1","order":"262",},
{"lineNum":"   40","line":""},
{"lineNum":"   41","line":"SECP256K1_INLINE static unsigned int secp256k1_scalar_get_bits(const secp256k1_scalar *a, unsigned int offset, unsigned int count) {","class":"lineCov","hits":"1","order":"265",},
{"lineNum":"   42","line":"    VERIFY_CHECK((offset + count - 1) >> 6 == offset >> 6);","class":"lineCov","hits":"1","order":"266",},
{"lineNum":"   43","line":"    return (a->d[offset >> 6] >> (offset & 0x3F)) & ((((uint64_t)1) << count) - 1);","class":"lineCov","hits":"1","order":"267",},
{"lineNum":"   44","line":"}"},
{"lineNum":"   45","line":""},
{"lineNum":"   46","line":"SECP256K1_INLINE static unsigned int secp256k1_scalar_get_bits_var(const secp256k1_scalar *a, unsigned int offset, unsigned int count) {","class":"lineCov","hits":"1","order":"1301",},
{"lineNum":"   47","line":"    VERIFY_CHECK(count < 32);","class":"lineCov","hits":"1","order":"1300",},
{"lineNum":"   48","line":"    VERIFY_CHECK(offset + count <= 256);","class":"lineCov","hits":"1","order":"1299",},
{"lineNum":"   49","line":"    if ((offset + count - 1) >> 6 == offset >> 6) {","class":"lineCov","hits":"1","order":"1335",},
{"lineNum":"   50","line":"        return secp256k1_scalar_get_bits(a, offset, count);","class":"lineCov","hits":"1","order":"1336",},
{"lineNum":"   51","line":"    } else {"},
{"lineNum":"   52","line":"        VERIFY_CHECK((offset >> 6) + 1 < 4);","class":"lineCov","hits":"1","order":"1298",},
{"lineNum":"   53","line":"        return ((a->d[offset >> 6] >> (offset & 0x3F)) | (a->d[(offset >> 6) + 1] << (64 - (offset & 0x3F)))) & ((((uint64_t)1) << count) - 1);","class":"lineCov","hits":"1","order":"1329",},
{"lineNum":"   54","line":"    }"},
{"lineNum":"   55","line":"}","class":"lineCov","hits":"1","order":"1338",},
{"lineNum":"   56","line":""},
{"lineNum":"   57","line":"SECP256K1_INLINE static int secp256k1_scalar_check_overflow(const secp256k1_scalar *a) {","class":"lineCov","hits":"1","order":"237",},
{"lineNum":"   58","line":"    int yes = 0;","class":"lineCov","hits":"1","order":"236",},
{"lineNum":"   59","line":"    int no = 0;","class":"lineCov","hits":"1","order":"235",},
{"lineNum":"   60","line":"    no |= (a->d[3] < SECP256K1_N_3); /* No need for a > check. */","class":"lineCov","hits":"1","order":"234",},
{"lineNum":"   61","line":"    no |= (a->d[2] < SECP256K1_N_2);","class":"lineCov","hits":"1","order":"233",},
{"lineNum":"   62","line":"    yes |= (a->d[2] > SECP256K1_N_2) & ~no;","class":"lineCov","hits":"1","order":"232",},
{"lineNum":"   63","line":"    no |= (a->d[1] < SECP256K1_N_1);","class":"lineCov","hits":"1","order":"231",},
{"lineNum":"   64","line":"    yes |= (a->d[1] > SECP256K1_N_1) & ~no;","class":"lineCov","hits":"1","order":"230",},
{"lineNum":"   65","line":"    yes |= (a->d[0] >= SECP256K1_N_0) & ~no;","class":"lineCov","hits":"1","order":"229",},
{"lineNum":"   66","line":"    return yes;","class":"lineCov","hits":"1","order":"228",},
{"lineNum":"   67","line":"}"},
{"lineNum":"   68","line":""},
{"lineNum":"   69","line":"SECP256K1_INLINE static int secp256k1_scalar_reduce(secp256k1_scalar *r, unsigned int overflow) {","class":"lineCov","hits":"1","order":"248",},
{"lineNum":"   70","line":"    uint128_t t;"},
{"lineNum":"   71","line":"    VERIFY_CHECK(overflow <= 1);","class":"lineCov","hits":"1","order":"247",},
{"lineNum":"   72","line":"    t = (uint128_t)r->d[0] + overflow * SECP256K1_N_C_0;","class":"lineCov","hits":"1","order":"246",},
{"lineNum":"   73","line":"    r->d[0] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"245",},
{"lineNum":"   74","line":"    t += (uint128_t)r->d[1] + overflow * SECP256K1_N_C_1;","class":"lineCov","hits":"1","order":"244",},
{"lineNum":"   75","line":"    r->d[1] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"243",},
{"lineNum":"   76","line":"    t += (uint128_t)r->d[2] + overflow * SECP256K1_N_C_2;","class":"lineCov","hits":"1","order":"242",},
{"lineNum":"   77","line":"    r->d[2] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"241",},
{"lineNum":"   78","line":"    t += (uint64_t)r->d[3];","class":"lineCov","hits":"1","order":"240",},
{"lineNum":"   79","line":"    r->d[3] = t & 0xFFFFFFFFFFFFFFFFULL;","class":"lineCov","hits":"1","order":"239",},
{"lineNum":"   80","line":"    return overflow;","class":"lineCov","hits":"1","order":"238",},
{"lineNum":"   81","line":"}"},
{"lineNum":"   82","line":""},
{"lineNum":"   83","line":"static int secp256k1_scalar_add(secp256k1_scalar *r, const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"1","order":"1322",},
{"lineNum":"   84","line":"    int overflow;"},
{"lineNum":"   85","line":"    uint128_t t = (uint128_t)a->d[0] + b->d[0];","class":"lineCov","hits":"1","order":"1316",},
{"lineNum":"   86","line":"    r->d[0] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"1313",},
{"lineNum":"   87","line":"    t += (uint128_t)a->d[1] + b->d[1];","class":"lineCov","hits":"1","order":"1311",},
{"lineNum":"   88","line":"    r->d[1] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"1309",},
{"lineNum":"   89","line":"    t += (uint128_t)a->d[2] + b->d[2];","class":"lineCov","hits":"1","order":"1306",},
{"lineNum":"   90","line":"    r->d[2] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"1304",},
{"lineNum":"   91","line":"    t += (uint128_t)a->d[3] + b->d[3];","class":"lineCov","hits":"1","order":"1327",},
{"lineNum":"   92","line":"    r->d[3] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"1348",},
{"lineNum":"   93","line":"    overflow = t + secp256k1_scalar_check_overflow(r);","class":"lineCov","hits":"1","order":"1328",},
{"lineNum":"   94","line":"    VERIFY_CHECK(overflow == 0 || overflow == 1);","class":"lineCov","hits":"1","order":"1297",},
{"lineNum":"   95","line":"    secp256k1_scalar_reduce(r, overflow);","class":"lineCov","hits":"1","order":"1296",},
{"lineNum":"   96","line":"    return overflow;","class":"lineCov","hits":"1","order":"1295",},
{"lineNum":"   97","line":"}"},
{"lineNum":"   98","line":""},
...
{"lineNum":"  115","line":"}"},
{"lineNum":"  116","line":""},
{"lineNum":"  117","line":"static void secp256k1_scalar_set_b32(secp256k1_scalar *r, const unsigned char *b32, int *overflow) {","class":"lineCov","hits":"1","order":"268",},
{"lineNum":"  118","line":"    int over;"},
{"lineNum":"  119","line":"    r->d[0] = (uint64_t)b32[31] | (uint64_t)b32[30] << 8 | (uint64_t)b32[29] << 16 | (uint64_t)b32[28] << 24 | (uint64_t)b32[27] << 32 | (uint64_t)b32[26] << 40 | (uint64_t)b32[25] << 48 | (uint64_t)b32[24] << 56;","class":"lineCov","hits":"1","order":"269",},
{"lineNum":"  120","line":"    r->d[1] = (uint64_t)b32[23] | (uint64_t)b32[22] << 8 | (uint64_t)b32[21] << 16 | (uint64_t)b32[20] << 24 | (uint64_t)b32[19] << 32 | (uint64_t)b32[18] << 40 | (uint64_t)b32[17] << 48 | (uint64_t)b32[16] << 56;","class":"lineCov","hits":"1","order":"270",},
{"lineNum":"  121","line":"    r->d[2] = (uint64_t)b32[15] | (uint64_t)b32[14] << 8 | (uint64_t)b32[13] << 16 | (uint64_t)b32[12] << 24 | (uint64_t)b32[11] << 32 | (uint64_t)b32[10] << 40 | (uint64_t)b32[9] << 48 | (uint64_t)b32[8] << 56;","class":"lineCov","hits":"1","order":"271",},
{"lineNum":"  122","line":"    r->d[3] = (uint64_t)b32[7] | (uint64_t)b32[6] << 8 | (uint64_t)b32[5] << 16 | (uint64_t)b32[4] << 24 | (uint64_t)b32[3] << 32 | (uint64_t)b32[2] << 40 | (uint64_t)b32[1] << 48 | (uint64_t)b32[0] << 56;","class":"lineCov","hits":"1","order":"272",},
{"lineNum":"  123","line":"    over = secp256k1_scalar_reduce(r, secp256k1_scalar_check_overflow(r));","class":"lineCov","hits":"1","order":"273",},
{"lineNum":"  124","line":"    if (overflow) {","class":"lineCov","hits":"1","order":"274",},
{"lineNum":"  125","line":"        *overflow = over;","class":"lineCov","hits":"1","order":"1344",},
{"lineNum":"  126","line":"    }"},
{"lineNum":"  127","line":"}","class":"lineCov","hits":"1","order":"276",},
{"lineNum":"  128","line":""},
{"lineNum":"  129","line":"static void secp256k1_scalar_get_b32(unsigned char *bin, const secp256k1_scalar* a) {","class":"lineCov","hits":"1","order":"275",},
{"lineNum":"  130","line":"    bin[0] = a->d[3] >> 56; bin[1] = a->d[3] >> 48; bin[2] = a->d[3] >> 40; bin[3] = a->d[3] >> 32; bin[4] = a->d[3] >> 24; bin[5] = a->d[3] >> 16; bin[6] = a->d[3] >> 8; bin[7] = a->d[3];","class":"lineCov","hits":"1","order":"250",},
{"lineNum":"  131","line":"    bin[8] = a->d[2] >> 56; bin[9] = a->d[2] >> 48; bin[10] = a->d[2] >> 40; bin[11] = a->d[2] >> 32; bin[12] = a->d[2] >> 24; bin[13] = a->d[2] >> 16; bin[14] = a->d[2] >> 8; bin[15] = a->d[2];","class":"lineCov","hits":"1","order":"278",},
{"lineNum":"  132","line":"    bin[16] = a->d[1] >> 56; bin[17] = a->d[1] >> 48; bin[18] = a->d[1] >> 40; bin[19] = a->d[1] >> 32; bin[20] = a->d[1] >> 24; bin[21] = a->d[1] >> 16; bin[22] = a->d[1] >> 8; bin[23] = a->d[1];","class":"lineCov","hits":"1","order":"277",},
{"lineNum":"  133","line":"    bin[24] = a->d[0] >> 56; bin[25] = a->d[0] >> 48; bin[26] = a->d[0] >> 40; bin[27] = a->d[0] >> 32; bin[28] = a->d[0] >> 24; bin[29] = a->d[0] >> 16; bin[30] = a->d[0] >> 8; bin[31] = a->d[0];","class":"lineCov","hits":"1","order":"279",},
{"lineNum":"  134","line":"}","class":"lineCov","hits":"1","order":"249",},
{"lineNum":"  135","line":""},
{"lineNum":"  136","line":"SECP256K1_INLINE static int secp256k1_scalar_is_zero(const secp256k1_scalar *a) {","class":"lineCov","hits":"1","order":"263",},
{"lineNum":"  137","line":"    return (a->d[0] | a->d[1] | a->d[2] | a->d[3]) == 0;","class":"lineCov","hits":"1","order":"264",},
{"lineNum":"  138","line":"}"},
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"static void secp256k1_scalar_negate(secp256k1_scalar *r, const secp256k1_scalar *a) {","class":"lineCov","hits":"1","order":"1331",},
{"lineNum":"  141","line":"    uint64_t nonzero = 0xFFFFFFFFFFFFFFFFULL * (secp256k1_scalar_is_zero(a) == 0);","class":"lineCov","hits":"1","order":"1333",},
{"lineNum":"  142","line":"    uint128_t t = (uint128_t)(~a->d[0]) + SECP256K1_N_0 + 1;","class":"lineCov","hits":"1","order":"1321",},
{"lineNum":"  143","line":"    r->d[0] = t & nonzero; t >>= 64;","class":"lineCov","hits":"1","order":"1319",},
{"lineNum":"  144","line":"    t += (uint128_t)(~a->d[1]) + SECP256K1_N_1;","class":"lineCov","hits":"1","order":"1315",},
{"lineNum":"  145","line":"    r->d[1] = t & nonzero; t >>= 64;","class":"lineCov","hits":"1","order":"1312",},
{"lineNum":"  146","line":"    t += (uint128_t)(~a->d[2]) + SECP256K1_N_2;","class":"lineCov","hits":"1","order":"1310",},
{"lineNum":"  147","line":"    r->d[2] = t & nonzero; t >>= 64;","class":"lineCov","hits":"1","order":"1308",},
{"lineNum":"  148","line":"    t += (uint128_t)(~a->d[3]) + SECP256K1_N_3;","class":"lineCov","hits":"1","order":"1305",},
{"lineNum":"  149","line":"    r->d[3] = t & nonzero;","class":"lineCov","hits":"1","order":"1303",},
{"lineNum":"  150","line":"}","class":"lineCov","hits":"1","order":"1325",},
{"lineNum":"  151","line":""},
...
{"lineNum":"  268","line":"}"},
{"lineNum":"  269","line":""},
{"lineNum":"  270","line":"static void secp256k1_scalar_reduce_512(secp256k1_scalar *r, const uint64_t *l) {","class":"lineCov","hits":"1","order":"1317",},
...
{"lineNum":"  276","line":""},
{"lineNum":"  277","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"1323",},
...
{"lineNum":"  379","line":"    : \"S\"(l), \"n\"(SECP256K1_N_C_0), \"n\"(SECP256K1_N_C_1)","class":"lineCov","hits":"1","order":"1343",},
{"lineNum":"  380","line":"    : \"rax\", \"rdx\", \"r8\", \"r9\", \"r10\", \"r11\", \"r12\", \"r13\", \"r14\", \"cc\");"},
{"lineNum":"  381","line":""},
{"lineNum":"  382","line":"    /* Reduce 385 bits into 258. */"},
{"lineNum":"  383","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"1341",},
...
{"lineNum":"  458","line":"    : \"g\"(m0), \"g\"(m1), \"g\"(m2), \"g\"(m3), \"g\"(m4), \"g\"(m5), \"g\"(m6), \"n\"(SECP256K1_N_C_0), \"n\"(SECP256K1_N_C_1)","class":"lineCov","hits":"1","order":"1284",},
{"lineNum":"  459","line":"    : \"rax\", \"rdx\", \"r8\", \"r9\", \"r10\", \"r11\", \"r12\", \"r13\", \"cc\");"},
{"lineNum":"  460","line":""},
{"lineNum":"  461","line":"    /* Reduce 258 bits into 256. */"},
{"lineNum":"  462","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"1282",},
...
{"lineNum":"  504","line":"    : \"g\"(p0), \"g\"(p1), \"g\"(p2), \"g\"(p3), \"g\"(p4), \"D\"(r), \"n\"(SECP256K1_N_C_0), \"n\"(SECP256K1_N_C_1)","class":"lineCov","hits":"1","order":"1340",},
...
{"lineNum":"  576","line":"    secp256k1_scalar_reduce(r, c + secp256k1_scalar_check_overflow(r));","class":"lineCov","hits":"1","order":"1281",},
{"lineNum":"  577","line":"}","class":"lineCov","hits":"1","order":"1289",},
{"lineNum":"  578","line":""},
{"lineNum":"  579","line":"static void secp256k1_scalar_mul_512(uint64_t l[8], const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"1","order":"1288",},
{"lineNum":"  580","line":"#ifdef USE_ASM_X86_64"},
{"lineNum":"  581","line":"    const uint64_t *pb = b->d;","class":"lineCov","hits":"1","order":"1287",},
{"lineNum":"  582","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"1286",},
...
{"lineNum":"  710","line":"    : \"S\"(l), \"D\"(a->d)","class":"lineCov","hits":"1","order":"1285",},
...
{"lineNum":"  744","line":"}","class":"lineCov","hits":"1","order":"1283",},
{"lineNum":"  745","line":""},
{"lineNum":"  746","line":"static void secp256k1_scalar_sqr_512(uint64_t l[8], const secp256k1_scalar *a) {","class":"lineCov","hits":"1","order":"1280",},
{"lineNum":"  747","line":"#ifdef USE_ASM_X86_64"},
{"lineNum":"  748","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"1279",},
...
{"lineNum":"  852","line":"    :"},
{"lineNum":"  853","line":"    : \"S\"(l), \"D\"(a->d)","class":"lineCov","hits":"1","order":"1326",},
...
{"lineNum":"  881","line":"}","class":"lineCov","hits":"1","order":"1339",},
{"lineNum":"  882","line":""},
...
{"lineNum":"  890","line":""},
{"lineNum":"  891","line":"static void secp256k1_scalar_mul(secp256k1_scalar *r, const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"1","order":"1342",},
{"lineNum":"  892","line":"    uint64_t l[8];"},
{"lineNum":"  893","line":"    secp256k1_scalar_mul_512(l, a, b);","class":"lineCov","hits":"1","order":"1346",},
{"lineNum":"  894","line":"    secp256k1_scalar_reduce_512(r, l);","class":"lineCov","hits":"1","order":"1345",},
{"lineNum":"  895","line":"}","class":"lineCov","hits":"1","order":"1347",},
{"lineNum":"  896","line":""},
{"lineNum":"  897","line":"static int secp256k1_scalar_shr_int(secp256k1_scalar *r, int n) {","class":"lineCov","hits":"1","order":"1292",},
{"lineNum":"  898","line":"    int ret;"},
{"lineNum":"  899","line":"    VERIFY_CHECK(n > 0);","class":"lineCov","hits":"1","order":"1337",},
{"lineNum":"  900","line":"    VERIFY_CHECK(n < 16);","class":"lineCov","hits":"1","order":"1291",},
{"lineNum":"  901","line":"    ret = r->d[0] & ((1 << n) - 1);","class":"lineCov","hits":"1","order":"1290",},
{"lineNum":"  902","line":"    r->d[0] = (r->d[0] >> n) + (r->d[1] << (64 - n));","class":"lineCov","hits":"1","order":"1330",},
{"lineNum":"  903","line":"    r->d[1] = (r->d[1] >> n) + (r->d[2] << (64 - n));","class":"lineCov","hits":"1","order":"1332",},
{"lineNum":"  904","line":"    r->d[2] = (r->d[2] >> n) + (r->d[3] << (64 - n));","class":"lineCov","hits":"1","order":"1320",},
{"lineNum":"  905","line":"    r->d[3] = (r->d[3] >> n);","class":"lineCov","hits":"1","order":"1318",},
{"lineNum":"  906","line":"    return ret;","class":"lineCov","hits":"1","order":"1314",},
{"lineNum":"  907","line":"}"},
{"lineNum":"  908","line":""},
{"lineNum":"  909","line":"static void secp256k1_scalar_sqr(secp256k1_scalar *r, const secp256k1_scalar *a) {","class":"lineCov","hits":"1","order":"1307",},
{"lineNum":"  910","line":"    uint64_t l[8];"},
{"lineNum":"  911","line":"    secp256k1_scalar_sqr_512(l, a);","class":"lineCov","hits":"1","order":"1302",},
{"lineNum":"  912","line":"    secp256k1_scalar_reduce_512(r, l);","class":"lineCov","hits":"1","order":"1324",},
{"lineNum":"  913","line":"}","class":"lineCov","hits":"1","order":"1293",},
{"lineNum":"  914","line":""},
...
{"lineNum":"  927","line":""},
{"lineNum":"  928","line":"SECP256K1_INLINE static int secp256k1_scalar_eq(const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"1","order":"1334",},
{"lineNum":"  929","line":"    return ((a->d[0] ^ b->d[0]) | (a->d[1] ^ b->d[1]) | (a->d[2] ^ b->d[2]) | (a->d[3] ^ b->d[3])) == 0;","class":"lineCov","hits":"1","order":"1294",},
{"lineNum":"  930","line":"}"},
{"lineNum":"  931","line":""},
...
var header = { "command" : "", "date" : "2023-08-24 10:21:39", "instrumented" : 122, "covered" : 122,};
var merged_data = [];
