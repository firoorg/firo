...
{"lineNum":"   36","line":"      : data_ptr_(data), remaining_bytes_(size) {}","class":"lineCov","hits":"1","order":"864",},
...
{"lineNum":"  108","line":"std::vector<T> FuzzedDataProvider::ConsumeBytes(size_t num_bytes) {","class":"lineCov","hits":"1","order":"884",},
{"lineNum":"  109","line":"  num_bytes = std::min(num_bytes, remaining_bytes_);","class":"lineCov","hits":"1","order":"886",},
{"lineNum":"  110","line":"  return ConsumeBytes<T>(num_bytes, num_bytes);","class":"lineCov","hits":"1","order":"885",},
{"lineNum":"  111","line":"}"},
{"lineNum":"  112","line":""},
...
{"lineNum":"  194","line":"template <typename T> T FuzzedDataProvider::ConsumeIntegral() {","class":"lineCov","hits":"1","order":"866",},
{"lineNum":"  195","line":"  return ConsumeIntegralInRange(std::numeric_limits<T>::min(),","class":"lineCov","hits":"1","order":"853",},
{"lineNum":"  196","line":"                                std::numeric_limits<T>::max());","class":"lineCov","hits":"1","order":"856",},
{"lineNum":"  197","line":"}"},
{"lineNum":"  198","line":""},
...
{"lineNum":"  204","line":"T FuzzedDataProvider::ConsumeIntegralInRange(T min, T max) {","class":"lineCov","hits":"1","order":"861",},
...
{"lineNum":"  207","line":""},
{"lineNum":"  208","line":"  if (min > max)","class":"lineCov","hits":"1","order":"858",},
{"lineNum":"  209","line":"    abort();","class":"lineCov","hits":"1","order":"1919",},
{"lineNum":"  210","line":""},
{"lineNum":"  211","line":"  // Use the biggest type possible to hold the range and the result."},
{"lineNum":"  212","line":"  uint64_t range = static_cast<uint64_t>(max) - min;","class":"lineCov","hits":"1","order":"857",},
{"lineNum":"  213","line":"  uint64_t result = 0;","class":"lineCov","hits":"1","order":"863",},
{"lineNum":"  214","line":"  size_t offset = 0;","class":"lineCov","hits":"1","order":"855",},
{"lineNum":"  215","line":""},
{"lineNum":"  216","line":"  while (offset < sizeof(T) * CHAR_BIT && (range >> offset) > 0 &&","class":"lineCov","hits":"1","order":"854",},
{"lineNum":"  217","line":"         remaining_bytes_ != 0) {","class":"lineCov","hits":"1","order":"860",},
...
{"lineNum":"  224","line":"    --remaining_bytes_;","class":"lineCov","hits":"1","order":"999",},
{"lineNum":"  225","line":"    result = (result << CHAR_BIT) | data_ptr_[remaining_bytes_];","class":"lineCov","hits":"1","order":"1001",},
{"lineNum":"  226","line":"    offset += CHAR_BIT;","class":"lineCov","hits":"1","order":"1000",},
{"lineNum":"  227","line":"  }"},
{"lineNum":"  228","line":""},
{"lineNum":"  229","line":"  // Avoid division by 0, in case |range + 1| results in overflow."},
{"lineNum":"  230","line":"  if (range != std::numeric_limits<decltype(range)>::max())","class":"lineCov","hits":"1","order":"859",},
{"lineNum":"  231","line":"    result = result % (range + 1);","class":"lineCov","hits":"1","order":"865",},
{"lineNum":"  232","line":""},
{"lineNum":"  233","line":"  return static_cast<T>(min + result);","class":"lineCov","hits":"1","order":"862",},
{"lineNum":"  234","line":"}"},
{"lineNum":"  235","line":""},
...
{"lineNum":"  338","line":"                                               size_t num_bytes) {","class":"lineCov","hits":"1","order":"1026",},
{"lineNum":"  339","line":"  std::memcpy(destination, data_ptr_, num_bytes);","class":"lineCov","hits":"1","order":"1018",},
{"lineNum":"  340","line":"  Advance(num_bytes);","class":"lineCov","hits":"1","order":"1017",},
{"lineNum":"  341","line":"}","class":"lineCov","hits":"1","order":"1016",},
{"lineNum":"  342","line":""},
{"lineNum":"  343","line":"inline void FuzzedDataProvider::Advance(size_t num_bytes) {","class":"lineCov","hits":"1","order":"1020",},
{"lineNum":"  344","line":"  if (num_bytes > remaining_bytes_)","class":"lineCov","hits":"1","order":"1019",},
{"lineNum":"  345","line":"    abort();","class":"lineNoCov","hits":"0",},
{"lineNum":"  346","line":""},
{"lineNum":"  347","line":"  data_ptr_ += num_bytes;","class":"lineCov","hits":"1","order":"1015",},
{"lineNum":"  348","line":"  remaining_bytes_ -= num_bytes;","class":"lineCov","hits":"1","order":"1021",},
{"lineNum":"  349","line":"}","class":"lineCov","hits":"1","order":"1022",},
{"lineNum":"  350","line":""},
{"lineNum":"  351","line":"template <typename T>"},
{"lineNum":"  352","line":"std::vector<T> FuzzedDataProvider::ConsumeBytes(size_t size, size_t num_bytes) {","class":"lineCov","hits":"1","order":"888",},
...
{"lineNum":"  361","line":"  std::vector<T> result(size);","class":"lineCov","hits":"1","order":"883",},
{"lineNum":"  362","line":"  if (size == 0) {","class":"lineCov","hits":"1","order":"887",},
{"lineNum":"  363","line":"    if (num_bytes != 0)","class":"lineCov","hits":"1","order":"889",},
{"lineNum":"  364","line":"      abort();","class":"lineNoCov","hits":"0",},
{"lineNum":"  365","line":"    return result;","class":"lineCov","hits":"1","order":"890",},
{"lineNum":"  366","line":"  }"},
{"lineNum":"  367","line":""},
{"lineNum":"  368","line":"  CopyAndAdvance(result.data(), num_bytes);","class":"lineCov","hits":"1","order":"1023",},
{"lineNum":"  369","line":""},
...
{"lineNum":"  373","line":"  result.shrink_to_fit();","class":"lineCov","hits":"1","order":"1024",},
{"lineNum":"  374","line":"  return result;","class":"lineCov","hits":"1","order":"1025",},
...
var header = { "command" : "", "date" : "2023-08-24 10:21:39", "instrumented" : 41, "covered" : 38,};
var merged_data = [];
