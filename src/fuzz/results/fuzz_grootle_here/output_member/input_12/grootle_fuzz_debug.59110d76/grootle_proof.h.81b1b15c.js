...
{"lineNum":"    7","line":""},
{"lineNum":"    8","line":"class GrootleProof {","class":"linePartCov","hits":"2","order":"1051","possible_hits":"6",},
...
{"lineNum":"   17","line":"    }"},
{"lineNum":"   18","line":""},
{"lineNum":"   19","line":"    ADD_SERIALIZE_METHODS;"},
{"lineNum":"   20","line":"    template <typename Stream, typename Operation>"},
{"lineNum":"   21","line":"    inline void SerializationOp(Stream& s, Operation ser_action) {"},
{"lineNum":"   22","line":"        READWRITE(A);"},
{"lineNum":"   23","line":"        READWRITE(B);"},
{"lineNum":"   24","line":"        READWRITE(X);"},
{"lineNum":"   25","line":"        READWRITE(X1);"},
{"lineNum":"   26","line":"        READWRITE(f);"},
{"lineNum":"   27","line":"        READWRITE(z);"},
{"lineNum":"   28","line":"        READWRITE(zS);"},
{"lineNum":"   29","line":"        READWRITE(zV);"},
{"lineNum":"   30","line":"    }"},
{"lineNum":"   31","line":""},
...
var header = { "command" : "grootle_fuzz_debug", "date" : "2023-08-17 10:24:19", "instrumented" : 1, "covered" : 1,};
var merged_data = [];
