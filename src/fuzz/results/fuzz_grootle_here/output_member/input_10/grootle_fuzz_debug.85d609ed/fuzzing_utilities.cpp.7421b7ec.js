...
{"lineNum":"   14","line":""},
{"lineNum":"   15","line":"secp_primitives::Scalar FuzzedSecp256k1Object::GetScalar() {","class":"lineCov","hits":"2","order":"68","possible_hits":"2",},
{"lineNum":"   16","line":"    uint64_t value = this->fdp->ConsumeIntegral<uint64_t>();","class":"lineCov","hits":"1","order":"69","possible_hits":"1",},
{"lineNum":"   17","line":"    secp_primitives::Scalar s = secp_primitives::Scalar(value);","class":"lineCov","hits":"1","order":"73","possible_hits":"1",},
{"lineNum":"   18","line":""},
{"lineNum":"   19","line":"    return s;","class":"lineCov","hits":"1","order":"74","possible_hits":"1",},
{"lineNum":"   20","line":"}","class":"lineCov","hits":"1","order":"75","possible_hits":"1",},
{"lineNum":"   21","line":""},
...
{"lineNum":"   36","line":""},
{"lineNum":"   37","line":"std::vector<secp_primitives::GroupElement> FuzzedSecp256k1Object::GetRandomGroupVector(size_t len) {","class":"lineCov","hits":"2","order":"27","possible_hits":"2",},
{"lineNum":"   38","line":"    std::vector<secp_primitives::GroupElement> result;","class":"lineCov","hits":"1","order":"28","possible_hits":"1",},
{"lineNum":"   39","line":"    result.resize(len);","class":"lineCov","hits":"1","order":"29","possible_hits":"1",},
{"lineNum":"   40","line":"    for (size_t i = 0; i < len; i++) {","class":"lineCov","hits":"2","order":"30","possible_hits":"2",},
{"lineNum":"   41","line":"        result[i].randomize();","class":"lineCov","hits":"1","order":"31","possible_hits":"1",},
{"lineNum":"   42","line":"    }","class":"lineCov","hits":"1","order":"32","possible_hits":"1",},
{"lineNum":"   43","line":"    return result;","class":"lineCov","hits":"1","order":"33","possible_hits":"1",},
{"lineNum":"   44","line":"}","class":"linePartCov","hits":"1","order":"34","possible_hits":"2",},
{"lineNum":"   45","line":""},
...
{"lineNum":"   55","line":""},
{"lineNum":"   56","line":"std::vector<secp_primitives::Scalar> FuzzedSecp256k1Object::GetScalars(int len) {","class":"lineNoCov","hits":"0","possible_hits":"2",},
...
{"lineNum":"   67","line":"    secp_primitives::Scalar s = secp_primitives::Scalar(this->fdp->ConsumeBytes<uint8_t>(32).data());","class":"lineNoCov","hits":"0","possible_hits":"4",},
...
var header = { "command" : "grootle_fuzz_debug", "date" : "2023-08-24 10:18:58", "instrumented" : 59, "covered" : 16,};
var merged_data = [];
