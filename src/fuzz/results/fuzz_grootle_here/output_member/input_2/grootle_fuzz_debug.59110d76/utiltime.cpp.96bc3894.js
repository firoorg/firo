...
{"lineNum":"   41","line":"{","class":"linePartCov","hits":"1","possible_hits":"2",},
{"lineNum":"   42","line":"    int64_t now = (boost::posix_time::microsec_clock::universal_time() -","class":"linePartCov","hits":"1","possible_hits":"3",},
{"lineNum":"   43","line":"                   boost::posix_time::ptime(boost::gregorian::date(1970,1,1))).total_microseconds();","class":"linePartCov","hits":"1","possible_hits":"2",},
{"lineNum":"   44","line":"    assert(now > 0);","class":"lineCov","hits":"1","possible_hits":"1",},
{"lineNum":"   45","line":"    return now;","class":"lineCov","hits":"1","possible_hits":"1",},
{"lineNum":"   46","line":"}"},
{"lineNum":"   47","line":""},
...
{"lineNum":"   56","line":"    if (nMockTime) return nMockTime*1000000;","class":"lineCov","hits":"1","possible_hits":"1",},
{"lineNum":"   57","line":""},
{"lineNum":"   58","line":"    return GetTimeMicros();","class":"lineCov","hits":"1","possible_hits":"1",},
...
{"lineNum":"   80","line":"{","class":"linePartCov","hits":"1","possible_hits":"2",},
{"lineNum":"   81","line":"    static std::locale classic(std::locale::classic());","class":"linePartCov","hits":"1","possible_hits":"4",},
{"lineNum":"   82","line":"    // std::locale takes ownership of the pointer"},
{"lineNum":"   83","line":"    std::locale loc(classic, new boost::posix_time::time_facet(pszFormat));","class":"linePartCov","hits":"1","possible_hits":"3",},
{"lineNum":"   84","line":"    std::stringstream ss;","class":"lineCov","hits":"1","possible_hits":"1",},
{"lineNum":"   85","line":"    ss.imbue(loc);","class":"lineCov","hits":"1","possible_hits":"1",},
{"lineNum":"   86","line":"    ss << boost::posix_time::from_time_t(nTime);","class":"lineCov","hits":"1","possible_hits":"1",},
{"lineNum":"   87","line":"    return ss.str();","class":"lineCov","hits":"1","possible_hits":"1",},
{"lineNum":"   88","line":"}","class":"linePartCov","hits":"1","possible_hits":"3",},
{"lineNum":"   89","line":""},
...
var header = { "command" : "grootle_fuzz_debug", "date" : "2023-08-17 10:19:15", "instrumented" : 49, "covered" : 17,};
var merged_data = [];
