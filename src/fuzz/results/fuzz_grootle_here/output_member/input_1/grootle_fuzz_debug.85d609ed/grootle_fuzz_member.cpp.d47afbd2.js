...
{"lineNum":"   25","line":"    std::vector<size_t> sizes;","class":"lineCov","hits":"1","order":"48","possible_hits":"1",},
{"lineNum":"   26","line":"    sizes.resize(N);","class":"lineCov","hits":"1","order":"49","possible_hits":"1",},
{"lineNum":"   27","line":"    for(size_t i=0; i < N; i++) {","class":"lineCov","hits":"2","order":"50","possible_hits":"2",},
{"lineNum":"   28","line":"        sizes[i] = fdp.ConsumeIntegralInRange<size_t>(0, N);","class":"lineCov","hits":"1","order":"51","possible_hits":"1",},
{"lineNum":"   29","line":"    }"},
{"lineNum":"   30","line":"    std::vector<GroupElement> S1, V1;","class":"lineCov","hits":"1","order":"52","possible_hits":"1",},
{"lineNum":"   31","line":"    std::vector<std::vector<unsigned char>> roots;","class":"lineCov","hits":"1","order":"53","possible_hits":"1",},
{"lineNum":"   32","line":"    std::vector<Scalar> s, v;","class":"lineCov","hits":"1","order":"54","possible_hits":"1",},
{"lineNum":"   33","line":"    for (std::size_t index : indexes) {","class":"linePartCov","hits":"1","order":"55","possible_hits":"2",},
...
{"lineNum":"   53","line":""},
{"lineNum":"   54","line":"    spark::Grootle grootle(H, Gi, Hi, n, m);","class":"lineCov","hits":"1","order":"56","possible_hits":"1",},
{"lineNum":"   55","line":"    std::vector<spark::GrootleProof> proofs;","class":"lineCov","hits":"1","order":"57","possible_hits":"1",},
{"lineNum":"   56","line":""},
{"lineNum":"   57","line":"    for (size_t i=0; i < indexes.size(); i++) {","class":"linePartCov","hits":"1","order":"58","possible_hits":"2",},
...
{"lineNum":"   77","line":""},
{"lineNum":"   78","line":"    assert(grootle.verify(S, S1, V, V1, roots, sizes, proofs));","class":"lineCov","hits":"1","order":"59","possible_hits":"1",},
{"lineNum":"   79","line":""},
...
var header = { "command" : "grootle_fuzz_debug", "date" : "2023-08-24 10:16:31", "instrumented" : 62, "covered" : 26,};
var merged_data = [];
