...
{"lineNum":"   26","line":""},
{"lineNum":"   27","line":"SECP256K1_INLINE static void secp256k1_scalar_clear(secp256k1_scalar *r) {","class":"linePartCov","hits":"2","order":"733","possible_hits":"4",},
{"lineNum":"   28","line":"    r->d[0] = 0;","class":"linePartCov","hits":"1","order":"734","possible_hits":"2",},
{"lineNum":"   29","line":"    r->d[1] = 0;","class":"linePartCov","hits":"1","order":"735","possible_hits":"2",},
{"lineNum":"   30","line":"    r->d[2] = 0;","class":"linePartCov","hits":"1","order":"736","possible_hits":"2",},
{"lineNum":"   31","line":"    r->d[3] = 0;","class":"linePartCov","hits":"1","order":"737","possible_hits":"2",},
{"lineNum":"   32","line":"}","class":"linePartCov","hits":"1","order":"738","possible_hits":"4",},
{"lineNum":"   33","line":""},
{"lineNum":"   34","line":"SECP256K1_INLINE static void secp256k1_scalar_set_int(secp256k1_scalar *r, unsigned int v) {","class":"linePartCov","hits":"2","order":"770","possible_hits":"6",},
{"lineNum":"   35","line":"    r->d[0] = v;","class":"linePartCov","hits":"1","order":"771","possible_hits":"3",},
{"lineNum":"   36","line":"    r->d[1] = 0;","class":"linePartCov","hits":"1","order":"772","possible_hits":"3",},
{"lineNum":"   37","line":"    r->d[2] = 0;","class":"linePartCov","hits":"1","order":"773","possible_hits":"3",},
{"lineNum":"   38","line":"    r->d[3] = 0;","class":"linePartCov","hits":"1","order":"774","possible_hits":"3",},
{"lineNum":"   39","line":"}","class":"linePartCov","hits":"1","order":"775","possible_hits":"6",},
{"lineNum":"   40","line":""},
{"lineNum":"   41","line":"SECP256K1_INLINE static unsigned int secp256k1_scalar_get_bits(const secp256k1_scalar *a, unsigned int offset, unsigned int count) {","class":"linePartCov","hits":"2","order":"809","possible_hits":"4",},
{"lineNum":"   42","line":"    VERIFY_CHECK((offset + count - 1) >> 6 == offset >> 6);","class":"linePartCov","hits":"1","order":"810","possible_hits":"2",},
{"lineNum":"   43","line":"    return (a->d[offset >> 6] >> (offset & 0x3F)) & ((((uint64_t)1) << count) - 1);","class":"linePartCov","hits":"1","order":"811","possible_hits":"2",},
{"lineNum":"   44","line":"}"},
{"lineNum":"   45","line":""},
...
{"lineNum":"  128","line":""},
{"lineNum":"  129","line":"static void secp256k1_scalar_get_b32(unsigned char *bin, const secp256k1_scalar* a) {","class":"lineCov","hits":"2","order":"856","possible_hits":"2",},
{"lineNum":"  130","line":"    bin[0] = a->d[3] >> 56; bin[1] = a->d[3] >> 48; bin[2] = a->d[3] >> 40; bin[3] = a->d[3] >> 32; bin[4] = a->d[3] >> 24; bin[5] = a->d[3] >> 16; bin[6] = a->d[3] >> 8; bin[7] = a->d[3];","class":"lineCov","hits":"1","order":"857","possible_hits":"1",},
{"lineNum":"  131","line":"    bin[8] = a->d[2] >> 56; bin[9] = a->d[2] >> 48; bin[10] = a->d[2] >> 40; bin[11] = a->d[2] >> 32; bin[12] = a->d[2] >> 24; bin[13] = a->d[2] >> 16; bin[14] = a->d[2] >> 8; bin[15] = a->d[2];","class":"lineCov","hits":"1","order":"858","possible_hits":"1",},
{"lineNum":"  132","line":"    bin[16] = a->d[1] >> 56; bin[17] = a->d[1] >> 48; bin[18] = a->d[1] >> 40; bin[19] = a->d[1] >> 32; bin[20] = a->d[1] >> 24; bin[21] = a->d[1] >> 16; bin[22] = a->d[1] >> 8; bin[23] = a->d[1];","class":"lineCov","hits":"1","order":"859","possible_hits":"1",},
{"lineNum":"  133","line":"    bin[24] = a->d[0] >> 56; bin[25] = a->d[0] >> 48; bin[26] = a->d[0] >> 40; bin[27] = a->d[0] >> 32; bin[28] = a->d[0] >> 24; bin[29] = a->d[0] >> 16; bin[30] = a->d[0] >> 8; bin[31] = a->d[0];","class":"lineCov","hits":"1","order":"860","possible_hits":"1",},
{"lineNum":"  134","line":"}","class":"linePartCov","hits":"1","order":"861","possible_hits":"2",},
{"lineNum":"  135","line":""},
{"lineNum":"  136","line":"SECP256K1_INLINE static int secp256k1_scalar_is_zero(const secp256k1_scalar *a) {","class":"linePartCov","hits":"2","order":"791","possible_hits":"6",},
{"lineNum":"  137","line":"    return (a->d[0] | a->d[1] | a->d[2] | a->d[3]) == 0;","class":"linePartCov","hits":"1","order":"792","possible_hits":"3",},
{"lineNum":"  138","line":"}"},
{"lineNum":"  139","line":""},
...
var header = { "command" : "grootle_fuzz_debug", "date" : "2023-08-17 08:35:11", "instrumented" : 122, "covered" : 52,};
var merged_data = [];
