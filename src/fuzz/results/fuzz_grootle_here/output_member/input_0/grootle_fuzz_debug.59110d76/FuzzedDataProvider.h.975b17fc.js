...
{"lineNum":"  108","line":"std::vector<T> FuzzedDataProvider::ConsumeBytes(size_t num_bytes) {","class":"lineCov","hits":"2","order":"725","possible_hits":"2",},
{"lineNum":"  109","line":"  num_bytes = std::min(num_bytes, remaining_bytes_);","class":"lineCov","hits":"1","order":"726","possible_hits":"1",},
{"lineNum":"  110","line":"  return ConsumeBytes<T>(num_bytes, num_bytes);","class":"lineCov","hits":"1","order":"727","possible_hits":"1",},
{"lineNum":"  111","line":"}"},
{"lineNum":"  112","line":""},
...
{"lineNum":"  215","line":""},
{"lineNum":"  216","line":"  while (offset < sizeof(T) * CHAR_BIT && (range >> offset) > 0 &&","class":"linePartCov","hits":"2","order":"150","possible_hits":"3",},
...
{"lineNum":"  224","line":"    --remaining_bytes_;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  225","line":"    result = (result << CHAR_BIT) | data_ptr_[remaining_bytes_];","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  226","line":"    offset += CHAR_BIT;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  227","line":"  }"},
{"lineNum":"  228","line":""},
{"lineNum":"  229","line":"  // Avoid division by 0, in case |range + 1| results in overflow."},
{"lineNum":"  230","line":"  if (range != std::numeric_limits<decltype(range)>::max())","class":"lineCov","hits":"1","order":"152","possible_hits":"1",},
{"lineNum":"  231","line":"    result = result % (range + 1);","class":"lineCov","hits":"1","order":"153","possible_hits":"1",},
{"lineNum":"  232","line":""},
{"lineNum":"  233","line":"  return static_cast<T>(min + result);","class":"lineCov","hits":"1","order":"154","possible_hits":"1",},
{"lineNum":"  234","line":"}"},
{"lineNum":"  235","line":""},
...
{"lineNum":"  352","line":"std::vector<T> FuzzedDataProvider::ConsumeBytes(size_t size, size_t num_bytes) {","class":"lineCov","hits":"2","order":"728","possible_hits":"2",},
...
{"lineNum":"  361","line":"  std::vector<T> result(size);","class":"linePartCov","hits":"1","order":"729","possible_hits":"4",},
{"lineNum":"  362","line":"  if (size == 0) {","class":"lineCov","hits":"1","order":"730","possible_hits":"1",},
{"lineNum":"  363","line":"    if (num_bytes != 0)","class":"lineCov","hits":"1","order":"731","possible_hits":"1",},
{"lineNum":"  364","line":"      abort();","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  365","line":"    return result;","class":"lineCov","hits":"1","order":"732","possible_hits":"1",},
{"lineNum":"  366","line":"  }"},
{"lineNum":"  367","line":""},
...
var header = { "command" : "grootle_fuzz_debug", "date" : "2023-08-17 10:19:00", "instrumented" : 41, "covered" : 19,};
var merged_data = [];
