...
{"lineNum":"  114","line":""},
{"lineNum":"  115","line":"CCriticalSection cs_args;","class":"lineCov","hits":"2","order":"71","possible_hits":"2",},
{"lineNum":"  116","line":"std::map<std::string, std::string> mapArgs;","class":"lineCov","hits":"2","order":"74","possible_hits":"2",},
{"lineNum":"  117","line":"static std::map<std::string, std::vector<std::string> > _mapMultiArgs;","class":"lineCov","hits":"2","order":"75","possible_hits":"2",},
...
{"lineNum":"  131","line":"CTranslationInterface translationInterface;","class":"lineCov","hits":"2","order":"76","possible_hits":"2",},
{"lineNum":"  132","line":""},
...
{"lineNum":"  152","line":"    {","class":"lineCov","hits":"2","order":"79","possible_hits":"2",},
{"lineNum":"  153","line":"        // Init OpenSSL library multithreading support"},
{"lineNum":"  154","line":"        ppmutexOpenSSL = (CCriticalSection**)OPENSSL_malloc(CRYPTO_num_locks() * sizeof(CCriticalSection*));","class":"lineCov","hits":"1","order":"80","possible_hits":"1",},
{"lineNum":"  155","line":"        for (int i = 0; i < CRYPTO_num_locks(); i++)","class":"lineCov","hits":"2","order":"81","possible_hits":"2",},
{"lineNum":"  156","line":"            ppmutexOpenSSL[i] = new CCriticalSection();","class":"linePartCov","hits":"1","order":"82","possible_hits":"4",},
...
{"lineNum":"  164","line":"        OPENSSL_no_config();","class":"lineCov","hits":"1","order":"83","possible_hits":"1",},
{"lineNum":"  165","line":""},
...
{"lineNum":"  172","line":"        RandAddSeed();","class":"lineCov","hits":"1","order":"84","possible_hits":"1",},
{"lineNum":"  173","line":"    }","class":"linePartCov","hits":"1","order":"98","possible_hits":"2",},
...
{"lineNum":"  184","line":"}"},
{"lineNum":"  185","line":"instance_of_cinit;","class":"lineCov","hits":"2","order":"78","possible_hits":"2",},
{"lineNum":"  186","line":""},
{"lineNum":"  187","line":"/**"},
...
{"lineNum":"  219","line":"{","class":"lineCov","hits":"2","order":"841","possible_hits":"2",},
{"lineNum":"  220","line":"    assert(mutexDebugLog == NULL);","class":"lineCov","hits":"1","order":"842","possible_hits":"1",},
{"lineNum":"  221","line":"    mutexDebugLog = new boost::mutex();","class":"linePartCov","hits":"1","order":"843","possible_hits":"2",},
{"lineNum":"  222","line":"    vMsgsBeforeOpenLog = new std::list<std::string>;","class":"lineCov","hits":"1","order":"844","possible_hits":"1",},
{"lineNum":"  223","line":"}","class":"lineCov","hits":"1","order":"845","possible_hits":"1",},
{"lineNum":"  224","line":""},
...
{"lineNum":"  285","line":"{","class":"lineCov","hits":"2","order":"808","possible_hits":"2",},
{"lineNum":"  286","line":"    std::string strStamped;","class":"lineCov","hits":"1","order":"809","possible_hits":"1",},
{"lineNum":"  287","line":""},
{"lineNum":"  288","line":"    if (!fLogTimestamps)","class":"lineCov","hits":"1","order":"810","possible_hits":"1",},
{"lineNum":"  289","line":"        return str;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  290","line":""},
{"lineNum":"  291","line":"    if (*fStartedNewLine) {","class":"lineCov","hits":"1","order":"811","possible_hits":"1",},
{"lineNum":"  292","line":"        int64_t nTimeMicros = GetLogTimeMicros();","class":"lineCov","hits":"1","order":"812","possible_hits":"1",},
{"lineNum":"  293","line":"        strStamped = DateTimeStrFormat(\"%Y-%m-%d %H:%M:%S\", nTimeMicros/1000000);","class":"lineCov","hits":"1","order":"822","possible_hits":"1",},
{"lineNum":"  294","line":"        if (fLogTimeMicros)","class":"lineCov","hits":"1","order":"831","possible_hits":"1",},
{"lineNum":"  295","line":"            strStamped += strprintf(\".%06d\", nTimeMicros%1000000);","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  296","line":"        strStamped += \' \' + str;","class":"linePartCov","hits":"1","order":"832","possible_hits":"2",},
{"lineNum":"  297","line":"    } else","class":"lineCov","hits":"1","order":"833","possible_hits":"1",},
{"lineNum":"  298","line":"        strStamped = str;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  299","line":""},
{"lineNum":"  300","line":"    if (!str.empty() && str[str.size()-1] == \'\\n\')","class":"lineCov","hits":"1","order":"834","possible_hits":"1",},
{"lineNum":"  301","line":"        *fStartedNewLine = true;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  302","line":"    else"},
{"lineNum":"  303","line":"        *fStartedNewLine = false;","class":"lineCov","hits":"1","order":"835","possible_hits":"1",},
{"lineNum":"  304","line":""},
{"lineNum":"  305","line":"    return strStamped;","class":"lineCov","hits":"1","order":"836","possible_hits":"1",},
{"lineNum":"  306","line":"}","class":"linePartCov","hits":"1","order":"837","possible_hits":"4",},
{"lineNum":"  307","line":""},
{"lineNum":"  308","line":"int LogPrintStr(const std::string &str)"},
{"lineNum":"  309","line":"{","class":"lineCov","hits":"2","order":"804","possible_hits":"2",},
{"lineNum":"  310","line":"    //A temporary fix for https://github.com/firoorg/firo/issues/1011"},
{"lineNum":"  311","line":"    if (fNoDebug && str.compare(0, 6, \"ERROR:\", 0, 6) != 0)","class":"linePartCov","hits":"1","order":"805","possible_hits":"4",},
{"lineNum":"  312","line":"        return 0;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  313","line":""},
{"lineNum":"  314","line":"    int ret = 0; // Returns total number of characters written","class":"lineCov","hits":"1","order":"806","possible_hits":"1",},
{"lineNum":"  315","line":"    static std::atomic_bool fStartedNewLine(true);"},
{"lineNum":"  316","line":""},
{"lineNum":"  317","line":"    std::string strTimestamped = LogTimestampStr(str, &fStartedNewLine);","class":"lineCov","hits":"1","order":"807","possible_hits":"1",},
{"lineNum":"  318","line":""},
{"lineNum":"  319","line":"    if (fPrintToConsole)","class":"lineCov","hits":"1","order":"838","possible_hits":"1",},
{"lineNum":"  320","line":"    {"},
...
{"lineNum":"  325","line":"    else if (fPrintToDebugLog)","class":"lineCov","hits":"1","order":"839","possible_hits":"1",},
{"lineNum":"  326","line":"    {"},
{"lineNum":"  327","line":"        boost::call_once(&DebugPrintInit, debugPrintInitFlag);","class":"lineCov","hits":"1","order":"840","possible_hits":"1",},
{"lineNum":"  328","line":"        boost::mutex::scoped_lock scoped_lock(*mutexDebugLog);","class":"lineCov","hits":"1","order":"846","possible_hits":"1",},
{"lineNum":"  329","line":""},
{"lineNum":"  330","line":"        // buffer if we haven\'t opened the log yet"},
{"lineNum":"  331","line":"        if (fileout == NULL) {","class":"lineCov","hits":"1","order":"847","possible_hits":"1",},
{"lineNum":"  332","line":"            assert(vMsgsBeforeOpenLog);","class":"lineCov","hits":"1","order":"848","possible_hits":"1",},
{"lineNum":"  333","line":"            ret = strTimestamped.length();","class":"lineCov","hits":"1","order":"849","possible_hits":"1",},
{"lineNum":"  334","line":"            vMsgsBeforeOpenLog->push_back(strTimestamped);","class":"lineCov","hits":"1","order":"850","possible_hits":"1",},
{"lineNum":"  335","line":"        }","class":"lineCov","hits":"1","order":"851","possible_hits":"1",},
...
{"lineNum":"  347","line":"        }"},
{"lineNum":"  348","line":"    }","class":"lineCov","hits":"1","order":"852","possible_hits":"1",},
{"lineNum":"  349","line":"    return ret;","class":"lineCov","hits":"1","order":"853","possible_hits":"1",},
{"lineNum":"  350","line":"}","class":"linePartCov","hits":"1","order":"854","possible_hits":"6",},
{"lineNum":"  351","line":""},
...
{"lineNum":"  544","line":""},
{"lineNum":"  545","line":"static boost::filesystem::path pathCached;","class":"lineCov","hits":"2","order":"99","possible_hits":"2",},
{"lineNum":"  546","line":"static boost::filesystem::path pathCachedNetSpecific;","class":"lineCov","hits":"2","order":"100","possible_hits":"2",},
{"lineNum":"  547","line":"static CCriticalSection csPathCached;","class":"lineCov","hits":"2","order":"101","possible_hits":"2",},
{"lineNum":"  548","line":""},
{"lineNum":"  549","line":"static boost::filesystem::path backupsDirCached;","class":"lineCov","hits":"2","order":"102","possible_hits":"2",},
{"lineNum":"  550","line":"static CCriticalSection csBackupsDirCached;","class":"lineCov","hits":"2","order":"103","possible_hits":"2",},
{"lineNum":"  551","line":""},
...
var header = { "command" : "grootle_fuzz_debug", "date" : "2023-08-17 10:19:00", "instrumented" : 430, "covered" : 51,};
var merged_data = [];
