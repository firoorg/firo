...
{"lineNum":"   36","line":"      : data_ptr_(data), remaining_bytes_(size) {}","class":"lineCov","hits":"1","order":"62",},
...
{"lineNum":"  108","line":"std::vector<T> FuzzedDataProvider::ConsumeBytes(size_t num_bytes) {","class":"lineCov","hits":"1","order":"63",},
{"lineNum":"  109","line":"  num_bytes = std::min(num_bytes, remaining_bytes_);","class":"lineCov","hits":"1","order":"61",},
{"lineNum":"  110","line":"  return ConsumeBytes<T>(num_bytes, num_bytes);","class":"lineCov","hits":"1","order":"60",},
{"lineNum":"  111","line":"}"},
{"lineNum":"  112","line":""},
...
{"lineNum":"  136","line":"inline std::string FuzzedDataProvider::ConsumeBytesAsString(size_t num_bytes) {","class":"lineCov","hits":"1","order":"402",},
...
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"  num_bytes = std::min(num_bytes, remaining_bytes_);","class":"lineCov","hits":"1","order":"391",},
{"lineNum":"  141","line":"  std::string result(","class":"lineCov","hits":"1","order":"404",},
{"lineNum":"  142","line":"      reinterpret_cast<const std::string::value_type *>(data_ptr_), num_bytes);","class":"lineCov","hits":"1","order":"403",},
{"lineNum":"  143","line":"  Advance(num_bytes);","class":"lineCov","hits":"1","order":"397",},
{"lineNum":"  144","line":"  return result;","class":"lineCov","hits":"1","order":"395",},
{"lineNum":"  145","line":"}","class":"lineCov","hits":"1","order":"407",},
{"lineNum":"  146","line":""},
...
{"lineNum":"  194","line":"template <typename T> T FuzzedDataProvider::ConsumeIntegral() {","class":"lineCov","hits":"1","order":"400",},
{"lineNum":"  195","line":"  return ConsumeIntegralInRange(std::numeric_limits<T>::min(),","class":"lineCov","hits":"1","order":"401",},
{"lineNum":"  196","line":"                                std::numeric_limits<T>::max());","class":"lineCov","hits":"1","order":"393",},
{"lineNum":"  197","line":"}"},
{"lineNum":"  198","line":""},
...
{"lineNum":"  204","line":"T FuzzedDataProvider::ConsumeIntegralInRange(T min, T max) {","class":"lineCov","hits":"1","order":"408",},
...
{"lineNum":"  207","line":""},
{"lineNum":"  208","line":"  if (min > max)","class":"lineCov","hits":"1","order":"409",},
...
{"lineNum":"  212","line":"  uint64_t range = static_cast<uint64_t>(max) - min;","class":"lineCov","hits":"1","order":"410",},
{"lineNum":"  213","line":"  uint64_t result = 0;","class":"lineCov","hits":"1","order":"411",},
{"lineNum":"  214","line":"  size_t offset = 0;","class":"lineCov","hits":"1","order":"412",},
{"lineNum":"  215","line":""},
{"lineNum":"  216","line":"  while (offset < sizeof(T) * CHAR_BIT && (range >> offset) > 0 &&","class":"lineCov","hits":"1","order":"413",},
{"lineNum":"  217","line":"         remaining_bytes_ != 0) {","class":"lineCov","hits":"1","order":"414",},
...
{"lineNum":"  230","line":"  if (range != std::numeric_limits<decltype(range)>::max())","class":"lineCov","hits":"1","order":"399",},
{"lineNum":"  231","line":"    result = result % (range + 1);","class":"lineCov","hits":"1","order":"405",},
{"lineNum":"  232","line":""},
{"lineNum":"  233","line":"  return static_cast<T>(min + result);","class":"lineCov","hits":"1","order":"390",},
{"lineNum":"  234","line":"}"},
{"lineNum":"  235","line":""},
...
{"lineNum":"  338","line":"                                               size_t num_bytes) {","class":"lineCov","hits":"1","order":"387",},
{"lineNum":"  339","line":"  std::memcpy(destination, data_ptr_, num_bytes);","class":"lineCov","hits":"1","order":"386",},
{"lineNum":"  340","line":"  Advance(num_bytes);","class":"lineCov","hits":"1","order":"385",},
{"lineNum":"  341","line":"}","class":"lineCov","hits":"1","order":"384",},
{"lineNum":"  342","line":""},
{"lineNum":"  343","line":"inline void FuzzedDataProvider::Advance(size_t num_bytes) {","class":"lineCov","hits":"1","order":"394",},
{"lineNum":"  344","line":"  if (num_bytes > remaining_bytes_)","class":"lineCov","hits":"1","order":"415",},
{"lineNum":"  345","line":"    abort();","class":"lineNoCov","hits":"0",},
{"lineNum":"  346","line":""},
{"lineNum":"  347","line":"  data_ptr_ += num_bytes;","class":"lineCov","hits":"1","order":"396",},
{"lineNum":"  348","line":"  remaining_bytes_ -= num_bytes;","class":"lineCov","hits":"1","order":"398",},
{"lineNum":"  349","line":"}","class":"lineCov","hits":"1","order":"406",},
{"lineNum":"  350","line":""},
{"lineNum":"  351","line":"template <typename T>"},
{"lineNum":"  352","line":"std::vector<T> FuzzedDataProvider::ConsumeBytes(size_t size, size_t num_bytes) {","class":"lineCov","hits":"1","order":"59",},
...
{"lineNum":"  361","line":"  std::vector<T> result(size);","class":"lineCov","hits":"1","order":"58",},
{"lineNum":"  362","line":"  if (size == 0) {","class":"lineCov","hits":"1","order":"57",},
{"lineNum":"  363","line":"    if (num_bytes != 0)","class":"lineCov","hits":"1","order":"56",},
{"lineNum":"  364","line":"      abort();","class":"lineNoCov","hits":"0",},
{"lineNum":"  365","line":"    return result;","class":"lineCov","hits":"1","order":"55",},
{"lineNum":"  366","line":"  }"},
{"lineNum":"  367","line":""},
{"lineNum":"  368","line":"  CopyAndAdvance(result.data(), num_bytes);","class":"lineCov","hits":"1","order":"389",},
{"lineNum":"  369","line":""},
...
{"lineNum":"  373","line":"  result.shrink_to_fit();","class":"lineCov","hits":"1","order":"392",},
{"lineNum":"  374","line":"  return result;","class":"lineCov","hits":"1","order":"388",},
...
var header = { "command" : "", "date" : "2023-08-09 11:47:51", "instrumented" : 48, "covered" : 41,};
var merged_data = [];
