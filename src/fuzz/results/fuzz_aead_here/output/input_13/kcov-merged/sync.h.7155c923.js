...
{"lineNum":"   81","line":"void static inline EnterCritical(const char* pszName, const char* pszFile, int nLine, void* cs, bool fTry = false) {}","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   85","line":"void static inline DeleteLock(void* cs) {}","class":"lineCov","hits":"1","order":"438",},
...
{"lineNum":"   93","line":" */"},
{"lineNum":"   94","line":"class CCriticalSection : public AnnotatedMixin<boost::recursive_mutex>","class":"lineCov","hits":"1","order":"442",},
{"lineNum":"   95","line":"{"},
{"lineNum":"   96","line":"public:"},
{"lineNum":"   97","line":"    ~CCriticalSection() {","class":"lineCov","hits":"1","order":"441",},
{"lineNum":"   98","line":"        DeleteLock((void*)this);","class":"lineCov","hits":"1","order":"440",},
{"lineNum":"   99","line":"    }","class":"lineCov","hits":"1","order":"439",},
{"lineNum":"  100","line":"};"},
{"lineNum":"  101","line":""},
...
{"lineNum":"  121","line":"    {","class":"lineNoCov","hits":"0",},
{"lineNum":"  122","line":"        EnterCritical(pszName, pszFile, nLine, (void*)(lock.mutex()));","class":"lineNoCov","hits":"0",},
...
{"lineNum":"  127","line":"            lock.lock();","class":"lineNoCov","hits":"0",},
...
{"lineNum":"  143","line":"    CMutexLock(Mutex& mutexIn, const char* pszName, const char* pszFile, int nLine, bool fTry = false) EXCLUSIVE_LOCK_FUNCTION(mutexIn) : lock(mutexIn, boost::defer_lock)","class":"lineNoCov","hits":"0",},
{"lineNum":"  144","line":"    {","class":"lineNoCov","hits":"0",},
{"lineNum":"  145","line":"        if (fTry)","class":"lineNoCov","hits":"0",},
{"lineNum":"  146","line":"            TryEnter(pszName, pszFile, nLine);","class":"lineNoCov","hits":"0",},
{"lineNum":"  147","line":"        else"},
{"lineNum":"  148","line":"            Enter(pszName, pszFile, nLine);","class":"lineNoCov","hits":"0",},
...
{"lineNum":"  164","line":"        if (lock.owns_lock())","class":"lineNoCov","hits":"0",},
{"lineNum":"  165","line":"            LeaveCritical();","class":"lineNoCov","hits":"0",},
...
var header = { "command" : "aead_fuzz_debug", "date" : "2023-08-09 11:47:50", "instrumented" : 36, "covered" : 6,};
var merged_data = [];
