...
{"lineNum":"   23","line":"class CHash256 {","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   28","line":""},
{"lineNum":"   29","line":"    void Finalize(unsigned char hash[OUTPUT_SIZE]) {","class":"lineNoCov","hits":"0",},
{"lineNum":"   30","line":"        unsigned char buf[CSHA256::OUTPUT_SIZE];"},
{"lineNum":"   31","line":"        sha.Finalize(buf);","class":"lineNoCov","hits":"0",},
{"lineNum":"   32","line":"        sha.Reset().Write(buf, CSHA256::OUTPUT_SIZE).Finalize(hash);","class":"lineNoCov","hits":"0",},
{"lineNum":"   33","line":"    }","class":"lineNoCov","hits":"0",},
{"lineNum":"   34","line":""},
{"lineNum":"   35","line":"    CHash256& Write(const unsigned char *data, size_t len) {","class":"lineNoCov","hits":"0",},
{"lineNum":"   36","line":"        sha.Write(data, len);","class":"lineNoCov","hits":"0",},
{"lineNum":"   37","line":"        return *this;","class":"lineNoCov","hits":"0",},
{"lineNum":"   38","line":"    }"},
{"lineNum":"   39","line":""},
{"lineNum":"   40","line":"    CHash256& Reset() {","class":"lineNoCov","hits":"0",},
{"lineNum":"   41","line":"        sha.Reset();","class":"lineNoCov","hits":"0",},
{"lineNum":"   42","line":"        return *this;","class":"lineNoCov","hits":"0",},
{"lineNum":"   43","line":"    }"},
{"lineNum":"   44","line":"};"},
{"lineNum":"   45","line":""},
{"lineNum":"   46","line":"/** A hasher class for Bitcoin\'s 160-bit hash (SHA-256 + RIPEMD-160). */"},
{"lineNum":"   47","line":"class CHash160 {","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   52","line":""},
{"lineNum":"   53","line":"    void Finalize(unsigned char hash[OUTPUT_SIZE]) {","class":"lineNoCov","hits":"0",},
{"lineNum":"   54","line":"        unsigned char buf[CSHA256::OUTPUT_SIZE];"},
{"lineNum":"   55","line":"        sha.Finalize(buf);","class":"lineNoCov","hits":"0",},
{"lineNum":"   56","line":"        CRIPEMD160().Write(buf, CSHA256::OUTPUT_SIZE).Finalize(hash);","class":"lineNoCov","hits":"0",},
{"lineNum":"   57","line":"    }","class":"lineNoCov","hits":"0",},
{"lineNum":"   58","line":""},
{"lineNum":"   59","line":"    CHash160& Write(const unsigned char *data, size_t len) {","class":"lineNoCov","hits":"0",},
{"lineNum":"   60","line":"        sha.Write(data, len);","class":"lineNoCov","hits":"0",},
{"lineNum":"   61","line":"        return *this;","class":"lineNoCov","hits":"0",},
{"lineNum":"   62","line":"    }"},
{"lineNum":"   63","line":""},
...
{"lineNum":"  122","line":"    uint256 result;","class":"lineNoCov","hits":"0",},
{"lineNum":"  123","line":"    CHash256().Write(pbegin == pend ? pblank : (const unsigned char*)&pbegin[0], (pend - pbegin) * sizeof(pbegin[0]))","class":"lineNoCov","hits":"0",},
{"lineNum":"  124","line":"              .Finalize((unsigned char*)&result);","class":"lineNoCov","hits":"0",},
{"lineNum":"  125","line":"    return result;","class":"lineNoCov","hits":"0",},
{"lineNum":"  126","line":"}"},
{"lineNum":"  127","line":""},
...
{"lineNum":"  159","line":"    uint160 result;","class":"lineNoCov","hits":"0",},
{"lineNum":"  160","line":"    CHash160().Write(pbegin == pend ? pblank : (const unsigned char*)&pbegin[0], (pend - pbegin) * sizeof(pbegin[0]))","class":"lineNoCov","hits":"0",},
{"lineNum":"  161","line":"              .Finalize((unsigned char*)&result);","class":"lineNoCov","hits":"0",},
{"lineNum":"  162","line":"    return result;","class":"lineNoCov","hits":"0",},
{"lineNum":"  163","line":"}"},
{"lineNum":"  164","line":""},
...
var header = { "command" : "aead_fuzz_debug", "date" : "2023-08-09 11:47:24", "instrumented" : 29, "covered" : 0,};
var merged_data = [];
