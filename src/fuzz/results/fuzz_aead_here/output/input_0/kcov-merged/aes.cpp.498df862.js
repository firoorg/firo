...
{"lineNum":"   47","line":"    AES256_init(&ctx, key);","class":"lineNoCov","hits":"0",},
{"lineNum":"   48","line":"}","class":"lineNoCov","hits":"0",},
{"lineNum":"   49","line":""},
{"lineNum":"   50","line":"AES256Encrypt::~AES256Encrypt()"},
{"lineNum":"   51","line":"{","class":"lineNoCov","hits":"0",},
{"lineNum":"   52","line":"    memset(&ctx, 0, sizeof(ctx));","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   57","line":"    AES256_encrypt(&ctx, 1, ciphertext, plaintext);","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   79","line":"    int written = 0;","class":"lineNoCov","hits":"0",},
{"lineNum":"   80","line":"    int padsize = size % AES_BLOCKSIZE;","class":"lineNoCov","hits":"0",},
{"lineNum":"   81","line":"    unsigned char mixed[AES_BLOCKSIZE];"},
{"lineNum":"   82","line":""},
{"lineNum":"   83","line":"    if (!data || !size || !out)","class":"lineNoCov","hits":"0",},
{"lineNum":"   84","line":"        return 0;","class":"lineNoCov","hits":"0",},
{"lineNum":"   85","line":""},
{"lineNum":"   86","line":"    if (!pad && padsize != 0)","class":"lineNoCov","hits":"0",},
{"lineNum":"   87","line":"        return 0;","class":"lineNoCov","hits":"0",},
{"lineNum":"   88","line":""},
{"lineNum":"   89","line":"    memcpy(mixed, iv, AES_BLOCKSIZE);","class":"lineNoCov","hits":"0",},
{"lineNum":"   90","line":""},
{"lineNum":"   91","line":"    // Write all but the last block"},
{"lineNum":"   92","line":"    while (written + AES_BLOCKSIZE <= size) {","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   98","line":"    }"},
{"lineNum":"   99","line":"    if (pad) {","class":"lineNoCov","hits":"0",},
...
{"lineNum":"  102","line":"        for (int i = 0; i != padsize; i++)","class":"lineNoCov","hits":"0",},
{"lineNum":"  103","line":"            mixed[i] ^= *data++;","class":"lineNoCov","hits":"0",},
{"lineNum":"  104","line":"        for (int i = padsize; i != AES_BLOCKSIZE; i++)","class":"lineNoCov","hits":"0",},
{"lineNum":"  105","line":"            mixed[i] ^= AES_BLOCKSIZE - padsize;","class":"lineNoCov","hits":"0",},
{"lineNum":"  106","line":"        enc.Encrypt(out + written, mixed);","class":"lineNoCov","hits":"0",},
{"lineNum":"  107","line":"        written += AES_BLOCKSIZE;","class":"lineNoCov","hits":"0",},
{"lineNum":"  108","line":"    }"},
{"lineNum":"  109","line":"    return written;","class":"lineNoCov","hits":"0",},
...
{"lineNum":"  155","line":"    : enc(key), pad(padIn)","class":"lineNoCov","hits":"0",},
{"lineNum":"  156","line":"{","class":"lineNoCov","hits":"0",},
{"lineNum":"  157","line":"    memcpy(iv, ivIn, AES_BLOCKSIZE);","class":"lineNoCov","hits":"0",},
...
{"lineNum":"  162","line":"    return CBCEncrypt(enc, iv, data, size, pad, out);","class":"lineNoCov","hits":"0",},
{"lineNum":"  163","line":"}"},
{"lineNum":"  164","line":""},
{"lineNum":"  165","line":"AES256CBCEncrypt::~AES256CBCEncrypt()"},
{"lineNum":"  166","line":"{","class":"lineNoCov","hits":"0",},
{"lineNum":"  167","line":"    memset(iv, 0, sizeof(iv));","class":"lineNoCov","hits":"0",},
...
var header = { "command" : "aead_fuzz_debug", "date" : "2023-08-09 11:46:56", "instrumented" : 119, "covered" : 0,};
var merged_data = [];
