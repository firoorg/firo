...
{"lineNum":"   46","line":"struct DecodeResult","class":"lineNoCov","hits":"0",},
{"lineNum":"   47","line":"{"},
...
{"lineNum":"   51","line":""},
{"lineNum":"   52","line":"    DecodeResult() : encoding(Encoding::INVALID) {}","class":"lineNoCov","hits":"0",},
{"lineNum":"   53","line":"    DecodeResult(Encoding enc, std::string&& h, std::vector<uint8_t>&& d) : encoding(enc), hrp(std::move(h)), data(std::move(d)) {}","class":"lineNoCov","hits":"0",},
{"lineNum":"   54","line":"};"},
{"lineNum":"   55","line":""},
