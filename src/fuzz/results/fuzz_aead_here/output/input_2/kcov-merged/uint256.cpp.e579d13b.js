...
{"lineNum":"   16","line":"    assert(vch.size() == sizeof(data));","class":"lineNoCov","hits":"0",},
{"lineNum":"   17","line":"    memcpy(data, &vch[0], sizeof(data));","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   23","line":"    memcpy(data, &vch[0], sizeof(data));","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   30","line":"    for (unsigned int i = 0; i < sizeof(data); i++)","class":"lineNoCov","hits":"0",},
{"lineNum":"   31","line":"        sprintf(psz + i * 2, \"%02x\", data[sizeof(data) - i - 1]);","class":"lineNoCov","hits":"0",},
{"lineNum":"   32","line":"    return std::string(psz, psz + sizeof(data) * 2);","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   38","line":"    memset(data, 0, sizeof(data));","class":"lineNoCov","hits":"0",},
{"lineNum":"   39","line":""},
{"lineNum":"   40","line":"    // skip leading spaces"},
{"lineNum":"   41","line":"    while (isspace(*psz))","class":"lineNoCov","hits":"0",},
{"lineNum":"   42","line":"        psz++;","class":"lineNoCov","hits":"0",},
{"lineNum":"   43","line":""},
{"lineNum":"   44","line":"    // skip 0x"},
{"lineNum":"   45","line":"    if (psz[0] == \'0\' && tolower(psz[1]) == \'x\')","class":"lineNoCov","hits":"0",},
{"lineNum":"   46","line":"        psz += 2;","class":"lineNoCov","hits":"0",},
{"lineNum":"   47","line":""},
{"lineNum":"   48","line":"    // hex string to uint"},
{"lineNum":"   49","line":"    const char* pbegin = psz;","class":"lineNoCov","hits":"0",},
{"lineNum":"   50","line":"    while (::HexDigit(*psz) != -1)","class":"lineNoCov","hits":"0",},
{"lineNum":"   51","line":"        psz++;","class":"lineNoCov","hits":"0",},
{"lineNum":"   52","line":"    psz--;","class":"lineNoCov","hits":"0",},
{"lineNum":"   53","line":"    unsigned char* p1 = (unsigned char*)data;","class":"lineNoCov","hits":"0",},
{"lineNum":"   54","line":"    unsigned char* pend = p1 + WIDTH;","class":"lineNoCov","hits":"0",},
{"lineNum":"   55","line":"    while (psz >= pbegin && p1 < pend) {","class":"lineNoCov","hits":"0",},
{"lineNum":"   56","line":"        *p1 = ::HexDigit(*psz--);","class":"lineNoCov","hits":"0",},
{"lineNum":"   57","line":"        if (psz >= pbegin) {","class":"lineNoCov","hits":"0",},
{"lineNum":"   58","line":"            *p1 |= ((unsigned char)::HexDigit(*psz--) << 4);","class":"lineNoCov","hits":"0",},
{"lineNum":"   59","line":"            p1++;","class":"lineNoCov","hits":"0",},
{"lineNum":"   60","line":"        }"},
{"lineNum":"   61","line":"    }"},
...
{"lineNum":"   67","line":"    SetHex(str.c_str());","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   73","line":"    return (GetHex());","class":"lineNoCov","hits":"0",},
{"lineNum":"   74","line":"}"},
{"lineNum":"   75","line":""},
...
{"lineNum":"   83","line":"    base_blob<BITS> rv;","class":"lineNoCov","hits":"0",},
{"lineNum":"   84","line":"    rv.SetHex(str);","class":"lineNoCov","hits":"0",},
{"lineNum":"   85","line":"    return rv;","class":"lineNoCov","hits":"0",},
{"lineNum":"   86","line":"}"},
...
{"lineNum":"   94","line":"    base_blob<BITS> rv;","class":"lineNoCov","hits":"0",},
{"lineNum":"   95","line":"    rv.SetHex(str);","class":"lineNoCov","hits":"0",},
{"lineNum":"   96","line":"    return rv;","class":"lineNoCov","hits":"0",},
{"lineNum":"   97","line":"}"},
{"lineNum":"   98","line":""},
...
var header = { "command" : "aead_fuzz_debug", "date" : "2023-08-09 11:47:05", "instrumented" : 43, "covered" : 0,};
var merged_data = [];
