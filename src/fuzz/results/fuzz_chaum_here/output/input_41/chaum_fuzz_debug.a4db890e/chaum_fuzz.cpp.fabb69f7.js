...
{"lineNum":"   29","line":"    for (size_t i=0; i < n; i++) {","class":"linePartCov","hits":"1","order":"707","possible_hits":"2",},
...
{"lineNum":"   36","line":"    }"},
{"lineNum":"   37","line":""},
{"lineNum":"   38","line":"    spark::ChaumProof proof0;","class":"lineCov","hits":"1","order":"708","possible_hits":"1",},
{"lineNum":"   39","line":""},
{"lineNum":"   40","line":"    spark::Chaum chaum0(F0, G0, H0, U0);","class":"lineCov","hits":"1","order":"710","possible_hits":"1",},
{"lineNum":"   41","line":"    chaum0.prove(mu0, x0, y0, z0, S0, T0, proof0);","class":"lineCov","hits":"1","order":"713","possible_hits":"1",},
{"lineNum":"   42","line":""},
{"lineNum":"   43","line":"    CDataStream serialized(SER_NETWORK, PROTOCOL_VERSION);","class":"lineCov","hits":"1","order":"1065","possible_hits":"1",},
{"lineNum":"   44","line":"    serialized << proof0;","class":"lineCov","hits":"1","order":"1076","possible_hits":"1",},
{"lineNum":"   45","line":""},
{"lineNum":"   46","line":"    spark::ChaumProof deserialized_proof0;","class":"lineCov","hits":"1","order":"1134","possible_hits":"1",},
{"lineNum":"   47","line":"    serialized >> deserialized_proof0;","class":"lineCov","hits":"1","order":"1135","possible_hits":"1",},
{"lineNum":"   48","line":""},
{"lineNum":"   49","line":"    assert(proof0.A1 == deserialized_proof0.A1);","class":"lineCov","hits":"1","order":"1220","possible_hits":"1",},
{"lineNum":"   50","line":"    assert(proof0.t2 == deserialized_proof0.t2);","class":"lineCov","hits":"1","order":"1232","possible_hits":"1",},
{"lineNum":"   51","line":"    assert(proof0.t3 == deserialized_proof0.t3);","class":"lineCov","hits":"1","order":"1233","possible_hits":"1",},
{"lineNum":"   52","line":"    for (size_t i = 0 ; i < n; i++) {","class":"linePartCov","hits":"1","order":"1234","possible_hits":"2",},
...
{"lineNum":"   58","line":""},
{"lineNum":"   59","line":"    GroupElement F1, G1, H1, U1;","class":"lineCov","hits":"1","order":"1235","possible_hits":"1",},
...
{"lineNum":"   64","line":"    F1.randomize();","class":"lineCov","hits":"1","order":"1236","possible_hits":"1",},
{"lineNum":"   65","line":"    G1.randomize();","class":"lineCov","hits":"1","order":"1237","possible_hits":"1",},
{"lineNum":"   66","line":"    H1.randomize();","class":"lineCov","hits":"1","order":"1238","possible_hits":"1",},
{"lineNum":"   67","line":"    U1.randomize();","class":"lineCov","hits":"1","order":"1239","possible_hits":"1",},
{"lineNum":"   68","line":""},
{"lineNum":"   69","line":"    Scalar mu1;","class":"lineCov","hits":"1","order":"1240","possible_hits":"1",},
{"lineNum":"   70","line":"    mu1 = fsp.GetScalar();","class":"linePartCov","hits":"1","order":"1241","possible_hits":"2",},
{"lineNum":"   71","line":"    std::vector<Scalar> x1, y1, z1;","class":"lineCov","hits":"1","order":"1247","possible_hits":"1",},
{"lineNum":"   72","line":"    x1.resize(n);","class":"lineCov","hits":"1","order":"1248","possible_hits":"1",},
{"lineNum":"   73","line":"    x1 = fsp.GetScalars(n);","class":"lineCov","hits":"1","order":"1249","possible_hits":"1",},
{"lineNum":"   74","line":"    y1.resize(n);","class":"lineCov","hits":"1","order":"1257","possible_hits":"1",},
{"lineNum":"   75","line":"    y1 = fsp.GetScalars(n);","class":"lineCov","hits":"1","order":"1258","possible_hits":"1",},
{"lineNum":"   76","line":"    z1.resize(n);","class":"lineCov","hits":"1","order":"1259","possible_hits":"1",},
{"lineNum":"   77","line":"    z1 = fsp.GetScalars(n);","class":"lineCov","hits":"1","order":"1260","possible_hits":"1",},
{"lineNum":"   78","line":""},
{"lineNum":"   79","line":"    std::vector<GroupElement> S1, T1;","class":"lineCov","hits":"1","order":"1261","possible_hits":"1",},
{"lineNum":"   80","line":"    S1.resize(n);","class":"lineCov","hits":"1","order":"1262","possible_hits":"1",},
{"lineNum":"   81","line":"    T1.resize(n);","class":"lineCov","hits":"1","order":"1263","possible_hits":"1",},
{"lineNum":"   82","line":"    for (size_t i=0; i < n; i++) {","class":"linePartCov","hits":"1","order":"1264","possible_hits":"2",},
...
{"lineNum":"   85","line":"    }"},
{"lineNum":"   86","line":""},
{"lineNum":"   87","line":"    spark::ChaumProof proof1;","class":"lineCov","hits":"1","order":"1265","possible_hits":"1",},
{"lineNum":"   88","line":""},
{"lineNum":"   89","line":"    spark::Chaum chaum1(F1, G1, H1, U1);","class":"lineCov","hits":"1","order":"1266","possible_hits":"1",},
{"lineNum":"   90","line":"    chaum1.prove(mu1, x1, y1, z1, S1, T1, proof1);","class":"lineCov","hits":"1","order":"1267","possible_hits":"1",},
{"lineNum":"   91","line":""},
...
var header = { "command" : "chaum_fuzz_debug", "date" : "2023-08-09 12:37:35", "instrumented" : 152, "covered" : 51,};
var merged_data = [];
