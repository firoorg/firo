...
{"lineNum":"    7","line":"    F(F_), G(G_), H(H_), U(U_) {","class":"lineCov","hits":"2","order":"711","possible_hits":"2",},
{"lineNum":"    8","line":"}","class":"linePartCov","hits":"1","order":"712","possible_hits":"2",},
{"lineNum":"    9","line":""},
...
{"lineNum":"   16","line":") {","class":"lineCov","hits":"2","order":"935","possible_hits":"2",},
{"lineNum":"   17","line":"    Transcript transcript(LABEL_TRANSCRIPT_CHAUM);","class":"linePartCov","hits":"1","order":"936","possible_hits":"4",},
{"lineNum":"   18","line":"    transcript.add(\"F\", F);","class":"linePartCov","hits":"1","order":"986","possible_hits":"2",},
{"lineNum":"   19","line":"    transcript.add(\"G\", G);","class":"linePartCov","hits":"1","order":"1008","possible_hits":"2",},
{"lineNum":"   20","line":"    transcript.add(\"H\", H);","class":"linePartCov","hits":"1","order":"1009","possible_hits":"2",},
{"lineNum":"   21","line":"    transcript.add(\"U\", U);","class":"linePartCov","hits":"1","order":"1010","possible_hits":"2",},
{"lineNum":"   22","line":"    transcript.add(\"mu\", mu);","class":"linePartCov","hits":"1","order":"1011","possible_hits":"2",},
{"lineNum":"   23","line":"    transcript.add(\"S\", S);","class":"linePartCov","hits":"1","order":"1020","possible_hits":"2",},
{"lineNum":"   24","line":"    transcript.add(\"T\", T);","class":"linePartCov","hits":"1","order":"1027","possible_hits":"2",},
{"lineNum":"   25","line":"    transcript.add(\"A1\", A1);","class":"linePartCov","hits":"1","order":"1028","possible_hits":"2",},
{"lineNum":"   26","line":"    transcript.add(\"A2\", A2);","class":"linePartCov","hits":"1","order":"1029","possible_hits":"2",},
{"lineNum":"   27","line":""},
{"lineNum":"   28","line":"    return transcript.challenge(\"c\");","class":"linePartCov","hits":"1","order":"1030","possible_hits":"2",},
{"lineNum":"   29","line":"}","class":"linePartCov","hits":"1","order":"1062","possible_hits":"12",},
{"lineNum":"   30","line":""},
...
{"lineNum":"   39","line":") {","class":"lineCov","hits":"2","order":"714","possible_hits":"2",},
{"lineNum":"   40","line":"    // Check statement validity"},
{"lineNum":"   41","line":"    std::size_t n = x.size();","class":"lineCov","hits":"1","order":"715","possible_hits":"1",},
{"lineNum":"   42","line":"    if (!(y.size() == n && z.size() == n && S.size() == n && T.size() == n)) {","class":"lineCov","hits":"1","order":"716","possible_hits":"1",},
{"lineNum":"   43","line":"        throw std::invalid_argument(\"Bad Chaum statement!\");","class":"linePartCov","hits":"1","order":"1280","possible_hits":"4",},
{"lineNum":"   44","line":"    }"},
{"lineNum":"   45","line":"    for (std::size_t i = 0; i < n; i++) {","class":"linePartCov","hits":"1","order":"717","possible_hits":"2",},
...
{"lineNum":"   50","line":""},
{"lineNum":"   51","line":"    std::vector<Scalar> r;","class":"lineCov","hits":"1","order":"718","possible_hits":"1",},
{"lineNum":"   52","line":"    r.resize(n);","class":"lineCov","hits":"1","order":"719","possible_hits":"1",},
{"lineNum":"   53","line":"    std::vector<Scalar> s;","class":"lineCov","hits":"1","order":"720","possible_hits":"1",},
{"lineNum":"   54","line":"    s.resize(n);","class":"lineCov","hits":"1","order":"721","possible_hits":"1",},
{"lineNum":"   55","line":"    for (std::size_t i = 0; i < n; i++) {","class":"linePartCov","hits":"1","order":"722","possible_hits":"2",},
...
{"lineNum":"   59","line":"    Scalar t;","class":"lineCov","hits":"1","order":"723","possible_hits":"1",},
{"lineNum":"   60","line":"    t.randomize();","class":"lineCov","hits":"1","order":"724","possible_hits":"1",},
{"lineNum":"   61","line":""},
{"lineNum":"   62","line":"    proof.A1 = H*t;","class":"linePartCov","hits":"1","order":"725","possible_hits":"2",},
{"lineNum":"   63","line":"    proof.A2.resize(n);","class":"lineCov","hits":"1","order":"932","possible_hits":"1",},
{"lineNum":"   64","line":"    for (std::size_t i = 0; i < n; i++) {","class":"linePartCov","hits":"1","order":"933","possible_hits":"2",},
...
{"lineNum":"   67","line":"    }"},
{"lineNum":"   68","line":""},
{"lineNum":"   69","line":"    Scalar c = challenge(mu, S, T, proof.A1, proof.A2);","class":"lineCov","hits":"1","order":"934","possible_hits":"1",},
{"lineNum":"   70","line":""},
{"lineNum":"   71","line":"    proof.t1.resize(n);","class":"lineCov","hits":"1","order":"1066","possible_hits":"1",},
{"lineNum":"   72","line":"    proof.t3 = t;","class":"lineCov","hits":"1","order":"1067","possible_hits":"1",},
{"lineNum":"   73","line":"    Scalar c_power(c);","class":"lineCov","hits":"1","order":"1073","possible_hits":"1",},
{"lineNum":"   74","line":"    for (std::size_t i = 0; i < n; i++) {","class":"linePartCov","hits":"1","order":"1074","possible_hits":"2",},
...
{"lineNum":"   80","line":"}","class":"linePartCov","hits":"1","order":"1075","possible_hits":"11",},
{"lineNum":"   81","line":""},
...
var header = { "command" : "chaum_fuzz_debug", "date" : "2023-08-09 12:12:15", "instrumented" : 99, "covered" : 36,};
var merged_data = [];
