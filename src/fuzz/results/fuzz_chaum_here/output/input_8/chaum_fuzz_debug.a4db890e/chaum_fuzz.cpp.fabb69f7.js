...
{"lineNum":"   15","line":"    H0.randomize();","class":"lineCov","hits":"1","order":"582","possible_hits":"1",},
{"lineNum":"   16","line":"    U0.randomize();","class":"lineCov","hits":"1","order":"583","possible_hits":"1",},
{"lineNum":"   17","line":""},
{"lineNum":"   18","line":"    const std::size_t n = fdp.ConsumeIntegral<size_t>();","class":"lineCov","hits":"1","order":"584","possible_hits":"1",},
{"lineNum":"   19","line":""},
{"lineNum":"   20","line":"    Scalar mu0;","class":"lineCov","hits":"1","order":"600","possible_hits":"1",},
{"lineNum":"   21","line":"    mu0.randomize();","class":"lineCov","hits":"1","order":"610","possible_hits":"1",},
{"lineNum":"   22","line":"    std::vector<Scalar> x0, y0, z0;","class":"lineCov","hits":"1","order":"694","possible_hits":"1",},
{"lineNum":"   23","line":"    x0.resize(n);","class":"lineCov","hits":"1","order":"695","possible_hits":"1",},
{"lineNum":"   24","line":"    y0.resize(n);","class":"lineCov","hits":"1","order":"696","possible_hits":"1",},
{"lineNum":"   25","line":"    z0.resize(n);","class":"lineCov","hits":"1","order":"697","possible_hits":"1",},
{"lineNum":"   26","line":"    std::vector<GroupElement> S0, T0;","class":"lineCov","hits":"1","order":"698","possible_hits":"1",},
{"lineNum":"   27","line":"    S0.resize(n);","class":"lineCov","hits":"1","order":"699","possible_hits":"1",},
{"lineNum":"   28","line":"    T0.resize(n);","class":"lineCov","hits":"1","order":"700","possible_hits":"1",},
{"lineNum":"   29","line":"    for (size_t i=0; i < n; i++) {","class":"lineCov","hits":"2","order":"701","possible_hits":"2",},
{"lineNum":"   30","line":"        x0[i].randomize();","class":"lineCov","hits":"1","order":"702","possible_hits":"1",},
{"lineNum":"   31","line":"        y0[i].randomize();","class":"lineCov","hits":"1","order":"703","possible_hits":"1",},
{"lineNum":"   32","line":"        z0[i].randomize();","class":"lineCov","hits":"1","order":"704","possible_hits":"1",},
{"lineNum":"   33","line":""},
{"lineNum":"   34","line":"        S0[i] = F0*x0[i] + G0*y0[i] + H0*z0[i];","class":"linePartCov","hits":"1","order":"705","possible_hits":"2",},
{"lineNum":"   35","line":"        T0[i] = (U0 + G0*y0[i].negate())*x0[i].inverse();","class":"linePartCov","hits":"1","order":"946","possible_hits":"2",},
{"lineNum":"   36","line":"    }"},
{"lineNum":"   37","line":""},
{"lineNum":"   38","line":"    spark::ChaumProof proof0;","class":"lineCov","hits":"1","order":"1116","possible_hits":"1",},
{"lineNum":"   39","line":""},
{"lineNum":"   40","line":"    spark::Chaum chaum0(F0, G0, H0, U0);","class":"lineCov","hits":"1","order":"1118","possible_hits":"1",},
{"lineNum":"   41","line":"    chaum0.prove(mu0, x0, y0, z0, S0, T0, proof0);","class":"lineCov","hits":"1","order":"1121","possible_hits":"1",},
{"lineNum":"   42","line":""},
{"lineNum":"   43","line":"    CDataStream serialized(SER_NETWORK, PROTOCOL_VERSION);","class":"lineCov","hits":"1","order":"1324","possible_hits":"1",},
{"lineNum":"   44","line":"    serialized << proof0;","class":"lineCov","hits":"1","order":"1335","possible_hits":"1",},
{"lineNum":"   45","line":""},
{"lineNum":"   46","line":"    spark::ChaumProof deserialized_proof0;","class":"lineCov","hits":"1","order":"1401","possible_hits":"1",},
{"lineNum":"   47","line":"    serialized >> deserialized_proof0;","class":"lineCov","hits":"1","order":"1402","possible_hits":"1",},
{"lineNum":"   48","line":""},
{"lineNum":"   49","line":"    assert(proof0.A1 == deserialized_proof0.A1);","class":"lineCov","hits":"1","order":"1500","possible_hits":"1",},
{"lineNum":"   50","line":"    assert(proof0.t2 == deserialized_proof0.t2);","class":"lineCov","hits":"1","order":"1501","possible_hits":"1",},
{"lineNum":"   51","line":"    assert(proof0.t3 == deserialized_proof0.t3);","class":"lineCov","hits":"1","order":"1502","possible_hits":"1",},
{"lineNum":"   52","line":"    for (size_t i = 0 ; i < n; i++) {","class":"lineCov","hits":"2","order":"1503","possible_hits":"2",},
{"lineNum":"   53","line":"        assert(proof0.A2[i] == deserialized_proof0.A2[i]);","class":"lineCov","hits":"1","order":"1504","possible_hits":"1",},
{"lineNum":"   54","line":"        assert(proof0.t1[i] == deserialized_proof0.t1[i]);","class":"lineCov","hits":"1","order":"1505","possible_hits":"1",},
{"lineNum":"   55","line":"    }","class":"lineCov","hits":"1","order":"1506","possible_hits":"1",},
{"lineNum":"   56","line":""},
{"lineNum":"   57","line":"    /** Now fuzz all the things **/"},
{"lineNum":"   58","line":""},
{"lineNum":"   59","line":"    GroupElement F1, G1, H1, U1;","class":"lineCov","hits":"1","order":"1507","possible_hits":"1",},
...
{"lineNum":"   64","line":"    F1.randomize();","class":"lineCov","hits":"1","order":"1508","possible_hits":"1",},
{"lineNum":"   65","line":"    G1.randomize();","class":"lineCov","hits":"1","order":"1509","possible_hits":"1",},
{"lineNum":"   66","line":"    H1.randomize();","class":"lineCov","hits":"1","order":"1510","possible_hits":"1",},
{"lineNum":"   67","line":"    U1.randomize();","class":"lineCov","hits":"1","order":"1511","possible_hits":"1",},
{"lineNum":"   68","line":""},
{"lineNum":"   69","line":"    Scalar mu1;","class":"lineCov","hits":"1","order":"1512","possible_hits":"1",},
{"lineNum":"   70","line":"    mu1 = fsp.GetScalar();","class":"linePartCov","hits":"1","order":"1513","possible_hits":"2",},
{"lineNum":"   71","line":"    std::vector<Scalar> x1, y1, z1;","class":"lineCov","hits":"1","order":"1519","possible_hits":"1",},
{"lineNum":"   72","line":"    x1.resize(n);","class":"lineCov","hits":"1","order":"1520","possible_hits":"1",},
{"lineNum":"   73","line":"    x1 = fsp.GetScalars(n);","class":"lineCov","hits":"1","order":"1521","possible_hits":"1",},
{"lineNum":"   74","line":"    y1.resize(n);","class":"lineCov","hits":"1","order":"1529","possible_hits":"1",},
{"lineNum":"   75","line":"    y1 = fsp.GetScalars(n);","class":"lineCov","hits":"1","order":"1530","possible_hits":"1",},
{"lineNum":"   76","line":"    z1.resize(n);","class":"lineCov","hits":"1","order":"1531","possible_hits":"1",},
{"lineNum":"   77","line":"    z1 = fsp.GetScalars(n);","class":"lineCov","hits":"1","order":"1532","possible_hits":"1",},
{"lineNum":"   78","line":""},
{"lineNum":"   79","line":"    std::vector<GroupElement> S1, T1;","class":"lineCov","hits":"1","order":"1533","possible_hits":"1",},
{"lineNum":"   80","line":"    S1.resize(n);","class":"lineCov","hits":"1","order":"1534","possible_hits":"1",},
{"lineNum":"   81","line":"    T1.resize(n);","class":"lineCov","hits":"1","order":"1535","possible_hits":"1",},
{"lineNum":"   82","line":"    for (size_t i=0; i < n; i++) {","class":"lineCov","hits":"2","order":"1536","possible_hits":"2",},
{"lineNum":"   83","line":"        S1[i] = F1*x1[i] + G1*y1[i] + H1*z1[i];","class":"linePartCov","hits":"1","order":"1537","possible_hits":"2",},
{"lineNum":"   84","line":"        T1[i] = (U1 + G1*y1[i].negate())*x1[i].inverse();","class":"linePartCov","hits":"1","order":"1543","possible_hits":"2",},
{"lineNum":"   85","line":"    }"},
{"lineNum":"   86","line":""},
{"lineNum":"   87","line":"    spark::ChaumProof proof1;","class":"lineCov","hits":"1","order":"1547","possible_hits":"1",},
{"lineNum":"   88","line":""},
{"lineNum":"   89","line":"    spark::Chaum chaum1(F1, G1, H1, U1);","class":"lineCov","hits":"1","order":"1548","possible_hits":"1",},
{"lineNum":"   90","line":"    chaum1.prove(mu1, x1, y1, z1, S1, T1, proof1);","class":"lineCov","hits":"1","order":"1549","possible_hits":"1",},
{"lineNum":"   91","line":""},
...
var header = { "command" : "chaum_fuzz_debug", "date" : "2023-08-09 12:27:22", "instrumented" : 152, "covered" : 61,};
var merged_data = [];
