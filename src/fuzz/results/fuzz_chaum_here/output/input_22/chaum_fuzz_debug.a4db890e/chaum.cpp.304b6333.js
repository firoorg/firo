...
{"lineNum":"    7","line":"    F(F_), G(G_), H(H_), U(U_) {","class":"lineCov","hits":"2","order":"1119","possible_hits":"2",},
{"lineNum":"    8","line":"}","class":"linePartCov","hits":"1","order":"1120","possible_hits":"2",},
{"lineNum":"    9","line":""},
...
{"lineNum":"   16","line":") {","class":"lineCov","hits":"2","order":"1159","possible_hits":"2",},
{"lineNum":"   17","line":"    Transcript transcript(LABEL_TRANSCRIPT_CHAUM);","class":"linePartCov","hits":"1","order":"1160","possible_hits":"4",},
{"lineNum":"   18","line":"    transcript.add(\"F\", F);","class":"linePartCov","hits":"1","order":"1210","possible_hits":"2",},
{"lineNum":"   19","line":"    transcript.add(\"G\", G);","class":"linePartCov","hits":"1","order":"1232","possible_hits":"2",},
{"lineNum":"   20","line":"    transcript.add(\"H\", H);","class":"linePartCov","hits":"1","order":"1233","possible_hits":"2",},
{"lineNum":"   21","line":"    transcript.add(\"U\", U);","class":"linePartCov","hits":"1","order":"1234","possible_hits":"2",},
{"lineNum":"   22","line":"    transcript.add(\"mu\", mu);","class":"linePartCov","hits":"1","order":"1235","possible_hits":"2",},
{"lineNum":"   23","line":"    transcript.add(\"S\", S);","class":"linePartCov","hits":"1","order":"1244","possible_hits":"2",},
{"lineNum":"   24","line":"    transcript.add(\"T\", T);","class":"linePartCov","hits":"1","order":"1256","possible_hits":"2",},
{"lineNum":"   25","line":"    transcript.add(\"A1\", A1);","class":"linePartCov","hits":"1","order":"1257","possible_hits":"2",},
{"lineNum":"   26","line":"    transcript.add(\"A2\", A2);","class":"linePartCov","hits":"1","order":"1258","possible_hits":"2",},
{"lineNum":"   27","line":""},
{"lineNum":"   28","line":"    return transcript.challenge(\"c\");","class":"linePartCov","hits":"1","order":"1259","possible_hits":"2",},
{"lineNum":"   29","line":"}","class":"linePartCov","hits":"1","order":"1291","possible_hits":"12",},
{"lineNum":"   30","line":""},
...
{"lineNum":"   39","line":") {","class":"lineCov","hits":"2","order":"1122","possible_hits":"2",},
{"lineNum":"   40","line":"    // Check statement validity"},
{"lineNum":"   41","line":"    std::size_t n = x.size();","class":"lineCov","hits":"1","order":"1123","possible_hits":"1",},
{"lineNum":"   42","line":"    if (!(y.size() == n && z.size() == n && S.size() == n && T.size() == n)) {","class":"lineCov","hits":"1","order":"1124","possible_hits":"1",},
{"lineNum":"   43","line":"        throw std::invalid_argument(\"Bad Chaum statement!\");","class":"linePartCov","hits":"1","order":"1549","possible_hits":"4",},
{"lineNum":"   44","line":"    }"},
{"lineNum":"   45","line":"    for (std::size_t i = 0; i < n; i++) {","class":"lineCov","hits":"2","order":"1125","possible_hits":"2",},
{"lineNum":"   46","line":"        if (!(F*x[i] + G*y[i] + H*z[i] == S[i] && T[i]*x[i] + G*y[i] == U)) {","class":"linePartCov","hits":"1","order":"1126","possible_hits":"2",},
{"lineNum":"   47","line":"            throw std::invalid_argument(\"Bad Chaum statement!\");","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   48","line":"        }"},
{"lineNum":"   49","line":"    }","class":"lineCov","hits":"1","order":"1138","possible_hits":"1",},
{"lineNum":"   50","line":""},
{"lineNum":"   51","line":"    std::vector<Scalar> r;","class":"lineCov","hits":"1","order":"1139","possible_hits":"1",},
{"lineNum":"   52","line":"    r.resize(n);","class":"lineCov","hits":"1","order":"1140","possible_hits":"1",},
{"lineNum":"   53","line":"    std::vector<Scalar> s;","class":"lineCov","hits":"1","order":"1141","possible_hits":"1",},
{"lineNum":"   54","line":"    s.resize(n);","class":"lineCov","hits":"1","order":"1142","possible_hits":"1",},
{"lineNum":"   55","line":"    for (std::size_t i = 0; i < n; i++) {","class":"lineCov","hits":"2","order":"1143","possible_hits":"2",},
{"lineNum":"   56","line":"        r[i].randomize();","class":"lineCov","hits":"1","order":"1144","possible_hits":"1",},
{"lineNum":"   57","line":"        s[i].randomize();","class":"lineCov","hits":"1","order":"1145","possible_hits":"1",},
{"lineNum":"   58","line":"    }","class":"lineCov","hits":"1","order":"1146","possible_hits":"1",},
{"lineNum":"   59","line":"    Scalar t;","class":"lineCov","hits":"1","order":"1147","possible_hits":"1",},
{"lineNum":"   60","line":"    t.randomize();","class":"lineCov","hits":"1","order":"1148","possible_hits":"1",},
{"lineNum":"   61","line":""},
{"lineNum":"   62","line":"    proof.A1 = H*t;","class":"linePartCov","hits":"1","order":"1149","possible_hits":"2",},
{"lineNum":"   63","line":"    proof.A2.resize(n);","class":"lineCov","hits":"1","order":"1150","possible_hits":"1",},
{"lineNum":"   64","line":"    for (std::size_t i = 0; i < n; i++) {","class":"lineCov","hits":"2","order":"1151","possible_hits":"2",},
{"lineNum":"   65","line":"        proof.A1 += F*r[i] + G*s[i];","class":"linePartCov","hits":"1","order":"1152","possible_hits":"2",},
{"lineNum":"   66","line":"        proof.A2[i] = T[i]*r[i] + G*s[i];","class":"linePartCov","hits":"1","order":"1157","possible_hits":"2",},
{"lineNum":"   67","line":"    }"},
{"lineNum":"   68","line":""},
{"lineNum":"   69","line":"    Scalar c = challenge(mu, S, T, proof.A1, proof.A2);","class":"lineCov","hits":"1","order":"1158","possible_hits":"1",},
{"lineNum":"   70","line":""},
{"lineNum":"   71","line":"    proof.t1.resize(n);","class":"lineCov","hits":"1","order":"1295","possible_hits":"1",},
{"lineNum":"   72","line":"    proof.t3 = t;","class":"lineCov","hits":"1","order":"1296","possible_hits":"1",},
{"lineNum":"   73","line":"    Scalar c_power(c);","class":"lineCov","hits":"1","order":"1302","possible_hits":"1",},
{"lineNum":"   74","line":"    for (std::size_t i = 0; i < n; i++) {","class":"lineCov","hits":"2","order":"1303","possible_hits":"2",},
{"lineNum":"   75","line":"        proof.t1[i] = r[i] + c_power*x[i];","class":"linePartCov","hits":"1","order":"1304","possible_hits":"2",},
{"lineNum":"   76","line":"        proof.t2 += s[i] + c_power*y[i];","class":"linePartCov","hits":"1","order":"1311","possible_hits":"2",},
{"lineNum":"   77","line":"        proof.t3 += c_power*z[i];","class":"linePartCov","hits":"1","order":"1316","possible_hits":"2",},
{"lineNum":"   78","line":"        c_power *= c;","class":"lineCov","hits":"1","order":"1317","possible_hits":"1",},
{"lineNum":"   79","line":"    }","class":"lineCov","hits":"1","order":"1322","possible_hits":"1",},
{"lineNum":"   80","line":"}","class":"linePartCov","hits":"1","order":"1323","possible_hits":"11",},
{"lineNum":"   81","line":""},
...
var header = { "command" : "chaum_fuzz_debug", "date" : "2023-08-09 12:35:07", "instrumented" : 99, "covered" : 48,};
var merged_data = [];
