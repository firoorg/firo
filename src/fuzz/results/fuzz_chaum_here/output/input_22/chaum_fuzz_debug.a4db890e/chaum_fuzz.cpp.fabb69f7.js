...
{"lineNum":"   45","line":""},
{"lineNum":"   46","line":"    spark::ChaumProof deserialized_proof0;","class":"lineCov","hits":"1","order":"1400","possible_hits":"1",},
{"lineNum":"   47","line":"    serialized >> deserialized_proof0;","class":"lineCov","hits":"1","order":"1401","possible_hits":"1",},
{"lineNum":"   48","line":""},
{"lineNum":"   49","line":"    assert(proof0.A1 == deserialized_proof0.A1);","class":"lineCov","hits":"1","order":"1498","possible_hits":"1",},
{"lineNum":"   50","line":"    assert(proof0.t2 == deserialized_proof0.t2);","class":"lineCov","hits":"1","order":"1499","possible_hits":"1",},
{"lineNum":"   51","line":"    assert(proof0.t3 == deserialized_proof0.t3);","class":"lineCov","hits":"1","order":"1500","possible_hits":"1",},
{"lineNum":"   52","line":"    for (size_t i = 0 ; i < n; i++) {","class":"lineCov","hits":"2","order":"1501","possible_hits":"2",},
{"lineNum":"   53","line":"        assert(proof0.A2[i] == deserialized_proof0.A2[i]);","class":"lineCov","hits":"1","order":"1502","possible_hits":"1",},
{"lineNum":"   54","line":"        assert(proof0.t1[i] == deserialized_proof0.t1[i]);","class":"lineCov","hits":"1","order":"1503","possible_hits":"1",},
{"lineNum":"   55","line":"    }","class":"lineCov","hits":"1","order":"1504","possible_hits":"1",},
{"lineNum":"   56","line":""},
{"lineNum":"   57","line":"    /** Now fuzz all the things **/"},
{"lineNum":"   58","line":""},
{"lineNum":"   59","line":"    GroupElement F1, G1, H1, U1;","class":"lineCov","hits":"1","order":"1505","possible_hits":"1",},
...
{"lineNum":"   64","line":"    F1.randomize();","class":"lineCov","hits":"1","order":"1506","possible_hits":"1",},
{"lineNum":"   65","line":"    G1.randomize();","class":"lineCov","hits":"1","order":"1508","possible_hits":"1",},
{"lineNum":"   66","line":"    H1.randomize();","class":"lineCov","hits":"1","order":"1509","possible_hits":"1",},
{"lineNum":"   67","line":"    U1.randomize();","class":"lineCov","hits":"1","order":"1510","possible_hits":"1",},
{"lineNum":"   68","line":""},
{"lineNum":"   69","line":"    Scalar mu1;","class":"lineCov","hits":"1","order":"1511","possible_hits":"1",},
{"lineNum":"   70","line":"    mu1 = fsp.GetScalar();","class":"linePartCov","hits":"1","order":"1512","possible_hits":"2",},
{"lineNum":"   71","line":"    std::vector<Scalar> x1, y1, z1;","class":"lineCov","hits":"1","order":"1518","possible_hits":"1",},
{"lineNum":"   72","line":"    x1.resize(n);","class":"lineCov","hits":"1","order":"1519","possible_hits":"1",},
{"lineNum":"   73","line":"    x1 = fsp.GetScalars(n);","class":"lineCov","hits":"1","order":"1520","possible_hits":"1",},
{"lineNum":"   74","line":"    y1.resize(n);","class":"lineCov","hits":"1","order":"1528","possible_hits":"1",},
{"lineNum":"   75","line":"    y1 = fsp.GetScalars(n);","class":"lineCov","hits":"1","order":"1529","possible_hits":"1",},
{"lineNum":"   76","line":"    z1.resize(n);","class":"lineCov","hits":"1","order":"1530","possible_hits":"1",},
{"lineNum":"   77","line":"    z1 = fsp.GetScalars(n);","class":"lineCov","hits":"1","order":"1531","possible_hits":"1",},
{"lineNum":"   78","line":""},
{"lineNum":"   79","line":"    std::vector<GroupElement> S1, T1;","class":"lineCov","hits":"1","order":"1532","possible_hits":"1",},
{"lineNum":"   80","line":"    S1.resize(n);","class":"lineCov","hits":"1","order":"1533","possible_hits":"1",},
{"lineNum":"   81","line":"    T1.resize(n);","class":"lineCov","hits":"1","order":"1534","possible_hits":"1",},
{"lineNum":"   82","line":"    for (size_t i=0; i < n; i++) {","class":"lineCov","hits":"2","order":"1535","possible_hits":"2",},
{"lineNum":"   83","line":"        S1[i] = F1*x1[i] + G1*y1[i] + H1*z1[i];","class":"linePartCov","hits":"1","order":"1536","possible_hits":"2",},
{"lineNum":"   84","line":"        T1[i] = (U1 + G1*y1[i].negate())*x1[i].inverse();","class":"linePartCov","hits":"1","order":"1542","possible_hits":"2",},
{"lineNum":"   85","line":"    }"},
{"lineNum":"   86","line":""},
{"lineNum":"   87","line":"    spark::ChaumProof proof1;","class":"lineCov","hits":"1","order":"1546","possible_hits":"1",},
{"lineNum":"   88","line":""},
{"lineNum":"   89","line":"    spark::Chaum chaum1(F1, G1, H1, U1);","class":"lineCov","hits":"1","order":"1547","possible_hits":"1",},
{"lineNum":"   90","line":"    chaum1.prove(mu1, x1, y1, z1, S1, T1, proof1);","class":"lineCov","hits":"1","order":"1548","possible_hits":"1",},
{"lineNum":"   91","line":""},
...
var header = { "command" : "chaum_fuzz_debug", "date" : "2023-08-09 12:35:07", "instrumented" : 152, "covered" : 61,};
var merged_data = [];
