...
{"lineNum":"   28","line":"{","class":"lineCov","hits":"2","order":"545","possible_hits":"2",},
{"lineNum":"   29","line":"    secp256k1_ge ge;"},
{"lineNum":"   30","line":"    secp256k1_gej j(gej);","class":"lineCov","hits":"1","order":"546","possible_hits":"1",},
{"lineNum":"   31","line":"    secp256k1_ge_set_gej(&ge, &j);","class":"lineCov","hits":"1","order":"547","possible_hits":"1",},
{"lineNum":"   32","line":"    return ge;","class":"linePartCov","hits":"1","order":"548","possible_hits":"2",},
{"lineNum":"   33","line":"}"},
{"lineNum":"   34","line":""},
...
{"lineNum":"  176","line":"        : g_(new secp256k1_gej(*reinterpret_cast<const secp256k1_gej *>(g)))","class":"lineCov","hits":"1","order":"897","possible_hits":"1",},
{"lineNum":"  177","line":"{","class":"lineCov","hits":"2","order":"896","possible_hits":"2",},
{"lineNum":"  178","line":"}","class":"linePartCov","hits":"1","order":"898","possible_hits":"2",},
{"lineNum":"  179","line":""},
...
{"lineNum":"  241","line":"{","class":"lineCov","hits":"2","order":"944","possible_hits":"2",},
{"lineNum":"  242","line":"    delete reinterpret_cast<secp256k1_gej *>(g_);","class":"lineCov","hits":"1","order":"945","possible_hits":"1",},
{"lineNum":"  243","line":"}","class":"linePartCov","hits":"1","order":"946","possible_hits":"2",},
{"lineNum":"  244","line":""},
{"lineNum":"  245","line":"GroupElement& GroupElement::operator=(const GroupElement &other)"},
{"lineNum":"  246","line":"{","class":"lineCov","hits":"2","order":"939","possible_hits":"2",},
{"lineNum":"  247","line":"    return set(other);","class":"lineCov","hits":"1","order":"940","possible_hits":"1",},
{"lineNum":"  248","line":"}"},
{"lineNum":"  249","line":""},
{"lineNum":"  250","line":"GroupElement& GroupElement::set(const GroupElement &other)"},
{"lineNum":"  251","line":"{","class":"lineCov","hits":"2","order":"941","possible_hits":"2",},
{"lineNum":"  252","line":"    *reinterpret_cast<secp256k1_gej *>(g_) = *reinterpret_cast<secp256k1_gej *>(other.g_);","class":"lineCov","hits":"1","order":"942","possible_hits":"1",},
{"lineNum":"  253","line":"    return *this;","class":"linePartCov","hits":"1","order":"943","possible_hits":"2",},
{"lineNum":"  254","line":"}"},
{"lineNum":"  255","line":""},
{"lineNum":"  256","line":"GroupElement GroupElement::operator*(const Scalar& multiplier) const"},
{"lineNum":"  257","line":"{","class":"lineCov","hits":"2","order":"712","possible_hits":"2",},
{"lineNum":"  258","line":"    secp256k1_gej result;"},
{"lineNum":"  259","line":"    secp256k1_scalar ng;"},
{"lineNum":"  260","line":"    secp256k1_scalar_set_int(&ng,0);","class":"lineCov","hits":"1","order":"713","possible_hits":"1",},
{"lineNum":"  261","line":"    secp256k1_ecmult(&ctx,&result,reinterpret_cast<secp256k1_gej *>(g_), reinterpret_cast<const secp256k1_scalar *>(multiplier.get_value()),&ng);","class":"lineCov","hits":"1","order":"714","possible_hits":"1",},
{"lineNum":"  262","line":"    return &result;","class":"lineCov","hits":"1","order":"895","possible_hits":"1",},
{"lineNum":"  263","line":"}"},
{"lineNum":"  264","line":""},
...
{"lineNum":"  275","line":"{","class":"lineCov","hits":"2","order":"911","possible_hits":"2",},
{"lineNum":"  276","line":"    secp256k1_gej result_gej;"},
{"lineNum":"  277","line":"    secp256k1_gej_add_var(&result_gej, reinterpret_cast<secp256k1_gej *>(g_), reinterpret_cast<secp256k1_gej *>(other.g_), NULL);","class":"lineCov","hits":"1","order":"912","possible_hits":"1",},
{"lineNum":"  278","line":"    return &result_gej;","class":"lineCov","hits":"1","order":"938","possible_hits":"1",},
{"lineNum":"  279","line":"}"},
{"lineNum":"  280","line":""},
{"lineNum":"  281","line":"GroupElement& GroupElement::operator+=(const GroupElement& other)"},
{"lineNum":"  282","line":"{","class":"lineCov","hits":"2","order":"1154","possible_hits":"2",},
{"lineNum":"  283","line":"    auto g = reinterpret_cast<secp256k1_gej *>(g_);","class":"lineCov","hits":"1","order":"1155","possible_hits":"1",},
{"lineNum":"  284","line":"    secp256k1_gej_add_var(g, g, reinterpret_cast<secp256k1_gej *>(other.g_), NULL);","class":"lineCov","hits":"1","order":"1156","possible_hits":"1",},
{"lineNum":"  285","line":"    return *this;","class":"linePartCov","hits":"1","order":"1157","possible_hits":"2",},
{"lineNum":"  286","line":"}"},
{"lineNum":"  287","line":""},
...
{"lineNum":"  302","line":"{","class":"lineCov","hits":"2","order":"1128","possible_hits":"2",},
{"lineNum":"  303","line":"    auto g = reinterpret_cast<secp256k1_gej *>(g_);","class":"lineCov","hits":"1","order":"1129","possible_hits":"1",},
{"lineNum":"  304","line":"    auto og = reinterpret_cast<secp256k1_gej *>(other.g_);","class":"lineCov","hits":"1","order":"1130","possible_hits":"1",},
{"lineNum":"  305","line":""},
{"lineNum":"  306","line":"    if(g->infinity && og->infinity)","class":"lineCov","hits":"1","order":"1131","possible_hits":"1",},
{"lineNum":"  307","line":"        return true;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  308","line":"    if(g->infinity != og->infinity)","class":"lineCov","hits":"1","order":"1132","possible_hits":"1",},
{"lineNum":"  309","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  310","line":"    secp256k1_ge this_ge = gej_to_ge(*g);","class":"lineCov","hits":"1","order":"1133","possible_hits":"1",},
{"lineNum":"  311","line":"    secp256k1_ge other_ge = gej_to_ge(*og);","class":"lineCov","hits":"1","order":"1134","possible_hits":"1",},
{"lineNum":"  312","line":"    if(!secp256k1_fe_equal(&this_ge.x, &other_ge.x))","class":"lineCov","hits":"1","order":"1135","possible_hits":"1",},
{"lineNum":"  313","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  314","line":"    if(!secp256k1_fe_equal(&this_ge.y, &other_ge.y))","class":"lineCov","hits":"1","order":"1136","possible_hits":"1",},
{"lineNum":"  315","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  316","line":""},
{"lineNum":"  317","line":"    return true;","class":"lineCov","hits":"1","order":"1137","possible_hits":"1",},
{"lineNum":"  318","line":"}","class":"linePartCov","hits":"1","order":"1138","possible_hits":"2",},
{"lineNum":"  319","line":""},
...
{"lineNum":"  326","line":"{","class":"lineCov","hits":"2","order":"543","possible_hits":"2",},
{"lineNum":"  327","line":"    secp256k1_ge v1 = gej_to_ge(*reinterpret_cast<secp256k1_gej *>(g_));","class":"lineCov","hits":"1","order":"544","possible_hits":"1",},
{"lineNum":"  328","line":"    if (secp256k1_ge_is_infinity(&v1)) {","class":"lineCov","hits":"1","order":"549","possible_hits":"1",},
{"lineNum":"  329","line":"        return true;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  330","line":"    }"},
{"lineNum":"  331","line":"    return secp256k1_ge_is_valid_var(&v1);","class":"lineCov","hits":"1","order":"552","possible_hits":"1",},
{"lineNum":"  332","line":"}","class":"linePartCov","hits":"1","order":"586","possible_hits":"2",},
{"lineNum":"  333","line":""},
...
{"lineNum":"  347","line":"    } while (!(this->isMember()));","class":"lineCov","hits":"1","order":"542","possible_hits":"1",},
...
{"lineNum":"  384","line":"        secp256k1_ge_neg(&ge, &ge);","class":"lineCov","hits":"1","order":"534","possible_hits":"1",},
{"lineNum":"  385","line":"    }"},
{"lineNum":"  386","line":"    secp256k1_gej_set_ge(reinterpret_cast<secp256k1_gej *>(g_), &ge);","class":"lineCov","hits":"1","order":"540","possible_hits":"1",},
{"lineNum":"  387","line":"    return *this;","class":"linePartCov","hits":"1","order":"541","possible_hits":"2",},
{"lineNum":"  388","line":"}"},
{"lineNum":"  389","line":""},
...
{"lineNum":"  506","line":"}"},
{"lineNum":"  507","line":""},
{"lineNum":"  508","line":"unsigned char* GroupElement::serialize(unsigned char* buffer) const {","class":"lineCov","hits":"2","order":"1216","possible_hits":"2",},
{"lineNum":"  509","line":"    secp256k1_ge value = gej_to_ge(*reinterpret_cast<secp256k1_gej *>(g_));","class":"lineCov","hits":"1","order":"1217","possible_hits":"1",},
{"lineNum":"  510","line":"    secp256k1_fe x = value.x;","class":"lineCov","hits":"1","order":"1218","possible_hits":"1",},
{"lineNum":"  511","line":"    secp256k1_fe y = value.y;","class":"lineCov","hits":"1","order":"1219","possible_hits":"1",},
{"lineNum":"  512","line":"    secp256k1_fe_normalize(&x);","class":"lineCov","hits":"1","order":"1220","possible_hits":"1",},
{"lineNum":"  513","line":"    secp256k1_fe_normalize(&y);","class":"lineCov","hits":"1","order":"1221","possible_hits":"1",},
{"lineNum":"  514","line":"    unsigned char oddness = secp256k1_fe_is_odd(&y);","class":"lineCov","hits":"1","order":"1222","possible_hits":"1",},
{"lineNum":"  515","line":"    unsigned char infinity = value.infinity;","class":"lineCov","hits":"1","order":"1223","possible_hits":"1",},
{"lineNum":"  516","line":"    secp256k1_fe_get_b32(buffer, &x);","class":"lineCov","hits":"1","order":"1224","possible_hits":"1",},
{"lineNum":"  517","line":"    buffer[32] = oddness;","class":"lineCov","hits":"1","order":"1225","possible_hits":"1",},
{"lineNum":"  518","line":"    buffer[33] = infinity;","class":"lineCov","hits":"1","order":"1226","possible_hits":"1",},
{"lineNum":"  519","line":"    return buffer + memoryRequired();","class":"lineCov","hits":"1","order":"1227","possible_hits":"1",},
{"lineNum":"  520","line":"}"},
{"lineNum":"  521","line":""},
{"lineNum":"  522","line":"const unsigned char* GroupElement::deserialize(const unsigned char* buffer) {","class":"lineCov","hits":"2","order":"1415","possible_hits":"2",},
{"lineNum":"  523","line":"    secp256k1_fe x;"},
{"lineNum":"  524","line":"    secp256k1_fe_set_b32(&x, buffer);","class":"lineCov","hits":"1","order":"1416","possible_hits":"1",},
{"lineNum":"  525","line":"    unsigned char oddness = buffer[32];","class":"lineCov","hits":"1","order":"1417","possible_hits":"1",},
{"lineNum":"  526","line":"    unsigned char infinity = buffer[33];","class":"lineCov","hits":"1","order":"1418","possible_hits":"1",},
{"lineNum":"  527","line":"    secp256k1_ge result;"},
{"lineNum":"  528","line":"    secp256k1_ge_set_xo_var(&result, &x, (int)oddness);","class":"lineCov","hits":"1","order":"1419","possible_hits":"1",},
{"lineNum":"  529","line":"    result.infinity = (int)infinity;","class":"lineCov","hits":"1","order":"1440","possible_hits":"1",},
{"lineNum":"  530","line":""},
{"lineNum":"  531","line":"    secp256k1_gej_set_ge(reinterpret_cast<secp256k1_gej *>(g_), &result);","class":"lineCov","hits":"1","order":"1441","possible_hits":"1",},
{"lineNum":"  532","line":""},
{"lineNum":"  533","line":"    if (!secp256k1_ge_is_valid_var(&result) && !result.infinity) {","class":"lineCov","hits":"1","order":"1442","possible_hits":"1",},
{"lineNum":"  534","line":"        throw std::invalid_argument(\"GroupElement: deserialize failed\");","class":"lineNoCov","hits":"0","possible_hits":"4",},
{"lineNum":"  535","line":"    }"},
{"lineNum":"  536","line":"    return buffer + memoryRequired();","class":"lineCov","hits":"1","order":"1443","possible_hits":"1",},
...
var header = { "command" : "chaum_fuzz_debug", "date" : "2023-08-09 12:37:31", "instrumented" : 343, "covered" : 145,};
var merged_data = [];
