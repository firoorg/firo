...
{"lineNum":"  194","line":"template <typename T> T FuzzedDataProvider::ConsumeIntegral() {","class":"lineCov","hits":"2","order":"92","possible_hits":"2",},
{"lineNum":"  195","line":"  return ConsumeIntegralInRange(std::numeric_limits<T>::min(),","class":"lineCov","hits":"2","order":"93","possible_hits":"2",},
{"lineNum":"  196","line":"                                std::numeric_limits<T>::max());","class":"lineCov","hits":"1","order":"94","possible_hits":"1",},
{"lineNum":"  197","line":"}"},
{"lineNum":"  198","line":""},
...
{"lineNum":"  204","line":"T FuzzedDataProvider::ConsumeIntegralInRange(T min, T max) {","class":"lineCov","hits":"4","order":"14","possible_hits":"4",},
...
{"lineNum":"  207","line":""},
{"lineNum":"  208","line":"  if (min > max)","class":"lineCov","hits":"2","order":"15","possible_hits":"2",},
...
{"lineNum":"  212","line":"  uint64_t range = static_cast<uint64_t>(max) - min;","class":"lineCov","hits":"2","order":"16","possible_hits":"2",},
{"lineNum":"  213","line":"  uint64_t result = 0;","class":"lineCov","hits":"2","order":"17","possible_hits":"2",},
{"lineNum":"  214","line":"  size_t offset = 0;","class":"lineCov","hits":"2","order":"18","possible_hits":"2",},
{"lineNum":"  215","line":""},
{"lineNum":"  216","line":"  while (offset < sizeof(T) * CHAR_BIT && (range >> offset) > 0 &&","class":"linePartCov","hits":"4","order":"19","possible_hits":"6",},
{"lineNum":"  217","line":"         remaining_bytes_ != 0) {","class":"lineCov","hits":"2","order":"20","possible_hits":"2",},
...
{"lineNum":"  230","line":"  if (range != std::numeric_limits<decltype(range)>::max())","class":"lineCov","hits":"2","order":"21","possible_hits":"2",},
{"lineNum":"  231","line":"    result = result % (range + 1);","class":"linePartCov","hits":"1","order":"22","possible_hits":"2",},
{"lineNum":"  232","line":""},
{"lineNum":"  233","line":"  return static_cast<T>(min + result);","class":"lineCov","hits":"2","order":"23","possible_hits":"2",},
{"lineNum":"  234","line":"}"},
{"lineNum":"  235","line":""},
...
var header = { "command" : "chaum_fuzz_debug", "date" : "2023-08-24 12:59:49", "instrumented" : 41, "covered" : 14,};
var merged_data = [];
