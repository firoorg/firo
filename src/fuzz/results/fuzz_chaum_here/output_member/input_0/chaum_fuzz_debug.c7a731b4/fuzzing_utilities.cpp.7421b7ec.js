...
{"lineNum":"    2","line":""},
{"lineNum":"    3","line":"FuzzedSecp256k1Object::FuzzedSecp256k1Object(FuzzedDataProvider *fdp) {","class":"lineCov","hits":"2","order":"5","possible_hits":"2",},
{"lineNum":"    4","line":"    this->fdp = fdp;","class":"lineCov","hits":"1","order":"6","possible_hits":"1",},
{"lineNum":"    5","line":"}","class":"linePartCov","hits":"1","order":"7","possible_hits":"2",},
{"lineNum":"    6","line":""},
...
{"lineNum":"   14","line":""},
{"lineNum":"   15","line":"secp_primitives::Scalar FuzzedSecp256k1Object::GetScalar() {","class":"lineCov","hits":"2","order":"90","possible_hits":"2",},
{"lineNum":"   16","line":"    size_t value = this->fdp->ConsumeIntegral<size_t>();","class":"lineCov","hits":"1","order":"91","possible_hits":"1",},
{"lineNum":"   17","line":"    secp_primitives::Scalar s = secp_primitives::Scalar(value);","class":"lineCov","hits":"1","order":"95","possible_hits":"1",},
{"lineNum":"   18","line":""},
{"lineNum":"   19","line":"    return s;","class":"lineCov","hits":"1","order":"96","possible_hits":"1",},
{"lineNum":"   20","line":"}","class":"lineCov","hits":"1","order":"97","possible_hits":"1",},
{"lineNum":"   21","line":""},
{"lineNum":"   22","line":"secp_primitives::GroupElement FuzzedSecp256k1Object::GetMemberGroupElement() {","class":"lineCov","hits":"2","order":"80","possible_hits":"2",},
{"lineNum":"   23","line":"    secp_primitives::GroupElement ge;","class":"lineCov","hits":"1","order":"81","possible_hits":"1",},
{"lineNum":"   24","line":"    ge.randomize();","class":"lineCov","hits":"1","order":"82","possible_hits":"1",},
{"lineNum":"   25","line":"    return ge;","class":"lineCov","hits":"1","order":"83","possible_hits":"1",},
{"lineNum":"   26","line":"}","class":"lineCov","hits":"1","order":"84","possible_hits":"1",},
{"lineNum":"   27","line":""},
...
{"lineNum":"   65","line":""},
{"lineNum":"   66","line":"std::vector<secp_primitives::Scalar> FuzzedSecp256k1Object::GetScalarsVector(size_t len) {","class":"lineCov","hits":"2","order":"101","possible_hits":"2",},
{"lineNum":"   67","line":"    std::vector<secp_primitives::Scalar> scalar_vec;","class":"lineCov","hits":"1","order":"102","possible_hits":"1",},
{"lineNum":"   68","line":"    scalar_vec.resize(len);","class":"lineCov","hits":"1","order":"103","possible_hits":"1",},
{"lineNum":"   69","line":"    for (int i = 0; i <= len; i++) {","class":"lineCov","hits":"2","order":"104","possible_hits":"2",},
{"lineNum":"   70","line":"        scalar_vec.push_back(GetScalar());","class":"linePartCov","hits":"1","order":"105","possible_hits":"2",},
{"lineNum":"   71","line":"    }"},
{"lineNum":"   72","line":""},
{"lineNum":"   73","line":"    return scalar_vec;","class":"lineCov","hits":"1","order":"106","possible_hits":"1",},
{"lineNum":"   74","line":"}","class":"linePartCov","hits":"1","order":"107","possible_hits":"2",},
{"lineNum":"   75","line":""},
{"lineNum":"   76","line":"secp_primitives::Scalar FuzzedSecp256k1Object::GetScalar_modified() {","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   77","line":"    secp_primitives::Scalar s = secp_primitives::Scalar(this->fdp->ConsumeBytes<uint8_t>(32).data());","class":"lineNoCov","hits":"0","possible_hits":"4",},
...
var header = { "command" : "chaum_fuzz_debug", "date" : "2023-08-24 12:59:49", "instrumented" : 66, "covered" : 20,};
var merged_data = [];
