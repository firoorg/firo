...
{"lineNum":"   28","line":"    T0.resize(n);","class":"lineCov","hits":"1","order":"35","possible_hits":"1",},
{"lineNum":"   29","line":"    for (size_t i=0; i < n; i++) {","class":"lineCov","hits":"2","order":"36","possible_hits":"2",},
{"lineNum":"   30","line":"        x0[i].randomize();","class":"lineCov","hits":"1","order":"37","possible_hits":"1",},
{"lineNum":"   31","line":"        y0[i].randomize();","class":"lineCov","hits":"1","order":"38","possible_hits":"1",},
{"lineNum":"   32","line":"        z0[i].randomize();","class":"lineCov","hits":"1","order":"39","possible_hits":"1",},
{"lineNum":"   33","line":""},
{"lineNum":"   34","line":"        S0[i] = F0*x0[i] + G0*y0[i] + H0*z0[i];","class":"linePartCov","hits":"1","order":"40","possible_hits":"2",},
{"lineNum":"   35","line":"        T0[i] = (U0 + G0*y0[i].negate())*x0[i].inverse();","class":"linePartCov","hits":"1","order":"41","possible_hits":"2",},
{"lineNum":"   36","line":"    }"},
{"lineNum":"   37","line":""},
{"lineNum":"   38","line":"    spark::ChaumProof proof0;","class":"lineCov","hits":"1","order":"42","possible_hits":"1",},
{"lineNum":"   39","line":""},
{"lineNum":"   40","line":"    spark::Chaum chaum0(F0, G0, H0, U0);","class":"lineCov","hits":"1","order":"43","possible_hits":"1",},
{"lineNum":"   41","line":"    chaum0.prove(mu0, x0, y0, z0, S0, T0, proof0);","class":"lineCov","hits":"1","order":"44","possible_hits":"1",},
{"lineNum":"   42","line":""},
{"lineNum":"   43","line":"    CDataStream serialized(SER_NETWORK, PROTOCOL_VERSION);","class":"lineCov","hits":"1","order":"45","possible_hits":"1",},
{"lineNum":"   44","line":"    serialized << proof0;","class":"lineCov","hits":"1","order":"46","possible_hits":"1",},
{"lineNum":"   45","line":""},
{"lineNum":"   46","line":"    spark::ChaumProof deserialized_proof0;","class":"lineCov","hits":"1","order":"47","possible_hits":"1",},
{"lineNum":"   47","line":"    serialized >> deserialized_proof0;","class":"lineCov","hits":"1","order":"48","possible_hits":"1",},
{"lineNum":"   48","line":""},
{"lineNum":"   49","line":"    assert(proof0.A1 == deserialized_proof0.A1);","class":"lineCov","hits":"1","order":"49","possible_hits":"1",},
{"lineNum":"   50","line":"    assert(proof0.t2 == deserialized_proof0.t2);","class":"lineCov","hits":"1","order":"50","possible_hits":"1",},
{"lineNum":"   51","line":"    assert(proof0.t3 == deserialized_proof0.t3);","class":"lineCov","hits":"1","order":"51","possible_hits":"1",},
{"lineNum":"   52","line":"    for (size_t i = 0 ; i < n; i++) {","class":"lineCov","hits":"2","order":"52","possible_hits":"2",},
{"lineNum":"   53","line":"        assert(proof0.A2[i] == deserialized_proof0.A2[i]);","class":"lineCov","hits":"1","order":"53","possible_hits":"1",},
{"lineNum":"   54","line":"        assert(proof0.t1[i] == deserialized_proof0.t1[i]);","class":"lineCov","hits":"1","order":"54","possible_hits":"1",},
{"lineNum":"   55","line":"    }","class":"lineCov","hits":"1","order":"55","possible_hits":"1",},
{"lineNum":"   56","line":""},
{"lineNum":"   57","line":"    // fuzz completeness"},
{"lineNum":"   58","line":"    GroupElement F1, G1, H1, U1;","class":"lineCov","hits":"1","order":"56","possible_hits":"1",},
{"lineNum":"   59","line":"    F1.randomize();","class":"lineCov","hits":"1","order":"57","possible_hits":"1",},
{"lineNum":"   60","line":"    G1.randomize();","class":"lineCov","hits":"1","order":"58","possible_hits":"1",},
{"lineNum":"   61","line":"    H1.randomize();","class":"lineCov","hits":"1","order":"59","possible_hits":"1",},
{"lineNum":"   62","line":"    U1.randomize();","class":"lineCov","hits":"1","order":"60","possible_hits":"1",},
{"lineNum":"   63","line":""},
{"lineNum":"   64","line":"    const std::size_t n1 = fdp.ConsumeIntegralInRange(1, INT_MAX);","class":"lineCov","hits":"1","order":"61","possible_hits":"1",},
{"lineNum":"   65","line":""},
{"lineNum":"   66","line":"    Scalar mu1;","class":"lineCov","hits":"1","order":"62","possible_hits":"1",},
{"lineNum":"   67","line":"    mu1.randomize();","class":"lineCov","hits":"1","order":"63","possible_hits":"1",},
{"lineNum":"   68","line":"    std::vector<Scalar> x1, y1, z1;","class":"lineCov","hits":"1","order":"64","possible_hits":"1",},
{"lineNum":"   69","line":"    x1.resize(n1);","class":"lineCov","hits":"1","order":"65","possible_hits":"1",},
{"lineNum":"   70","line":"    y1.resize(n1);","class":"lineCov","hits":"1","order":"66","possible_hits":"1",},
{"lineNum":"   71","line":"    z1.resize(n1);","class":"lineCov","hits":"1","order":"67","possible_hits":"1",},
{"lineNum":"   72","line":"    std::vector<GroupElement> S1, T1;","class":"lineCov","hits":"1","order":"68","possible_hits":"1",},
{"lineNum":"   73","line":"    S1.resize(n1);","class":"lineCov","hits":"1","order":"69","possible_hits":"1",},
{"lineNum":"   74","line":"    T1.resize(n1);","class":"lineCov","hits":"1","order":"70","possible_hits":"1",},
{"lineNum":"   75","line":"    for (std::size_t i = 0; i < n; i++) {","class":"lineCov","hits":"2","order":"71","possible_hits":"2",},
{"lineNum":"   76","line":"        x1[i].randomize();","class":"lineCov","hits":"1","order":"72","possible_hits":"1",},
{"lineNum":"   77","line":"        y1[i].randomize();","class":"lineCov","hits":"1","order":"73","possible_hits":"1",},
{"lineNum":"   78","line":"        z1[i].randomize();","class":"lineCov","hits":"1","order":"74","possible_hits":"1",},
{"lineNum":"   79","line":""},
{"lineNum":"   80","line":"        S1[i] = F1*x1[i] + G1*y1[i] + H1*z1[i];","class":"linePartCov","hits":"1","order":"75","possible_hits":"2",},
{"lineNum":"   81","line":"        T1[i] = (U1 + G1*y1[i].negate())*x1[i].inverse();","class":"linePartCov","hits":"1","order":"76","possible_hits":"2",},
{"lineNum":"   82","line":"    }"},
{"lineNum":"   83","line":""},
...
var header = { "command" : "chaum_fuzz_debug", "date" : "2023-08-24 13:03:08", "instrumented" : 120, "covered" : 59,};
var merged_data = [];
