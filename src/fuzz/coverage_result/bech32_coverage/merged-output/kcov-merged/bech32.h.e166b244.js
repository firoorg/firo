...
{"lineNum":"   46","line":"struct DecodeResult","class":"lineCov","hits":"1","order":"117",},
{"lineNum":"   47","line":"{"},
...
{"lineNum":"   51","line":""},
{"lineNum":"   52","line":"    DecodeResult() : encoding(Encoding::INVALID) {}","class":"lineCov","hits":"1","order":"116",},
{"lineNum":"   53","line":"    DecodeResult(Encoding enc, std::string&& h, std::vector<uint8_t>&& d) : encoding(enc), hrp(std::move(h)), data(std::move(d)) {}","class":"lineCov","hits":"1","order":"115",},
{"lineNum":"   54","line":"};"},
{"lineNum":"   55","line":""},
...
var header = { "command" : "", "date" : "2023-08-29 07:45:04", "instrumented" : 3, "covered" : 3,};
var merged_data = [];
