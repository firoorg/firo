...
{"lineNum":"   33","line":"    if(r1.hrp.empty()) {","class":"lineCov","hits":"1","order":"37","possible_hits":"1",},
{"lineNum":"   34","line":"        assert(r1.encoding == bech32::Encoding::INVALID);","class":"lineCov","hits":"1","order":"38","possible_hits":"1",},
{"lineNum":"   35","line":"        assert(r1.data.empty());","class":"lineCov","hits":"1","order":"39","possible_hits":"1",},
{"lineNum":"   36","line":"    } else {","class":"lineCov","hits":"1","order":"40","possible_hits":"1",},
...
{"lineNum":"   41","line":""},
{"lineNum":"   42","line":"    std::vector<uint8_t> input = fuzzed_data.ConsumeBytes<uint8_t>(len);","class":"lineCov","hits":"1","order":"41","possible_hits":"1",},
{"lineNum":"   43","line":"    std::vector<uint8_t> test_vec2 = fuzzed_data.ConsumeBytes<uint8_t>(len);","class":"lineCov","hits":"1","order":"50","possible_hits":"1",},
{"lineNum":"   44","line":"    int test_frombits = fuzzed_data.ConsumeIntegral<int>();","class":"lineCov","hits":"1","order":"51","possible_hits":"1",},
{"lineNum":"   45","line":"    int test_to_bits = fuzzed_data.ConsumeIntegral<int>();","class":"lineCov","hits":"1","order":"65","possible_hits":"1",},
{"lineNum":"   46","line":"    bool test_pad = fuzzed_data.ConsumeBool();","class":"lineCov","hits":"1","order":"66","possible_hits":"1",},
{"lineNum":"   47","line":"    bech32::convertbits(input, test_vec2, test_frombits, test_to_bits, test_pad);","class":"lineCov","hits":"1","order":"69","possible_hits":"1",},
{"lineNum":"   48","line":""},
{"lineNum":"   49","line":"    if(input.size() + 3 + 6 <= 90) {","class":"lineCov","hits":"1","order":"79","possible_hits":"1",},
{"lineNum":"   50","line":"        for (auto encoding: {bech32::Encoding::BECH32, bech32::Encoding::BECH32M}) {","class":"lineCov","hits":"2","order":"80","possible_hits":"2",},
{"lineNum":"   51","line":"            const std::string encoded = bech32::encode(\"bc\",  input, encoding );","class":"linePartCov","hits":"1","order":"81","possible_hits":"2",},
{"lineNum":"   52","line":"            assert(!encoded.empty());","class":"lineCov","hits":"1","order":"129","possible_hits":"1",},
{"lineNum":"   53","line":""},
{"lineNum":"   54","line":"            const auto r2 = bech32::decode(encoded);","class":"lineCov","hits":"1","order":"130","possible_hits":"1",},
...
var header = { "command" : "bech32_debug", "date" : "2023-08-29 07:43:53", "instrumented" : 40, "covered" : 25,};
var merged_data = [];
