...
{"lineNum":"   46","line":"struct DecodeResult","class":"lineCov","hits":"2","order":"151","possible_hits":"2",},
{"lineNum":"   47","line":"{"},
...
{"lineNum":"   51","line":""},
{"lineNum":"   52","line":"    DecodeResult() : encoding(Encoding::INVALID) {}","class":"lineCov","hits":"2","order":"76","possible_hits":"2",},
{"lineNum":"   53","line":"    DecodeResult(Encoding enc, std::string&& h, std::vector<uint8_t>&& d) : encoding(enc), hrp(std::move(h)), data(std::move(d)) {}","class":"lineCov","hits":"2","order":"146","possible_hits":"2",},
{"lineNum":"   54","line":"};"},
{"lineNum":"   55","line":""},
...
var header = { "command" : "bech32_debug", "date" : "2023-08-29 07:45:04", "instrumented" : 3, "covered" : 3,};
var merged_data = [];
