...
{"lineNum":"  108","line":"std::vector<T> FuzzedDataProvider::ConsumeBytes(size_t num_bytes) {","class":"lineCov","hits":"2","order":"32","possible_hits":"2",},
{"lineNum":"  109","line":"  num_bytes = std::min(num_bytes, remaining_bytes_);","class":"lineCov","hits":"1","order":"33","possible_hits":"1",},
{"lineNum":"  110","line":"  return ConsumeBytes<T>(num_bytes, num_bytes);","class":"lineCov","hits":"1","order":"34","possible_hits":"1",},
{"lineNum":"  111","line":"}"},
{"lineNum":"  112","line":""},
...
{"lineNum":"  194","line":"template <typename T> T FuzzedDataProvider::ConsumeIntegral() {","class":"lineCov","hits":"4","order":"42","possible_hits":"4",},
{"lineNum":"  195","line":"  return ConsumeIntegralInRange(std::numeric_limits<T>::min(),","class":"lineCov","hits":"4","order":"43","possible_hits":"4",},
{"lineNum":"  196","line":"                                std::numeric_limits<T>::max());","class":"lineCov","hits":"2","order":"44","possible_hits":"2",},
{"lineNum":"  197","line":"}"},
{"lineNum":"  198","line":""},
...
{"lineNum":"  204","line":"T FuzzedDataProvider::ConsumeIntegralInRange(T min, T max) {","class":"lineCov","hits":"4","order":"45","possible_hits":"4",},
...
{"lineNum":"  207","line":""},
{"lineNum":"  208","line":"  if (min > max)","class":"lineCov","hits":"2","order":"46","possible_hits":"2",},
...
{"lineNum":"  212","line":"  uint64_t range = static_cast<uint64_t>(max) - min;","class":"lineCov","hits":"2","order":"47","possible_hits":"2",},
{"lineNum":"  213","line":"  uint64_t result = 0;","class":"lineCov","hits":"2","order":"48","possible_hits":"2",},
{"lineNum":"  214","line":"  size_t offset = 0;","class":"lineCov","hits":"2","order":"49","possible_hits":"2",},
{"lineNum":"  215","line":""},
{"lineNum":"  216","line":"  while (offset < sizeof(T) * CHAR_BIT && (range >> offset) > 0 &&","class":"linePartCov","hits":"4","order":"50","possible_hits":"6",},
{"lineNum":"  217","line":"         remaining_bytes_ != 0) {","class":"lineCov","hits":"2","order":"51","possible_hits":"2",},
...
{"lineNum":"  230","line":"  if (range != std::numeric_limits<decltype(range)>::max())","class":"lineCov","hits":"2","order":"52","possible_hits":"2",},
{"lineNum":"  231","line":"    result = result % (range + 1);","class":"lineCov","hits":"2","order":"53","possible_hits":"2",},
{"lineNum":"  232","line":""},
{"lineNum":"  233","line":"  return static_cast<T>(min + result);","class":"lineCov","hits":"2","order":"54","possible_hits":"2",},
{"lineNum":"  234","line":"}"},
{"lineNum":"  235","line":""},
...
{"lineNum":"  288","line":"inline bool FuzzedDataProvider::ConsumeBool() {","class":"lineCov","hits":"2","order":"57","possible_hits":"2",},
{"lineNum":"  289","line":"  return 1 & ConsumeIntegral<uint8_t>();","class":"lineCov","hits":"1","order":"58","possible_hits":"1",},
{"lineNum":"  290","line":"}"},
{"lineNum":"  291","line":""},
...
{"lineNum":"  352","line":"std::vector<T> FuzzedDataProvider::ConsumeBytes(size_t size, size_t num_bytes) {","class":"lineCov","hits":"2","order":"35","possible_hits":"2",},
...
{"lineNum":"  361","line":"  std::vector<T> result(size);","class":"linePartCov","hits":"1","order":"36","possible_hits":"4",},
{"lineNum":"  362","line":"  if (size == 0) {","class":"lineCov","hits":"1","order":"37","possible_hits":"1",},
{"lineNum":"  363","line":"    if (num_bytes != 0)","class":"lineCov","hits":"1","order":"38","possible_hits":"1",},
{"lineNum":"  364","line":"      abort();","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  365","line":"    return result;","class":"lineCov","hits":"1","order":"39","possible_hits":"1",},
{"lineNum":"  366","line":"  }"},
{"lineNum":"  367","line":""},
...
var header = { "command" : "bech32_debug", "date" : "2023-08-29 07:44:51", "instrumented" : 50, "covered" : 36,};
var merged_data = [];
