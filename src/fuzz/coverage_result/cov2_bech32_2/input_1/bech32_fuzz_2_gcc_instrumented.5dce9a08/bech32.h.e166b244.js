...
{"lineNum":"   46","line":"struct DecodeResult","class":"lineNoCov","hits":"0","possible_hits":"3",},
{"lineNum":"   47","line":"{"},
...
{"lineNum":"   51","line":""},
{"lineNum":"   52","line":"    DecodeResult() : encoding(Encoding::INVALID) {}","class":"lineNoCov","hits":"0","possible_hits":"4",},
{"lineNum":"   53","line":"    DecodeResult(Encoding enc, std::string&& h, std::vector<uint8_t>&& d) : encoding(enc), hrp(std::move(h)), data(std::move(d)) {}","class":"lineNoCov","hits":"0","possible_hits":"8",},
{"lineNum":"   54","line":"};"},
{"lineNum":"   55","line":""},
...
var header = { "command" : "bech32_fuzz_2_gcc_instrumented", "date" : "2023-07-28 14:59:10", "instrumented" : 3, "covered" : 0,};
var merged_data = [];
