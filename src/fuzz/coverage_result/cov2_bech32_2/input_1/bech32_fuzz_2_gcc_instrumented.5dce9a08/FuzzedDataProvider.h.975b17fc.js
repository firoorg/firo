...
{"lineNum":"   35","line":"  FuzzedDataProvider(const uint8_t *data, size_t size)","class":"lineCov","hits":"1","order":"3","possible_hits":"1",},
{"lineNum":"   36","line":"      : data_ptr_(data), remaining_bytes_(size) {}","class":"lineCov","hits":"3","order":"4","possible_hits":"3",},
...
{"lineNum":"  136","line":"inline std::string FuzzedDataProvider::ConsumeBytesAsString(size_t num_bytes) {","class":"lineCov","hits":"2","order":"6","possible_hits":"2",},
...
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"  num_bytes = std::min(num_bytes, remaining_bytes_);","class":"lineCov","hits":"4","order":"7","possible_hits":"4",},
{"lineNum":"  141","line":"  std::string result("},
{"lineNum":"  142","line":"      reinterpret_cast<const std::string::value_type *>(data_ptr_), num_bytes);","class":"lineCov","hits":"3","order":"8","possible_hits":"3",},
...
var header = { "command" : "bech32_fuzz_2_gcc_instrumented", "date" : "2023-07-28 14:59:10", "instrumented" : 54, "covered" : 5,};
var merged_data = [];
