...
{"lineNum":"   26","line":""},
{"lineNum":"   27","line":"SECP256K1_INLINE static void secp256k1_scalar_clear(secp256k1_scalar *r) {","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   28","line":"    r->d[0] = 0;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   29","line":"    r->d[1] = 0;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   30","line":"    r->d[2] = 0;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   31","line":"    r->d[3] = 0;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   32","line":"}","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   33","line":""},
{"lineNum":"   34","line":"SECP256K1_INLINE static void secp256k1_scalar_set_int(secp256k1_scalar *r, unsigned int v) {","class":"lineNoCov","hits":"0","possible_hits":"4",},
{"lineNum":"   35","line":"    r->d[0] = v;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   36","line":"    r->d[1] = 0;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   37","line":"    r->d[2] = 0;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   38","line":"    r->d[3] = 0;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   39","line":"}","class":"lineNoCov","hits":"0","possible_hits":"4",},
{"lineNum":"   40","line":""},
{"lineNum":"   41","line":"SECP256K1_INLINE static unsigned int secp256k1_scalar_get_bits(const secp256k1_scalar *a, unsigned int offset, unsigned int count) {","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   42","line":"    VERIFY_CHECK((offset + count - 1) >> 6 == offset >> 6);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   43","line":"    return (a->d[offset >> 6] >> (offset & 0x3F)) & ((((uint64_t)1) << count) - 1);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   44","line":"}"},
{"lineNum":"   45","line":""},
{"lineNum":"   46","line":"SECP256K1_INLINE static unsigned int secp256k1_scalar_get_bits_var(const secp256k1_scalar *a, unsigned int offset, unsigned int count) {","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   47","line":"    VERIFY_CHECK(count < 32);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   48","line":"    VERIFY_CHECK(offset + count <= 256);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   49","line":"    if ((offset + count - 1) >> 6 == offset >> 6) {","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   50","line":"        return secp256k1_scalar_get_bits(a, offset, count);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   51","line":"    } else {"},
{"lineNum":"   52","line":"        VERIFY_CHECK((offset >> 6) + 1 < 4);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   53","line":"        return ((a->d[offset >> 6] >> (offset & 0x3F)) | (a->d[(offset >> 6) + 1] << (64 - (offset & 0x3F)))) & ((((uint64_t)1) << count) - 1);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   54","line":"    }"},
...
{"lineNum":"  135","line":""},
{"lineNum":"  136","line":"SECP256K1_INLINE static int secp256k1_scalar_is_zero(const secp256k1_scalar *a) {","class":"lineNoCov","hits":"0","possible_hits":"4",},
{"lineNum":"  137","line":"    return (a->d[0] | a->d[1] | a->d[2] | a->d[3]) == 0;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  138","line":"}"},
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"static void secp256k1_scalar_negate(secp256k1_scalar *r, const secp256k1_scalar *a) {","class":"lineNoCov","hits":"0","possible_hits":"4",},
{"lineNum":"  141","line":"    uint64_t nonzero = 0xFFFFFFFFFFFFFFFFULL * (secp256k1_scalar_is_zero(a) == 0);","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  142","line":"    uint128_t t = (uint128_t)(~a->d[0]) + SECP256K1_N_0 + 1;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  143","line":"    r->d[0] = t & nonzero; t >>= 64;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  144","line":"    t += (uint128_t)(~a->d[1]) + SECP256K1_N_1;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  145","line":"    r->d[1] = t & nonzero; t >>= 64;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  146","line":"    t += (uint128_t)(~a->d[2]) + SECP256K1_N_2;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  147","line":"    r->d[2] = t & nonzero; t >>= 64;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  148","line":"    t += (uint128_t)(~a->d[3]) + SECP256K1_N_3;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  149","line":"    r->d[3] = t & nonzero;","class":"lineNoCov","hits":"0","possible_hits":"2",},
...
var header = { "command" : "f4grumble_debug", "date" : "2023-08-29 14:58:12", "instrumented" : 122, "covered" : 0,};
var merged_data = [];
