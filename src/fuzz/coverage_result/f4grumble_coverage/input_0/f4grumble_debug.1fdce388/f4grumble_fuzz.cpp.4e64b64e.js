...
{"lineNum":"    8","line":""},
{"lineNum":"    9","line":"    for (int i=0; i < len; i++) {","class":"linePartCov","hits":"1","order":"30","possible_hits":"2",},
{"lineNum":"   10","line":"        test_char_vec.push_back(test_string[i]);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   11","line":"    }","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   12","line":""},
{"lineNum":"   13","line":"    // too_long_size"},
{"lineNum":"   14","line":"    bool exception_thrown_size = false;","class":"lineCov","hits":"1","order":"31","possible_hits":"1",},
{"lineNum":"   15","line":"    bool exception_thrown_encode = false;","class":"lineCov","hits":"1","order":"32","possible_hits":"1",},
{"lineNum":"   16","line":"    bool exception_thrown_decode = false;","class":"lineCov","hits":"1","order":"33","possible_hits":"1",},
{"lineNum":"   17","line":""},
{"lineNum":"   18","line":"    if(len > spark::F4Grumble::get_max_size()){","class":"lineCov","hits":"1","order":"34","possible_hits":"1",},
{"lineNum":"   19","line":""},
{"lineNum":"   20","line":"        try {"},
...
{"lineNum":"   43","line":"    }"},
{"lineNum":"   44","line":""},
{"lineNum":"   45","line":"    spark::F4Grumble f4grumble_fuzz = spark::F4Grumble(test_string[0], len);","class":"lineCov","hits":"1","order":"37","possible_hits":"1",},
{"lineNum":"   46","line":"    std::vector<unsigned char> scrambled = f4grumble_fuzz.encode(test_char_vec);","class":"lineCov","hits":"1","order":"45","possible_hits":"1",},
{"lineNum":"   47","line":"    std::vector<unsigned char> unscrambled = f4grumble_fuzz.decode(scrambled);","class":"lineCov","hits":"1","order":"97","possible_hits":"1",},
{"lineNum":"   48","line":""},
{"lineNum":"   49","line":"    assert(scrambled.size() == test_char_vec.size());","class":"lineCov","hits":"1","order":"110","possible_hits":"1",},
{"lineNum":"   50","line":"    assert(unscrambled == test_char_vec);","class":"lineCov","hits":"1","order":"111","possible_hits":"1",},
{"lineNum":"   51","line":""},
{"lineNum":"   52","line":"    // bad_network"},
{"lineNum":"   53","line":"    unsigned char evil_network = ~test_string[0];","class":"lineCov","hits":"1","order":"112","possible_hits":"1",},
{"lineNum":"   54","line":"    assert(test_string[0] != evil_network);","class":"lineCov","hits":"1","order":"113","possible_hits":"1",},
{"lineNum":"   55","line":""},
{"lineNum":"   56","line":"    spark::F4Grumble evil_grumble(evil_network, len);","class":"lineCov","hits":"1","order":"114","possible_hits":"1",},
{"lineNum":"   57","line":"    //decoding with a different network"},
{"lineNum":"   58","line":"    std::vector<unsigned char> evil_unscrambled = evil_grumble.decode(scrambled);","class":"lineCov","hits":"1","order":"115","possible_hits":"1",},
{"lineNum":"   59","line":"    assert(evil_unscrambled.size() == scrambled.size());","class":"lineCov","hits":"1","order":"116","possible_hits":"1",},
{"lineNum":"   60","line":"    assert(evil_unscrambled != test_char_vec);","class":"lineCov","hits":"1","order":"117","possible_hits":"1",},
...
var header = { "command" : "f4grumble_debug", "date" : "2023-08-29 14:57:27", "instrumented" : 41, "covered" : 20,};
var merged_data = [];
