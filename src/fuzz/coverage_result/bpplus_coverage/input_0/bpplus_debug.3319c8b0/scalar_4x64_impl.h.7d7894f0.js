...
{"lineNum":"   26","line":""},
{"lineNum":"   27","line":"SECP256K1_INLINE static void secp256k1_scalar_clear(secp256k1_scalar *r) {","class":"lineCov","hits":"4","order":"731","possible_hits":"4",},
{"lineNum":"   28","line":"    r->d[0] = 0;","class":"lineCov","hits":"2","order":"732","possible_hits":"2",},
{"lineNum":"   29","line":"    r->d[1] = 0;","class":"lineCov","hits":"2","order":"733","possible_hits":"2",},
{"lineNum":"   30","line":"    r->d[2] = 0;","class":"lineCov","hits":"2","order":"734","possible_hits":"2",},
{"lineNum":"   31","line":"    r->d[3] = 0;","class":"lineCov","hits":"2","order":"735","possible_hits":"2",},
{"lineNum":"   32","line":"}","class":"linePartCov","hits":"2","order":"736","possible_hits":"4",},
{"lineNum":"   33","line":""},
{"lineNum":"   34","line":"SECP256K1_INLINE static void secp256k1_scalar_set_int(secp256k1_scalar *r, unsigned int v) {","class":"linePartCov","hits":"4","order":"757","possible_hits":"6",},
{"lineNum":"   35","line":"    r->d[0] = v;","class":"linePartCov","hits":"2","order":"758","possible_hits":"3",},
{"lineNum":"   36","line":"    r->d[1] = 0;","class":"linePartCov","hits":"2","order":"759","possible_hits":"3",},
{"lineNum":"   37","line":"    r->d[2] = 0;","class":"linePartCov","hits":"2","order":"760","possible_hits":"3",},
{"lineNum":"   38","line":"    r->d[3] = 0;","class":"linePartCov","hits":"2","order":"761","possible_hits":"3",},
{"lineNum":"   39","line":"}","class":"linePartCov","hits":"2","order":"762","possible_hits":"6",},
{"lineNum":"   40","line":""},
{"lineNum":"   41","line":"SECP256K1_INLINE static unsigned int secp256k1_scalar_get_bits(const secp256k1_scalar *a, unsigned int offset, unsigned int count) {","class":"lineCov","hits":"4","order":"838","possible_hits":"4",},
{"lineNum":"   42","line":"    VERIFY_CHECK((offset + count - 1) >> 6 == offset >> 6);","class":"lineCov","hits":"2","order":"839","possible_hits":"2",},
{"lineNum":"   43","line":"    return (a->d[offset >> 6] >> (offset & 0x3F)) & ((((uint64_t)1) << count) - 1);","class":"lineCov","hits":"2","order":"840","possible_hits":"2",},
{"lineNum":"   44","line":"}"},
{"lineNum":"   45","line":""},
{"lineNum":"   46","line":"SECP256K1_INLINE static unsigned int secp256k1_scalar_get_bits_var(const secp256k1_scalar *a, unsigned int offset, unsigned int count) {","class":"lineCov","hits":"4","order":"847","possible_hits":"4",},
{"lineNum":"   47","line":"    VERIFY_CHECK(count < 32);","class":"lineCov","hits":"2","order":"848","possible_hits":"2",},
{"lineNum":"   48","line":"    VERIFY_CHECK(offset + count <= 256);","class":"lineCov","hits":"2","order":"849","possible_hits":"2",},
{"lineNum":"   49","line":"    if ((offset + count - 1) >> 6 == offset >> 6) {","class":"lineCov","hits":"2","order":"850","possible_hits":"2",},
{"lineNum":"   50","line":"        return secp256k1_scalar_get_bits(a, offset, count);","class":"lineCov","hits":"2","order":"851","possible_hits":"2",},
{"lineNum":"   51","line":"    } else {"},
{"lineNum":"   52","line":"        VERIFY_CHECK((offset >> 6) + 1 < 4);","class":"lineCov","hits":"2","order":"1002","possible_hits":"2",},
{"lineNum":"   53","line":"        return ((a->d[offset >> 6] >> (offset & 0x3F)) | (a->d[(offset >> 6) + 1] << (64 - (offset & 0x3F)))) & ((((uint64_t)1) << count) - 1);","class":"lineCov","hits":"2","order":"1003","possible_hits":"2",},
{"lineNum":"   54","line":"    }"},
{"lineNum":"   55","line":"}","class":"linePartCov","hits":"2","order":"852","possible_hits":"4",},
{"lineNum":"   56","line":""},
...
{"lineNum":"   81","line":"}"},
{"lineNum":"   82","line":""},
{"lineNum":"   83","line":"static int secp256k1_scalar_add(secp256k1_scalar *r, const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"2","order":"764","possible_hits":"2",},
{"lineNum":"   84","line":"    int overflow;"},
{"lineNum":"   85","line":"    uint128_t t = (uint128_t)a->d[0] + b->d[0];","class":"lineCov","hits":"1","order":"765","possible_hits":"1",},
{"lineNum":"   86","line":"    r->d[0] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"766","possible_hits":"1",},
{"lineNum":"   87","line":"    t += (uint128_t)a->d[1] + b->d[1];","class":"lineCov","hits":"1","order":"767","possible_hits":"1",},
{"lineNum":"   88","line":"    r->d[1] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"768","possible_hits":"1",},
{"lineNum":"   89","line":"    t += (uint128_t)a->d[2] + b->d[2];","class":"lineCov","hits":"1","order":"769","possible_hits":"1",},
{"lineNum":"   90","line":"    r->d[2] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"770","possible_hits":"1",},
{"lineNum":"   91","line":"    t += (uint128_t)a->d[3] + b->d[3];","class":"lineCov","hits":"1","order":"771","possible_hits":"1",},
{"lineNum":"   92","line":"    r->d[3] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"772","possible_hits":"1",},
{"lineNum":"   93","line":"    overflow = t + secp256k1_scalar_check_overflow(r);","class":"lineCov","hits":"1","order":"773","possible_hits":"1",},
{"lineNum":"   94","line":"    VERIFY_CHECK(overflow == 0 || overflow == 1);","class":"lineCov","hits":"1","order":"774","possible_hits":"1",},
{"lineNum":"   95","line":"    secp256k1_scalar_reduce(r, overflow);","class":"lineCov","hits":"1","order":"775","possible_hits":"1",},
{"lineNum":"   96","line":"    return overflow;","class":"lineCov","hits":"1","order":"776","possible_hits":"1",},
{"lineNum":"   97","line":"}"},
{"lineNum":"   98","line":""},
...
{"lineNum":"  125","line":"        *overflow = over;","class":"lineCov","hits":"1","order":"1513","possible_hits":"1",},
{"lineNum":"  126","line":"    }"},
{"lineNum":"  127","line":"}","class":"linePartCov","hits":"1","order":"67","possible_hits":"2",},
{"lineNum":"  128","line":""},
{"lineNum":"  129","line":"static void secp256k1_scalar_get_b32(unsigned char *bin, const secp256k1_scalar* a) {","class":"lineCov","hits":"2","order":"1124","possible_hits":"2",},
{"lineNum":"  130","line":"    bin[0] = a->d[3] >> 56; bin[1] = a->d[3] >> 48; bin[2] = a->d[3] >> 40; bin[3] = a->d[3] >> 32; bin[4] = a->d[3] >> 24; bin[5] = a->d[3] >> 16; bin[6] = a->d[3] >> 8; bin[7] = a->d[3];","class":"lineCov","hits":"1","order":"1125","possible_hits":"1",},
{"lineNum":"  131","line":"    bin[8] = a->d[2] >> 56; bin[9] = a->d[2] >> 48; bin[10] = a->d[2] >> 40; bin[11] = a->d[2] >> 32; bin[12] = a->d[2] >> 24; bin[13] = a->d[2] >> 16; bin[14] = a->d[2] >> 8; bin[15] = a->d[2];","class":"lineCov","hits":"1","order":"1126","possible_hits":"1",},
{"lineNum":"  132","line":"    bin[16] = a->d[1] >> 56; bin[17] = a->d[1] >> 48; bin[18] = a->d[1] >> 40; bin[19] = a->d[1] >> 32; bin[20] = a->d[1] >> 24; bin[21] = a->d[1] >> 16; bin[22] = a->d[1] >> 8; bin[23] = a->d[1];","class":"lineCov","hits":"1","order":"1127","possible_hits":"1",},
{"lineNum":"  133","line":"    bin[24] = a->d[0] >> 56; bin[25] = a->d[0] >> 48; bin[26] = a->d[0] >> 40; bin[27] = a->d[0] >> 32; bin[28] = a->d[0] >> 24; bin[29] = a->d[0] >> 16; bin[30] = a->d[0] >> 8; bin[31] = a->d[0];","class":"lineCov","hits":"1","order":"1128","possible_hits":"1",},
{"lineNum":"  134","line":"}","class":"linePartCov","hits":"1","order":"1129","possible_hits":"2",},
{"lineNum":"  135","line":""},
{"lineNum":"  136","line":"SECP256K1_INLINE static int secp256k1_scalar_is_zero(const secp256k1_scalar *a) {","class":"lineCov","hits":"6","order":"798","possible_hits":"6",},
{"lineNum":"  137","line":"    return (a->d[0] | a->d[1] | a->d[2] | a->d[3]) == 0;","class":"lineCov","hits":"3","order":"799","possible_hits":"3",},
{"lineNum":"  138","line":"}"},
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"static void secp256k1_scalar_negate(secp256k1_scalar *r, const secp256k1_scalar *a) {","class":"lineCov","hits":"6","order":"991","possible_hits":"6",},
{"lineNum":"  141","line":"    uint64_t nonzero = 0xFFFFFFFFFFFFFFFFULL * (secp256k1_scalar_is_zero(a) == 0);","class":"lineCov","hits":"3","order":"992","possible_hits":"3",},
{"lineNum":"  142","line":"    uint128_t t = (uint128_t)(~a->d[0]) + SECP256K1_N_0 + 1;","class":"lineCov","hits":"3","order":"993","possible_hits":"3",},
{"lineNum":"  143","line":"    r->d[0] = t & nonzero; t >>= 64;","class":"lineCov","hits":"3","order":"994","possible_hits":"3",},
{"lineNum":"  144","line":"    t += (uint128_t)(~a->d[1]) + SECP256K1_N_1;","class":"lineCov","hits":"3","order":"995","possible_hits":"3",},
{"lineNum":"  145","line":"    r->d[1] = t & nonzero; t >>= 64;","class":"lineCov","hits":"3","order":"996","possible_hits":"3",},
{"lineNum":"  146","line":"    t += (uint128_t)(~a->d[2]) + SECP256K1_N_2;","class":"lineCov","hits":"3","order":"997","possible_hits":"3",},
{"lineNum":"  147","line":"    r->d[2] = t & nonzero; t >>= 64;","class":"lineCov","hits":"3","order":"998","possible_hits":"3",},
{"lineNum":"  148","line":"    t += (uint128_t)(~a->d[3]) + SECP256K1_N_3;","class":"lineCov","hits":"3","order":"999","possible_hits":"3",},
{"lineNum":"  149","line":"    r->d[3] = t & nonzero;","class":"lineCov","hits":"3","order":"1000","possible_hits":"3",},
{"lineNum":"  150","line":"}","class":"lineCov","hits":"6","order":"846","possible_hits":"6",},
{"lineNum":"  151","line":""},
...
{"lineNum":"  268","line":"}"},
{"lineNum":"  269","line":""},
{"lineNum":"  270","line":"static void secp256k1_scalar_reduce_512(secp256k1_scalar *r, const uint64_t *l) {","class":"lineCov","hits":"2","order":"1072","possible_hits":"2",},
...
{"lineNum":"  276","line":""},
{"lineNum":"  277","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"1074","possible_hits":"1",},
...
{"lineNum":"  379","line":"    : \"S\"(l), \"n\"(SECP256K1_N_C_0), \"n\"(SECP256K1_N_C_1)","class":"lineCov","hits":"1","order":"1073","possible_hits":"1",},
{"lineNum":"  380","line":"    : \"rax\", \"rdx\", \"r8\", \"r9\", \"r10\", \"r11\", \"r12\", \"r13\", \"r14\", \"cc\");"},
{"lineNum":"  381","line":""},
{"lineNum":"  382","line":"    /* Reduce 385 bits into 258. */"},
{"lineNum":"  383","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"1076","possible_hits":"1",},
...
{"lineNum":"  458","line":"    : \"g\"(m0), \"g\"(m1), \"g\"(m2), \"g\"(m3), \"g\"(m4), \"g\"(m5), \"g\"(m6), \"n\"(SECP256K1_N_C_0), \"n\"(SECP256K1_N_C_1)","class":"lineCov","hits":"1","order":"1075","possible_hits":"1",},
{"lineNum":"  459","line":"    : \"rax\", \"rdx\", \"r8\", \"r9\", \"r10\", \"r11\", \"r12\", \"r13\", \"cc\");"},
{"lineNum":"  460","line":""},
{"lineNum":"  461","line":"    /* Reduce 258 bits into 256. */"},
{"lineNum":"  462","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"1078","possible_hits":"1",},
...
{"lineNum":"  504","line":"    : \"g\"(p0), \"g\"(p1), \"g\"(p2), \"g\"(p3), \"g\"(p4), \"D\"(r), \"n\"(SECP256K1_N_C_0), \"n\"(SECP256K1_N_C_1)","class":"lineCov","hits":"1","order":"1077","possible_hits":"1",},
...
{"lineNum":"  576","line":"    secp256k1_scalar_reduce(r, c + secp256k1_scalar_check_overflow(r));","class":"lineCov","hits":"1","order":"1079","possible_hits":"1",},
{"lineNum":"  577","line":"}","class":"linePartCov","hits":"1","order":"1080","possible_hits":"2",},
{"lineNum":"  578","line":""},
{"lineNum":"  579","line":"static void secp256k1_scalar_mul_512(uint64_t l[8], const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"2","order":"1066","possible_hits":"2",},
{"lineNum":"  580","line":"#ifdef USE_ASM_X86_64"},
{"lineNum":"  581","line":"    const uint64_t *pb = b->d;","class":"lineCov","hits":"1","order":"1067","possible_hits":"1",},
{"lineNum":"  582","line":"    __asm__ __volatile__(","class":"lineCov","hits":"2","order":"1068","possible_hits":"2",},
...
{"lineNum":"  710","line":"    : \"S\"(l), \"D\"(a->d)","class":"lineCov","hits":"1","order":"1069","possible_hits":"1",},
...
{"lineNum":"  744","line":"}","class":"linePartCov","hits":"1","order":"1070","possible_hits":"2",},
{"lineNum":"  745","line":""},
{"lineNum":"  746","line":"static void secp256k1_scalar_sqr_512(uint64_t l[8], const secp256k1_scalar *a) {","class":"lineCov","hits":"2","order":"1527","possible_hits":"2",},
{"lineNum":"  747","line":"#ifdef USE_ASM_X86_64"},
{"lineNum":"  748","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"1529","possible_hits":"1",},
...
{"lineNum":"  852","line":"    :"},
{"lineNum":"  853","line":"    : \"S\"(l), \"D\"(a->d)","class":"lineCov","hits":"1","order":"1528","possible_hits":"1",},
...
{"lineNum":"  881","line":"}","class":"linePartCov","hits":"1","order":"1530","possible_hits":"2",},
{"lineNum":"  882","line":""},
...
{"lineNum":"  890","line":""},
{"lineNum":"  891","line":"static void secp256k1_scalar_mul(secp256k1_scalar *r, const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"2","order":"1064","possible_hits":"2",},
{"lineNum":"  892","line":"    uint64_t l[8];"},
{"lineNum":"  893","line":"    secp256k1_scalar_mul_512(l, a, b);","class":"lineCov","hits":"1","order":"1065","possible_hits":"1",},
{"lineNum":"  894","line":"    secp256k1_scalar_reduce_512(r, l);","class":"lineCov","hits":"1","order":"1071","possible_hits":"1",},
{"lineNum":"  895","line":"}","class":"linePartCov","hits":"1","order":"1081","possible_hits":"2",},
{"lineNum":"  896","line":""},
...
{"lineNum":"  907","line":"}"},
{"lineNum":"  908","line":""},
{"lineNum":"  909","line":"static void secp256k1_scalar_sqr(secp256k1_scalar *r, const secp256k1_scalar *a) {","class":"lineCov","hits":"2","order":"1525","possible_hits":"2",},
{"lineNum":"  910","line":"    uint64_t l[8];"},
{"lineNum":"  911","line":"    secp256k1_scalar_sqr_512(l, a);","class":"lineCov","hits":"1","order":"1526","possible_hits":"1",},
{"lineNum":"  912","line":"    secp256k1_scalar_reduce_512(r, l);","class":"lineCov","hits":"1","order":"1531","possible_hits":"1",},
{"lineNum":"  913","line":"}","class":"linePartCov","hits":"1","order":"1532","possible_hits":"2",},
{"lineNum":"  914","line":""},
...
{"lineNum":"  927","line":""},
{"lineNum":"  928","line":"SECP256K1_INLINE static int secp256k1_scalar_eq(const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"2","order":"793","possible_hits":"2",},
{"lineNum":"  929","line":"    return ((a->d[0] ^ b->d[0]) | (a->d[1] ^ b->d[1]) | (a->d[2] ^ b->d[2]) | (a->d[3] ^ b->d[3])) == 0;","class":"lineCov","hits":"1","order":"794","possible_hits":"1",},
{"lineNum":"  930","line":"}"},
{"lineNum":"  931","line":""},
...
var header = { "command" : "bpplus_debug", "date" : "2023-08-25 16:07:06", "instrumented" : 122, "covered" : 113,};
var merged_data = [];
