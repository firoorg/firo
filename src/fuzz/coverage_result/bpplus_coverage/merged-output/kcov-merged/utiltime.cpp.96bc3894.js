...
{"lineNum":"   42","line":"    int64_t now = (boost::posix_time::microsec_clock::universal_time() -","class":"lineNoCov","hits":"0",},
{"lineNum":"   43","line":"                   boost::posix_time::ptime(boost::gregorian::date(1970,1,1))).total_microseconds();","class":"lineNoCov","hits":"0",},
{"lineNum":"   44","line":"    assert(now > 0);","class":"lineNoCov","hits":"0",},
{"lineNum":"   45","line":"    return now;","class":"lineNoCov","hits":"0",},
{"lineNum":"   46","line":"}"},
{"lineNum":"   47","line":""},
...
{"lineNum":"   56","line":"    if (nMockTime) return nMockTime*1000000;","class":"lineNoCov","hits":"0",},
{"lineNum":"   57","line":""},
{"lineNum":"   58","line":"    return GetTimeMicros();","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   81","line":"    static std::locale classic(std::locale::classic());","class":"lineNoCov","hits":"0",},
{"lineNum":"   82","line":"    // std::locale takes ownership of the pointer"},
{"lineNum":"   83","line":"    std::locale loc(classic, new boost::posix_time::time_facet(pszFormat));","class":"lineNoCov","hits":"0",},
{"lineNum":"   84","line":"    std::stringstream ss;","class":"lineNoCov","hits":"0",},
{"lineNum":"   85","line":"    ss.imbue(loc);","class":"lineNoCov","hits":"0",},
{"lineNum":"   86","line":"    ss << boost::posix_time::from_time_t(nTime);","class":"lineNoCov","hits":"0",},
{"lineNum":"   87","line":"    return ss.str();","class":"lineNoCov","hits":"0",},
...
var header = { "command" : "", "date" : "2023-08-25 16:09:03", "instrumented" : 49, "covered" : 0,};
var merged_data = [];
