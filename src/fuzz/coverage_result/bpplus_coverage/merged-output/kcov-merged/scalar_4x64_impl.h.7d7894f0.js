...
{"lineNum":"   26","line":""},
{"lineNum":"   27","line":"SECP256K1_INLINE static void secp256k1_scalar_clear(secp256k1_scalar *r) {","class":"lineCov","hits":"1","order":"614",},
{"lineNum":"   28","line":"    r->d[0] = 0;","class":"lineCov","hits":"1","order":"617",},
{"lineNum":"   29","line":"    r->d[1] = 0;","class":"lineCov","hits":"1","order":"621",},
{"lineNum":"   30","line":"    r->d[2] = 0;","class":"lineCov","hits":"1","order":"648",},
{"lineNum":"   31","line":"    r->d[3] = 0;","class":"lineCov","hits":"1","order":"629",},
{"lineNum":"   32","line":"}","class":"lineCov","hits":"1","order":"638",},
{"lineNum":"   33","line":""},
{"lineNum":"   34","line":"SECP256K1_INLINE static void secp256k1_scalar_set_int(secp256k1_scalar *r, unsigned int v) {","class":"lineCov","hits":"1","order":"626",},
{"lineNum":"   35","line":"    r->d[0] = v;","class":"lineCov","hits":"1","order":"633",},
{"lineNum":"   36","line":"    r->d[1] = 0;","class":"lineCov","hits":"1","order":"644",},
{"lineNum":"   37","line":"    r->d[2] = 0;","class":"lineCov","hits":"1","order":"652",},
{"lineNum":"   38","line":"    r->d[3] = 0;","class":"lineCov","hits":"1","order":"609",},
{"lineNum":"   39","line":"}","class":"lineCov","hits":"1","order":"659",},
{"lineNum":"   40","line":""},
{"lineNum":"   41","line":"SECP256K1_INLINE static unsigned int secp256k1_scalar_get_bits(const secp256k1_scalar *a, unsigned int offset, unsigned int count) {","class":"lineCov","hits":"1","order":"561",},
{"lineNum":"   42","line":"    VERIFY_CHECK((offset + count - 1) >> 6 == offset >> 6);","class":"lineCov","hits":"1","order":"560",},
{"lineNum":"   43","line":"    return (a->d[offset >> 6] >> (offset & 0x3F)) & ((((uint64_t)1) << count) - 1);","class":"lineCov","hits":"1","order":"559",},
{"lineNum":"   44","line":"}"},
{"lineNum":"   45","line":""},
{"lineNum":"   46","line":"SECP256K1_INLINE static unsigned int secp256k1_scalar_get_bits_var(const secp256k1_scalar *a, unsigned int offset, unsigned int count) {","class":"lineCov","hits":"1","order":"558",},
{"lineNum":"   47","line":"    VERIFY_CHECK(count < 32);","class":"lineCov","hits":"1","order":"557",},
{"lineNum":"   48","line":"    VERIFY_CHECK(offset + count <= 256);","class":"lineCov","hits":"1","order":"556",},
{"lineNum":"   49","line":"    if ((offset + count - 1) >> 6 == offset >> 6) {","class":"lineCov","hits":"1","order":"555",},
{"lineNum":"   50","line":"        return secp256k1_scalar_get_bits(a, offset, count);","class":"lineCov","hits":"1","order":"554",},
{"lineNum":"   51","line":"    } else {"},
{"lineNum":"   52","line":"        VERIFY_CHECK((offset >> 6) + 1 < 4);","class":"lineCov","hits":"1","order":"553",},
{"lineNum":"   53","line":"        return ((a->d[offset >> 6] >> (offset & 0x3F)) | (a->d[(offset >> 6) + 1] << (64 - (offset & 0x3F)))) & ((((uint64_t)1) << count) - 1);","class":"lineCov","hits":"1","order":"552",},
{"lineNum":"   54","line":"    }"},
{"lineNum":"   55","line":"}","class":"lineCov","hits":"1","order":"551",},
{"lineNum":"   56","line":""},
{"lineNum":"   57","line":"SECP256K1_INLINE static int secp256k1_scalar_check_overflow(const secp256k1_scalar *a) {","class":"lineCov","hits":"1","order":"576",},
{"lineNum":"   58","line":"    int yes = 0;","class":"lineCov","hits":"1","order":"575",},
{"lineNum":"   59","line":"    int no = 0;","class":"lineCov","hits":"1","order":"574",},
{"lineNum":"   60","line":"    no |= (a->d[3] < SECP256K1_N_3); /* No need for a > check. */","class":"lineCov","hits":"1","order":"573",},
{"lineNum":"   61","line":"    no |= (a->d[2] < SECP256K1_N_2);","class":"lineCov","hits":"1","order":"572",},
{"lineNum":"   62","line":"    yes |= (a->d[2] > SECP256K1_N_2) & ~no;","class":"lineCov","hits":"1","order":"571",},
{"lineNum":"   63","line":"    no |= (a->d[1] < SECP256K1_N_1);","class":"lineCov","hits":"1","order":"570",},
{"lineNum":"   64","line":"    yes |= (a->d[1] > SECP256K1_N_1) & ~no;","class":"lineCov","hits":"1","order":"569",},
{"lineNum":"   65","line":"    yes |= (a->d[0] >= SECP256K1_N_0) & ~no;","class":"lineCov","hits":"1","order":"568",},
{"lineNum":"   66","line":"    return yes;","class":"lineCov","hits":"1","order":"567",},
{"lineNum":"   67","line":"}"},
{"lineNum":"   68","line":""},
{"lineNum":"   69","line":"SECP256K1_INLINE static int secp256k1_scalar_reduce(secp256k1_scalar *r, unsigned int overflow) {","class":"lineCov","hits":"1","order":"593",},
{"lineNum":"   70","line":"    uint128_t t;"},
{"lineNum":"   71","line":"    VERIFY_CHECK(overflow <= 1);","class":"lineCov","hits":"1","order":"591",},
{"lineNum":"   72","line":"    t = (uint128_t)r->d[0] + overflow * SECP256K1_N_C_0;","class":"lineCov","hits":"1","order":"589",},
{"lineNum":"   73","line":"    r->d[0] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"588",},
{"lineNum":"   74","line":"    t += (uint128_t)r->d[1] + overflow * SECP256K1_N_C_1;","class":"lineCov","hits":"1","order":"586",},
{"lineNum":"   75","line":"    r->d[1] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"584",},
{"lineNum":"   76","line":"    t += (uint128_t)r->d[2] + overflow * SECP256K1_N_C_2;","class":"lineCov","hits":"1","order":"582",},
{"lineNum":"   77","line":"    r->d[2] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"581",},
{"lineNum":"   78","line":"    t += (uint64_t)r->d[3];","class":"lineCov","hits":"1","order":"579",},
{"lineNum":"   79","line":"    r->d[3] = t & 0xFFFFFFFFFFFFFFFFULL;","class":"lineCov","hits":"1","order":"578",},
{"lineNum":"   80","line":"    return overflow;","class":"lineCov","hits":"1","order":"577",},
{"lineNum":"   81","line":"}"},
{"lineNum":"   82","line":""},
{"lineNum":"   83","line":"static int secp256k1_scalar_add(secp256k1_scalar *r, const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"1","order":"596",},
{"lineNum":"   84","line":"    int overflow;"},
{"lineNum":"   85","line":"    uint128_t t = (uint128_t)a->d[0] + b->d[0];","class":"lineCov","hits":"1","order":"612",},
{"lineNum":"   86","line":"    r->d[0] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"615",},
{"lineNum":"   87","line":"    t += (uint128_t)a->d[1] + b->d[1];","class":"lineCov","hits":"1","order":"618",},
{"lineNum":"   88","line":"    r->d[1] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"622",},
{"lineNum":"   89","line":"    t += (uint128_t)a->d[2] + b->d[2];","class":"lineCov","hits":"1","order":"649",},
{"lineNum":"   90","line":"    r->d[2] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"630",},
{"lineNum":"   91","line":"    t += (uint128_t)a->d[3] + b->d[3];","class":"lineCov","hits":"1","order":"640",},
{"lineNum":"   92","line":"    r->d[3] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"654",},
{"lineNum":"   93","line":"    overflow = t + secp256k1_scalar_check_overflow(r);","class":"lineCov","hits":"1","order":"627",},
{"lineNum":"   94","line":"    VERIFY_CHECK(overflow == 0 || overflow == 1);","class":"lineCov","hits":"1","order":"634",},
{"lineNum":"   95","line":"    secp256k1_scalar_reduce(r, overflow);","class":"lineCov","hits":"1","order":"645",},
{"lineNum":"   96","line":"    return overflow;","class":"lineCov","hits":"1","order":"653",},
{"lineNum":"   97","line":"}"},
{"lineNum":"   98","line":""},
...
{"lineNum":"  115","line":"}"},
{"lineNum":"  116","line":""},
{"lineNum":"  117","line":"static void secp256k1_scalar_set_b32(secp256k1_scalar *r, const unsigned char *b32, int *overflow) {","class":"lineCov","hits":"1","order":"651",},
{"lineNum":"  118","line":"    int over;"},
{"lineNum":"  119","line":"    r->d[0] = (uint64_t)b32[31] | (uint64_t)b32[30] << 8 | (uint64_t)b32[29] << 16 | (uint64_t)b32[28] << 24 | (uint64_t)b32[27] << 32 | (uint64_t)b32[26] << 40 | (uint64_t)b32[25] << 48 | (uint64_t)b32[24] << 56;","class":"lineCov","hits":"1","order":"637",},
{"lineNum":"  120","line":"    r->d[1] = (uint64_t)b32[23] | (uint64_t)b32[22] << 8 | (uint64_t)b32[21] << 16 | (uint64_t)b32[20] << 24 | (uint64_t)b32[19] << 32 | (uint64_t)b32[18] << 40 | (uint64_t)b32[17] << 48 | (uint64_t)b32[16] << 56;","class":"lineCov","hits":"1","order":"625",},
{"lineNum":"  121","line":"    r->d[2] = (uint64_t)b32[15] | (uint64_t)b32[14] << 8 | (uint64_t)b32[13] << 16 | (uint64_t)b32[12] << 24 | (uint64_t)b32[11] << 32 | (uint64_t)b32[10] << 40 | (uint64_t)b32[9] << 48 | (uint64_t)b32[8] << 56;","class":"lineCov","hits":"1","order":"628",},
{"lineNum":"  122","line":"    r->d[3] = (uint64_t)b32[7] | (uint64_t)b32[6] << 8 | (uint64_t)b32[5] << 16 | (uint64_t)b32[4] << 24 | (uint64_t)b32[3] << 32 | (uint64_t)b32[2] << 40 | (uint64_t)b32[1] << 48 | (uint64_t)b32[0] << 56;","class":"lineCov","hits":"1","order":"635",},
{"lineNum":"  123","line":"    over = secp256k1_scalar_reduce(r, secp256k1_scalar_check_overflow(r));","class":"lineCov","hits":"1","order":"647",},
{"lineNum":"  124","line":"    if (overflow) {","class":"lineCov","hits":"1","order":"608",},
{"lineNum":"  125","line":"        *overflow = over;","class":"lineCov","hits":"1","order":"611",},
{"lineNum":"  126","line":"    }"},
{"lineNum":"  127","line":"}","class":"lineCov","hits":"1","order":"602",},
{"lineNum":"  128","line":""},
{"lineNum":"  129","line":"static void secp256k1_scalar_get_b32(unsigned char *bin, const secp256k1_scalar* a) {","class":"lineCov","hits":"1","order":"606",},
{"lineNum":"  130","line":"    bin[0] = a->d[3] >> 56; bin[1] = a->d[3] >> 48; bin[2] = a->d[3] >> 40; bin[3] = a->d[3] >> 32; bin[4] = a->d[3] >> 24; bin[5] = a->d[3] >> 16; bin[6] = a->d[3] >> 8; bin[7] = a->d[3];","class":"lineCov","hits":"1","order":"595",},
{"lineNum":"  131","line":"    bin[8] = a->d[2] >> 56; bin[9] = a->d[2] >> 48; bin[10] = a->d[2] >> 40; bin[11] = a->d[2] >> 32; bin[12] = a->d[2] >> 24; bin[13] = a->d[2] >> 16; bin[14] = a->d[2] >> 8; bin[15] = a->d[2];","class":"lineCov","hits":"1","order":"603",},
{"lineNum":"  132","line":"    bin[16] = a->d[1] >> 56; bin[17] = a->d[1] >> 48; bin[18] = a->d[1] >> 40; bin[19] = a->d[1] >> 32; bin[20] = a->d[1] >> 24; bin[21] = a->d[1] >> 16; bin[22] = a->d[1] >> 8; bin[23] = a->d[1];","class":"lineCov","hits":"1","order":"600",},
{"lineNum":"  133","line":"    bin[24] = a->d[0] >> 56; bin[25] = a->d[0] >> 48; bin[26] = a->d[0] >> 40; bin[27] = a->d[0] >> 32; bin[28] = a->d[0] >> 24; bin[29] = a->d[0] >> 16; bin[30] = a->d[0] >> 8; bin[31] = a->d[0];","class":"lineCov","hits":"1","order":"598",},
{"lineNum":"  134","line":"}","class":"lineCov","hits":"1","order":"594",},
{"lineNum":"  135","line":""},
{"lineNum":"  136","line":"SECP256K1_INLINE static int secp256k1_scalar_is_zero(const secp256k1_scalar *a) {","class":"lineCov","hits":"1","order":"662",},
{"lineNum":"  137","line":"    return (a->d[0] | a->d[1] | a->d[2] | a->d[3]) == 0;","class":"lineCov","hits":"1","order":"663",},
{"lineNum":"  138","line":"}"},
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"static void secp256k1_scalar_negate(secp256k1_scalar *r, const secp256k1_scalar *a) {","class":"lineCov","hits":"1","order":"655",},
{"lineNum":"  141","line":"    uint64_t nonzero = 0xFFFFFFFFFFFFFFFFULL * (secp256k1_scalar_is_zero(a) == 0);","class":"lineCov","hits":"1","order":"656",},
{"lineNum":"  142","line":"    uint128_t t = (uint128_t)(~a->d[0]) + SECP256K1_N_0 + 1;","class":"lineCov","hits":"1","order":"597",},
{"lineNum":"  143","line":"    r->d[0] = t & nonzero; t >>= 64;","class":"lineCov","hits":"1","order":"658",},
{"lineNum":"  144","line":"    t += (uint128_t)(~a->d[1]) + SECP256K1_N_1;","class":"lineCov","hits":"1","order":"613",},
{"lineNum":"  145","line":"    r->d[1] = t & nonzero; t >>= 64;","class":"lineCov","hits":"1","order":"616",},
{"lineNum":"  146","line":"    t += (uint128_t)(~a->d[2]) + SECP256K1_N_2;","class":"lineCov","hits":"1","order":"619",},
{"lineNum":"  147","line":"    r->d[2] = t & nonzero; t >>= 64;","class":"lineCov","hits":"1","order":"624",},
{"lineNum":"  148","line":"    t += (uint128_t)(~a->d[3]) + SECP256K1_N_3;","class":"lineCov","hits":"1","order":"650",},
{"lineNum":"  149","line":"    r->d[3] = t & nonzero;","class":"lineCov","hits":"1","order":"632",},
{"lineNum":"  150","line":"}","class":"lineCov","hits":"1","order":"643",},
{"lineNum":"  151","line":""},
...
{"lineNum":"  268","line":"}"},
{"lineNum":"  269","line":""},
{"lineNum":"  270","line":"static void secp256k1_scalar_reduce_512(secp256k1_scalar *r, const uint64_t *l) {","class":"lineCov","hits":"1","order":"657",},
...
{"lineNum":"  276","line":""},
{"lineNum":"  277","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"641",},
...
{"lineNum":"  379","line":"    : \"S\"(l), \"n\"(SECP256K1_N_C_0), \"n\"(SECP256K1_N_C_1)","class":"lineCov","hits":"1","order":"610",},
{"lineNum":"  380","line":"    : \"rax\", \"rdx\", \"r8\", \"r9\", \"r10\", \"r11\", \"r12\", \"r13\", \"r14\", \"cc\");"},
{"lineNum":"  381","line":""},
{"lineNum":"  382","line":"    /* Reduce 385 bits into 258. */"},
{"lineNum":"  383","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"605",},
...
{"lineNum":"  458","line":"    : \"g\"(m0), \"g\"(m1), \"g\"(m2), \"g\"(m3), \"g\"(m4), \"g\"(m5), \"g\"(m6), \"n\"(SECP256K1_N_C_0), \"n\"(SECP256K1_N_C_1)","class":"lineCov","hits":"1","order":"580",},
{"lineNum":"  459","line":"    : \"rax\", \"rdx\", \"r8\", \"r9\", \"r10\", \"r11\", \"r12\", \"r13\", \"cc\");"},
{"lineNum":"  460","line":""},
{"lineNum":"  461","line":"    /* Reduce 258 bits into 256. */"},
{"lineNum":"  462","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"565",},
...
{"lineNum":"  504","line":"    : \"g\"(p0), \"g\"(p1), \"g\"(p2), \"g\"(p3), \"g\"(p4), \"D\"(r), \"n\"(SECP256K1_N_C_0), \"n\"(SECP256K1_N_C_1)","class":"lineCov","hits":"1","order":"646",},
...
{"lineNum":"  576","line":"    secp256k1_scalar_reduce(r, c + secp256k1_scalar_check_overflow(r));","class":"lineCov","hits":"1","order":"564",},
{"lineNum":"  577","line":"}","class":"lineCov","hits":"1","order":"592",},
{"lineNum":"  578","line":""},
{"lineNum":"  579","line":"static void secp256k1_scalar_mul_512(uint64_t l[8], const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"1","order":"590",},
{"lineNum":"  580","line":"#ifdef USE_ASM_X86_64"},
{"lineNum":"  581","line":"    const uint64_t *pb = b->d;","class":"lineCov","hits":"1","order":"587",},
{"lineNum":"  582","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"585",},
...
{"lineNum":"  710","line":"    : \"S\"(l), \"D\"(a->d)","class":"lineCov","hits":"1","order":"583",},
...
{"lineNum":"  744","line":"}","class":"lineCov","hits":"1","order":"566",},
{"lineNum":"  745","line":""},
{"lineNum":"  746","line":"static void secp256k1_scalar_sqr_512(uint64_t l[8], const secp256k1_scalar *a) {","class":"lineCov","hits":"1","order":"563",},
{"lineNum":"  747","line":"#ifdef USE_ASM_X86_64"},
{"lineNum":"  748","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"562",},
...
{"lineNum":"  852","line":"    :"},
{"lineNum":"  853","line":"    : \"S\"(l), \"D\"(a->d)","class":"lineCov","hits":"1","order":"639",},
...
{"lineNum":"  881","line":"}","class":"lineCov","hits":"1","order":"636",},
{"lineNum":"  882","line":""},
...
{"lineNum":"  890","line":""},
{"lineNum":"  891","line":"static void secp256k1_scalar_mul(secp256k1_scalar *r, const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"1","order":"607",},
{"lineNum":"  892","line":"    uint64_t l[8];"},
{"lineNum":"  893","line":"    secp256k1_scalar_mul_512(l, a, b);","class":"lineCov","hits":"1","order":"604",},
{"lineNum":"  894","line":"    secp256k1_scalar_reduce_512(r, l);","class":"lineCov","hits":"1","order":"601",},
{"lineNum":"  895","line":"}","class":"lineCov","hits":"1","order":"599",},
{"lineNum":"  896","line":""},
...
{"lineNum":"  907","line":"}"},
{"lineNum":"  908","line":""},
{"lineNum":"  909","line":"static void secp256k1_scalar_sqr(secp256k1_scalar *r, const secp256k1_scalar *a) {","class":"lineCov","hits":"1","order":"623",},
{"lineNum":"  910","line":"    uint64_t l[8];"},
{"lineNum":"  911","line":"    secp256k1_scalar_sqr_512(l, a);","class":"lineCov","hits":"1","order":"631",},
{"lineNum":"  912","line":"    secp256k1_scalar_reduce_512(r, l);","class":"lineCov","hits":"1","order":"642",},
{"lineNum":"  913","line":"}","class":"lineCov","hits":"1","order":"620",},
{"lineNum":"  914","line":""},
...
{"lineNum":"  927","line":""},
{"lineNum":"  928","line":"SECP256K1_INLINE static int secp256k1_scalar_eq(const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"1","order":"660",},
{"lineNum":"  929","line":"    return ((a->d[0] ^ b->d[0]) | (a->d[1] ^ b->d[1]) | (a->d[2] ^ b->d[2]) | (a->d[3] ^ b->d[3])) == 0;","class":"lineCov","hits":"1","order":"661",},
{"lineNum":"  930","line":"}"},
{"lineNum":"  931","line":""},
...
var header = { "command" : "", "date" : "2023-08-25 16:09:03", "instrumented" : 122, "covered" : 113,};
var merged_data = [];
