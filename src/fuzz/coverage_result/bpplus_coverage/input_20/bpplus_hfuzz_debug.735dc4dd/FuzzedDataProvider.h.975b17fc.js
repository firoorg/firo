...
{"lineNum":"  128","line":"std::vector<T> FuzzedDataProvider::ConsumeRemainingBytes() {","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  129","line":"  return ConsumeBytes<T>(remaining_bytes_);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  130","line":"}"},
{"lineNum":"  131","line":""},
...
{"lineNum":"  194","line":"template <typename T> T FuzzedDataProvider::ConsumeIntegral() {","class":"lineCov","hits":"2","order":"145","possible_hits":"2",},
{"lineNum":"  195","line":"  return ConsumeIntegralInRange(std::numeric_limits<T>::min(),","class":"lineCov","hits":"2","order":"146","possible_hits":"2",},
{"lineNum":"  196","line":"                                std::numeric_limits<T>::max());","class":"lineCov","hits":"1","order":"147","possible_hits":"1",},
{"lineNum":"  197","line":"}"},
{"lineNum":"  198","line":""},
...
{"lineNum":"  204","line":"T FuzzedDataProvider::ConsumeIntegralInRange(T min, T max) {","class":"lineCov","hits":"2","order":"148","possible_hits":"2",},
...
{"lineNum":"  207","line":""},
{"lineNum":"  208","line":"  if (min > max)","class":"lineCov","hits":"1","order":"149","possible_hits":"1",},
...
{"lineNum":"  212","line":"  uint64_t range = static_cast<uint64_t>(max) - min;","class":"lineCov","hits":"1","order":"150","possible_hits":"1",},
{"lineNum":"  213","line":"  uint64_t result = 0;","class":"lineCov","hits":"1","order":"151","possible_hits":"1",},
{"lineNum":"  214","line":"  size_t offset = 0;","class":"lineCov","hits":"1","order":"152","possible_hits":"1",},
{"lineNum":"  215","line":""},
{"lineNum":"  216","line":"  while (offset < sizeof(T) * CHAR_BIT && (range >> offset) > 0 &&","class":"lineCov","hits":"3","order":"153","possible_hits":"3",},
{"lineNum":"  217","line":"         remaining_bytes_ != 0) {","class":"lineCov","hits":"1","order":"154","possible_hits":"1",},
...
{"lineNum":"  224","line":"    --remaining_bytes_;","class":"lineCov","hits":"1","order":"155","possible_hits":"1",},
{"lineNum":"  225","line":"    result = (result << CHAR_BIT) | data_ptr_[remaining_bytes_];","class":"lineCov","hits":"1","order":"156","possible_hits":"1",},
{"lineNum":"  226","line":"    offset += CHAR_BIT;","class":"lineCov","hits":"1","order":"157","possible_hits":"1",},
{"lineNum":"  227","line":"  }"},
{"lineNum":"  228","line":""},
{"lineNum":"  229","line":"  // Avoid division by 0, in case |range + 1| results in overflow."},
{"lineNum":"  230","line":"  if (range != std::numeric_limits<decltype(range)>::max())","class":"lineCov","hits":"1","order":"158","possible_hits":"1",},
{"lineNum":"  231","line":"    result = result % (range + 1);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  232","line":""},
{"lineNum":"  233","line":"  return static_cast<T>(min + result);","class":"lineCov","hits":"1","order":"159","possible_hits":"1",},
{"lineNum":"  234","line":"}"},
{"lineNum":"  235","line":""},
...
var header = { "command" : "bpplus_hfuzz_debug", "date" : "2023-08-17 17:18:19", "instrumented" : 43, "covered" : 16,};
var merged_data = [];
