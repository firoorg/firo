...
{"lineNum":"   25","line":"    }","class":"lineCov","hits":"1","order":"727","possible_hits":"1",},
{"lineNum":"   26","line":""},
{"lineNum":"   27","line":"    Gi0.resize(generators_needed);","class":"lineCov","hits":"1","order":"728","possible_hits":"1",},
{"lineNum":"   28","line":"    Hi0.resize(generators_needed);","class":"lineCov","hits":"1","order":"729","possible_hits":"1",},
{"lineNum":"   29","line":"    for (size_t i=0; i < generators_needed; i++) {","class":"lineCov","hits":"2","order":"730","possible_hits":"2",},
{"lineNum":"   30","line":"        Gi0[i].randomize();","class":"lineCov","hits":"1","order":"731","possible_hits":"1",},
{"lineNum":"   31","line":"        Hi0[i].randomize();","class":"lineCov","hits":"1","order":"732","possible_hits":"1",},
{"lineNum":"   32","line":"    }","class":"lineCov","hits":"1","order":"733","possible_hits":"1",},
{"lineNum":"   33","line":""},
{"lineNum":"   34","line":"    // Commitments"},
{"lineNum":"   35","line":"    std::vector<Scalar> v, r;","class":"lineCov","hits":"1","order":"734","possible_hits":"1",},
{"lineNum":"   36","line":"    v = fsp.GetScalars(M0);","class":"lineCov","hits":"1","order":"735","possible_hits":"1",},
{"lineNum":"   37","line":"    r = fsp.GetScalars(M0);","class":"lineCov","hits":"1","order":"762","possible_hits":"1",},
{"lineNum":"   38","line":""},
{"lineNum":"   39","line":"    std::vector<GroupElement> C0;","class":"lineCov","hits":"1","order":"763","possible_hits":"1",},
{"lineNum":"   40","line":"    for (size_t i=0; i < M0; i++) {","class":"linePartCov","hits":"1","order":"764","possible_hits":"2",},
{"lineNum":"   41","line":"        C0[i] = G0*v[i] + H0*r[i];","class":"linePartCov","hits":"1","order":"765","possible_hits":"2",},
{"lineNum":"   42","line":"    }"},
{"lineNum":"   43","line":""},
{"lineNum":"   44","line":"    spark::BPPlus bpplus0(G0, H0, Gi0, Hi0, N0);","class":"lineNoCov","hits":"0","possible_hits":"1",},
...
var header = { "command" : "bpplus_hfuzz_debug", "date" : "2023-08-17 17:25:52", "instrumented" : 62, "covered" : 25,};
var merged_data = [];
