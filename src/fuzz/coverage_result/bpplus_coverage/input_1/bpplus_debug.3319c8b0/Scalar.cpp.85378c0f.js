...
{"lineNum":"   48","line":"   : value_(new secp256k1_scalar(*reinterpret_cast<const secp256k1_scalar *>(value))) {","class":"lineCov","hits":"2","order":"1230","possible_hits":"2",},
{"lineNum":"   49","line":""},
{"lineNum":"   50","line":"}","class":"linePartCov","hits":"1","order":"1231","possible_hits":"2",},
{"lineNum":"   51","line":""},
...
{"lineNum":"   78","line":"}"},
{"lineNum":"   79","line":""},
{"lineNum":"   80","line":"Scalar Scalar::operator*(const Scalar& other) const {","class":"lineCov","hits":"2","order":"1545","possible_hits":"2",},
{"lineNum":"   81","line":"    secp256k1_scalar result;"},
{"lineNum":"   82","line":"    secp256k1_scalar_mul(&result, reinterpret_cast<const secp256k1_scalar *>(value_), reinterpret_cast<const secp256k1_scalar *>(other.value_));","class":"lineCov","hits":"1","order":"1546","possible_hits":"1",},
{"lineNum":"   83","line":"    return &result;","class":"lineCov","hits":"1","order":"1547","possible_hits":"1",},
{"lineNum":"   84","line":"}"},
{"lineNum":"   85","line":""},
{"lineNum":"   86","line":"Scalar& Scalar::operator*=(const Scalar& other) {","class":"lineCov","hits":"2","order":"1053","possible_hits":"2",},
{"lineNum":"   87","line":"    secp256k1_scalar result;"},
{"lineNum":"   88","line":""},
{"lineNum":"   89","line":"    secp256k1_scalar_mul(&result, reinterpret_cast<const secp256k1_scalar *>(value_), reinterpret_cast<const secp256k1_scalar *>(other.value_));","class":"lineCov","hits":"1","order":"1054","possible_hits":"1",},
{"lineNum":"   90","line":"    *reinterpret_cast<secp256k1_scalar *>(value_) = result;","class":"lineCov","hits":"1","order":"1073","possible_hits":"1",},
{"lineNum":"   91","line":""},
{"lineNum":"   92","line":"    return *this;","class":"linePartCov","hits":"1","order":"1074","possible_hits":"2",},
{"lineNum":"   93","line":"}"},
{"lineNum":"   94","line":""},
{"lineNum":"   95","line":"Scalar Scalar::operator+(const Scalar& other) const {","class":"lineCov","hits":"2","order":"1561","possible_hits":"2",},
{"lineNum":"   96","line":"    secp256k1_scalar result;"},
{"lineNum":"   97","line":"    secp256k1_scalar_add(&result, reinterpret_cast<const secp256k1_scalar *>(value_), reinterpret_cast<const secp256k1_scalar *>(other.value_));","class":"lineCov","hits":"1","order":"1562","possible_hits":"1",},
{"lineNum":"   98","line":"    return &result;","class":"lineCov","hits":"1","order":"1563","possible_hits":"1",},
{"lineNum":"   99","line":"}"},
{"lineNum":"  100","line":""},
{"lineNum":"  101","line":"Scalar& Scalar::operator+=(const Scalar& other) {","class":"lineCov","hits":"2","order":"1569","possible_hits":"2",},
{"lineNum":"  102","line":"    secp256k1_scalar result;"},
{"lineNum":"  103","line":""},
{"lineNum":"  104","line":"    secp256k1_scalar_add(&result, reinterpret_cast<const secp256k1_scalar *>(value_), reinterpret_cast<const secp256k1_scalar *>(other.value_));","class":"lineCov","hits":"1","order":"1570","possible_hits":"1",},
{"lineNum":"  105","line":"    *reinterpret_cast<secp256k1_scalar *>(value_) = result;","class":"lineCov","hits":"1","order":"1571","possible_hits":"1",},
{"lineNum":"  106","line":""},
{"lineNum":"  107","line":"    return *this;","class":"linePartCov","hits":"1","order":"1572","possible_hits":"2",},
{"lineNum":"  108","line":"}"},
{"lineNum":"  109","line":""},
{"lineNum":"  110","line":"Scalar Scalar::operator-(const Scalar& other) const {","class":"lineCov","hits":"2","order":"1226","possible_hits":"2",},
{"lineNum":"  111","line":"    secp256k1_scalar negated, result;"},
{"lineNum":"  112","line":""},
{"lineNum":"  113","line":"    secp256k1_scalar_negate(&negated, reinterpret_cast<const secp256k1_scalar *>(other.value_));","class":"lineCov","hits":"1","order":"1227","possible_hits":"1",},
{"lineNum":"  114","line":"    secp256k1_scalar_add(&result, &negated, reinterpret_cast<const secp256k1_scalar *>(value_));","class":"lineCov","hits":"1","order":"1228","possible_hits":"1",},
{"lineNum":"  115","line":""},
{"lineNum":"  116","line":"    return &result;","class":"lineCov","hits":"1","order":"1229","possible_hits":"1",},
{"lineNum":"  117","line":"}"},
{"lineNum":"  118","line":""},
{"lineNum":"  119","line":"Scalar& Scalar::operator-=(const Scalar& other) {","class":"lineCov","hits":"2","order":"1077","possible_hits":"2",},
{"lineNum":"  120","line":"    secp256k1_scalar negated, result;"},
{"lineNum":"  121","line":""},
{"lineNum":"  122","line":"    secp256k1_scalar_negate(&negated, reinterpret_cast<const secp256k1_scalar *>(other.value_));","class":"lineCov","hits":"1","order":"1078","possible_hits":"1",},
{"lineNum":"  123","line":"    secp256k1_scalar_add(&result, reinterpret_cast<const secp256k1_scalar *>(value_), &negated);","class":"lineCov","hits":"1","order":"1089","possible_hits":"1",},
{"lineNum":"  124","line":"    *reinterpret_cast<secp256k1_scalar *>(value_) = result;","class":"lineCov","hits":"1","order":"1090","possible_hits":"1",},
{"lineNum":"  125","line":""},
{"lineNum":"  126","line":"    return *this;","class":"linePartCov","hits":"1","order":"1091","possible_hits":"2",},
{"lineNum":"  127","line":"}"},
{"lineNum":"  128","line":""},
...
{"lineNum":"  139","line":"}"},
{"lineNum":"  140","line":""},
{"lineNum":"  141","line":"Scalar Scalar::inverse() const {","class":"lineCov","hits":"2","order":"1595","possible_hits":"2",},
{"lineNum":"  142","line":"    secp256k1_scalar result;"},
{"lineNum":"  143","line":"    secp256k1_scalar_inverse(&result, reinterpret_cast<const secp256k1_scalar *>(value_));","class":"lineCov","hits":"1","order":"1596","possible_hits":"1",},
{"lineNum":"  144","line":" return &result;","class":"lineCov","hits":"1","order":"1732","possible_hits":"1",},
{"lineNum":"  145","line":"}"},
{"lineNum":"  146","line":""},
...
{"lineNum":"  151","line":"}"},
{"lineNum":"  152","line":""},
{"lineNum":"  153","line":"Scalar Scalar::square() const{","class":"lineCov","hits":"2","order":"1528","possible_hits":"2",},
{"lineNum":"  154","line":"    secp256k1_scalar result;"},
{"lineNum":"  155","line":"    secp256k1_scalar_sqr(&result, reinterpret_cast<const secp256k1_scalar *>(value_));","class":"lineCov","hits":"1","order":"1529","possible_hits":"1",},
{"lineNum":"  156","line":" return &result;","class":"lineCov","hits":"1","order":"1538","possible_hits":"1",},
{"lineNum":"  157","line":"}"},
{"lineNum":"  158","line":""},
...
{"lineNum":"  283","line":""},
{"lineNum":"  284","line":"unsigned char* Scalar::serialize(unsigned char* buffer) const {","class":"lineCov","hits":"2","order":"1123","possible_hits":"2",},
{"lineNum":"  285","line":"    secp256k1_scalar_get_b32(buffer, reinterpret_cast<const secp256k1_scalar *>(value_));","class":"lineCov","hits":"1","order":"1124","possible_hits":"1",},
{"lineNum":"  286","line":"    return buffer + 32;","class":"lineCov","hits":"1","order":"1131","possible_hits":"1",},
{"lineNum":"  287","line":"}"},
{"lineNum":"  288","line":""},
{"lineNum":"  289","line":"unsigned const char* Scalar::deserialize(unsigned const char* buffer) {","class":"lineCov","hits":"2","order":"1515","possible_hits":"2",},
{"lineNum":"  290","line":"    int overflow = 0;","class":"lineCov","hits":"1","order":"1516","possible_hits":"1",},
{"lineNum":"  291","line":""},
{"lineNum":"  292","line":"    secp256k1_scalar_set_b32(reinterpret_cast<secp256k1_scalar *>(value_), buffer, &overflow);","class":"lineCov","hits":"1","order":"1517","possible_hits":"1",},
{"lineNum":"  293","line":""},
{"lineNum":"  294","line":"    if (overflow) {","class":"lineCov","hits":"1","order":"1519","possible_hits":"1",},
{"lineNum":"  295","line":"        throw \"Scalar: decoding overflowed\";","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  296","line":"    }"},
{"lineNum":"  297","line":""},
{"lineNum":"  298","line":"    return buffer + 32;","class":"lineCov","hits":"1","order":"1520","possible_hits":"1",},
{"lineNum":"  299","line":"}"},
{"lineNum":"  300","line":""},
...
{"lineNum":"  340","line":""},
{"lineNum":"  341","line":"void Scalar::get_bits(std::vector<bool>& bits) const {","class":"lineCov","hits":"2","order":"1210","possible_hits":"2",},
{"lineNum":"  342","line":"    unsigned char bin[32];"},
{"lineNum":"  343","line":""},
{"lineNum":"  344","line":"    secp256k1_scalar_get_b32(bin, reinterpret_cast<const secp256k1_scalar *>(value_));","class":"lineCov","hits":"1","order":"1211","possible_hits":"1",},
{"lineNum":"  345","line":""},
{"lineNum":"  346","line":"    for (int i = 0; i < 32; ++i) {","class":"lineCov","hits":"2","order":"1212","possible_hits":"2",},
{"lineNum":"  347","line":"        int32_t val = bin[i];","class":"lineCov","hits":"1","order":"1213","possible_hits":"1",},
{"lineNum":"  348","line":"        for (int j = 7; j >= 0; j--) {","class":"lineCov","hits":"2","order":"1214","possible_hits":"2",},
{"lineNum":"  349","line":"            bits.push_back((val >> j) & 1);","class":"lineCov","hits":"1","order":"1215","possible_hits":"1",},
{"lineNum":"  350","line":"        }"},
{"lineNum":"  351","line":"    }","class":"lineCov","hits":"1","order":"1216","possible_hits":"1",},
{"lineNum":"  352","line":"}","class":"linePartCov","hits":"1","order":"1217","possible_hits":"2",},
{"lineNum":"  353","line":""},
{"lineNum":"  354","line":"} // namespace secp_primitives"},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "bpplus_debug", "date" : "2023-08-25 16:07:12", "instrumented" : 187, "covered" : 104,};
var merged_data = [];
