...
{"lineNum":"  171","line":"        : g_(new secp256k1_gej(*reinterpret_cast<secp256k1_gej *>(other.g_)))","class":"lineCov","hits":"1","order":"1036","possible_hits":"1",},
{"lineNum":"  172","line":"{","class":"lineCov","hits":"2","order":"1035","possible_hits":"2",},
{"lineNum":"  173","line":"}","class":"linePartCov","hits":"1","order":"1037","possible_hits":"2",},
{"lineNum":"  174","line":""},
...
{"lineNum":"  241","line":"{","class":"lineCov","hits":"2","order":"1029","possible_hits":"2",},
{"lineNum":"  242","line":"    delete reinterpret_cast<secp256k1_gej *>(g_);","class":"lineCov","hits":"1","order":"1030","possible_hits":"1",},
{"lineNum":"  243","line":"}","class":"linePartCov","hits":"1","order":"1031","possible_hits":"2",},
{"lineNum":"  244","line":""},
{"lineNum":"  245","line":"GroupElement& GroupElement::operator=(const GroupElement &other)"},
{"lineNum":"  246","line":"{","class":"lineCov","hits":"2","order":"1024","possible_hits":"2",},
{"lineNum":"  247","line":"    return set(other);","class":"lineCov","hits":"1","order":"1025","possible_hits":"1",},
{"lineNum":"  248","line":"}"},
{"lineNum":"  249","line":""},
{"lineNum":"  250","line":"GroupElement& GroupElement::set(const GroupElement &other)"},
{"lineNum":"  251","line":"{","class":"lineCov","hits":"2","order":"1026","possible_hits":"2",},
{"lineNum":"  252","line":"    *reinterpret_cast<secp256k1_gej *>(g_) = *reinterpret_cast<secp256k1_gej *>(other.g_);","class":"lineCov","hits":"1","order":"1027","possible_hits":"1",},
{"lineNum":"  253","line":"    return *this;","class":"linePartCov","hits":"1","order":"1028","possible_hits":"2",},
{"lineNum":"  254","line":"}"},
{"lineNum":"  255","line":""},
...
{"lineNum":"  275","line":"{","class":"lineCov","hits":"2","order":"996","possible_hits":"2",},
{"lineNum":"  276","line":"    secp256k1_gej result_gej;"},
{"lineNum":"  277","line":"    secp256k1_gej_add_var(&result_gej, reinterpret_cast<secp256k1_gej *>(g_), reinterpret_cast<secp256k1_gej *>(other.g_), NULL);","class":"lineCov","hits":"1","order":"997","possible_hits":"1",},
{"lineNum":"  278","line":"    return &result_gej;","class":"lineCov","hits":"1","order":"1023","possible_hits":"1",},
{"lineNum":"  279","line":"}"},
{"lineNum":"  280","line":""},
...
{"lineNum":"  302","line":"{","class":"lineCov","hits":"2","order":"1194","possible_hits":"2",},
{"lineNum":"  303","line":"    auto g = reinterpret_cast<secp256k1_gej *>(g_);","class":"lineCov","hits":"1","order":"1195","possible_hits":"1",},
{"lineNum":"  304","line":"    auto og = reinterpret_cast<secp256k1_gej *>(other.g_);","class":"lineCov","hits":"1","order":"1196","possible_hits":"1",},
{"lineNum":"  305","line":""},
{"lineNum":"  306","line":"    if(g->infinity && og->infinity)","class":"lineCov","hits":"1","order":"1197","possible_hits":"1",},
{"lineNum":"  307","line":"        return true;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  308","line":"    if(g->infinity != og->infinity)","class":"lineCov","hits":"1","order":"1198","possible_hits":"1",},
{"lineNum":"  309","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  310","line":"    secp256k1_ge this_ge = gej_to_ge(*g);","class":"lineCov","hits":"1","order":"1199","possible_hits":"1",},
{"lineNum":"  311","line":"    secp256k1_ge other_ge = gej_to_ge(*og);","class":"lineCov","hits":"1","order":"1200","possible_hits":"1",},
{"lineNum":"  312","line":"    if(!secp256k1_fe_equal(&this_ge.x, &other_ge.x))","class":"lineCov","hits":"1","order":"1201","possible_hits":"1",},
{"lineNum":"  313","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  314","line":"    if(!secp256k1_fe_equal(&this_ge.y, &other_ge.y))","class":"lineCov","hits":"1","order":"1202","possible_hits":"1",},
{"lineNum":"  315","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  316","line":""},
{"lineNum":"  317","line":"    return true;","class":"lineCov","hits":"1","order":"1203","possible_hits":"1",},
{"lineNum":"  318","line":"}","class":"linePartCov","hits":"1","order":"1204","possible_hits":"2",},
{"lineNum":"  319","line":""},
...
{"lineNum":"  506","line":"}"},
{"lineNum":"  507","line":""},
{"lineNum":"  508","line":"unsigned char* GroupElement::serialize(unsigned char* buffer) const {","class":"lineCov","hits":"2","order":"1143","possible_hits":"2",},
{"lineNum":"  509","line":"    secp256k1_ge value = gej_to_ge(*reinterpret_cast<secp256k1_gej *>(g_));","class":"lineCov","hits":"1","order":"1144","possible_hits":"1",},
{"lineNum":"  510","line":"    secp256k1_fe x = value.x;","class":"lineCov","hits":"1","order":"1145","possible_hits":"1",},
{"lineNum":"  511","line":"    secp256k1_fe y = value.y;","class":"lineCov","hits":"1","order":"1146","possible_hits":"1",},
{"lineNum":"  512","line":"    secp256k1_fe_normalize(&x);","class":"lineCov","hits":"1","order":"1147","possible_hits":"1",},
{"lineNum":"  513","line":"    secp256k1_fe_normalize(&y);","class":"lineCov","hits":"1","order":"1148","possible_hits":"1",},
{"lineNum":"  514","line":"    unsigned char oddness = secp256k1_fe_is_odd(&y);","class":"lineCov","hits":"1","order":"1149","possible_hits":"1",},
{"lineNum":"  515","line":"    unsigned char infinity = value.infinity;","class":"lineCov","hits":"1","order":"1150","possible_hits":"1",},
{"lineNum":"  516","line":"    secp256k1_fe_get_b32(buffer, &x);","class":"lineCov","hits":"1","order":"1151","possible_hits":"1",},
{"lineNum":"  517","line":"    buffer[32] = oddness;","class":"lineCov","hits":"1","order":"1152","possible_hits":"1",},
{"lineNum":"  518","line":"    buffer[33] = infinity;","class":"lineCov","hits":"1","order":"1153","possible_hits":"1",},
{"lineNum":"  519","line":"    return buffer + memoryRequired();","class":"lineCov","hits":"1","order":"1154","possible_hits":"1",},
{"lineNum":"  520","line":"}"},
{"lineNum":"  521","line":""},
...
{"lineNum":"  566","line":"}"},
{"lineNum":"  567","line":""},
{"lineNum":"  568","line":"const void* GroupElement::get_value() const {","class":"lineCov","hits":"2","order":"1255","possible_hits":"2",},
{"lineNum":"  569","line":"    return g_;","class":"lineCov","hits":"1","order":"1256","possible_hits":"1",},
{"lineNum":"  570","line":"}"},
{"lineNum":"  571","line":""},
...
var header = { "command" : "bpplus_debug", "date" : "2023-08-25 16:07:12", "instrumented" : 343, "covered" : 139,};
var merged_data = [];
