...
{"lineNum":"   20","line":"const std::string LABEL_PROTOCOL = \"SPARK\";","class":"lineCov","hits":"10","order":"1","possible_hits":"10",},
{"lineNum":"   21","line":""},
...
{"lineNum":"   29","line":"const std::string LABEL_TRANSCRIPT_BPPLUS = \"BULLETPROOF_PLUS_V1\";","class":"lineCov","hits":"10","order":"2","possible_hits":"10",},
{"lineNum":"   30","line":"const std::string LABEL_TRANSCRIPT_CHAUM = \"CHAUM_V1\";","class":"lineCov","hits":"10","order":"3","possible_hits":"10",},
{"lineNum":"   31","line":"const std::string LABEL_TRANSCRIPT_GROOTLE = \"GROOTLE_V1\";","class":"lineCov","hits":"10","order":"4","possible_hits":"10",},
{"lineNum":"   32","line":"const std::string LABEL_TRANSCRIPT_SCHNORR = \"SCHNORR_V1\";","class":"lineCov","hits":"10","order":"5","possible_hits":"10",},
{"lineNum":"   33","line":""},
{"lineNum":"   34","line":"// Generator labels"},
{"lineNum":"   35","line":"const std::string LABEL_GENERATOR_F = \"F\";","class":"lineCov","hits":"10","order":"6","possible_hits":"10",},
{"lineNum":"   36","line":"const std::string LABEL_GENERATOR_H = \"H\";","class":"lineCov","hits":"10","order":"7","possible_hits":"10",},
{"lineNum":"   37","line":"const std::string LABEL_GENERATOR_U = \"U\";","class":"lineCov","hits":"10","order":"8","possible_hits":"10",},
{"lineNum":"   38","line":"const std::string LABEL_GENERATOR_G_RANGE = \"G_RANGE\";","class":"lineCov","hits":"10","order":"9","possible_hits":"10",},
{"lineNum":"   39","line":"const std::string LABEL_GENERATOR_H_RANGE = \"H_RANGE\";","class":"lineCov","hits":"10","order":"10","possible_hits":"10",},
{"lineNum":"   40","line":"const std::string LABEL_GENERATOR_G_GROOTLE = \"G_GROOTLE\";","class":"lineCov","hits":"10","order":"11","possible_hits":"10",},
{"lineNum":"   41","line":"const std::string LABEL_GENERATOR_H_GROOTLE = \"H_GROOTLE\";","class":"lineCov","hits":"10","order":"12","possible_hits":"10",},
{"lineNum":"   42","line":""},
{"lineNum":"   43","line":"// Hash function labels"},
{"lineNum":"   44","line":"const std::string LABEL_HASH_DIV = \"DIV\";","class":"lineCov","hits":"10","order":"13","possible_hits":"10",},
{"lineNum":"   45","line":"const std::string LABEL_HASH_Q2 = \"Q2\";","class":"lineCov","hits":"10","order":"14","possible_hits":"10",},
{"lineNum":"   46","line":"const std::string LABEL_HASH_K = \"K\";","class":"lineCov","hits":"10","order":"15","possible_hits":"10",},
{"lineNum":"   47","line":"const std::string LABEL_HASH_SER = \"SER\";","class":"lineCov","hits":"10","order":"16","possible_hits":"10",},
{"lineNum":"   48","line":"const std::string LABEL_HASH_VAL = \"VAL\";","class":"lineCov","hits":"10","order":"17","possible_hits":"10",},
{"lineNum":"   49","line":"const std::string LABEL_HASH_SER1 = \"SER1\";","class":"lineCov","hits":"10","order":"18","possible_hits":"10",},
{"lineNum":"   50","line":"const std::string LABEL_HASH_VAL1 = \"VAL1\";","class":"lineCov","hits":"10","order":"19","possible_hits":"10",},
{"lineNum":"   51","line":"const std::string LABEL_HASH_BIND = \"BIND\";","class":"lineCov","hits":"10","order":"20","possible_hits":"10",},
{"lineNum":"   52","line":"const std::string LABEL_F4GRUMBLE_G = \"SPARK_F4GRUMBLE_G\";","class":"lineCov","hits":"10","order":"21","possible_hits":"10",},
{"lineNum":"   53","line":"const std::string LABEL_F4GRUMBLE_H = \"SPARK_F4GRUMBLE_H\";","class":"lineCov","hits":"10","order":"22","possible_hits":"10",},
{"lineNum":"   54","line":""},
{"lineNum":"   55","line":"// KDF labels"},
{"lineNum":"   56","line":"const std::string LABEL_KDF_DIVERSIFIER = \"DIVERSIFIER\";","class":"lineCov","hits":"10","order":"23","possible_hits":"10",},
{"lineNum":"   57","line":"const std::string LABEL_KDF_AEAD = \"AEAD\";","class":"lineCov","hits":"10","order":"24","possible_hits":"10",},
{"lineNum":"   58","line":"const std::string LABEL_COMMIT_AEAD = \"COMMIT_AEAD\";","class":"lineCov","hits":"10","order":"25","possible_hits":"10",},
{"lineNum":"   59","line":""},
...
var header = { "command" : "bpplus_hfuzz_debug", "date" : "2023-08-17 17:11:39", "instrumented" : 25, "covered" : 25,};
var merged_data = [];
