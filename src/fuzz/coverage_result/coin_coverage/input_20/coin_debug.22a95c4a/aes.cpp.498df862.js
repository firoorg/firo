...
{"lineNum":"   46","line":"{","class":"lineCov","hits":"2","order":"941","possible_hits":"2",},
{"lineNum":"   47","line":"    AES256_init(&ctx, key);","class":"lineCov","hits":"1","order":"942","possible_hits":"1",},
{"lineNum":"   48","line":"}","class":"linePartCov","hits":"1","order":"1105","possible_hits":"2",},
{"lineNum":"   49","line":""},
{"lineNum":"   50","line":"AES256Encrypt::~AES256Encrypt()"},
{"lineNum":"   51","line":"{","class":"lineCov","hits":"2","order":"1204","possible_hits":"2",},
{"lineNum":"   52","line":"    memset(&ctx, 0, sizeof(ctx));","class":"lineCov","hits":"1","order":"1205","possible_hits":"1",},
{"lineNum":"   53","line":"}","class":"linePartCov","hits":"1","order":"1206","possible_hits":"2",},
{"lineNum":"   54","line":""},
{"lineNum":"   55","line":"void AES256Encrypt::Encrypt(unsigned char ciphertext[16], const unsigned char plaintext[16]) const"},
{"lineNum":"   56","line":"{","class":"lineCov","hits":"2","order":"1124","possible_hits":"2",},
{"lineNum":"   57","line":"    AES256_encrypt(&ctx, 1, ciphertext, plaintext);","class":"lineCov","hits":"1","order":"1125","possible_hits":"1",},
{"lineNum":"   58","line":"}","class":"linePartCov","hits":"1","order":"1195","possible_hits":"2",},
{"lineNum":"   59","line":""},
{"lineNum":"   60","line":"AES256Decrypt::AES256Decrypt(const unsigned char key[32])"},
{"lineNum":"   61","line":"{","class":"lineCov","hits":"2","order":"1628","possible_hits":"2",},
{"lineNum":"   62","line":"    AES256_init(&ctx, key);","class":"lineCov","hits":"1","order":"1629","possible_hits":"1",},
{"lineNum":"   63","line":"}","class":"linePartCov","hits":"1","order":"1630","possible_hits":"2",},
{"lineNum":"   64","line":""},
{"lineNum":"   65","line":"AES256Decrypt::~AES256Decrypt()"},
{"lineNum":"   66","line":"{","class":"lineCov","hits":"2","order":"1785","possible_hits":"2",},
{"lineNum":"   67","line":"    memset(&ctx, 0, sizeof(ctx));","class":"lineCov","hits":"1","order":"1786","possible_hits":"1",},
{"lineNum":"   68","line":"}","class":"linePartCov","hits":"1","order":"1787","possible_hits":"2",},
{"lineNum":"   69","line":""},
{"lineNum":"   70","line":"void AES256Decrypt::Decrypt(unsigned char plaintext[16], const unsigned char ciphertext[16]) const"},
{"lineNum":"   71","line":"{","class":"lineCov","hits":"2","order":"1645","possible_hits":"2",},
{"lineNum":"   72","line":"    AES256_decrypt(&ctx, 1, plaintext, ciphertext);","class":"lineCov","hits":"1","order":"1646","possible_hits":"1",},
{"lineNum":"   73","line":"}","class":"linePartCov","hits":"1","order":"1760","possible_hits":"2",},
{"lineNum":"   74","line":""},
{"lineNum":"   75","line":""},
...
{"lineNum":"   78","line":"{","class":"linePartCov","hits":"2","order":"1111","possible_hits":"4",},
{"lineNum":"   79","line":"    int written = 0;","class":"linePartCov","hits":"1","order":"1112","possible_hits":"2",},
{"lineNum":"   80","line":"    int padsize = size % AES_BLOCKSIZE;","class":"linePartCov","hits":"1","order":"1113","possible_hits":"2",},
{"lineNum":"   81","line":"    unsigned char mixed[AES_BLOCKSIZE];"},
{"lineNum":"   82","line":""},
{"lineNum":"   83","line":"    if (!data || !size || !out)","class":"linePartCov","hits":"1","order":"1114","possible_hits":"2",},
{"lineNum":"   84","line":"        return 0;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   85","line":""},
{"lineNum":"   86","line":"    if (!pad && padsize != 0)","class":"linePartCov","hits":"1","order":"1115","possible_hits":"2",},
{"lineNum":"   87","line":"        return 0;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   88","line":""},
{"lineNum":"   89","line":"    memcpy(mixed, iv, AES_BLOCKSIZE);","class":"linePartCov","hits":"1","order":"1116","possible_hits":"2",},
{"lineNum":"   90","line":""},
{"lineNum":"   91","line":"    // Write all but the last block"},
{"lineNum":"   92","line":"    while (written + AES_BLOCKSIZE <= size) {","class":"linePartCov","hits":"1","order":"1117","possible_hits":"4",},
...
{"lineNum":"   98","line":"    }"},
{"lineNum":"   99","line":"    if (pad) {","class":"linePartCov","hits":"1","order":"1118","possible_hits":"2",},
...
{"lineNum":"  102","line":"        for (int i = 0; i != padsize; i++)","class":"linePartCov","hits":"2","order":"1119","possible_hits":"4",},
{"lineNum":"  103","line":"            mixed[i] ^= *data++;","class":"linePartCov","hits":"1","order":"1120","possible_hits":"2",},
{"lineNum":"  104","line":"        for (int i = padsize; i != AES_BLOCKSIZE; i++)","class":"linePartCov","hits":"2","order":"1121","possible_hits":"4",},
{"lineNum":"  105","line":"            mixed[i] ^= AES_BLOCKSIZE - padsize;","class":"linePartCov","hits":"1","order":"1122","possible_hits":"2",},
{"lineNum":"  106","line":"        enc.Encrypt(out + written, mixed);","class":"linePartCov","hits":"1","order":"1123","possible_hits":"2",},
{"lineNum":"  107","line":"        written += AES_BLOCKSIZE;","class":"linePartCov","hits":"1","order":"1196","possible_hits":"2",},
{"lineNum":"  108","line":"    }"},
{"lineNum":"  109","line":"    return written;","class":"linePartCov","hits":"1","order":"1197","possible_hits":"2",},
{"lineNum":"  110","line":"}","class":"linePartCov","hits":"1","order":"1198","possible_hits":"4",},
{"lineNum":"  111","line":""},
...
{"lineNum":"  114","line":"{","class":"linePartCov","hits":"2","order":"1636","possible_hits":"4",},
{"lineNum":"  115","line":"    unsigned char padsize = 0;","class":"linePartCov","hits":"1","order":"1637","possible_hits":"2",},
{"lineNum":"  116","line":"    int written = 0;","class":"linePartCov","hits":"1","order":"1638","possible_hits":"2",},
{"lineNum":"  117","line":"    bool fail = false;","class":"linePartCov","hits":"1","order":"1639","possible_hits":"2",},
{"lineNum":"  118","line":"    const unsigned char* prev = iv;","class":"linePartCov","hits":"1","order":"1640","possible_hits":"2",},
{"lineNum":"  119","line":""},
{"lineNum":"  120","line":"    if (!data || !size || !out)","class":"linePartCov","hits":"1","order":"1641","possible_hits":"2",},
{"lineNum":"  121","line":"        return 0;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  122","line":""},
{"lineNum":"  123","line":"    if (size % AES_BLOCKSIZE != 0)","class":"linePartCov","hits":"1","order":"1642","possible_hits":"2",},
...
{"lineNum":"  127","line":"    while (written != size) {","class":"linePartCov","hits":"2","order":"1643","possible_hits":"4",},
{"lineNum":"  128","line":"        dec.Decrypt(out, data + written);","class":"linePartCov","hits":"1","order":"1644","possible_hits":"2",},
{"lineNum":"  129","line":"        for (int i = 0; i != AES_BLOCKSIZE; i++)","class":"linePartCov","hits":"2","order":"1761","possible_hits":"4",},
{"lineNum":"  130","line":"            *out++ ^= prev[i];","class":"linePartCov","hits":"1","order":"1762","possible_hits":"2",},
{"lineNum":"  131","line":"        prev = data + written;","class":"linePartCov","hits":"1","order":"1763","possible_hits":"2",},
{"lineNum":"  132","line":"        written += AES_BLOCKSIZE;","class":"linePartCov","hits":"1","order":"1764","possible_hits":"2",},
{"lineNum":"  133","line":"    }"},
{"lineNum":"  134","line":""},
{"lineNum":"  135","line":"    // When decrypting padding, attempt to run in constant-time"},
{"lineNum":"  136","line":"    if (pad) {","class":"linePartCov","hits":"1","order":"1765","possible_hits":"2",},
...
{"lineNum":"  139","line":"        padsize = *--out;","class":"linePartCov","hits":"1","order":"1766","possible_hits":"2",},
{"lineNum":"  140","line":"        fail = !padsize | (padsize > AES_BLOCKSIZE);","class":"linePartCov","hits":"1","order":"1767","possible_hits":"2",},
{"lineNum":"  141","line":""},
{"lineNum":"  142","line":"        // If not well-formed, treat it as though there\'s no padding."},
{"lineNum":"  143","line":"        padsize *= !fail;","class":"linePartCov","hits":"1","order":"1768","possible_hits":"2",},
{"lineNum":"  144","line":""},
{"lineNum":"  145","line":"        // All padding must equal the last byte otherwise it\'s not well-formed"},
{"lineNum":"  146","line":"        for (int i = AES_BLOCKSIZE; i != 0; i--)","class":"linePartCov","hits":"2","order":"1769","possible_hits":"4",},
{"lineNum":"  147","line":"            fail |= ((i > AES_BLOCKSIZE - padsize) & (*out-- != padsize));","class":"linePartCov","hits":"1","order":"1770","possible_hits":"2",},
{"lineNum":"  148","line":""},
{"lineNum":"  149","line":"        written -= padsize;","class":"linePartCov","hits":"1","order":"1771","possible_hits":"2",},
{"lineNum":"  150","line":"    }"},
{"lineNum":"  151","line":"    return written * !fail;","class":"linePartCov","hits":"1","order":"1772","possible_hits":"2",},
{"lineNum":"  152","line":"}","class":"linePartCov","hits":"1","order":"1773","possible_hits":"4",},
{"lineNum":"  153","line":""},
...
{"lineNum":"  155","line":"    : enc(key), pad(padIn)","class":"lineCov","hits":"1","order":"940","possible_hits":"1",},
{"lineNum":"  156","line":"{","class":"lineCov","hits":"2","order":"939","possible_hits":"2",},
{"lineNum":"  157","line":"    memcpy(iv, ivIn, AES_BLOCKSIZE);","class":"lineCov","hits":"1","order":"1106","possible_hits":"1",},
{"lineNum":"  158","line":"}","class":"linePartCov","hits":"1","order":"1107","possible_hits":"2",},
{"lineNum":"  159","line":""},
{"lineNum":"  160","line":"int AES256CBCEncrypt::Encrypt(const unsigned char* data, int size, unsigned char* out) const"},
{"lineNum":"  161","line":"{","class":"lineCov","hits":"2","order":"1109","possible_hits":"2",},
{"lineNum":"  162","line":"    return CBCEncrypt(enc, iv, data, size, pad, out);","class":"lineCov","hits":"1","order":"1110","possible_hits":"1",},
{"lineNum":"  163","line":"}"},
{"lineNum":"  164","line":""},
{"lineNum":"  165","line":"AES256CBCEncrypt::~AES256CBCEncrypt()"},
{"lineNum":"  166","line":"{","class":"lineCov","hits":"2","order":"1201","possible_hits":"2",},
{"lineNum":"  167","line":"    memset(iv, 0, sizeof(iv));","class":"lineCov","hits":"1","order":"1202","possible_hits":"1",},
{"lineNum":"  168","line":"}","class":"lineCov","hits":"1","order":"1203","possible_hits":"1",},
{"lineNum":"  169","line":""},
...
{"lineNum":"  171","line":"    : dec(key), pad(padIn)","class":"lineCov","hits":"1","order":"1627","possible_hits":"1",},
{"lineNum":"  172","line":"{","class":"lineCov","hits":"2","order":"1626","possible_hits":"2",},
{"lineNum":"  173","line":"    memcpy(iv, ivIn, AES_BLOCKSIZE);","class":"lineCov","hits":"1","order":"1631","possible_hits":"1",},
{"lineNum":"  174","line":"}","class":"linePartCov","hits":"1","order":"1632","possible_hits":"2",},
{"lineNum":"  175","line":""},
{"lineNum":"  176","line":""},
{"lineNum":"  177","line":"int AES256CBCDecrypt::Decrypt(const unsigned char* data, int size, unsigned char* out) const"},
{"lineNum":"  178","line":"{","class":"lineCov","hits":"2","order":"1634","possible_hits":"2",},
{"lineNum":"  179","line":"    return CBCDecrypt(dec, iv, data, size, pad, out);","class":"lineCov","hits":"1","order":"1635","possible_hits":"1",},
{"lineNum":"  180","line":"}"},
{"lineNum":"  181","line":""},
{"lineNum":"  182","line":"AES256CBCDecrypt::~AES256CBCDecrypt()"},
{"lineNum":"  183","line":"{","class":"lineCov","hits":"2","order":"1782","possible_hits":"2",},
{"lineNum":"  184","line":"    memset(iv, 0, sizeof(iv));","class":"lineCov","hits":"1","order":"1783","possible_hits":"1",},
{"lineNum":"  185","line":"}","class":"lineCov","hits":"1","order":"1784","possible_hits":"1",},
{"lineNum":"  186","line":""},
...
var header = { "command" : "coin_debug", "date" : "2023-08-28 08:53:38", "instrumented" : 119, "covered" : 74,};
var merged_data = [];
