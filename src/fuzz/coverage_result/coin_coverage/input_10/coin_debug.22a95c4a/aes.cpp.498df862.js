...
{"lineNum":"   46","line":"{","class":"lineCov","hits":"2","order":"953","possible_hits":"2",},
{"lineNum":"   47","line":"    AES256_init(&ctx, key);","class":"lineCov","hits":"1","order":"954","possible_hits":"1",},
{"lineNum":"   48","line":"}","class":"linePartCov","hits":"1","order":"1117","possible_hits":"2",},
{"lineNum":"   49","line":""},
{"lineNum":"   50","line":"AES256Encrypt::~AES256Encrypt()"},
{"lineNum":"   51","line":"{","class":"lineCov","hits":"2","order":"1216","possible_hits":"2",},
{"lineNum":"   52","line":"    memset(&ctx, 0, sizeof(ctx));","class":"lineCov","hits":"1","order":"1217","possible_hits":"1",},
{"lineNum":"   53","line":"}","class":"linePartCov","hits":"1","order":"1218","possible_hits":"2",},
{"lineNum":"   54","line":""},
{"lineNum":"   55","line":"void AES256Encrypt::Encrypt(unsigned char ciphertext[16], const unsigned char plaintext[16]) const"},
{"lineNum":"   56","line":"{","class":"lineCov","hits":"2","order":"1136","possible_hits":"2",},
{"lineNum":"   57","line":"    AES256_encrypt(&ctx, 1, ciphertext, plaintext);","class":"lineCov","hits":"1","order":"1137","possible_hits":"1",},
{"lineNum":"   58","line":"}","class":"linePartCov","hits":"1","order":"1207","possible_hits":"2",},
{"lineNum":"   59","line":""},
...
{"lineNum":"   78","line":"{","class":"linePartCov","hits":"2","order":"1123","possible_hits":"4",},
{"lineNum":"   79","line":"    int written = 0;","class":"linePartCov","hits":"1","order":"1124","possible_hits":"2",},
{"lineNum":"   80","line":"    int padsize = size % AES_BLOCKSIZE;","class":"linePartCov","hits":"1","order":"1125","possible_hits":"2",},
{"lineNum":"   81","line":"    unsigned char mixed[AES_BLOCKSIZE];"},
{"lineNum":"   82","line":""},
{"lineNum":"   83","line":"    if (!data || !size || !out)","class":"linePartCov","hits":"1","order":"1126","possible_hits":"2",},
{"lineNum":"   84","line":"        return 0;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   85","line":""},
{"lineNum":"   86","line":"    if (!pad && padsize != 0)","class":"linePartCov","hits":"1","order":"1127","possible_hits":"2",},
{"lineNum":"   87","line":"        return 0;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   88","line":""},
{"lineNum":"   89","line":"    memcpy(mixed, iv, AES_BLOCKSIZE);","class":"linePartCov","hits":"1","order":"1128","possible_hits":"2",},
{"lineNum":"   90","line":""},
{"lineNum":"   91","line":"    // Write all but the last block"},
{"lineNum":"   92","line":"    while (written + AES_BLOCKSIZE <= size) {","class":"linePartCov","hits":"1","order":"1129","possible_hits":"4",},
...
{"lineNum":"   98","line":"    }"},
{"lineNum":"   99","line":"    if (pad) {","class":"linePartCov","hits":"1","order":"1130","possible_hits":"2",},
...
{"lineNum":"  102","line":"        for (int i = 0; i != padsize; i++)","class":"linePartCov","hits":"2","order":"1131","possible_hits":"4",},
{"lineNum":"  103","line":"            mixed[i] ^= *data++;","class":"linePartCov","hits":"1","order":"1132","possible_hits":"2",},
{"lineNum":"  104","line":"        for (int i = padsize; i != AES_BLOCKSIZE; i++)","class":"linePartCov","hits":"2","order":"1133","possible_hits":"4",},
{"lineNum":"  105","line":"            mixed[i] ^= AES_BLOCKSIZE - padsize;","class":"linePartCov","hits":"1","order":"1134","possible_hits":"2",},
{"lineNum":"  106","line":"        enc.Encrypt(out + written, mixed);","class":"linePartCov","hits":"1","order":"1135","possible_hits":"2",},
{"lineNum":"  107","line":"        written += AES_BLOCKSIZE;","class":"linePartCov","hits":"1","order":"1208","possible_hits":"2",},
{"lineNum":"  108","line":"    }"},
{"lineNum":"  109","line":"    return written;","class":"linePartCov","hits":"1","order":"1209","possible_hits":"2",},
{"lineNum":"  110","line":"}","class":"linePartCov","hits":"1","order":"1210","possible_hits":"4",},
{"lineNum":"  111","line":""},
...
{"lineNum":"  155","line":"    : enc(key), pad(padIn)","class":"lineCov","hits":"1","order":"952","possible_hits":"1",},
{"lineNum":"  156","line":"{","class":"lineCov","hits":"2","order":"951","possible_hits":"2",},
{"lineNum":"  157","line":"    memcpy(iv, ivIn, AES_BLOCKSIZE);","class":"lineCov","hits":"1","order":"1118","possible_hits":"1",},
{"lineNum":"  158","line":"}","class":"linePartCov","hits":"1","order":"1119","possible_hits":"2",},
{"lineNum":"  159","line":""},
{"lineNum":"  160","line":"int AES256CBCEncrypt::Encrypt(const unsigned char* data, int size, unsigned char* out) const"},
{"lineNum":"  161","line":"{","class":"lineCov","hits":"2","order":"1121","possible_hits":"2",},
{"lineNum":"  162","line":"    return CBCEncrypt(enc, iv, data, size, pad, out);","class":"lineCov","hits":"1","order":"1122","possible_hits":"1",},
{"lineNum":"  163","line":"}"},
{"lineNum":"  164","line":""},
{"lineNum":"  165","line":"AES256CBCEncrypt::~AES256CBCEncrypt()"},
{"lineNum":"  166","line":"{","class":"lineCov","hits":"2","order":"1213","possible_hits":"2",},
{"lineNum":"  167","line":"    memset(iv, 0, sizeof(iv));","class":"lineCov","hits":"1","order":"1214","possible_hits":"1",},
{"lineNum":"  168","line":"}","class":"lineCov","hits":"1","order":"1215","possible_hits":"1",},
{"lineNum":"  169","line":""},
...
var header = { "command" : "coin_debug", "date" : "2023-08-28 08:52:51", "instrumented" : 119, "covered" : 74,};
var merged_data = [];
