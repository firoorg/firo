...
{"lineNum":"   61","line":"{","class":"lineCov","hits":"2","order":"1626","possible_hits":"2",},
{"lineNum":"   62","line":"    AES256_init(&ctx, key);","class":"lineCov","hits":"1","order":"1627","possible_hits":"1",},
{"lineNum":"   63","line":"}","class":"linePartCov","hits":"1","order":"1628","possible_hits":"2",},
{"lineNum":"   64","line":""},
{"lineNum":"   65","line":"AES256Decrypt::~AES256Decrypt()"},
{"lineNum":"   66","line":"{","class":"lineCov","hits":"2","order":"1783","possible_hits":"2",},
{"lineNum":"   67","line":"    memset(&ctx, 0, sizeof(ctx));","class":"lineCov","hits":"1","order":"1784","possible_hits":"1",},
{"lineNum":"   68","line":"}","class":"linePartCov","hits":"1","order":"1785","possible_hits":"2",},
{"lineNum":"   69","line":""},
{"lineNum":"   70","line":"void AES256Decrypt::Decrypt(unsigned char plaintext[16], const unsigned char ciphertext[16]) const"},
{"lineNum":"   71","line":"{","class":"lineCov","hits":"2","order":"1643","possible_hits":"2",},
{"lineNum":"   72","line":"    AES256_decrypt(&ctx, 1, plaintext, ciphertext);","class":"lineCov","hits":"1","order":"1644","possible_hits":"1",},
{"lineNum":"   73","line":"}","class":"linePartCov","hits":"1","order":"1758","possible_hits":"2",},
{"lineNum":"   74","line":""},
{"lineNum":"   75","line":""},
...
{"lineNum":"  114","line":"{","class":"linePartCov","hits":"2","order":"1634","possible_hits":"4",},
{"lineNum":"  115","line":"    unsigned char padsize = 0;","class":"linePartCov","hits":"1","order":"1635","possible_hits":"2",},
{"lineNum":"  116","line":"    int written = 0;","class":"linePartCov","hits":"1","order":"1636","possible_hits":"2",},
{"lineNum":"  117","line":"    bool fail = false;","class":"linePartCov","hits":"1","order":"1637","possible_hits":"2",},
{"lineNum":"  118","line":"    const unsigned char* prev = iv;","class":"linePartCov","hits":"1","order":"1638","possible_hits":"2",},
{"lineNum":"  119","line":""},
{"lineNum":"  120","line":"    if (!data || !size || !out)","class":"linePartCov","hits":"1","order":"1639","possible_hits":"2",},
{"lineNum":"  121","line":"        return 0;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  122","line":""},
{"lineNum":"  123","line":"    if (size % AES_BLOCKSIZE != 0)","class":"linePartCov","hits":"1","order":"1640","possible_hits":"2",},
...
{"lineNum":"  127","line":"    while (written != size) {","class":"linePartCov","hits":"2","order":"1641","possible_hits":"4",},
{"lineNum":"  128","line":"        dec.Decrypt(out, data + written);","class":"linePartCov","hits":"1","order":"1642","possible_hits":"2",},
{"lineNum":"  129","line":"        for (int i = 0; i != AES_BLOCKSIZE; i++)","class":"linePartCov","hits":"2","order":"1759","possible_hits":"4",},
{"lineNum":"  130","line":"            *out++ ^= prev[i];","class":"linePartCov","hits":"1","order":"1760","possible_hits":"2",},
{"lineNum":"  131","line":"        prev = data + written;","class":"linePartCov","hits":"1","order":"1761","possible_hits":"2",},
{"lineNum":"  132","line":"        written += AES_BLOCKSIZE;","class":"linePartCov","hits":"1","order":"1762","possible_hits":"2",},
{"lineNum":"  133","line":"    }"},
{"lineNum":"  134","line":""},
{"lineNum":"  135","line":"    // When decrypting padding, attempt to run in constant-time"},
{"lineNum":"  136","line":"    if (pad) {","class":"linePartCov","hits":"1","order":"1763","possible_hits":"2",},
...
{"lineNum":"  139","line":"        padsize = *--out;","class":"linePartCov","hits":"1","order":"1764","possible_hits":"2",},
{"lineNum":"  140","line":"        fail = !padsize | (padsize > AES_BLOCKSIZE);","class":"linePartCov","hits":"1","order":"1765","possible_hits":"2",},
{"lineNum":"  141","line":""},
{"lineNum":"  142","line":"        // If not well-formed, treat it as though there\'s no padding."},
{"lineNum":"  143","line":"        padsize *= !fail;","class":"linePartCov","hits":"1","order":"1766","possible_hits":"2",},
{"lineNum":"  144","line":""},
{"lineNum":"  145","line":"        // All padding must equal the last byte otherwise it\'s not well-formed"},
{"lineNum":"  146","line":"        for (int i = AES_BLOCKSIZE; i != 0; i--)","class":"linePartCov","hits":"2","order":"1767","possible_hits":"4",},
{"lineNum":"  147","line":"            fail |= ((i > AES_BLOCKSIZE - padsize) & (*out-- != padsize));","class":"linePartCov","hits":"1","order":"1768","possible_hits":"2",},
{"lineNum":"  148","line":""},
{"lineNum":"  149","line":"        written -= padsize;","class":"linePartCov","hits":"1","order":"1769","possible_hits":"2",},
{"lineNum":"  150","line":"    }"},
{"lineNum":"  151","line":"    return written * !fail;","class":"linePartCov","hits":"1","order":"1770","possible_hits":"2",},
{"lineNum":"  152","line":"}","class":"linePartCov","hits":"1","order":"1771","possible_hits":"4",},
{"lineNum":"  153","line":""},
...
{"lineNum":"  171","line":"    : dec(key), pad(padIn)","class":"lineCov","hits":"1","order":"1625","possible_hits":"1",},
{"lineNum":"  172","line":"{","class":"lineCov","hits":"2","order":"1624","possible_hits":"2",},
{"lineNum":"  173","line":"    memcpy(iv, ivIn, AES_BLOCKSIZE);","class":"lineCov","hits":"1","order":"1629","possible_hits":"1",},
{"lineNum":"  174","line":"}","class":"linePartCov","hits":"1","order":"1630","possible_hits":"2",},
{"lineNum":"  175","line":""},
{"lineNum":"  176","line":""},
{"lineNum":"  177","line":"int AES256CBCDecrypt::Decrypt(const unsigned char* data, int size, unsigned char* out) const"},
{"lineNum":"  178","line":"{","class":"lineCov","hits":"2","order":"1632","possible_hits":"2",},
{"lineNum":"  179","line":"    return CBCDecrypt(dec, iv, data, size, pad, out);","class":"lineCov","hits":"1","order":"1633","possible_hits":"1",},
{"lineNum":"  180","line":"}"},
{"lineNum":"  181","line":""},
{"lineNum":"  182","line":"AES256CBCDecrypt::~AES256CBCDecrypt()"},
{"lineNum":"  183","line":"{","class":"lineCov","hits":"2","order":"1780","possible_hits":"2",},
{"lineNum":"  184","line":"    memset(iv, 0, sizeof(iv));","class":"lineCov","hits":"1","order":"1781","possible_hits":"1",},
{"lineNum":"  185","line":"}","class":"lineCov","hits":"1","order":"1782","possible_hits":"1",},
{"lineNum":"  186","line":""},
...
var header = { "command" : "coin_debug", "date" : "2023-08-28 08:52:01", "instrumented" : 119, "covered" : 74,};
var merged_data = [];
