...
{"lineNum":"   69","line":"\t\tthis->r_ = AEAD::encrypt(address.get_Q1()*SparkUtils::hash_k(k), \"Mint coin data\", r_stream);","class":"linePartCov","hits":"1","order":"1419","possible_hits":"2",},
{"lineNum":"   70","line":"\t} else {","class":"linePartCov","hits":"1","order":"1502","possible_hits":"2",},
...
{"lineNum":"   81","line":"}","class":"linePartCov","hits":"1","order":"1503","possible_hits":"11",},
{"lineNum":"   82","line":""},
...
{"lineNum":"   88","line":") {","class":"lineCov","hits":"2","order":"1596","possible_hits":"2",},
{"lineNum":"   89","line":"\t// Check recovery key"},
{"lineNum":"   90","line":"\tif (SparkUtils::hash_div(data.d)*SparkUtils::hash_k(data.k) != this->K) {","class":"linePartCov","hits":"1","order":"1597","possible_hits":"4",},
{"lineNum":"   91","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   92","line":"\t}"},
{"lineNum":"   93","line":""},
{"lineNum":"   94","line":"\t// Check value commitment"},
{"lineNum":"   95","line":"\tif (this->params->get_G()*Scalar(data.v) + this->params->get_H()*SparkUtils::hash_val(data.k) != this->C) {","class":"linePartCov","hits":"1","order":"1611","possible_hits":"2",},
{"lineNum":"   96","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   97","line":"\t}"},
{"lineNum":"   98","line":""},
{"lineNum":"   99","line":"\t// Check serial commitment"},
{"lineNum":"  100","line":"\tdata.i = incoming_view_key.get_diversifier(data.d);","class":"lineCov","hits":"1","order":"1612","possible_hits":"1",},
{"lineNum":"  101","line":""},
{"lineNum":"  102","line":"\tif (this->params->get_F()*(SparkUtils::hash_ser(data.k, this->serial_context) + SparkUtils::hash_Q2(incoming_view_key.get_s1(), data.i)) + incoming_view_key.get_P2() != this->S) {","class":"linePartCov","hits":"1","order":"1788","possible_hits":"2",},
{"lineNum":"  103","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  104","line":"\t}"},
{"lineNum":"  105","line":""},
{"lineNum":"  106","line":"\treturn true;","class":"lineCov","hits":"1","order":"1794","possible_hits":"1",},
{"lineNum":"  107","line":"}","class":"linePartCov","hits":"1","order":"1795","possible_hits":"4",},
{"lineNum":"  108","line":""},
{"lineNum":"  109","line":"// Recover a coin"},
{"lineNum":"  110","line":"RecoveredCoinData Coin::recover(const FullViewKey& full_view_key, const IdentifiedCoinData& data) {","class":"lineCov","hits":"2","order":"1803","possible_hits":"2",},
{"lineNum":"  111","line":"\tRecoveredCoinData recovered_data;","class":"lineCov","hits":"1","order":"1804","possible_hits":"1",},
{"lineNum":"  112","line":"\trecovered_data.s = SparkUtils::hash_ser(data.k, this->serial_context) + SparkUtils::hash_Q2(full_view_key.get_s1(), data.i) + full_view_key.get_s2();","class":"linePartCov","hits":"1","order":"1806","possible_hits":"2",},
{"lineNum":"  113","line":"\trecovered_data.T = (this->params->get_U() + full_view_key.get_D().inverse())*recovered_data.s.inverse();","class":"linePartCov","hits":"1","order":"1809","possible_hits":"2",},
{"lineNum":"  114","line":""},
{"lineNum":"  115","line":"\treturn recovered_data;","class":"lineCov","hits":"1","order":"1989","possible_hits":"1",},
{"lineNum":"  116","line":"}","class":"linePartCov","hits":"1","order":"1990","possible_hits":"3",},
{"lineNum":"  117","line":""},
{"lineNum":"  118","line":"// Identify a coin"},
{"lineNum":"  119","line":"IdentifiedCoinData Coin::identify(const IncomingViewKey& incoming_view_key) {","class":"lineCov","hits":"2","order":"1505","possible_hits":"2",},
{"lineNum":"  120","line":"\tIdentifiedCoinData data;","class":"lineCov","hits":"1","order":"1506","possible_hits":"1",},
{"lineNum":"  121","line":""},
{"lineNum":"  122","line":"\t// Deserialization means this process depends on the coin type"},
{"lineNum":"  123","line":"\tif (this->type == COIN_TYPE_MINT) {","class":"lineCov","hits":"1","order":"1508","possible_hits":"1",},
{"lineNum":"  124","line":"\t\tMintCoinRecipientData r;","class":"lineCov","hits":"1","order":"1509","possible_hits":"1",},
{"lineNum":"  125","line":""},
{"lineNum":"  126","line":"\t\ttry {"},
{"lineNum":"  127","line":"\t\t\t// Decrypt recipient data"},
{"lineNum":"  128","line":"\t\t\tCDataStream stream = AEAD::decrypt_and_verify(this->K*incoming_view_key.get_s1(), \"Mint coin data\", this->r_);","class":"linePartCov","hits":"1","order":"1510","possible_hits":"2",},
{"lineNum":"  129","line":"\t\t\tstream >> r;","class":"lineCov","hits":"1","order":"1532","possible_hits":"1",},
{"lineNum":"  130","line":"\t\t} catch (...) {","class":"linePartCov","hits":"1","order":"1589","possible_hits":"2",},
...
{"lineNum":"  133","line":""},
{"lineNum":"  134","line":"\t\tdata.d = r.d;","class":"lineCov","hits":"1","order":"1590","possible_hits":"1",},
{"lineNum":"  135","line":"\t\tdata.v = this->v;","class":"lineCov","hits":"1","order":"1591","possible_hits":"1",},
{"lineNum":"  136","line":"\t\tdata.k = r.k;","class":"lineCov","hits":"1","order":"1592","possible_hits":"1",},
{"lineNum":"  137","line":"\t\tdata.memo = r.memo;","class":"lineCov","hits":"1","order":"1593","possible_hits":"1",},
{"lineNum":"  138","line":"\t} else {","class":"linePartCov","hits":"1","order":"1594","possible_hits":"2",},
...
{"lineNum":"  156","line":"\tif (!validate(incoming_view_key, data)) {","class":"lineCov","hits":"1","order":"1595","possible_hits":"1",},
{"lineNum":"  157","line":"\t\tthrow std::runtime_error(\"Malformed coin\");","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  158","line":"\t}"},
{"lineNum":"  159","line":""},
{"lineNum":"  160","line":"\treturn data;","class":"lineCov","hits":"1","order":"1796","possible_hits":"1",},
{"lineNum":"  161","line":"}","class":"linePartCov","hits":"1","order":"1797","possible_hits":"12",},
{"lineNum":"  162","line":""},
...
var header = { "command" : "coin_debug", "date" : "2023-08-28 08:52:01", "instrumented" : 103, "covered" : 52,};
var merged_data = [];
