...
{"lineNum":"   83","line":"}","class":"linePartCov","hits":"1","order":"838","possible_hits":"3",},
{"lineNum":"   84","line":""},
{"lineNum":"   85","line":"const Params* FullViewKey::get_params() const {","class":"lineCov","hits":"2","order":"842","possible_hits":"2",},
{"lineNum":"   86","line":"\treturn this->params;","class":"lineCov","hits":"1","order":"843","possible_hits":"1",},
{"lineNum":"   87","line":"}"},
{"lineNum":"   88","line":""},
{"lineNum":"   89","line":"const Scalar& FullViewKey::get_s1() const {","class":"lineCov","hits":"2","order":"845","possible_hits":"2",},
{"lineNum":"   90","line":"\treturn this->s1;","class":"lineCov","hits":"1","order":"846","possible_hits":"1",},
{"lineNum":"   91","line":"}"},
{"lineNum":"   92","line":""},
{"lineNum":"   93","line":"const Scalar& FullViewKey::get_s2() const {","class":"lineCov","hits":"2","order":"1813","possible_hits":"2",},
{"lineNum":"   94","line":"\treturn this->s2;","class":"lineCov","hits":"1","order":"1814","possible_hits":"1",},
{"lineNum":"   95","line":"}"},
{"lineNum":"   96","line":""},
{"lineNum":"   97","line":"const GroupElement& FullViewKey::get_D() const {","class":"lineCov","hits":"2","order":"1818","possible_hits":"2",},
{"lineNum":"   98","line":"\treturn this->D;","class":"lineCov","hits":"1","order":"1819","possible_hits":"1",},
{"lineNum":"   99","line":"}"},
{"lineNum":"  100","line":""},
{"lineNum":"  101","line":"const GroupElement& FullViewKey::get_P2() const {","class":"lineCov","hits":"2","order":"848","possible_hits":"2",},
{"lineNum":"  102","line":"\treturn this->P2;","class":"lineCov","hits":"1","order":"849","possible_hits":"1",},
{"lineNum":"  103","line":"}"},
{"lineNum":"  104","line":""},
...
{"lineNum":"  110","line":""},
{"lineNum":"  111","line":"IncomingViewKey::IncomingViewKey(const FullViewKey& full_view_key) {","class":"lineCov","hits":"2","order":"840","possible_hits":"2",},
{"lineNum":"  112","line":"\tthis->params = full_view_key.get_params();","class":"lineCov","hits":"1","order":"841","possible_hits":"1",},
{"lineNum":"  113","line":"\tthis->s1 = full_view_key.get_s1();","class":"lineCov","hits":"1","order":"844","possible_hits":"1",},
{"lineNum":"  114","line":"\tthis->P2 = full_view_key.get_P2();","class":"lineCov","hits":"1","order":"847","possible_hits":"1",},
{"lineNum":"  115","line":"}","class":"lineCov","hits":"1","order":"850","possible_hits":"1",},
{"lineNum":"  116","line":""},
{"lineNum":"  117","line":"const Params* IncomingViewKey::get_params() const {","class":"lineCov","hits":"2","order":"940","possible_hits":"2",},
{"lineNum":"  118","line":"\treturn this->params;","class":"lineCov","hits":"1","order":"941","possible_hits":"1",},
{"lineNum":"  119","line":"}"},
{"lineNum":"  120","line":""},
{"lineNum":"  121","line":"const Scalar& IncomingViewKey::get_s1() const {","class":"lineCov","hits":"2","order":"855","possible_hits":"2",},
{"lineNum":"  122","line":"\treturn this->s1;","class":"lineCov","hits":"1","order":"856","possible_hits":"1",},
{"lineNum":"  123","line":"}"},
{"lineNum":"  124","line":""},
{"lineNum":"  125","line":"const GroupElement& IncomingViewKey::get_P2() const {","class":"lineCov","hits":"2","order":"1348","possible_hits":"2",},
{"lineNum":"  126","line":"\treturn this->P2;","class":"lineCov","hits":"1","order":"1349","possible_hits":"1",},
{"lineNum":"  127","line":"}"},
{"lineNum":"  128","line":""},
{"lineNum":"  129","line":"uint64_t IncomingViewKey::get_diversifier(const std::vector<unsigned char>& d) const {","class":"lineCov","hits":"2","order":"1619","possible_hits":"2",},
{"lineNum":"  130","line":"\t// Assert proper size"},
{"lineNum":"  131","line":"\tif (d.size() != AES_BLOCKSIZE) {","class":"lineCov","hits":"1","order":"1620","possible_hits":"1",},
...
{"lineNum":"  136","line":"\tstd::vector<unsigned char> key = SparkUtils::kdf_diversifier(this->s1);","class":"lineCov","hits":"1","order":"1621","possible_hits":"1",},
{"lineNum":"  137","line":"\tuint64_t i = SparkUtils::diversifier_decrypt(key, d);","class":"lineCov","hits":"1","order":"1622","possible_hits":"1",},
{"lineNum":"  138","line":""},
{"lineNum":"  139","line":"\treturn i;","class":"lineCov","hits":"1","order":"1792","possible_hits":"1",},
{"lineNum":"  140","line":"}","class":"linePartCov","hits":"1","order":"1793","possible_hits":"2",},
{"lineNum":"  141","line":""},
...
{"lineNum":"  147","line":""},
{"lineNum":"  148","line":"Address::Address(const IncomingViewKey& incoming_view_key, const uint64_t i) {","class":"lineCov","hits":"3","order":"852","possible_hits":"3",},
{"lineNum":"  149","line":"\t// Encrypt the diversifier"},
{"lineNum":"  150","line":"\tstd::vector<unsigned char> key = SparkUtils::kdf_diversifier(incoming_view_key.get_s1());","class":"lineCov","hits":"1","order":"854","possible_hits":"1",},
{"lineNum":"  151","line":"\tthis->params = incoming_view_key.get_params();","class":"lineCov","hits":"1","order":"939","possible_hits":"1",},
{"lineNum":"  152","line":"\tthis->d = SparkUtils::diversifier_encrypt(key, i);","class":"lineCov","hits":"1","order":"942","possible_hits":"1",},
{"lineNum":"  153","line":"\tthis->Q1 = SparkUtils::hash_div(this->d)*incoming_view_key.get_s1();","class":"linePartCov","hits":"1","order":"1220","possible_hits":"2",},
{"lineNum":"  154","line":"\tthis->Q2 = this->params->get_F()*SparkUtils::hash_Q2(incoming_view_key.get_s1(), i) + incoming_view_key.get_P2();","class":"linePartCov","hits":"1","order":"1298","possible_hits":"2",},
{"lineNum":"  155","line":"}","class":"linePartCov","hits":"1","order":"1350","possible_hits":"3",},
{"lineNum":"  156","line":""},
...
{"lineNum":"  159","line":"}"},
{"lineNum":"  160","line":""},
{"lineNum":"  161","line":"const std::vector<unsigned char>& Address::get_d() const {","class":"lineCov","hits":"2","order":"1363","possible_hits":"2",},
{"lineNum":"  162","line":"\treturn this->d;","class":"lineCov","hits":"1","order":"1364","possible_hits":"1",},
{"lineNum":"  163","line":"}"},
{"lineNum":"  164","line":""},
{"lineNum":"  165","line":"const GroupElement& Address::get_Q1() const {","class":"lineCov","hits":"2","order":"1425","possible_hits":"2",},
{"lineNum":"  166","line":"\treturn this->Q1;","class":"lineCov","hits":"1","order":"1426","possible_hits":"1",},
{"lineNum":"  167","line":"}"},
{"lineNum":"  168","line":""},
{"lineNum":"  169","line":"const GroupElement& Address::get_Q2() const {","class":"lineCov","hits":"2","order":"1381","possible_hits":"2",},
{"lineNum":"  170","line":"\treturn this->Q2;","class":"lineCov","hits":"1","order":"1382","possible_hits":"1",},
{"lineNum":"  171","line":"}"},
{"lineNum":"  172","line":""},
...
var header = { "command" : "coin_debug", "date" : "2023-08-28 08:53:10", "instrumented" : 188, "covered" : 61,};
var merged_data = [];
