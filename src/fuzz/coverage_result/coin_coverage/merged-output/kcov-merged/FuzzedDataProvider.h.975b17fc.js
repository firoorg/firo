...
{"lineNum":"   36","line":"      : data_ptr_(data), remaining_bytes_(size) {}","class":"lineCov","hits":"1","order":"1475",},
...
{"lineNum":"  108","line":"std::vector<T> FuzzedDataProvider::ConsumeBytes(size_t num_bytes) {","class":"lineNoCov","hits":"0",},
{"lineNum":"  109","line":"  num_bytes = std::min(num_bytes, remaining_bytes_);","class":"lineNoCov","hits":"0",},
{"lineNum":"  110","line":"  return ConsumeBytes<T>(num_bytes, num_bytes);","class":"lineNoCov","hits":"0",},
{"lineNum":"  111","line":"}"},
{"lineNum":"  112","line":""},
...
{"lineNum":"  136","line":"inline std::string FuzzedDataProvider::ConsumeBytesAsString(size_t num_bytes) {","class":"lineCov","hits":"1","order":"1478",},
...
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"  num_bytes = std::min(num_bytes, remaining_bytes_);","class":"lineCov","hits":"1","order":"1470",},
{"lineNum":"  141","line":"  std::string result(","class":"lineCov","hits":"1","order":"1474",},
{"lineNum":"  142","line":"      reinterpret_cast<const std::string::value_type *>(data_ptr_), num_bytes);","class":"lineCov","hits":"1","order":"1468",},
{"lineNum":"  143","line":"  Advance(num_bytes);","class":"lineCov","hits":"1","order":"1473",},
{"lineNum":"  144","line":"  return result;","class":"lineCov","hits":"1","order":"1467",},
{"lineNum":"  145","line":"}","class":"lineCov","hits":"1","order":"1471",},
{"lineNum":"  146","line":""},
...
{"lineNum":"  342","line":""},
{"lineNum":"  343","line":"inline void FuzzedDataProvider::Advance(size_t num_bytes) {","class":"lineCov","hits":"1","order":"1469",},
{"lineNum":"  344","line":"  if (num_bytes > remaining_bytes_)","class":"lineCov","hits":"1","order":"1477",},
{"lineNum":"  345","line":"    abort();","class":"lineNoCov","hits":"0",},
{"lineNum":"  346","line":""},
{"lineNum":"  347","line":"  data_ptr_ += num_bytes;","class":"lineCov","hits":"1","order":"1466",},
{"lineNum":"  348","line":"  remaining_bytes_ -= num_bytes;","class":"lineCov","hits":"1","order":"1472",},
{"lineNum":"  349","line":"}","class":"lineCov","hits":"1","order":"1476",},
{"lineNum":"  350","line":""},
{"lineNum":"  351","line":"template <typename T>"},
{"lineNum":"  352","line":"std::vector<T> FuzzedDataProvider::ConsumeBytes(size_t size, size_t num_bytes) {","class":"lineNoCov","hits":"0",},
...
{"lineNum":"  361","line":"  std::vector<T> result(size);","class":"lineNoCov","hits":"0",},
{"lineNum":"  362","line":"  if (size == 0) {","class":"lineNoCov","hits":"0",},
...
var header = { "command" : "", "date" : "2023-08-28 08:54:15", "instrumented" : 48, "covered" : 13,};
var merged_data = [];
