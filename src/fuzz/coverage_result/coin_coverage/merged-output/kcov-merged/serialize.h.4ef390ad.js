...
{"lineNum":"   70","line":"{","class":"lineCov","hits":"1","order":"200",},
{"lineNum":"   71","line":"    return const_cast<T*>(val);","class":"lineCov","hits":"1","order":"197",},
{"lineNum":"   72","line":"}"},
{"lineNum":"   73","line":""},
{"lineNum":"   74","line":"/**"},
...
{"lineNum":"  108","line":"{","class":"lineCov","hits":"1","order":"227",},
{"lineNum":"  109","line":"    s.write((char*)&obj, 1);","class":"lineCov","hits":"1","order":"231",},
{"lineNum":"  110","line":"}","class":"lineCov","hits":"1","order":"232",},
...
{"lineNum":"  122","line":"{","class":"lineCov","hits":"1","order":"238",},
{"lineNum":"  123","line":"    obj = htole64(obj);","class":"lineCov","hits":"1","order":"194",},
{"lineNum":"  124","line":"    s.write((char*)&obj, 8);","class":"lineCov","hits":"1","order":"192",},
{"lineNum":"  125","line":"}","class":"lineCov","hits":"1","order":"207",},
{"lineNum":"  126","line":""},
...
{"lineNum":"  134","line":"{","class":"lineCov","hits":"1","order":"176",},
{"lineNum":"  135","line":"    uint8_t obj;"},
{"lineNum":"  136","line":"    s.read((char*)&obj, 1);","class":"lineCov","hits":"1","order":"175",},
{"lineNum":"  137","line":"    return obj;","class":"lineCov","hits":"1","order":"174",},
{"lineNum":"  138","line":"}"},
...
{"lineNum":"  152","line":"{","class":"lineCov","hits":"1","order":"239",},
{"lineNum":"  153","line":"    uint64_t obj;"},
{"lineNum":"  154","line":"    s.read((char*)&obj, 8);","class":"lineCov","hits":"1","order":"228",},
{"lineNum":"  155","line":"    return le64toh(obj);","class":"lineCov","hits":"1","order":"173",},
{"lineNum":"  156","line":"}"},
...
{"lineNum":"  232","line":"template<typename Stream> inline void Serialize(Stream& s, uint64_t a) { ser_writedata64(s, a); }","class":"lineCov","hits":"1","order":"234",},
...
{"lineNum":"  244","line":"template<typename Stream> inline void Unserialize(Stream& s, uint64_t& a) { a = ser_readdata64(s); }","class":"lineCov","hits":"1","order":"218",},
...
{"lineNum":"  293","line":"{","class":"lineCov","hits":"1","order":"212",},
{"lineNum":"  294","line":"    if (nSize < 253)","class":"lineCov","hits":"1","order":"217",},
{"lineNum":"  295","line":"    {"},
{"lineNum":"  296","line":"        ser_writedata8(os, nSize);","class":"lineCov","hits":"1","order":"203",},
{"lineNum":"  297","line":"    }","class":"lineCov","hits":"1","order":"205",},
...
{"lineNum":"  312","line":"    }"},
{"lineNum":"  313","line":"    return;","class":"lineCov","hits":"1","order":"226",},
{"lineNum":"  314","line":"}"},
{"lineNum":"  315","line":""},
{"lineNum":"  316","line":"template<typename Stream>"},
{"lineNum":"  317","line":"uint64_t ReadCompactSize(Stream& is)"},
{"lineNum":"  318","line":"{","class":"lineCov","hits":"1","order":"236",},
{"lineNum":"  319","line":"    uint8_t chSize = ser_readdata8(is);","class":"lineCov","hits":"1","order":"185",},
{"lineNum":"  320","line":"    uint64_t nSizeRet = 0;","class":"lineCov","hits":"1","order":"184",},
{"lineNum":"  321","line":"    if (chSize < 253)","class":"lineCov","hits":"1","order":"183",},
{"lineNum":"  322","line":"    {"},
{"lineNum":"  323","line":"        nSizeRet = chSize;","class":"lineCov","hits":"1","order":"182",},
{"lineNum":"  324","line":"    }","class":"lineCov","hits":"1","order":"199",},
...
{"lineNum":"  329","line":"            throw std::ios_base::failure(\"non-canonical ReadCompactSize()\");","class":"lineCov","hits":"1","order":"179",},
...
{"lineNum":"  342","line":"    }"},
{"lineNum":"  343","line":"    if (nSizeRet > (uint64_t)MAX_SIZE)","class":"lineCov","hits":"1","order":"178",},
{"lineNum":"  344","line":"        throw std::ios_base::failure(\"ReadCompactSize(): size too large\");","class":"lineNoCov","hits":"0",},
{"lineNum":"  345","line":"    return nSizeRet;","class":"lineCov","hits":"1","order":"177",},
...
{"lineNum":"  803","line":"{","class":"lineCov","hits":"1","order":"220",},
{"lineNum":"  804","line":"    a.Serialize(os);","class":"lineCov","hits":"1","order":"204",},
{"lineNum":"  805","line":"}","class":"lineCov","hits":"1","order":"206",},
{"lineNum":"  806","line":""},
...
{"lineNum":"  809","line":"{","class":"lineCov","hits":"1","order":"215",},
{"lineNum":"  810","line":"    a.Unserialize(is);","class":"lineCov","hits":"1","order":"210",},
{"lineNum":"  811","line":"}","class":"lineCov","hits":"1","order":"223",},
{"lineNum":"  812","line":""},
{"lineNum":"  813","line":""},
{"lineNum":"  814","line":""},
{"lineNum":"  815","line":""},
...
{"lineNum":"  822","line":"{","class":"lineCov","hits":"1","order":"233",},
{"lineNum":"  823","line":"    WriteCompactSize(os, str.size());","class":"lineCov","hits":"1","order":"235",},
{"lineNum":"  824","line":"    if (!str.empty())","class":"lineCov","hits":"1","order":"213",},
{"lineNum":"  825","line":"        os.write((char*)&str[0], str.size() * sizeof(str[0]));","class":"lineCov","hits":"1","order":"1994",},
{"lineNum":"  826","line":"}","class":"lineCov","hits":"1","order":"237",},
{"lineNum":"  827","line":""},
{"lineNum":"  828","line":"template<typename Stream, typename C>"},
{"lineNum":"  829","line":"void Unserialize(Stream& is, std::basic_string<C>& str)"},
{"lineNum":"  830","line":"{","class":"lineCov","hits":"1","order":"172",},
{"lineNum":"  831","line":"    unsigned int nSize = ReadCompactSize(is);","class":"lineCov","hits":"1","order":"181",},
{"lineNum":"  832","line":"    str.resize(nSize);","class":"lineCov","hits":"1","order":"198",},
{"lineNum":"  833","line":"    if (nSize != 0)","class":"lineCov","hits":"1","order":"196",},
{"lineNum":"  834","line":"        is.read((char*)&str[0], nSize * sizeof(str[0]));","class":"lineCov","hits":"1","order":"1993",},
{"lineNum":"  835","line":"}","class":"lineCov","hits":"1","order":"180",},
{"lineNum":"  836","line":""},
{"lineNum":"  837","line":""},
{"lineNum":"  838","line":""},
{"lineNum":"  839","line":"/**"},
...
{"lineNum":"  912","line":"{","class":"lineCov","hits":"1","order":"224",},
{"lineNum":"  913","line":"    WriteCompactSize(os, v.size());","class":"lineCov","hits":"1","order":"225",},
{"lineNum":"  914","line":"    if (!v.empty())","class":"lineCov","hits":"1","order":"240",},
{"lineNum":"  915","line":"        os.write((char*)&v[0], v.size() * sizeof(T));","class":"lineCov","hits":"1","order":"242",},
{"lineNum":"  916","line":"}","class":"lineCov","hits":"1","order":"229",},
{"lineNum":"  917","line":""},
...
{"lineNum":"  928","line":"{","class":"lineCov","hits":"1","order":"211",},
{"lineNum":"  929","line":"    Serialize_impl(os, v, T());","class":"lineCov","hits":"1","order":"216",},
{"lineNum":"  930","line":"}","class":"lineCov","hits":"1","order":"221",},
{"lineNum":"  931","line":""},
{"lineNum":"  932","line":""},
...
{"lineNum":"  935","line":"{","class":"lineCov","hits":"1","order":"193",},
{"lineNum":"  936","line":"    // Limit size per read so bogus size value won\'t cause out of memory"},
{"lineNum":"  937","line":"    v.clear();","class":"lineCov","hits":"1","order":"209",},
{"lineNum":"  938","line":"    unsigned int nSize = ReadCompactSize(is);","class":"lineCov","hits":"1","order":"222",},
{"lineNum":"  939","line":"    unsigned int i = 0;","class":"lineCov","hits":"1","order":"189",},
{"lineNum":"  940","line":"    while (i < nSize)","class":"lineCov","hits":"1","order":"201",},
{"lineNum":"  941","line":"    {"},
{"lineNum":"  942","line":"        unsigned int blk = std::min(nSize - i, (unsigned int)(1 + 4999999 / sizeof(T)));","class":"lineCov","hits":"1","order":"195",},
{"lineNum":"  943","line":"        v.resize(i + blk);","class":"lineCov","hits":"1","order":"188",},
{"lineNum":"  944","line":"        is.read((char*)&v[i], blk * sizeof(T));","class":"lineCov","hits":"1","order":"187",},
{"lineNum":"  945","line":"        i += blk;","class":"lineCov","hits":"1","order":"202",},
{"lineNum":"  946","line":"    }"},
{"lineNum":"  947","line":"}","class":"lineCov","hits":"1","order":"186",},
{"lineNum":"  948","line":""},
...
{"lineNum":"  969","line":"{","class":"lineCov","hits":"1","order":"244",},
{"lineNum":"  970","line":"    Unserialize_impl(is, v, T());","class":"lineCov","hits":"1","order":"191",},
{"lineNum":"  971","line":"}","class":"lineCov","hits":"1","order":"190",},
{"lineNum":"  972","line":""},
{"lineNum":"  973","line":""},
{"lineNum":"  974","line":""},
{"lineNum":"  975","line":"/**"},
...
{"lineNum":" 1162","line":"{","class":"lineCov","hits":"1","order":"219",},
{"lineNum":" 1163","line":"    ::Serialize(s, obj);","class":"lineCov","hits":"1","order":"214",},
...
{"lineNum":" 1168","line":"{","class":"lineCov","hits":"1","order":"241",},
{"lineNum":" 1169","line":"    ::Unserialize(s, obj);","class":"lineCov","hits":"1","order":"243",},
{"lineNum":" 1170","line":"}","class":"lineCov","hits":"1","order":"230",},
{"lineNum":" 1171","line":""},
{"lineNum":" 1172","line":""},
{"lineNum":" 1173","line":""},
{"lineNum":" 1174","line":""},
...
var header = { "command" : "", "date" : "2023-08-28 08:54:15", "instrumented" : 114, "covered" : 75,};
var merged_data = [];
