...
{"lineNum":"    7","line":""},
{"lineNum":"    8","line":"SpendKey::SpendKey(const Params* params) {","class":"lineCov","hits":"1","order":"1959",},
{"lineNum":"    9","line":"\tthis->params = params;","class":"lineCov","hits":"1","order":"1954",},
{"lineNum":"   10","line":"\tthis->s1.randomize();","class":"lineCov","hits":"1","order":"1951",},
{"lineNum":"   11","line":"\tthis->s2.randomize();","class":"lineCov","hits":"1","order":"1950",},
{"lineNum":"   12","line":"\tthis->r.randomize();","class":"lineCov","hits":"1","order":"1948",},
{"lineNum":"   13","line":"}","class":"lineCov","hits":"1","order":"1946",},
{"lineNum":"   14","line":""},
...
{"lineNum":"   41","line":""},
{"lineNum":"   42","line":"const Params* SpendKey::get_params() const {","class":"lineCov","hits":"1","order":"1941",},
{"lineNum":"   43","line":"\treturn this->params;","class":"lineCov","hits":"1","order":"1939",},
{"lineNum":"   44","line":"}"},
{"lineNum":"   45","line":""},
{"lineNum":"   46","line":"const Scalar& SpendKey::get_s1() const {","class":"lineCov","hits":"1","order":"1938",},
{"lineNum":"   47","line":"\treturn this->s1;","class":"lineCov","hits":"1","order":"1937",},
{"lineNum":"   48","line":"}"},
{"lineNum":"   49","line":""},
{"lineNum":"   50","line":"const Scalar& SpendKey::get_s2() const {","class":"lineCov","hits":"1","order":"1936",},
{"lineNum":"   51","line":"\treturn this->s2;","class":"lineCov","hits":"1","order":"1935",},
{"lineNum":"   52","line":"}"},
{"lineNum":"   53","line":""},
{"lineNum":"   54","line":"const Scalar& SpendKey::get_r() const {","class":"lineCov","hits":"1","order":"1934",},
{"lineNum":"   55","line":"\treturn this->r;","class":"lineCov","hits":"1","order":"1933",},
{"lineNum":"   56","line":"}"},
{"lineNum":"   57","line":""},
...
{"lineNum":"   77","line":"FullViewKey::FullViewKey(const SpendKey& spend_key) {","class":"lineCov","hits":"1","order":"1945",},
{"lineNum":"   78","line":"\tthis->params = spend_key.get_params();","class":"lineCov","hits":"1","order":"1944",},
{"lineNum":"   79","line":"\tthis->s1 = spend_key.get_s1();","class":"lineCov","hits":"1","order":"1943",},
{"lineNum":"   80","line":"\tthis->s2 = spend_key.get_s2();","class":"lineCov","hits":"1","order":"1957",},
{"lineNum":"   81","line":"\tthis->D = this->params->get_G()*spend_key.get_r();","class":"lineCov","hits":"1","order":"1932",},
{"lineNum":"   82","line":"\tthis->P2 = this->params->get_F()*this->s2 + this->D;","class":"lineCov","hits":"1","order":"1960",},
{"lineNum":"   83","line":"}","class":"lineCov","hits":"1","order":"1968",},
{"lineNum":"   84","line":""},
{"lineNum":"   85","line":"const Params* FullViewKey::get_params() const {","class":"lineCov","hits":"1","order":"1969",},
{"lineNum":"   86","line":"\treturn this->params;","class":"lineCov","hits":"1","order":"1970",},
{"lineNum":"   87","line":"}"},
{"lineNum":"   88","line":""},
{"lineNum":"   89","line":"const Scalar& FullViewKey::get_s1() const {","class":"lineCov","hits":"1","order":"1971",},
{"lineNum":"   90","line":"\treturn this->s1;","class":"lineCov","hits":"1","order":"1972",},
{"lineNum":"   91","line":"}"},
{"lineNum":"   92","line":""},
{"lineNum":"   93","line":"const Scalar& FullViewKey::get_s2() const {","class":"lineCov","hits":"1","order":"1973",},
{"lineNum":"   94","line":"\treturn this->s2;","class":"lineCov","hits":"1","order":"1974",},
{"lineNum":"   95","line":"}"},
{"lineNum":"   96","line":""},
{"lineNum":"   97","line":"const GroupElement& FullViewKey::get_D() const {","class":"lineCov","hits":"1","order":"1975",},
{"lineNum":"   98","line":"\treturn this->D;","class":"lineCov","hits":"1","order":"1976",},
{"lineNum":"   99","line":"}"},
{"lineNum":"  100","line":""},
{"lineNum":"  101","line":"const GroupElement& FullViewKey::get_P2() const {","class":"lineCov","hits":"1","order":"1977",},
{"lineNum":"  102","line":"\treturn this->P2;","class":"lineCov","hits":"1","order":"1978",},
{"lineNum":"  103","line":"}"},
{"lineNum":"  104","line":""},
...
{"lineNum":"  110","line":""},
{"lineNum":"  111","line":"IncomingViewKey::IncomingViewKey(const FullViewKey& full_view_key) {","class":"lineCov","hits":"1","order":"1979",},
{"lineNum":"  112","line":"\tthis->params = full_view_key.get_params();","class":"lineCov","hits":"1","order":"1980",},
{"lineNum":"  113","line":"\tthis->s1 = full_view_key.get_s1();","class":"lineCov","hits":"1","order":"1981",},
{"lineNum":"  114","line":"\tthis->P2 = full_view_key.get_P2();","class":"lineCov","hits":"1","order":"1982",},
{"lineNum":"  115","line":"}","class":"lineCov","hits":"1","order":"1983",},
{"lineNum":"  116","line":""},
{"lineNum":"  117","line":"const Params* IncomingViewKey::get_params() const {","class":"lineCov","hits":"1","order":"1984",},
{"lineNum":"  118","line":"\treturn this->params;","class":"lineCov","hits":"1","order":"1985",},
{"lineNum":"  119","line":"}"},
{"lineNum":"  120","line":""},
{"lineNum":"  121","line":"const Scalar& IncomingViewKey::get_s1() const {","class":"lineCov","hits":"1","order":"1986",},
{"lineNum":"  122","line":"\treturn this->s1;","class":"lineCov","hits":"1","order":"1987",},
{"lineNum":"  123","line":"}"},
{"lineNum":"  124","line":""},
{"lineNum":"  125","line":"const GroupElement& IncomingViewKey::get_P2() const {","class":"lineCov","hits":"1","order":"1988",},
{"lineNum":"  126","line":"\treturn this->P2;","class":"lineCov","hits":"1","order":"1989",},
{"lineNum":"  127","line":"}"},
{"lineNum":"  128","line":""},
{"lineNum":"  129","line":"uint64_t IncomingViewKey::get_diversifier(const std::vector<unsigned char>& d) const {","class":"lineCov","hits":"1","order":"1990",},
{"lineNum":"  130","line":"\t// Assert proper size"},
{"lineNum":"  131","line":"\tif (d.size() != AES_BLOCKSIZE) {","class":"lineCov","hits":"1","order":"1991",},
...
{"lineNum":"  136","line":"\tstd::vector<unsigned char> key = SparkUtils::kdf_diversifier(this->s1);","class":"lineCov","hits":"1","order":"1955",},
{"lineNum":"  137","line":"\tuint64_t i = SparkUtils::diversifier_decrypt(key, d);","class":"lineCov","hits":"1","order":"1952",},
{"lineNum":"  138","line":""},
{"lineNum":"  139","line":"\treturn i;","class":"lineCov","hits":"1","order":"1949",},
{"lineNum":"  140","line":"}","class":"lineCov","hits":"1","order":"1947",},
{"lineNum":"  141","line":""},
...
{"lineNum":"  147","line":""},
{"lineNum":"  148","line":"Address::Address(const IncomingViewKey& incoming_view_key, const uint64_t i) {","class":"lineCov","hits":"1","order":"1958",},
{"lineNum":"  149","line":"\t// Encrypt the diversifier"},
{"lineNum":"  150","line":"\tstd::vector<unsigned char> key = SparkUtils::kdf_diversifier(incoming_view_key.get_s1());","class":"lineCov","hits":"1","order":"1961",},
{"lineNum":"  151","line":"\tthis->params = incoming_view_key.get_params();","class":"lineCov","hits":"1","order":"1962",},
{"lineNum":"  152","line":"\tthis->d = SparkUtils::diversifier_encrypt(key, i);","class":"lineCov","hits":"1","order":"1963",},
{"lineNum":"  153","line":"\tthis->Q1 = SparkUtils::hash_div(this->d)*incoming_view_key.get_s1();","class":"lineCov","hits":"1","order":"1964",},
{"lineNum":"  154","line":"\tthis->Q2 = this->params->get_F()*SparkUtils::hash_Q2(incoming_view_key.get_s1(), i) + incoming_view_key.get_P2();","class":"lineCov","hits":"1","order":"1965",},
{"lineNum":"  155","line":"}","class":"lineCov","hits":"1","order":"1966",},
{"lineNum":"  156","line":""},
...
{"lineNum":"  159","line":"}"},
{"lineNum":"  160","line":""},
{"lineNum":"  161","line":"const std::vector<unsigned char>& Address::get_d() const {","class":"lineCov","hits":"1","order":"1992",},
{"lineNum":"  162","line":"\treturn this->d;","class":"lineCov","hits":"1","order":"1967",},
{"lineNum":"  163","line":"}"},
{"lineNum":"  164","line":""},
{"lineNum":"  165","line":"const GroupElement& Address::get_Q1() const {","class":"lineCov","hits":"1","order":"1956",},
{"lineNum":"  166","line":"\treturn this->Q1;","class":"lineCov","hits":"1","order":"1953",},
{"lineNum":"  167","line":"}"},
{"lineNum":"  168","line":""},
{"lineNum":"  169","line":"const GroupElement& Address::get_Q2() const {","class":"lineCov","hits":"1","order":"1942",},
{"lineNum":"  170","line":"\treturn this->Q2;","class":"lineCov","hits":"1","order":"1940",},
{"lineNum":"  171","line":"}"},
{"lineNum":"  172","line":""},
...
var header = { "command" : "", "date" : "2023-08-28 08:54:15", "instrumented" : 188, "covered" : 61,};
var merged_data = [];
