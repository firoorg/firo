...
{"lineNum":"  145","line":" */"},
{"lineNum":"  146","line":"class CDataStream","class":"lineCov","hits":"1","order":"1921",},
{"lineNum":"  147","line":"{"},
...
{"lineNum":"  166","line":""},
{"lineNum":"  167","line":"    explicit CDataStream(int nTypeIn, int nVersionIn)","class":"lineCov","hits":"1","order":"1914",},
{"lineNum":"  168","line":"    {","class":"lineCov","hits":"1","order":"1909",},
{"lineNum":"  169","line":"        Init(nTypeIn, nVersionIn);","class":"lineCov","hits":"1","order":"1917",},
{"lineNum":"  170","line":"    }","class":"lineCov","hits":"1","order":"1913",},
{"lineNum":"  171","line":""},
...
{"lineNum":"  205","line":"    {","class":"lineCov","hits":"1","order":"1920",},
{"lineNum":"  206","line":"        nReadPos = 0;","class":"lineCov","hits":"1","order":"1919",},
{"lineNum":"  207","line":"        nType = nTypeIn;","class":"lineCov","hits":"1","order":"1925",},
{"lineNum":"  208","line":"        nVersion = nVersionIn;","class":"lineCov","hits":"1","order":"1927",},
{"lineNum":"  209","line":"    }","class":"lineCov","hits":"1","order":"1923",},
{"lineNum":"  210","line":""},
...
{"lineNum":"  234","line":"    iterator begin()                                 { return vch.begin() + nReadPos; }","class":"lineNoCov","hits":"0",},
{"lineNum":"  235","line":"    const_iterator end() const                       { return vch.end(); }"},
{"lineNum":"  236","line":"    iterator end()                                   { return vch.end(); }","class":"lineNoCov","hits":"0",},
{"lineNum":"  237","line":"    size_type size() const                           { return vch.size() - nReadPos; }","class":"lineCov","hits":"1","order":"1904",},
{"lineNum":"  238","line":"    bool empty() const                               { return vch.size() == nReadPos; }"},
{"lineNum":"  239","line":"    void resize(size_type n, value_type c=0)         { vch.resize(n + nReadPos, c); }","class":"lineCov","hits":"1","order":"1901",},
...
{"lineNum":"  246","line":"    value_type* data()                               { return vch.data() + nReadPos; }","class":"lineCov","hits":"1","order":"1898",},
...
{"lineNum":"  343","line":"    {","class":"lineCov","hits":"1","order":"1918",},
{"lineNum":"  344","line":"        if (nSize == 0) return;","class":"lineCov","hits":"1","order":"1915",},
{"lineNum":"  345","line":""},
{"lineNum":"  346","line":"        // Read from the beginning of the buffer"},
{"lineNum":"  347","line":"        unsigned int nReadPosNext = nReadPos + nSize;","class":"lineCov","hits":"1","order":"1912",},
{"lineNum":"  348","line":"        if (nReadPosNext >= vch.size())","class":"lineCov","hits":"1","order":"1930",},
{"lineNum":"  349","line":"        {"},
{"lineNum":"  350","line":"            if (nReadPosNext > vch.size())","class":"lineCov","hits":"1","order":"1907",},
{"lineNum":"  351","line":"            {"},
{"lineNum":"  352","line":"                throw std::ios_base::failure(\"CDataStream::read(): end of data\");","class":"lineNoCov","hits":"0",},
{"lineNum":"  353","line":"            }"},
{"lineNum":"  354","line":"            memcpy(pch, &vch[nReadPos], nSize);","class":"lineCov","hits":"1","order":"1924",},
{"lineNum":"  355","line":"            nReadPos = 0;","class":"lineCov","hits":"1","order":"1905",},
{"lineNum":"  356","line":"            vch.clear();","class":"lineCov","hits":"1","order":"1903",},
{"lineNum":"  357","line":"            return;","class":"lineCov","hits":"1","order":"1902",},
{"lineNum":"  358","line":"        }"},
{"lineNum":"  359","line":"        memcpy(pch, &vch[nReadPos], nSize);","class":"lineCov","hits":"1","order":"1900",},
{"lineNum":"  360","line":"        nReadPos = nReadPosNext;","class":"lineCov","hits":"1","order":"1899",},
{"lineNum":"  361","line":"    }","class":"lineCov","hits":"1","order":"1931",},
{"lineNum":"  362","line":""},
...
{"lineNum":"  382","line":"    {","class":"lineCov","hits":"1","order":"1922",},
{"lineNum":"  383","line":"        // Write to the end of the buffer"},
{"lineNum":"  384","line":"        vch.insert(vch.end(), pch, pch + nSize);","class":"lineCov","hits":"1","order":"1926",},
{"lineNum":"  385","line":"    }","class":"lineCov","hits":"1","order":"1928",},
{"lineNum":"  386","line":""},
...
{"lineNum":"  397","line":"    {","class":"lineCov","hits":"1","order":"1911",},
{"lineNum":"  398","line":"        // Serialize to this stream"},
{"lineNum":"  399","line":"        ::Serialize(*this, obj);","class":"lineCov","hits":"1","order":"1910",},
{"lineNum":"  400","line":"        return (*this);","class":"lineCov","hits":"1","order":"1908",},
{"lineNum":"  401","line":"    }"},
{"lineNum":"  402","line":""},
{"lineNum":"  403","line":"    template<typename T>"},
{"lineNum":"  404","line":"    CDataStream& operator>>(T& obj)"},
{"lineNum":"  405","line":"    {","class":"lineCov","hits":"1","order":"1916",},
{"lineNum":"  406","line":"        // Unserialize from this stream"},
{"lineNum":"  407","line":"        ::Unserialize(*this, obj);","class":"lineCov","hits":"1","order":"1929",},
{"lineNum":"  408","line":"        return (*this);","class":"lineCov","hits":"1","order":"1906",},
{"lineNum":"  409","line":"    }"},
{"lineNum":"  410","line":""},
...
var header = { "command" : "", "date" : "2023-08-28 08:54:15", "instrumented" : 37, "covered" : 34,};
var merged_data = [];
