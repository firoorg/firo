...
{"lineNum":"   55","line":"class LOCKABLE AnnotatedMixin : public PARENT","class":"lineCov","hits":"1","order":"1256",},
{"lineNum":"   56","line":"{"},
{"lineNum":"   57","line":"public:"},
{"lineNum":"   58","line":"    void lock() EXCLUSIVE_LOCK_FUNCTION()"},
{"lineNum":"   59","line":"    {","class":"lineCov","hits":"1","order":"1245",},
{"lineNum":"   60","line":"        PARENT::lock();","class":"lineCov","hits":"1","order":"1244",},
{"lineNum":"   61","line":"    }","class":"lineCov","hits":"1","order":"1243",},
{"lineNum":"   62","line":""},
{"lineNum":"   63","line":"    void unlock() UNLOCK_FUNCTION()"},
{"lineNum":"   64","line":"    {","class":"lineCov","hits":"1","order":"1242",},
{"lineNum":"   65","line":"        PARENT::unlock();","class":"lineCov","hits":"1","order":"1241",},
{"lineNum":"   66","line":"    }","class":"lineCov","hits":"1","order":"1240",},
{"lineNum":"   67","line":""},
...
{"lineNum":"   81","line":"void static inline EnterCritical(const char* pszName, const char* pszFile, int nLine, void* cs, bool fTry = false) {}","class":"lineCov","hits":"1","order":"1257",},
{"lineNum":"   82","line":"void static inline LeaveCritical() {}","class":"lineCov","hits":"1","order":"1261",},
...
{"lineNum":"   93","line":" */"},
{"lineNum":"   94","line":"class CCriticalSection : public AnnotatedMixin<boost::recursive_mutex>","class":"lineCov","hits":"1","order":"1255",},
{"lineNum":"   95","line":"{"},
...
{"lineNum":"  121","line":"    {","class":"lineCov","hits":"1","order":"1258",},
{"lineNum":"  122","line":"        EnterCritical(pszName, pszFile, nLine, (void*)(lock.mutex()));","class":"lineCov","hits":"1","order":"1259",},
...
{"lineNum":"  127","line":"            lock.lock();","class":"lineCov","hits":"1","order":"1253",},
{"lineNum":"  128","line":"#ifdef DEBUG_LOCKCONTENTION"},
{"lineNum":"  129","line":"        }"},
{"lineNum":"  130","line":"#endif"},
{"lineNum":"  131","line":"    }","class":"lineCov","hits":"1","order":"1260",},
{"lineNum":"  132","line":""},
...
{"lineNum":"  143","line":"    CMutexLock(Mutex& mutexIn, const char* pszName, const char* pszFile, int nLine, bool fTry = false) EXCLUSIVE_LOCK_FUNCTION(mutexIn) : lock(mutexIn, boost::defer_lock)","class":"lineCov","hits":"1","order":"1249",},
{"lineNum":"  144","line":"    {","class":"lineCov","hits":"1","order":"1250",},
{"lineNum":"  145","line":"        if (fTry)","class":"lineCov","hits":"1","order":"1248",},
{"lineNum":"  146","line":"            TryEnter(pszName, pszFile, nLine);","class":"lineNoCov","hits":"0",},
{"lineNum":"  147","line":"        else"},
{"lineNum":"  148","line":"            Enter(pszName, pszFile, nLine);","class":"lineCov","hits":"1","order":"1247",},
{"lineNum":"  149","line":"    }","class":"lineCov","hits":"1","order":"1254",},
{"lineNum":"  150","line":""},
...
{"lineNum":"  163","line":"    {","class":"lineCov","hits":"1","order":"1252",},
{"lineNum":"  164","line":"        if (lock.owns_lock())","class":"lineCov","hits":"1","order":"1251",},
{"lineNum":"  165","line":"            LeaveCritical();","class":"lineCov","hits":"1","order":"1246",},
...
var header = { "command" : "", "date" : "2023-08-28 08:54:15", "instrumented" : 36, "covered" : 22,};
var merged_data = [];
