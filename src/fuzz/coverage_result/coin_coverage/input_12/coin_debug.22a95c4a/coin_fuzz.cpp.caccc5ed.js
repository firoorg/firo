...
{"lineNum":"   44","line":"    Scalar k;","class":"lineCov","hits":"1","order":"1351","possible_hits":"1",},
{"lineNum":"   45","line":"    k.randomize();","class":"lineCov","hits":"1","order":"1352","possible_hits":"1",},
{"lineNum":"   46","line":""},
{"lineNum":"   47","line":"    spark::Coin coin = spark::Coin (","class":"lineCov","hits":"2","order":"1353","possible_hits":"2",},
{"lineNum":"   48","line":"        params,","class":"lineCov","hits":"1","order":"1354","possible_hits":"1",},
...
{"lineNum":"   58","line":"    spark::IdentifiedCoinData i_data = coin.identify(incoming_view_key);","class":"lineCov","hits":"1","order":"1509","possible_hits":"1",},
{"lineNum":"   59","line":"    assert(i_data.i == i);","class":"lineCov","hits":"1","order":"1804","possible_hits":"1",},
{"lineNum":"   60","line":"    assert(i_data.d == address.get_d());","class":"lineCov","hits":"1","order":"1805","possible_hits":"1",},
{"lineNum":"   61","line":"    assert(i_data.v == v);","class":"lineCov","hits":"1","order":"1806","possible_hits":"1",},
{"lineNum":"   62","line":"    assert(i_data.memo == memo);","class":"lineCov","hits":"1","order":"1807","possible_hits":"1",},
{"lineNum":"   63","line":""},
{"lineNum":"   64","line":"    // Recover coin"},
{"lineNum":"   65","line":"    spark::RecoveredCoinData r_data = coin.recover(full_view_key, i_data);","class":"lineCov","hits":"1","order":"1808","possible_hits":"1",},
{"lineNum":"   66","line":"    assert(params->get_F()*(spark::SparkUtils::hash_ser(k, coin.serial_context) + spark::SparkUtils::hash_Q2(incoming_view_key.get_s1(), i) + full_view_key.get_s2()) + full_view_key.get_D() == params->get_F()*r_data.s + full_view_key.get_D());","class":"linePartCov","hits":"1","order":"1997","possible_hits":"3",},
{"lineNum":"   67","line":""},
{"lineNum":"   68","line":"    assert(r_data.T * r_data.s + full_view_key.get_D() == params->get_U());","class":"linePartCov","hits":"1","order":"1998","possible_hits":"2",},
{"lineNum":"   69","line":""},
{"lineNum":"   70","line":""},
{"lineNum":"   71","line":""},
...
var header = { "command" : "coin_debug", "date" : "2023-08-28 08:53:01", "instrumented" : 30, "covered" : 29,};
var merged_data = [];
