...
{"lineNum":"   14","line":""},
{"lineNum":"   15","line":"Coin::Coin(","class":"lineCov","hits":"1","order":"1356","possible_hits":"1",},
...
{"lineNum":"   23","line":") {","class":"lineCov","hits":"2","order":"1355","possible_hits":"2",},
{"lineNum":"   24","line":"\tthis->params = params;","class":"lineCov","hits":"1","order":"1358","possible_hits":"1",},
{"lineNum":"   25","line":"\tthis->serial_context = serial_context;","class":"lineCov","hits":"1","order":"1359","possible_hits":"1",},
{"lineNum":"   26","line":""},
{"lineNum":"   27","line":"\t// Validate the type"},
{"lineNum":"   28","line":"\tif (type != COIN_TYPE_MINT && type != COIN_TYPE_SPEND) {","class":"lineCov","hits":"1","order":"1360","possible_hits":"1",},
{"lineNum":"   29","line":"\t\tthrow std::invalid_argument(\"Bad coin type\");","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   30","line":"\t}"},
{"lineNum":"   31","line":"\tthis->type = type;","class":"lineCov","hits":"1","order":"1361","possible_hits":"1",},
{"lineNum":"   32","line":""},
{"lineNum":"   33","line":""},
{"lineNum":"   34","line":"\t//"},
...
{"lineNum":"   39","line":"\tthis->K = SparkUtils::hash_div(address.get_d())*SparkUtils::hash_k(k);","class":"linePartCov","hits":"1","order":"1362","possible_hits":"2",},
{"lineNum":"   40","line":""},
{"lineNum":"   41","line":"\t// Construct the serial commitment"},
{"lineNum":"   42","line":"\tthis->S = this->params->get_F()*SparkUtils::hash_ser(k, serial_context) + address.get_Q2();","class":"linePartCov","hits":"1","order":"1372","possible_hits":"2",},
{"lineNum":"   43","line":""},
{"lineNum":"   44","line":"\t// Construct the value commitment"},
{"lineNum":"   45","line":"\tthis->C = this->params->get_G()*Scalar(v) + this->params->get_H()*SparkUtils::hash_val(k);","class":"linePartCov","hits":"1","order":"1383","possible_hits":"2",},
{"lineNum":"   46","line":""},
{"lineNum":"   47","line":"\t// Check the memo validity, and pad if needed"},
{"lineNum":"   48","line":"\tif (memo.size() > this->params->get_memo_bytes()) {","class":"lineCov","hits":"1","order":"1393","possible_hits":"1",},
{"lineNum":"   49","line":"\t\tthrow std::invalid_argument(\"Memo is too large\");","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   50","line":"\t}"},
{"lineNum":"   51","line":"\tstd::vector<unsigned char> memo_bytes(memo.begin(), memo.end());","class":"linePartCov","hits":"1","order":"1396","possible_hits":"2",},
{"lineNum":"   52","line":"\tstd::vector<unsigned char> padded_memo(memo_bytes);","class":"lineCov","hits":"1","order":"1397","possible_hits":"1",},
{"lineNum":"   53","line":"\tpadded_memo.resize(this->params->get_memo_bytes());","class":"lineCov","hits":"1","order":"1398","possible_hits":"1",},
{"lineNum":"   54","line":""},
{"lineNum":"   55","line":"\t//"},
{"lineNum":"   56","line":"\t// Type-specific elements"},
{"lineNum":"   57","line":"\t//"},
{"lineNum":"   58","line":""},
{"lineNum":"   59","line":"\tif (this->type == COIN_TYPE_MINT) {","class":"lineCov","hits":"1","order":"1399","possible_hits":"1",},
{"lineNum":"   60","line":"\t\tthis->v = v;","class":"lineCov","hits":"1","order":"1400","possible_hits":"1",},
{"lineNum":"   61","line":""},
{"lineNum":"   62","line":"\t\t// Encrypt recipient data"},
{"lineNum":"   63","line":"\t\tMintCoinRecipientData r;","class":"lineCov","hits":"1","order":"1401","possible_hits":"1",},
{"lineNum":"   64","line":"\t\tr.d = address.get_d();","class":"lineCov","hits":"1","order":"1403","possible_hits":"1",},
{"lineNum":"   65","line":"\t\tr.k = k;","class":"lineCov","hits":"1","order":"1404","possible_hits":"1",},
{"lineNum":"   66","line":"\t\tr.memo = std::string(memo.begin(), memo.end());","class":"linePartCov","hits":"1","order":"1405","possible_hits":"2",},
{"lineNum":"   67","line":"\t\tCDataStream r_stream(SER_NETWORK, PROTOCOL_VERSION);","class":"lineCov","hits":"1","order":"1406","possible_hits":"1",},
{"lineNum":"   68","line":"\t\tr_stream << r;","class":"lineCov","hits":"1","order":"1407","possible_hits":"1",},
{"lineNum":"   69","line":"\t\tthis->r_ = AEAD::encrypt(address.get_Q1()*SparkUtils::hash_k(k), \"Mint coin data\", r_stream);","class":"linePartCov","hits":"1","order":"1424","possible_hits":"2",},
{"lineNum":"   70","line":"\t} else {","class":"linePartCov","hits":"1","order":"1507","possible_hits":"2",},
...
{"lineNum":"   81","line":"}","class":"linePartCov","hits":"1","order":"1508","possible_hits":"11",},
{"lineNum":"   82","line":""},
...
{"lineNum":"   88","line":") {","class":"lineCov","hits":"2","order":"1602","possible_hits":"2",},
{"lineNum":"   89","line":"\t// Check recovery key"},
{"lineNum":"   90","line":"\tif (SparkUtils::hash_div(data.d)*SparkUtils::hash_k(data.k) != this->K) {","class":"linePartCov","hits":"1","order":"1603","possible_hits":"4",},
{"lineNum":"   91","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   92","line":"\t}"},
{"lineNum":"   93","line":""},
{"lineNum":"   94","line":"\t// Check value commitment"},
{"lineNum":"   95","line":"\tif (this->params->get_G()*Scalar(data.v) + this->params->get_H()*SparkUtils::hash_val(data.k) != this->C) {","class":"linePartCov","hits":"1","order":"1617","possible_hits":"2",},
{"lineNum":"   96","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   97","line":"\t}"},
{"lineNum":"   98","line":""},
{"lineNum":"   99","line":"\t// Check serial commitment"},
{"lineNum":"  100","line":"\tdata.i = incoming_view_key.get_diversifier(data.d);","class":"lineCov","hits":"1","order":"1618","possible_hits":"1",},
{"lineNum":"  101","line":""},
{"lineNum":"  102","line":"\tif (this->params->get_F()*(SparkUtils::hash_ser(data.k, this->serial_context) + SparkUtils::hash_Q2(incoming_view_key.get_s1(), data.i)) + incoming_view_key.get_P2() != this->S) {","class":"linePartCov","hits":"1","order":"1794","possible_hits":"2",},
{"lineNum":"  103","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  104","line":"\t}"},
{"lineNum":"  105","line":""},
{"lineNum":"  106","line":"\treturn true;","class":"lineCov","hits":"1","order":"1800","possible_hits":"1",},
{"lineNum":"  107","line":"}","class":"linePartCov","hits":"1","order":"1801","possible_hits":"4",},
{"lineNum":"  108","line":""},
{"lineNum":"  109","line":"// Recover a coin"},
{"lineNum":"  110","line":"RecoveredCoinData Coin::recover(const FullViewKey& full_view_key, const IdentifiedCoinData& data) {","class":"lineCov","hits":"2","order":"1809","possible_hits":"2",},
{"lineNum":"  111","line":"\tRecoveredCoinData recovered_data;","class":"lineCov","hits":"1","order":"1810","possible_hits":"1",},
{"lineNum":"  112","line":"\trecovered_data.s = SparkUtils::hash_ser(data.k, this->serial_context) + SparkUtils::hash_Q2(full_view_key.get_s1(), data.i) + full_view_key.get_s2();","class":"linePartCov","hits":"1","order":"1812","possible_hits":"2",},
{"lineNum":"  113","line":"\trecovered_data.T = (this->params->get_U() + full_view_key.get_D().inverse())*recovered_data.s.inverse();","class":"linePartCov","hits":"1","order":"1815","possible_hits":"2",},
{"lineNum":"  114","line":""},
{"lineNum":"  115","line":"\treturn recovered_data;","class":"lineCov","hits":"1","order":"1995","possible_hits":"1",},
{"lineNum":"  116","line":"}","class":"linePartCov","hits":"1","order":"1996","possible_hits":"3",},
{"lineNum":"  117","line":""},
{"lineNum":"  118","line":"// Identify a coin"},
{"lineNum":"  119","line":"IdentifiedCoinData Coin::identify(const IncomingViewKey& incoming_view_key) {","class":"lineCov","hits":"2","order":"1510","possible_hits":"2",},
{"lineNum":"  120","line":"\tIdentifiedCoinData data;","class":"lineCov","hits":"1","order":"1511","possible_hits":"1",},
{"lineNum":"  121","line":""},
{"lineNum":"  122","line":"\t// Deserialization means this process depends on the coin type"},
{"lineNum":"  123","line":"\tif (this->type == COIN_TYPE_MINT) {","class":"lineCov","hits":"1","order":"1513","possible_hits":"1",},
{"lineNum":"  124","line":"\t\tMintCoinRecipientData r;","class":"lineCov","hits":"1","order":"1514","possible_hits":"1",},
{"lineNum":"  125","line":""},
{"lineNum":"  126","line":"\t\ttry {"},
{"lineNum":"  127","line":"\t\t\t// Decrypt recipient data"},
{"lineNum":"  128","line":"\t\t\tCDataStream stream = AEAD::decrypt_and_verify(this->K*incoming_view_key.get_s1(), \"Mint coin data\", this->r_);","class":"linePartCov","hits":"1","order":"1515","possible_hits":"2",},
{"lineNum":"  129","line":"\t\t\tstream >> r;","class":"lineCov","hits":"1","order":"1537","possible_hits":"1",},
{"lineNum":"  130","line":"\t\t} catch (...) {","class":"linePartCov","hits":"1","order":"1595","possible_hits":"2",},
...
{"lineNum":"  133","line":""},
{"lineNum":"  134","line":"\t\tdata.d = r.d;","class":"lineCov","hits":"1","order":"1596","possible_hits":"1",},
{"lineNum":"  135","line":"\t\tdata.v = this->v;","class":"lineCov","hits":"1","order":"1597","possible_hits":"1",},
{"lineNum":"  136","line":"\t\tdata.k = r.k;","class":"lineCov","hits":"1","order":"1598","possible_hits":"1",},
{"lineNum":"  137","line":"\t\tdata.memo = r.memo;","class":"lineCov","hits":"1","order":"1599","possible_hits":"1",},
{"lineNum":"  138","line":"\t} else {","class":"linePartCov","hits":"1","order":"1600","possible_hits":"2",},
...
{"lineNum":"  156","line":"\tif (!validate(incoming_view_key, data)) {","class":"lineCov","hits":"1","order":"1601","possible_hits":"1",},
{"lineNum":"  157","line":"\t\tthrow std::runtime_error(\"Malformed coin\");","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  158","line":"\t}"},
{"lineNum":"  159","line":""},
{"lineNum":"  160","line":"\treturn data;","class":"lineCov","hits":"1","order":"1802","possible_hits":"1",},
{"lineNum":"  161","line":"}","class":"linePartCov","hits":"1","order":"1803","possible_hits":"12",},
{"lineNum":"  162","line":""},
...
var header = { "command" : "coin_debug", "date" : "2023-08-28 08:54:09", "instrumented" : 103, "covered" : 52,};
var merged_data = [];
