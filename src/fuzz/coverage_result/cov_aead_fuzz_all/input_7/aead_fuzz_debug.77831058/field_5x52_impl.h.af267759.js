...
{"lineNum":"   57","line":""},
{"lineNum":"   58","line":"static void secp256k1_fe_normalize(secp256k1_fe *r) {","class":"lineCov","hits":"2","order":"301","possible_hits":"2",},
{"lineNum":"   59","line":"    uint64_t t0 = r->n[0], t1 = r->n[1], t2 = r->n[2], t3 = r->n[3], t4 = r->n[4];","class":"lineCov","hits":"1","order":"302","possible_hits":"1",},
{"lineNum":"   60","line":""},
...
{"lineNum":"   63","line":"    uint64_t x = t4 >> 48; t4 &= 0x0FFFFFFFFFFFFULL;","class":"lineCov","hits":"1","order":"303","possible_hits":"1",},
{"lineNum":"   64","line":""},
{"lineNum":"   65","line":"    /* The first pass ensures the magnitude is 1, ... */"},
{"lineNum":"   66","line":"    t0 += x * 0x1000003D1ULL;","class":"lineCov","hits":"1","order":"304","possible_hits":"1",},
{"lineNum":"   67","line":"    t1 += (t0 >> 52); t0 &= 0xFFFFFFFFFFFFFULL;","class":"lineCov","hits":"1","order":"305","possible_hits":"1",},
{"lineNum":"   68","line":"    t2 += (t1 >> 52); t1 &= 0xFFFFFFFFFFFFFULL; m = t1;","class":"lineCov","hits":"1","order":"306","possible_hits":"1",},
{"lineNum":"   69","line":"    t3 += (t2 >> 52); t2 &= 0xFFFFFFFFFFFFFULL; m &= t2;","class":"lineCov","hits":"1","order":"307","possible_hits":"1",},
{"lineNum":"   70","line":"    t4 += (t3 >> 52); t3 &= 0xFFFFFFFFFFFFFULL; m &= t3;","class":"lineCov","hits":"1","order":"308","possible_hits":"1",},
{"lineNum":"   71","line":""},
{"lineNum":"   72","line":"    /* ... except for a possible carry at bit 48 of t4 (i.e. bit 256 of the field element) */"},
{"lineNum":"   73","line":"    VERIFY_CHECK(t4 >> 49 == 0);","class":"lineCov","hits":"1","order":"309","possible_hits":"1",},
{"lineNum":"   74","line":""},
{"lineNum":"   75","line":"    /* At most a single final reduction is needed; check if the value is >= the field characteristic */"},
{"lineNum":"   76","line":"    x = (t4 >> 48) | ((t4 == 0x0FFFFFFFFFFFFULL) & (m == 0xFFFFFFFFFFFFFULL)","class":"lineCov","hits":"2","order":"310","possible_hits":"2",},
{"lineNum":"   77","line":"        & (t0 >= 0xFFFFEFFFFFC2FULL));","class":"lineCov","hits":"1","order":"311","possible_hits":"1",},
{"lineNum":"   78","line":""},
{"lineNum":"   79","line":"    /* Apply the final reduction (for constant-time behaviour, we do it always) */"},
{"lineNum":"   80","line":"    t0 += x * 0x1000003D1ULL;","class":"lineCov","hits":"1","order":"312","possible_hits":"1",},
{"lineNum":"   81","line":"    t1 += (t0 >> 52); t0 &= 0xFFFFFFFFFFFFFULL;","class":"lineCov","hits":"1","order":"313","possible_hits":"1",},
{"lineNum":"   82","line":"    t2 += (t1 >> 52); t1 &= 0xFFFFFFFFFFFFFULL;","class":"lineCov","hits":"1","order":"314","possible_hits":"1",},
{"lineNum":"   83","line":"    t3 += (t2 >> 52); t2 &= 0xFFFFFFFFFFFFFULL;","class":"lineCov","hits":"1","order":"315","possible_hits":"1",},
{"lineNum":"   84","line":"    t4 += (t3 >> 52); t3 &= 0xFFFFFFFFFFFFFULL;","class":"lineCov","hits":"1","order":"316","possible_hits":"1",},
{"lineNum":"   85","line":""},
{"lineNum":"   86","line":"    /* If t4 didn\'t carry to bit 48 already, then it should have after any final reduction */"},
{"lineNum":"   87","line":"    VERIFY_CHECK(t4 >> 48 == x);","class":"lineCov","hits":"1","order":"317","possible_hits":"1",},
{"lineNum":"   88","line":""},
{"lineNum":"   89","line":"    /* Mask off the possible multiple of 2^256 from the final reduction */"},
{"lineNum":"   90","line":"    t4 &= 0x0FFFFFFFFFFFFULL;","class":"lineCov","hits":"1","order":"318","possible_hits":"1",},
{"lineNum":"   91","line":""},
{"lineNum":"   92","line":"    r->n[0] = t0; r->n[1] = t1; r->n[2] = t2; r->n[3] = t3; r->n[4] = t4;","class":"lineCov","hits":"1","order":"319","possible_hits":"1",},
{"lineNum":"   93","line":""},
...
{"lineNum":"   99","line":"}","class":"linePartCov","hits":"1","order":"320","possible_hits":"2",},
{"lineNum":"  100","line":""},
...
{"lineNum":"  232","line":""},
{"lineNum":"  233","line":"SECP256K1_INLINE static void secp256k1_fe_set_int(secp256k1_fe *r, int a) {","class":"lineCov","hits":"2","order":"110","possible_hits":"2",},
{"lineNum":"  234","line":"    r->n[0] = a;","class":"lineCov","hits":"1","order":"111","possible_hits":"1",},
{"lineNum":"  235","line":"    r->n[1] = r->n[2] = r->n[3] = r->n[4] = 0;","class":"lineCov","hits":"1","order":"112","possible_hits":"1",},
...
{"lineNum":"  241","line":"}","class":"linePartCov","hits":"1","order":"113","possible_hits":"2",},
{"lineNum":"  242","line":""},
...
{"lineNum":"  250","line":"}"},
{"lineNum":"  251","line":""},
{"lineNum":"  252","line":"SECP256K1_INLINE static int secp256k1_fe_is_odd(const secp256k1_fe *a) {","class":"lineCov","hits":"2","order":"323","possible_hits":"2",},
...
{"lineNum":"  257","line":"    return a->n[0] & 1;","class":"lineCov","hits":"1","order":"324","possible_hits":"1",},
{"lineNum":"  258","line":"}"},
{"lineNum":"  259","line":""},
{"lineNum":"  260","line":"SECP256K1_INLINE static void secp256k1_fe_clear(secp256k1_fe *a) {","class":"lineCov","hits":"2","order":"64","possible_hits":"2",},
...
{"lineNum":"  266","line":"    for (i=0; i<5; i++) {","class":"lineCov","hits":"2","order":"65","possible_hits":"2",},
{"lineNum":"  267","line":"        a->n[i] = 0;","class":"lineCov","hits":"1","order":"66","possible_hits":"1",},
{"lineNum":"  268","line":"    }"},
{"lineNum":"  269","line":"}","class":"linePartCov","hits":"1","order":"67","possible_hits":"2",},
{"lineNum":"  270","line":""},
...
{"lineNum":"  288","line":"}"},
{"lineNum":"  289","line":""},
{"lineNum":"  290","line":"static int secp256k1_fe_set_b32(secp256k1_fe *r, const unsigned char *a) {","class":"lineCov","hits":"2","order":"90","possible_hits":"2",},
{"lineNum":"  291","line":"    int i;"},
{"lineNum":"  292","line":"    r->n[0] = r->n[1] = r->n[2] = r->n[3] = r->n[4] = 0;","class":"lineCov","hits":"1","order":"91","possible_hits":"1",},
{"lineNum":"  293","line":"    for (i=0; i<32; i++) {","class":"lineCov","hits":"2","order":"92","possible_hits":"2",},
{"lineNum":"  294","line":"        int j;"},
{"lineNum":"  295","line":"        for (j=0; j<2; j++) {","class":"lineCov","hits":"2","order":"93","possible_hits":"2",},
{"lineNum":"  296","line":"            int limb = (8*i+4*j)/52;","class":"lineCov","hits":"1","order":"94","possible_hits":"1",},
{"lineNum":"  297","line":"            int shift = (8*i+4*j)%52;","class":"lineCov","hits":"1","order":"95","possible_hits":"1",},
{"lineNum":"  298","line":"            r->n[limb] |= (uint64_t)((a[31-i] >> (4*j)) & 0xF) << shift;","class":"lineCov","hits":"1","order":"96","possible_hits":"1",},
{"lineNum":"  299","line":"        }"},
{"lineNum":"  300","line":"    }","class":"lineCov","hits":"1","order":"97","possible_hits":"1",},
{"lineNum":"  301","line":"    if (r->n[4] == 0x0FFFFFFFFFFFFULL && (r->n[3] & r->n[2] & r->n[1]) == 0xFFFFFFFFFFFFFULL && r->n[0] >= 0xFFFFEFFFFFC2FULL) {","class":"lineCov","hits":"1","order":"98","possible_hits":"1",},
...
{"lineNum":"  309","line":"    return 1;","class":"lineCov","hits":"1","order":"99","possible_hits":"1",},
{"lineNum":"  310","line":"}","class":"linePartCov","hits":"1","order":"100","possible_hits":"2",},
{"lineNum":"  311","line":""},
{"lineNum":"  312","line":"/** Convert a field element to a 32-byte big endian value. Requires the input to be normalized */"},
{"lineNum":"  313","line":"static void secp256k1_fe_get_b32(unsigned char *r, const secp256k1_fe *a) {","class":"lineCov","hits":"2","order":"327","possible_hits":"2",},
...
{"lineNum":"  319","line":"    for (i=0; i<32; i++) {","class":"lineCov","hits":"2","order":"328","possible_hits":"2",},
{"lineNum":"  320","line":"        int j;"},
{"lineNum":"  321","line":"        int c = 0;","class":"lineCov","hits":"1","order":"329","possible_hits":"1",},
{"lineNum":"  322","line":"        for (j=0; j<2; j++) {","class":"lineCov","hits":"2","order":"330","possible_hits":"2",},
{"lineNum":"  323","line":"            int limb = (8*i+4*j)/52;","class":"lineCov","hits":"1","order":"331","possible_hits":"1",},
{"lineNum":"  324","line":"            int shift = (8*i+4*j)%52;","class":"lineCov","hits":"1","order":"332","possible_hits":"1",},
{"lineNum":"  325","line":"            c |= ((a->n[limb] >> shift) & 0xF) << (4 * j);","class":"lineCov","hits":"1","order":"333","possible_hits":"1",},
{"lineNum":"  326","line":"        }"},
{"lineNum":"  327","line":"        r[31-i] = c;","class":"lineCov","hits":"1","order":"334","possible_hits":"1",},
{"lineNum":"  328","line":"    }"},
{"lineNum":"  329","line":"}","class":"linePartCov","hits":"1","order":"335","possible_hits":"2",},
{"lineNum":"  330","line":""},
...
{"lineNum":"  376","line":""},
{"lineNum":"  377","line":"static void secp256k1_fe_mul(secp256k1_fe *r, const secp256k1_fe *a, const secp256k1_fe * SECP256K1_RESTRICT b) {","class":"lineCov","hits":"2","order":"230","possible_hits":"2",},
...
{"lineNum":"  385","line":"    secp256k1_fe_mul_inner(r->n, a->n, b->n);","class":"lineCov","hits":"1","order":"231","possible_hits":"1",},
...
{"lineNum":"  391","line":"}","class":"linePartCov","hits":"1","order":"236","possible_hits":"2",},
{"lineNum":"  392","line":""},
{"lineNum":"  393","line":"static void secp256k1_fe_sqr(secp256k1_fe *r, const secp256k1_fe *a) {","class":"lineCov","hits":"2","order":"222","possible_hits":"2",},
...
{"lineNum":"  398","line":"    secp256k1_fe_sqr_inner(r->n, a->n);","class":"lineCov","hits":"1","order":"223","possible_hits":"1",},
...
{"lineNum":"  404","line":"}","class":"linePartCov","hits":"1","order":"228","possible_hits":"2",},
{"lineNum":"  405","line":""},
...
var header = { "command" : "aead_fuzz_debug", "date" : "2023-07-31 11:08:31", "instrumented" : 161, "covered" : 56,};
var merged_data = [];
