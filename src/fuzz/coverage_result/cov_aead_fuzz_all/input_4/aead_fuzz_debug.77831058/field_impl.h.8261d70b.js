...
{"lineNum":"  134","line":"}"},
{"lineNum":"  135","line":""},
{"lineNum":"  136","line":"static void secp256k1_fe_inv(secp256k1_fe *r, const secp256k1_fe *a) {","class":"lineCov","hits":"2","order":"220","possible_hits":"2",},
...
{"lineNum":"  143","line":"     */"},
{"lineNum":"  144","line":""},
{"lineNum":"  145","line":"    secp256k1_fe_sqr(&x2, a);","class":"lineCov","hits":"1","order":"221","possible_hits":"1",},
{"lineNum":"  146","line":"    secp256k1_fe_mul(&x2, &x2, a);","class":"lineCov","hits":"1","order":"229","possible_hits":"1",},
{"lineNum":"  147","line":""},
{"lineNum":"  148","line":"    secp256k1_fe_sqr(&x3, &x2);","class":"lineCov","hits":"1","order":"237","possible_hits":"1",},
{"lineNum":"  149","line":"    secp256k1_fe_mul(&x3, &x3, a);","class":"lineCov","hits":"1","order":"238","possible_hits":"1",},
{"lineNum":"  150","line":""},
{"lineNum":"  151","line":"    x6 = x3;","class":"lineCov","hits":"1","order":"239","possible_hits":"1",},
{"lineNum":"  152","line":"    for (j=0; j<3; j++) {","class":"lineCov","hits":"2","order":"240","possible_hits":"2",},
{"lineNum":"  153","line":"        secp256k1_fe_sqr(&x6, &x6);","class":"lineCov","hits":"1","order":"241","possible_hits":"1",},
{"lineNum":"  154","line":"    }"},
{"lineNum":"  155","line":"    secp256k1_fe_mul(&x6, &x6, &x3);","class":"lineCov","hits":"1","order":"242","possible_hits":"1",},
{"lineNum":"  156","line":""},
{"lineNum":"  157","line":"    x9 = x6;","class":"lineCov","hits":"1","order":"243","possible_hits":"1",},
{"lineNum":"  158","line":"    for (j=0; j<3; j++) {","class":"lineCov","hits":"2","order":"244","possible_hits":"2",},
{"lineNum":"  159","line":"        secp256k1_fe_sqr(&x9, &x9);","class":"lineCov","hits":"1","order":"245","possible_hits":"1",},
{"lineNum":"  160","line":"    }"},
{"lineNum":"  161","line":"    secp256k1_fe_mul(&x9, &x9, &x3);","class":"lineCov","hits":"1","order":"246","possible_hits":"1",},
{"lineNum":"  162","line":""},
{"lineNum":"  163","line":"    x11 = x9;","class":"lineCov","hits":"1","order":"247","possible_hits":"1",},
{"lineNum":"  164","line":"    for (j=0; j<2; j++) {","class":"lineCov","hits":"2","order":"248","possible_hits":"2",},
{"lineNum":"  165","line":"        secp256k1_fe_sqr(&x11, &x11);","class":"lineCov","hits":"1","order":"249","possible_hits":"1",},
{"lineNum":"  166","line":"    }"},
{"lineNum":"  167","line":"    secp256k1_fe_mul(&x11, &x11, &x2);","class":"lineCov","hits":"1","order":"250","possible_hits":"1",},
{"lineNum":"  168","line":""},
{"lineNum":"  169","line":"    x22 = x11;","class":"lineCov","hits":"1","order":"251","possible_hits":"1",},
{"lineNum":"  170","line":"    for (j=0; j<11; j++) {","class":"lineCov","hits":"2","order":"252","possible_hits":"2",},
{"lineNum":"  171","line":"        secp256k1_fe_sqr(&x22, &x22);","class":"lineCov","hits":"1","order":"253","possible_hits":"1",},
{"lineNum":"  172","line":"    }"},
{"lineNum":"  173","line":"    secp256k1_fe_mul(&x22, &x22, &x11);","class":"lineCov","hits":"1","order":"254","possible_hits":"1",},
{"lineNum":"  174","line":""},
{"lineNum":"  175","line":"    x44 = x22;","class":"lineCov","hits":"1","order":"255","possible_hits":"1",},
{"lineNum":"  176","line":"    for (j=0; j<22; j++) {","class":"lineCov","hits":"2","order":"256","possible_hits":"2",},
{"lineNum":"  177","line":"        secp256k1_fe_sqr(&x44, &x44);","class":"lineCov","hits":"1","order":"257","possible_hits":"1",},
{"lineNum":"  178","line":"    }"},
{"lineNum":"  179","line":"    secp256k1_fe_mul(&x44, &x44, &x22);","class":"lineCov","hits":"1","order":"258","possible_hits":"1",},
{"lineNum":"  180","line":""},
{"lineNum":"  181","line":"    x88 = x44;","class":"lineCov","hits":"1","order":"259","possible_hits":"1",},
{"lineNum":"  182","line":"    for (j=0; j<44; j++) {","class":"lineCov","hits":"2","order":"260","possible_hits":"2",},
{"lineNum":"  183","line":"        secp256k1_fe_sqr(&x88, &x88);","class":"lineCov","hits":"1","order":"261","possible_hits":"1",},
{"lineNum":"  184","line":"    }"},
{"lineNum":"  185","line":"    secp256k1_fe_mul(&x88, &x88, &x44);","class":"lineCov","hits":"1","order":"262","possible_hits":"1",},
{"lineNum":"  186","line":""},
{"lineNum":"  187","line":"    x176 = x88;","class":"lineCov","hits":"1","order":"263","possible_hits":"1",},
{"lineNum":"  188","line":"    for (j=0; j<88; j++) {","class":"lineCov","hits":"2","order":"264","possible_hits":"2",},
{"lineNum":"  189","line":"        secp256k1_fe_sqr(&x176, &x176);","class":"lineCov","hits":"1","order":"265","possible_hits":"1",},
{"lineNum":"  190","line":"    }"},
{"lineNum":"  191","line":"    secp256k1_fe_mul(&x176, &x176, &x88);","class":"lineCov","hits":"1","order":"266","possible_hits":"1",},
{"lineNum":"  192","line":""},
{"lineNum":"  193","line":"    x220 = x176;","class":"lineCov","hits":"1","order":"267","possible_hits":"1",},
{"lineNum":"  194","line":"    for (j=0; j<44; j++) {","class":"lineCov","hits":"2","order":"268","possible_hits":"2",},
{"lineNum":"  195","line":"        secp256k1_fe_sqr(&x220, &x220);","class":"lineCov","hits":"1","order":"269","possible_hits":"1",},
{"lineNum":"  196","line":"    }"},
{"lineNum":"  197","line":"    secp256k1_fe_mul(&x220, &x220, &x44);","class":"lineCov","hits":"1","order":"270","possible_hits":"1",},
{"lineNum":"  198","line":""},
{"lineNum":"  199","line":"    x223 = x220;","class":"lineCov","hits":"1","order":"271","possible_hits":"1",},
{"lineNum":"  200","line":"    for (j=0; j<3; j++) {","class":"lineCov","hits":"2","order":"272","possible_hits":"2",},
{"lineNum":"  201","line":"        secp256k1_fe_sqr(&x223, &x223);","class":"lineCov","hits":"1","order":"273","possible_hits":"1",},
{"lineNum":"  202","line":"    }"},
{"lineNum":"  203","line":"    secp256k1_fe_mul(&x223, &x223, &x3);","class":"lineCov","hits":"1","order":"274","possible_hits":"1",},
{"lineNum":"  204","line":""},
{"lineNum":"  205","line":"    /* The final result is then assembled using a sliding window over the blocks. */"},
{"lineNum":"  206","line":""},
{"lineNum":"  207","line":"    t1 = x223;","class":"lineCov","hits":"1","order":"275","possible_hits":"1",},
{"lineNum":"  208","line":"    for (j=0; j<23; j++) {","class":"lineCov","hits":"2","order":"276","possible_hits":"2",},
{"lineNum":"  209","line":"        secp256k1_fe_sqr(&t1, &t1);","class":"lineCov","hits":"1","order":"277","possible_hits":"1",},
{"lineNum":"  210","line":"    }"},
{"lineNum":"  211","line":"    secp256k1_fe_mul(&t1, &t1, &x22);","class":"lineCov","hits":"1","order":"278","possible_hits":"1",},
{"lineNum":"  212","line":"    for (j=0; j<5; j++) {","class":"lineCov","hits":"2","order":"279","possible_hits":"2",},
{"lineNum":"  213","line":"        secp256k1_fe_sqr(&t1, &t1);","class":"lineCov","hits":"1","order":"280","possible_hits":"1",},
{"lineNum":"  214","line":"    }"},
{"lineNum":"  215","line":"    secp256k1_fe_mul(&t1, &t1, a);","class":"lineCov","hits":"1","order":"281","possible_hits":"1",},
{"lineNum":"  216","line":"    for (j=0; j<3; j++) {","class":"lineCov","hits":"2","order":"282","possible_hits":"2",},
{"lineNum":"  217","line":"        secp256k1_fe_sqr(&t1, &t1);","class":"lineCov","hits":"1","order":"283","possible_hits":"1",},
{"lineNum":"  218","line":"    }"},
{"lineNum":"  219","line":"    secp256k1_fe_mul(&t1, &t1, &x2);","class":"lineCov","hits":"1","order":"284","possible_hits":"1",},
{"lineNum":"  220","line":"    for (j=0; j<2; j++) {","class":"lineCov","hits":"2","order":"285","possible_hits":"2",},
{"lineNum":"  221","line":"        secp256k1_fe_sqr(&t1, &t1);","class":"lineCov","hits":"1","order":"286","possible_hits":"1",},
{"lineNum":"  222","line":"    }"},
{"lineNum":"  223","line":"    secp256k1_fe_mul(r, a, &t1);","class":"lineCov","hits":"1","order":"287","possible_hits":"1",},
{"lineNum":"  224","line":"}","class":"linePartCov","hits":"1","order":"288","possible_hits":"2",},
{"lineNum":"  225","line":""},
...
var header = { "command" : "aead_fuzz_debug", "date" : "2023-07-31 11:08:19", "instrumented" : 117, "covered" : 55,};
var merged_data = [];
