...
{"lineNum":"   36","line":"      : data_ptr_(data), remaining_bytes_(size) {}","class":"lineCov","hits":"2","order":"28","possible_hits":"2",},
...
{"lineNum":"  108","line":"std::vector<T> FuzzedDataProvider::ConsumeBytes(size_t num_bytes) {","class":"lineCov","hits":"2","order":"36","possible_hits":"2",},
{"lineNum":"  109","line":"  num_bytes = std::min(num_bytes, remaining_bytes_);","class":"lineCov","hits":"1","order":"37","possible_hits":"1",},
{"lineNum":"  110","line":"  return ConsumeBytes<T>(num_bytes, num_bytes);","class":"lineCov","hits":"1","order":"38","possible_hits":"1",},
{"lineNum":"  111","line":"}"},
{"lineNum":"  112","line":""},
...
{"lineNum":"  136","line":"inline std::string FuzzedDataProvider::ConsumeBytesAsString(size_t num_bytes) {","class":"lineCov","hits":"2","order":"119","possible_hits":"2",},
...
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"  num_bytes = std::min(num_bytes, remaining_bytes_);","class":"lineCov","hits":"1","order":"120","possible_hits":"1",},
{"lineNum":"  141","line":"  std::string result(","class":"linePartCov","hits":"2","order":"121","possible_hits":"5",},
{"lineNum":"  142","line":"      reinterpret_cast<const std::string::value_type *>(data_ptr_), num_bytes);","class":"lineCov","hits":"1","order":"122","possible_hits":"1",},
{"lineNum":"  143","line":"  Advance(num_bytes);","class":"lineCov","hits":"1","order":"123","possible_hits":"1",},
{"lineNum":"  144","line":"  return result;","class":"lineCov","hits":"1","order":"124","possible_hits":"1",},
{"lineNum":"  145","line":"}","class":"linePartCov","hits":"1","order":"125","possible_hits":"2",},
{"lineNum":"  146","line":""},
...
{"lineNum":"  194","line":"template <typename T> T FuzzedDataProvider::ConsumeIntegral() {","class":"linePartCov","hits":"2","order":"127","possible_hits":"4",},
{"lineNum":"  195","line":"  return ConsumeIntegralInRange(std::numeric_limits<T>::min(),","class":"linePartCov","hits":"2","order":"128","possible_hits":"4",},
{"lineNum":"  196","line":"                                std::numeric_limits<T>::max());","class":"linePartCov","hits":"1","order":"129","possible_hits":"2",},
{"lineNum":"  197","line":"}"},
{"lineNum":"  198","line":""},
...
{"lineNum":"  204","line":"T FuzzedDataProvider::ConsumeIntegralInRange(T min, T max) {","class":"linePartCov","hits":"2","order":"130","possible_hits":"4",},
...
{"lineNum":"  207","line":""},
{"lineNum":"  208","line":"  if (min > max)","class":"linePartCov","hits":"1","order":"131","possible_hits":"2",},
...
{"lineNum":"  212","line":"  uint64_t range = static_cast<uint64_t>(max) - min;","class":"linePartCov","hits":"1","order":"132","possible_hits":"2",},
{"lineNum":"  213","line":"  uint64_t result = 0;","class":"linePartCov","hits":"1","order":"133","possible_hits":"2",},
{"lineNum":"  214","line":"  size_t offset = 0;","class":"linePartCov","hits":"1","order":"134","possible_hits":"2",},
{"lineNum":"  215","line":""},
{"lineNum":"  216","line":"  while (offset < sizeof(T) * CHAR_BIT && (range >> offset) > 0 &&","class":"linePartCov","hits":"2","order":"135","possible_hits":"6",},
{"lineNum":"  217","line":"         remaining_bytes_ != 0) {","class":"linePartCov","hits":"1","order":"136","possible_hits":"2",},
...
{"lineNum":"  224","line":"    --remaining_bytes_;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  225","line":"    result = (result << CHAR_BIT) | data_ptr_[remaining_bytes_];","class":"lineNoCov","hits":"0","possible_hits":"2",},
...
{"lineNum":"  230","line":"  if (range != std::numeric_limits<decltype(range)>::max())","class":"linePartCov","hits":"1","order":"137","possible_hits":"2",},
{"lineNum":"  231","line":"    result = result % (range + 1);","class":"linePartCov","hits":"1","order":"138","possible_hits":"2",},
{"lineNum":"  232","line":""},
{"lineNum":"  233","line":"  return static_cast<T>(min + result);","class":"linePartCov","hits":"1","order":"139","possible_hits":"2",},
{"lineNum":"  234","line":"}"},
{"lineNum":"  235","line":""},
...
{"lineNum":"  338","line":"                                               size_t num_bytes) {","class":"lineCov","hits":"2","order":"43","possible_hits":"2",},
{"lineNum":"  339","line":"  std::memcpy(destination, data_ptr_, num_bytes);","class":"lineCov","hits":"1","order":"44","possible_hits":"1",},
{"lineNum":"  340","line":"  Advance(num_bytes);","class":"lineCov","hits":"1","order":"45","possible_hits":"1",},
{"lineNum":"  341","line":"}","class":"lineCov","hits":"2","order":"51","possible_hits":"2",},
{"lineNum":"  342","line":""},
{"lineNum":"  343","line":"inline void FuzzedDataProvider::Advance(size_t num_bytes) {","class":"lineCov","hits":"2","order":"46","possible_hits":"2",},
{"lineNum":"  344","line":"  if (num_bytes > remaining_bytes_)","class":"lineCov","hits":"1","order":"47","possible_hits":"1",},
{"lineNum":"  345","line":"    abort();","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  346","line":""},
{"lineNum":"  347","line":"  data_ptr_ += num_bytes;","class":"lineCov","hits":"1","order":"48","possible_hits":"1",},
{"lineNum":"  348","line":"  remaining_bytes_ -= num_bytes;","class":"lineCov","hits":"1","order":"49","possible_hits":"1",},
{"lineNum":"  349","line":"}","class":"linePartCov","hits":"1","order":"50","possible_hits":"2",},
{"lineNum":"  350","line":""},
{"lineNum":"  351","line":"template <typename T>"},
{"lineNum":"  352","line":"std::vector<T> FuzzedDataProvider::ConsumeBytes(size_t size, size_t num_bytes) {","class":"lineCov","hits":"2","order":"39","possible_hits":"2",},
...
{"lineNum":"  361","line":"  std::vector<T> result(size);","class":"linePartCov","hits":"1","order":"40","possible_hits":"4",},
{"lineNum":"  362","line":"  if (size == 0) {","class":"lineCov","hits":"1","order":"41","possible_hits":"1",},
...
{"lineNum":"  366","line":"  }"},
{"lineNum":"  367","line":""},
{"lineNum":"  368","line":"  CopyAndAdvance(result.data(), num_bytes);","class":"lineCov","hits":"1","order":"42","possible_hits":"1",},
{"lineNum":"  369","line":""},
...
{"lineNum":"  373","line":"  result.shrink_to_fit();","class":"lineCov","hits":"1","order":"52","possible_hits":"1",},
{"lineNum":"  374","line":"  return result;","class":"lineCov","hits":"1","order":"53","possible_hits":"1",},
...
var header = { "command" : "aead_fuzz_debug", "date" : "2023-07-31 11:08:47", "instrumented" : 48, "covered" : 39,};
var merged_data = [];
