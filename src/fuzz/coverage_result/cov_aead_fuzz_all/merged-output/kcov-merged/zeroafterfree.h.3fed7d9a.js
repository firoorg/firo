...
{"lineNum":"   25","line":"    zero_after_free_allocator() throw() {}","class":"lineCov","hits":"1","order":"339",},
{"lineNum":"   26","line":"    zero_after_free_allocator(const zero_after_free_allocator& a) throw() : base(a) {}","class":"lineCov","hits":"1","order":"336",},
...
{"lineNum":"   29","line":"    {"},
{"lineNum":"   30","line":"    }"},
{"lineNum":"   31","line":"    ~zero_after_free_allocator() throw() {}","class":"lineCov","hits":"1","order":"332",},
...
{"lineNum":"   38","line":"    {","class":"lineCov","hits":"1","order":"338",},
{"lineNum":"   39","line":"        if (p != NULL)","class":"lineCov","hits":"1","order":"337",},
{"lineNum":"   40","line":"            memory_cleanse(p, sizeof(T) * n);","class":"lineCov","hits":"1","order":"335",},
{"lineNum":"   41","line":"        std::allocator<T>::deallocate(p, n);","class":"lineCov","hits":"1","order":"334",},
{"lineNum":"   42","line":"    }","class":"lineCov","hits":"1","order":"333",},
{"lineNum":"   43","line":"};"},
{"lineNum":"   44","line":""},
