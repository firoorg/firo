...
{"lineNum":"   28","line":"{","class":"lineCov","hits":"2","order":"214","possible_hits":"2",},
{"lineNum":"   29","line":"    secp256k1_ge ge;"},
{"lineNum":"   30","line":"    secp256k1_gej j(gej);","class":"lineCov","hits":"1","order":"215","possible_hits":"1",},
{"lineNum":"   31","line":"    secp256k1_ge_set_gej(&ge, &j);","class":"lineCov","hits":"1","order":"216","possible_hits":"1",},
{"lineNum":"   32","line":"    return ge;","class":"linePartCov","hits":"1","order":"297","possible_hits":"2",},
{"lineNum":"   33","line":"}"},
{"lineNum":"   34","line":""},
...
{"lineNum":"  112","line":"{","class":"linePartCov","hits":"2","order":"79","possible_hits":"4",},
{"lineNum":"  113","line":"    memset(dst, 0, sizeof(Value) * Len);","class":"linePartCov","hits":"1","order":"80","possible_hits":"2",},
{"lineNum":"  114","line":""},
{"lineNum":"  115","line":"    int resLen = 0;","class":"linePartCov","hits":"1","order":"81","possible_hits":"2",},
{"lineNum":"  116","line":"    for (auto iter = begin; iter != end; iter++) {","class":"linePartCov","hits":"1","order":"82","possible_hits":"4",},
...
{"lineNum":"  133","line":""},
{"lineNum":"  134","line":"    for (int i = 0; i < Len / 2; i++) {","class":"linePartCov","hits":"2","order":"83","possible_hits":"4",},
{"lineNum":"  135","line":"        unsigned char tmp = dst[i];","class":"linePartCov","hits":"1","order":"84","possible_hits":"2",},
{"lineNum":"  136","line":"        dst[i] = dst[Len - i - 1];","class":"linePartCov","hits":"1","order":"85","possible_hits":"2",},
{"lineNum":"  137","line":"        dst[Len - i - 1] = tmp;","class":"linePartCov","hits":"1","order":"86","possible_hits":"2",},
{"lineNum":"  138","line":"    }"},
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"    return resLen;","class":"linePartCov","hits":"1","order":"87","possible_hits":"2",},
...
{"lineNum":"  163","line":"        : g_(new secp256k1_gej())","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  164","line":"{","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  165","line":"    auto g = reinterpret_cast<secp256k1_gej *>(g_);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  166","line":"    secp256k1_gej_clear(g);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  167","line":"    g->infinity = 1;","class":"lineNoCov","hits":"0","possible_hits":"1",},
...
{"lineNum":"  176","line":"        : g_(new secp256k1_gej(*reinterpret_cast<const secp256k1_gej *>(g)))","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  177","line":"{","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  178","line":"}","class":"linePartCov","hits":"1","order":"56","possible_hits":"2",},
{"lineNum":"  179","line":""},
{"lineNum":"  180","line":"static void _convertToFieldElement(secp256k1_fe *r, const char* str, int base) {","class":"lineCov","hits":"2","order":"72","possible_hits":"2",},
{"lineNum":"  181","line":"    uint8_t buffer[32];"},
{"lineNum":"  182","line":"    auto negative = *str == \'-\';","class":"lineCov","hits":"1","order":"73","possible_hits":"1",},
{"lineNum":"  183","line":"    if (negative) {","class":"lineCov","hits":"1","order":"74","possible_hits":"1",},
{"lineNum":"  184","line":"        str++;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  185","line":"    }"},
{"lineNum":"  186","line":""},
{"lineNum":"  187","line":"    auto strLen = strlen(str);","class":"lineCov","hits":"1","order":"75","possible_hits":"1",},
{"lineNum":"  188","line":"    std::vector<uint8_t> src(strLen, 0);","class":"linePartCov","hits":"2","order":"76","possible_hits":"4",},
{"lineNum":"  189","line":""},
{"lineNum":"  190","line":"    for (int i = 0; i < strLen; i++) {","class":"linePartCov","hits":"1","order":"77","possible_hits":"2",},
...
{"lineNum":"  218","line":""},
{"lineNum":"  219","line":"    _convertBase(src.begin(), src.end(), base, buffer, 256);","class":"lineCov","hits":"1","order":"78","possible_hits":"1",},
{"lineNum":"  220","line":"    if (negative) {","class":"lineCov","hits":"1","order":"88","possible_hits":"1",},
...
{"lineNum":"  223","line":""},
{"lineNum":"  224","line":"    secp256k1_fe_set_b32(r, buffer);","class":"lineCov","hits":"1","order":"89","possible_hits":"1",},
{"lineNum":"  225","line":"}","class":"linePartCov","hits":"1","order":"101","possible_hits":"5",},
{"lineNum":"  226","line":""},
{"lineNum":"  227","line":"GroupElement::GroupElement(const char* x,const char* y, int base)"},
{"lineNum":"  228","line":"        : g_(new secp256k1_gej())","class":"lineCov","hits":"1","order":"58","possible_hits":"1",},
{"lineNum":"  229","line":"{","class":"lineCov","hits":"2","order":"57","possible_hits":"2",},
{"lineNum":"  230","line":"    auto g = reinterpret_cast<secp256k1_gej *>(g_);","class":"lineCov","hits":"1","order":"59","possible_hits":"1",},
{"lineNum":"  231","line":""},
{"lineNum":"  232","line":"    secp256k1_gej_clear(g);","class":"lineCov","hits":"1","order":"60","possible_hits":"1",},
{"lineNum":"  233","line":"    secp256k1_ge element;"},
{"lineNum":"  234","line":"    _convertToFieldElement(&element.x,x,base);","class":"lineCov","hits":"1","order":"71","possible_hits":"1",},
{"lineNum":"  235","line":"    _convertToFieldElement(&element.y,y,base);","class":"lineCov","hits":"1","order":"102","possible_hits":"1",},
{"lineNum":"  236","line":"    element.infinity = 0;","class":"lineCov","hits":"1","order":"103","possible_hits":"1",},
{"lineNum":"  237","line":"    secp256k1_gej_set_ge(g,&element);","class":"lineCov","hits":"1","order":"104","possible_hits":"1",},
{"lineNum":"  238","line":"}","class":"linePartCov","hits":"1","order":"115","possible_hits":"2",},
{"lineNum":"  239","line":""},
{"lineNum":"  240","line":"GroupElement::~GroupElement()"},
{"lineNum":"  241","line":"{","class":"lineCov","hits":"2","order":"428","possible_hits":"2",},
{"lineNum":"  242","line":"    delete reinterpret_cast<secp256k1_gej *>(g_);","class":"lineCov","hits":"1","order":"429","possible_hits":"1",},
{"lineNum":"  243","line":"}","class":"linePartCov","hits":"1","order":"430","possible_hits":"2",},
{"lineNum":"  244","line":""},
...
{"lineNum":"  247","line":"    return set(other);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  248","line":"}"},
{"lineNum":"  249","line":""},
...
{"lineNum":"  252","line":"    *reinterpret_cast<secp256k1_gej *>(g_) = *reinterpret_cast<secp256k1_gej *>(other.g_);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  253","line":"    return *this;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  254","line":"}"},
{"lineNum":"  255","line":""},
...
{"lineNum":"  260","line":"    secp256k1_scalar_set_int(&ng,0);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  261","line":"    secp256k1_ecmult(&ctx,&result,reinterpret_cast<secp256k1_gej *>(g_), reinterpret_cast<const secp256k1_scalar *>(multiplier.get_value()),&ng);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  262","line":"    return &result;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  263","line":"}"},
{"lineNum":"  264","line":""},
...
{"lineNum":"  303","line":"    auto g = reinterpret_cast<secp256k1_gej *>(g_);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  304","line":"    auto og = reinterpret_cast<secp256k1_gej *>(other.g_);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  305","line":""},
{"lineNum":"  306","line":"    if(g->infinity && og->infinity)","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  307","line":"        return true;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  308","line":"    if(g->infinity != og->infinity)","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  309","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  310","line":"    secp256k1_ge this_ge = gej_to_ge(*g);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  311","line":"    secp256k1_ge other_ge = gej_to_ge(*og);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  312","line":"    if(!secp256k1_fe_equal(&this_ge.x, &other_ge.x))","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  313","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  314","line":"    if(!secp256k1_fe_equal(&this_ge.y, &other_ge.y))","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  315","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  316","line":""},
{"lineNum":"  317","line":"    return true;","class":"lineNoCov","hits":"0","possible_hits":"1",},
...
{"lineNum":"  327","line":"    secp256k1_ge v1 = gej_to_ge(*reinterpret_cast<secp256k1_gej *>(g_));","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  328","line":"    if (secp256k1_ge_is_infinity(&v1)) {","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  329","line":"        return true;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  330","line":"    }"},
{"lineNum":"  331","line":"    return secp256k1_ge_is_valid_var(&v1);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  332","line":"}","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  333","line":""},
...
{"lineNum":"  506","line":"}"},
{"lineNum":"  507","line":""},
{"lineNum":"  508","line":"unsigned char* GroupElement::serialize(unsigned char* buffer) const {","class":"lineCov","hits":"2","order":"212","possible_hits":"2",},
{"lineNum":"  509","line":"    secp256k1_ge value = gej_to_ge(*reinterpret_cast<secp256k1_gej *>(g_));","class":"lineCov","hits":"1","order":"213","possible_hits":"1",},
{"lineNum":"  510","line":"    secp256k1_fe x = value.x;","class":"lineCov","hits":"1","order":"298","possible_hits":"1",},
{"lineNum":"  511","line":"    secp256k1_fe y = value.y;","class":"lineCov","hits":"1","order":"299","possible_hits":"1",},
{"lineNum":"  512","line":"    secp256k1_fe_normalize(&x);","class":"lineCov","hits":"1","order":"300","possible_hits":"1",},
{"lineNum":"  513","line":"    secp256k1_fe_normalize(&y);","class":"lineCov","hits":"1","order":"321","possible_hits":"1",},
{"lineNum":"  514","line":"    unsigned char oddness = secp256k1_fe_is_odd(&y);","class":"lineCov","hits":"1","order":"322","possible_hits":"1",},
{"lineNum":"  515","line":"    unsigned char infinity = value.infinity;","class":"lineCov","hits":"1","order":"325","possible_hits":"1",},
{"lineNum":"  516","line":"    secp256k1_fe_get_b32(buffer, &x);","class":"lineCov","hits":"1","order":"326","possible_hits":"1",},
{"lineNum":"  517","line":"    buffer[32] = oddness;","class":"lineCov","hits":"1","order":"336","possible_hits":"1",},
{"lineNum":"  518","line":"    buffer[33] = infinity;","class":"lineCov","hits":"1","order":"337","possible_hits":"1",},
{"lineNum":"  519","line":"    return buffer + memoryRequired();","class":"lineCov","hits":"1","order":"338","possible_hits":"1",},
{"lineNum":"  520","line":"}"},
{"lineNum":"  521","line":""},
...
var header = { "command" : "aead_fuzz_debug", "date" : "2023-07-31 11:08:24", "instrumented" : 343, "covered" : 48,};
var merged_data = [];
