...
{"lineNum":"  145","line":" */"},
{"lineNum":"  146","line":"class CDataStream","class":"linePartCov","hits":"2","order":"887","possible_hits":"6",},
{"lineNum":"  147","line":"{"},
...
{"lineNum":"  166","line":""},
{"lineNum":"  167","line":"    explicit CDataStream(int nTypeIn, int nVersionIn)","class":"lineCov","hits":"1","order":"862","possible_hits":"1",},
{"lineNum":"  168","line":"    {","class":"lineCov","hits":"2","order":"861","possible_hits":"2",},
{"lineNum":"  169","line":"        Init(nTypeIn, nVersionIn);","class":"lineCov","hits":"1","order":"864","possible_hits":"1",},
{"lineNum":"  170","line":"    }","class":"lineCov","hits":"1","order":"870","possible_hits":"1",},
{"lineNum":"  171","line":""},
...
{"lineNum":"  205","line":"    {","class":"lineCov","hits":"2","order":"865","possible_hits":"2",},
{"lineNum":"  206","line":"        nReadPos = 0;","class":"lineCov","hits":"1","order":"866","possible_hits":"1",},
{"lineNum":"  207","line":"        nType = nTypeIn;","class":"lineCov","hits":"1","order":"867","possible_hits":"1",},
{"lineNum":"  208","line":"        nVersion = nVersionIn;","class":"lineCov","hits":"1","order":"868","possible_hits":"1",},
{"lineNum":"  209","line":"    }","class":"linePartCov","hits":"1","order":"869","possible_hits":"2",},
{"lineNum":"  210","line":""},
...
{"lineNum":"  237","line":"    size_type size() const                           { return vch.size() - nReadPos; }","class":"lineCov","hits":"2","order":"885","possible_hits":"2",},
{"lineNum":"  238","line":"    bool empty() const                               { return vch.size() == nReadPos; }"},
{"lineNum":"  239","line":"    void resize(size_type n, value_type c=0)         { vch.resize(n + nReadPos, c); }","class":"lineNoCov","hits":"0","possible_hits":"2",},
...
{"lineNum":"  246","line":"    value_type* data()                               { return vch.data() + nReadPos; }","class":"lineCov","hits":"2","order":"884","possible_hits":"2",},
...
{"lineNum":"  343","line":"    {","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  344","line":"        if (nSize == 0) return;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  345","line":""},
{"lineNum":"  346","line":"        // Read from the beginning of the buffer"},
{"lineNum":"  347","line":"        unsigned int nReadPosNext = nReadPos + nSize;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  348","line":"        if (nReadPosNext >= vch.size())","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  349","line":"        {"},
{"lineNum":"  350","line":"            if (nReadPosNext > vch.size())","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  351","line":"            {"},
{"lineNum":"  352","line":"                throw std::ios_base::failure(\"CDataStream::read(): end of data\");","class":"lineNoCov","hits":"0","possible_hits":"4",},
{"lineNum":"  353","line":"            }"},
{"lineNum":"  354","line":"            memcpy(pch, &vch[nReadPos], nSize);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  355","line":"            nReadPos = 0;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  356","line":"            vch.clear();","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  357","line":"            return;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  358","line":"        }"},
{"lineNum":"  359","line":"        memcpy(pch, &vch[nReadPos], nSize);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  360","line":"        nReadPos = nReadPosNext;","class":"lineNoCov","hits":"0","possible_hits":"1",},
...
{"lineNum":"  382","line":"    {","class":"lineCov","hits":"2","order":"878","possible_hits":"2",},
{"lineNum":"  383","line":"        // Write to the end of the buffer"},
{"lineNum":"  384","line":"        vch.insert(vch.end(), pch, pch + nSize);","class":"lineCov","hits":"1","order":"879","possible_hits":"1",},
{"lineNum":"  385","line":"    }","class":"linePartCov","hits":"1","order":"880","possible_hits":"2",},
{"lineNum":"  386","line":""},
...
{"lineNum":"  397","line":"    {","class":"linePartCov","hits":"10","order":"872","possible_hits":"20",},
{"lineNum":"  398","line":"        // Serialize to this stream"},
{"lineNum":"  399","line":"        ::Serialize(*this, obj);","class":"linePartCov","hits":"5","order":"873","possible_hits":"10",},
{"lineNum":"  400","line":"        return (*this);","class":"linePartCov","hits":"9","order":"882","possible_hits":"20",},
{"lineNum":"  401","line":"    }"},
{"lineNum":"  402","line":""},
{"lineNum":"  403","line":"    template<typename T>"},
{"lineNum":"  404","line":"    CDataStream& operator>>(T& obj)"},
{"lineNum":"  405","line":"    {","class":"lineNoCov","hits":"0","possible_hits":"10",},
{"lineNum":"  406","line":"        // Unserialize from this stream"},
{"lineNum":"  407","line":"        ::Unserialize(*this, obj);","class":"lineNoCov","hits":"0","possible_hits":"5",},
{"lineNum":"  408","line":"        return (*this);","class":"linePartCov","hits":"1","order":"84","possible_hits":"10",},
{"lineNum":"  409","line":"    }"},
{"lineNum":"  410","line":""},
...
var header = { "command" : "mint_transaction_debug", "date" : "2023-08-28 11:27:29", "instrumented" : 37, "covered" : 19,};
var merged_data = [];
