...
{"lineNum":"    7","line":""},
{"lineNum":"    8","line":"SpendKey::SpendKey(const Params* params) {","class":"lineCov","hits":"2","order":"466","possible_hits":"2",},
{"lineNum":"    9","line":"\tthis->params = params;","class":"lineCov","hits":"1","order":"476","possible_hits":"1",},
{"lineNum":"   10","line":"\tthis->s1.randomize();","class":"lineCov","hits":"1","order":"477","possible_hits":"1",},
{"lineNum":"   11","line":"\tthis->s2.randomize();","class":"lineCov","hits":"1","order":"561","possible_hits":"1",},
{"lineNum":"   12","line":"\tthis->r.randomize();","class":"lineCov","hits":"1","order":"562","possible_hits":"1",},
{"lineNum":"   13","line":"}","class":"lineCov","hits":"1","order":"563","possible_hits":"1",},
{"lineNum":"   14","line":""},
...
{"lineNum":"   41","line":""},
{"lineNum":"   42","line":"const Params* SpendKey::get_params() const {","class":"lineCov","hits":"2","order":"567","possible_hits":"2",},
{"lineNum":"   43","line":"\treturn this->params;","class":"lineCov","hits":"1","order":"568","possible_hits":"1",},
{"lineNum":"   44","line":"}"},
{"lineNum":"   45","line":""},
{"lineNum":"   46","line":"const Scalar& SpendKey::get_s1() const {","class":"lineCov","hits":"2","order":"570","possible_hits":"2",},
{"lineNum":"   47","line":"\treturn this->s1;","class":"lineCov","hits":"1","order":"571","possible_hits":"1",},
{"lineNum":"   48","line":"}"},
{"lineNum":"   49","line":""},
{"lineNum":"   50","line":"const Scalar& SpendKey::get_s2() const {","class":"lineCov","hits":"2","order":"578","possible_hits":"2",},
{"lineNum":"   51","line":"\treturn this->s2;","class":"lineCov","hits":"1","order":"579","possible_hits":"1",},
{"lineNum":"   52","line":"}"},
{"lineNum":"   53","line":""},
{"lineNum":"   54","line":"const Scalar& SpendKey::get_r() const {","class":"lineCov","hits":"2","order":"584","possible_hits":"2",},
{"lineNum":"   55","line":"\treturn this->r;","class":"lineCov","hits":"1","order":"585","possible_hits":"1",},
{"lineNum":"   56","line":"}"},
{"lineNum":"   57","line":""},
...
{"lineNum":"   77","line":"FullViewKey::FullViewKey(const SpendKey& spend_key) {","class":"lineCov","hits":"2","order":"565","possible_hits":"2",},
{"lineNum":"   78","line":"\tthis->params = spend_key.get_params();","class":"lineCov","hits":"1","order":"566","possible_hits":"1",},
{"lineNum":"   79","line":"\tthis->s1 = spend_key.get_s1();","class":"lineCov","hits":"1","order":"569","possible_hits":"1",},
{"lineNum":"   80","line":"\tthis->s2 = spend_key.get_s2();","class":"lineCov","hits":"1","order":"577","possible_hits":"1",},
{"lineNum":"   81","line":"\tthis->D = this->params->get_G()*spend_key.get_r();","class":"linePartCov","hits":"1","order":"580","possible_hits":"2",},
{"lineNum":"   82","line":"\tthis->P2 = this->params->get_F()*this->s2 + this->D;","class":"linePartCov","hits":"1","order":"784","possible_hits":"2",},
...
{"lineNum":"  116","line":""},
{"lineNum":"  117","line":"const Params* IncomingViewKey::get_params() const {","class":"lineCov","hits":"2","order":"942","possible_hits":"2",},
{"lineNum":"  118","line":"\treturn this->params;","class":"lineCov","hits":"1","order":"943","possible_hits":"1",},
{"lineNum":"  119","line":"}"},
{"lineNum":"  120","line":""},
{"lineNum":"  121","line":"const Scalar& IncomingViewKey::get_s1() const {","class":"lineCov","hits":"2","order":"848","possible_hits":"2",},
{"lineNum":"  122","line":"\treturn this->s1;","class":"lineCov","hits":"1","order":"849","possible_hits":"1",},
{"lineNum":"  123","line":"}"},
{"lineNum":"  124","line":""},
{"lineNum":"  125","line":"const GroupElement& IncomingViewKey::get_P2() const {","class":"lineCov","hits":"2","order":"1346","possible_hits":"2",},
{"lineNum":"  126","line":"\treturn this->P2;","class":"lineCov","hits":"1","order":"1347","possible_hits":"1",},
{"lineNum":"  127","line":"}"},
{"lineNum":"  128","line":""},
...
{"lineNum":"  141","line":""},
{"lineNum":"  142","line":"Address::Address() {}","class":"lineCov","hits":"3","order":"843","possible_hits":"3",},
{"lineNum":"  143","line":""},
...
{"lineNum":"  147","line":""},
{"lineNum":"  148","line":"Address::Address(const IncomingViewKey& incoming_view_key, const uint64_t i) {","class":"lineCov","hits":"3","order":"846","possible_hits":"3",},
{"lineNum":"  149","line":"\t// Encrypt the diversifier"},
{"lineNum":"  150","line":"\tstd::vector<unsigned char> key = SparkUtils::kdf_diversifier(incoming_view_key.get_s1());","class":"lineCov","hits":"1","order":"847","possible_hits":"1",},
{"lineNum":"  151","line":"\tthis->params = incoming_view_key.get_params();","class":"lineCov","hits":"1","order":"941","possible_hits":"1",},
{"lineNum":"  152","line":"\tthis->d = SparkUtils::diversifier_encrypt(key, i);","class":"lineCov","hits":"1","order":"944","possible_hits":"1",},
{"lineNum":"  153","line":"\tthis->Q1 = SparkUtils::hash_div(this->d)*incoming_view_key.get_s1();","class":"linePartCov","hits":"1","order":"1222","possible_hits":"2",},
{"lineNum":"  154","line":"\tthis->Q2 = this->params->get_F()*SparkUtils::hash_Q2(incoming_view_key.get_s1(), i) + incoming_view_key.get_P2();","class":"linePartCov","hits":"1","order":"1296","possible_hits":"2",},
{"lineNum":"  155","line":"}","class":"linePartCov","hits":"1","order":"1348","possible_hits":"3",},
{"lineNum":"  156","line":""},
...
{"lineNum":"  159","line":"}"},
{"lineNum":"  160","line":""},
{"lineNum":"  161","line":"const std::vector<unsigned char>& Address::get_d() const {","class":"lineCov","hits":"2","order":"1411","possible_hits":"2",},
{"lineNum":"  162","line":"\treturn this->d;","class":"lineCov","hits":"1","order":"1412","possible_hits":"1",},
{"lineNum":"  163","line":"}"},
{"lineNum":"  164","line":""},
{"lineNum":"  165","line":"const GroupElement& Address::get_Q1() const {","class":"lineCov","hits":"2","order":"1470","possible_hits":"2",},
{"lineNum":"  166","line":"\treturn this->Q1;","class":"lineCov","hits":"1","order":"1471","possible_hits":"1",},
{"lineNum":"  167","line":"}"},
{"lineNum":"  168","line":""},
{"lineNum":"  169","line":"const GroupElement& Address::get_Q2() const {","class":"lineCov","hits":"2","order":"1429","possible_hits":"2",},
{"lineNum":"  170","line":"\treturn this->Q2;","class":"lineCov","hits":"1","order":"1430","possible_hits":"1",},
{"lineNum":"  171","line":"}"},
{"lineNum":"  172","line":""},
...
var header = { "command" : "mint_transaction_debug", "date" : "2023-08-28 11:27:29", "instrumented" : 188, "covered" : 52,};
var merged_data = [];
