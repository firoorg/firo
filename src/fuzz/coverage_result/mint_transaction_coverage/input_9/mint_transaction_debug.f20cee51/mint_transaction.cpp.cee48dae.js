...
{"lineNum":"    8","line":""},
{"lineNum":"    9","line":"MintTransaction::MintTransaction(","class":"lineCov","hits":"1","order":"1383","possible_hits":"1",},
...
{"lineNum":"   14","line":") {","class":"lineCov","hits":"2","order":"1382","possible_hits":"2",},
...
{"lineNum":"   17","line":""},
{"lineNum":"   18","line":"\tthis->params = params;","class":"lineCov","hits":"1","order":"1385","possible_hits":"1",},
{"lineNum":"   19","line":"\tSchnorr schnorr(this->params->get_H());","class":"lineCov","hits":"1","order":"1386","possible_hits":"1",},
{"lineNum":"   20","line":""},
{"lineNum":"   21","line":"\tstd::vector<GroupElement> value_statement;","class":"lineCov","hits":"1","order":"1391","possible_hits":"1",},
{"lineNum":"   22","line":"\tstd::vector<Scalar> value_witness;","class":"lineCov","hits":"1","order":"1392","possible_hits":"1",},
{"lineNum":"   23","line":""},
{"lineNum":"   24","line":"\tfor (std::size_t j = 0; j < outputs.size(); j++) {","class":"lineCov","hits":"2","order":"1393","possible_hits":"2",},
{"lineNum":"   25","line":"        if (generate) {","class":"lineCov","hits":"1","order":"1394","possible_hits":"1",},
{"lineNum":"   26","line":"            MintedCoinData output = outputs[j];","class":"lineCov","hits":"1","order":"1395","possible_hits":"1",},
{"lineNum":"   27","line":""},
{"lineNum":"   28","line":"            // Generate the coin"},
{"lineNum":"   29","line":"            Scalar k;","class":"lineCov","hits":"1","order":"1396","possible_hits":"1",},
{"lineNum":"   30","line":"            k.randomize();","class":"lineCov","hits":"1","order":"1397","possible_hits":"1",},
{"lineNum":"   31","line":"            this->coins.emplace_back(Coin(","class":"linePartCov","hits":"2","order":"1398","possible_hits":"3",},
{"lineNum":"   32","line":"                this->params,","class":"lineCov","hits":"1","order":"1399","possible_hits":"1",},
{"lineNum":"   33","line":"                COIN_TYPE_MINT,"},
{"lineNum":"   34","line":"                k,"},
{"lineNum":"   35","line":"                output.address,"},
{"lineNum":"   36","line":"                output.v,","class":"lineCov","hits":"1","order":"1400","possible_hits":"1",},
{"lineNum":"   37","line":"                output.memo,","class":"lineCov","hits":"1","order":"1401","possible_hits":"1",},
{"lineNum":"   38","line":"                serial_context","class":"lineCov","hits":"1","order":"1402","possible_hits":"1",},
{"lineNum":"   39","line":"            ));"},
{"lineNum":"   40","line":""},
{"lineNum":"   41","line":"            // Prepare the value proof"},
{"lineNum":"   42","line":"            value_statement.emplace_back(this->coins[j].C + this->params->get_G().inverse()*Scalar(this->coins[j].v));","class":"linePartCov","hits":"1","order":"1555","possible_hits":"2",},
{"lineNum":"   43","line":"            value_witness.emplace_back(SparkUtils::hash_val(k));","class":"linePartCov","hits":"1","order":"1567","possible_hits":"2",},
{"lineNum":"   44","line":"        } else {","class":"linePartCov","hits":"1","order":"1568","possible_hits":"2",},
...
{"lineNum":"   53","line":"\t}","class":"lineCov","hits":"1","order":"1569","possible_hits":"1",},
{"lineNum":"   54","line":""},
{"lineNum":"   55","line":"\t// Complete the value proof"},
{"lineNum":"   56","line":"    if (generate)","class":"lineCov","hits":"1","order":"1570","possible_hits":"1",},
{"lineNum":"   57","line":"\t    schnorr.prove(value_witness, value_statement, this->value_proof);","class":"lineCov","hits":"1","order":"1571","possible_hits":"1",},
{"lineNum":"   58","line":"    else"},
{"lineNum":"   59","line":"        value_proof = SchnorrProof();","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   60","line":"}","class":"linePartCov","hits":"1","order":"1717","possible_hits":"6",},
{"lineNum":"   61","line":""},
{"lineNum":"   62","line":"bool MintTransaction::verify() {","class":"lineCov","hits":"2","order":"1719","possible_hits":"2",},
{"lineNum":"   63","line":"\t// Verify the value proof"},
{"lineNum":"   64","line":"\tSchnorr schnorr(this->params->get_H());","class":"lineCov","hits":"1","order":"1720","possible_hits":"1",},
{"lineNum":"   65","line":"\tstd::vector<GroupElement> value_statement;","class":"lineCov","hits":"1","order":"1721","possible_hits":"1",},
{"lineNum":"   66","line":""},
{"lineNum":"   67","line":"\tfor (std::size_t j = 0; j < this->coins.size(); j++) {","class":"lineCov","hits":"2","order":"1722","possible_hits":"2",},
{"lineNum":"   68","line":"\t\tvalue_statement.emplace_back(this->coins[j].C + this->params->get_G().inverse()*Scalar(this->coins[j].v));","class":"linePartCov","hits":"1","order":"1723","possible_hits":"2",},
{"lineNum":"   69","line":"\t}"},
{"lineNum":"   70","line":""},
{"lineNum":"   71","line":"\treturn schnorr.verify(value_statement, this->value_proof);","class":"lineCov","hits":"1","order":"1724","possible_hits":"1",},
{"lineNum":"   72","line":"}","class":"linePartCov","hits":"1","order":"1912","possible_hits":"2",},
{"lineNum":"   73","line":""},
...
var header = { "command" : "mint_transaction_debug", "date" : "2023-08-28 11:27:29", "instrumented" : 74, "covered" : 30,};
var merged_data = [];
