...
{"lineNum":"   25","line":"    zero_after_free_allocator() throw() {}","class":"lineCov","hits":"1","order":"1745",},
{"lineNum":"   26","line":"    zero_after_free_allocator(const zero_after_free_allocator& a) throw() : base(a) {}","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   29","line":"    {"},
{"lineNum":"   30","line":"    }"},
{"lineNum":"   31","line":"    ~zero_after_free_allocator() throw() {}","class":"lineCov","hits":"1","order":"1739",},
...
{"lineNum":"   38","line":"    {","class":"lineCov","hits":"1","order":"1744",},
{"lineNum":"   39","line":"        if (p != NULL)","class":"lineCov","hits":"1","order":"1743",},
{"lineNum":"   40","line":"            memory_cleanse(p, sizeof(T) * n);","class":"lineCov","hits":"1","order":"1742",},
{"lineNum":"   41","line":"        std::allocator<T>::deallocate(p, n);","class":"lineCov","hits":"1","order":"1741",},
{"lineNum":"   42","line":"    }","class":"lineCov","hits":"1","order":"1740",},
{"lineNum":"   43","line":"};"},
{"lineNum":"   44","line":""},
...
var header = { "command" : "", "date" : "2023-08-28 11:28:35", "instrumented" : 8, "covered" : 7,};
var merged_data = [];
