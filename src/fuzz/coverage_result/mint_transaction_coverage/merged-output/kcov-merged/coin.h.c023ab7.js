...
{"lineNum":"   18","line":""},
{"lineNum":"   19","line":"struct IdentifiedCoinData {","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   25","line":"};"},
{"lineNum":"   26","line":""},
{"lineNum":"   27","line":"struct RecoveredCoinData {","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   33","line":"struct MintCoinRecipientData {","class":"lineCov","hits":"1","order":"1738",},
...
{"lineNum":"   37","line":""},
{"lineNum":"   38","line":"\tADD_SERIALIZE_METHODS;","class":"lineCov","hits":"1","order":"1736",},
{"lineNum":"   39","line":""},
{"lineNum":"   40","line":"\ttemplate <typename Stream, typename Operation>"},
{"lineNum":"   41","line":"    inline void SerializationOp(Stream& s, Operation ser_action) {","class":"lineCov","hits":"1","order":"1735",},
{"lineNum":"   42","line":"        READWRITE(d);","class":"lineCov","hits":"1","order":"1734",},
{"lineNum":"   43","line":"\t\tREADWRITE(k);","class":"lineCov","hits":"1","order":"1733",},
{"lineNum":"   44","line":"\t\tREADWRITE(memo);","class":"lineCov","hits":"1","order":"1732",},
{"lineNum":"   45","line":"    }","class":"lineCov","hits":"1","order":"1731",},
{"lineNum":"   46","line":"};"},
{"lineNum":"   47","line":""},
{"lineNum":"   48","line":"// Data to be encrypted for the recipient of a coin generated in a spend transaction"},
{"lineNum":"   49","line":"struct SpendCoinRecipientData {","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   54","line":""},
{"lineNum":"   55","line":"\tADD_SERIALIZE_METHODS;","class":"lineNoCov","hits":"0",},
{"lineNum":"   56","line":""},
{"lineNum":"   57","line":"\ttemplate <typename Stream, typename Operation>"},
{"lineNum":"   58","line":"    inline void SerializationOp(Stream& s, Operation ser_action) {","class":"lineNoCov","hits":"0",},
{"lineNum":"   59","line":"        READWRITE(v);","class":"lineNoCov","hits":"0",},
{"lineNum":"   60","line":"        READWRITE(d);","class":"lineNoCov","hits":"0",},
{"lineNum":"   61","line":"\t\tREADWRITE(k);","class":"lineNoCov","hits":"0",},
{"lineNum":"   62","line":"\t\tREADWRITE(memo);","class":"lineNoCov","hits":"0",},
{"lineNum":"   63","line":"    }","class":"lineNoCov","hits":"0",},
{"lineNum":"   64","line":"};"},
{"lineNum":"   65","line":""},
{"lineNum":"   66","line":"class Coin {","class":"lineCov","hits":"1","order":"1737",},
...
{"lineNum":"  106","line":"\tADD_SERIALIZE_METHODS;","class":"lineNoCov","hits":"0",},
{"lineNum":"  107","line":"\ttemplate <typename Stream, typename Operation>"},
{"lineNum":"  108","line":"\tinline void SerializationOp(Stream& s, Operation ser_action) {","class":"lineNoCov","hits":"0",},
{"lineNum":"  109","line":"\t\tREADWRITE(type);","class":"lineNoCov","hits":"0",},
{"lineNum":"  110","line":"\t\tREADWRITE(S);","class":"lineNoCov","hits":"0",},
{"lineNum":"  111","line":"\t\tREADWRITE(K);","class":"lineNoCov","hits":"0",},
{"lineNum":"  112","line":"\t\tREADWRITE(C);","class":"lineNoCov","hits":"0",},
{"lineNum":"  113","line":"\t\tREADWRITE(r_);","class":"lineNoCov","hits":"0",},
{"lineNum":"  114","line":""},
{"lineNum":"  115","line":"\t\tif (type == COIN_TYPE_MINT) {","class":"lineNoCov","hits":"0",},
{"lineNum":"  116","line":"\t\t\tREADWRITE(v);","class":"lineNoCov","hits":"0",},
{"lineNum":"  117","line":"\t\t}"},
...
var header = { "command" : "", "date" : "2023-08-28 11:28:35", "instrumented" : 28, "covered" : 8,};
var merged_data = [];
