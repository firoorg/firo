...
{"lineNum":"   46","line":"{","class":"lineCov","hits":"1","order":"1768",},
{"lineNum":"   47","line":"    AES256_init(&ctx, key);","class":"lineCov","hits":"1","order":"1769",},
{"lineNum":"   48","line":"}","class":"lineCov","hits":"1","order":"1763",},
{"lineNum":"   49","line":""},
{"lineNum":"   50","line":"AES256Encrypt::~AES256Encrypt()"},
{"lineNum":"   51","line":"{","class":"lineCov","hits":"1","order":"1771",},
{"lineNum":"   52","line":"    memset(&ctx, 0, sizeof(ctx));","class":"lineCov","hits":"1","order":"1772",},
{"lineNum":"   53","line":"}","class":"lineCov","hits":"1","order":"1762",},
{"lineNum":"   54","line":""},
{"lineNum":"   55","line":"void AES256Encrypt::Encrypt(unsigned char ciphertext[16], const unsigned char plaintext[16]) const"},
{"lineNum":"   56","line":"{","class":"lineCov","hits":"1","order":"1773",},
{"lineNum":"   57","line":"    AES256_encrypt(&ctx, 1, ciphertext, plaintext);","class":"lineCov","hits":"1","order":"1775",},
{"lineNum":"   58","line":"}","class":"lineCov","hits":"1","order":"1761",},
{"lineNum":"   59","line":""},
{"lineNum":"   60","line":"AES256Decrypt::AES256Decrypt(const unsigned char key[32])"},
{"lineNum":"   61","line":"{","class":"lineNoCov","hits":"0",},
{"lineNum":"   62","line":"    AES256_init(&ctx, key);","class":"lineNoCov","hits":"0",},
{"lineNum":"   63","line":"}","class":"lineNoCov","hits":"0",},
{"lineNum":"   64","line":""},
{"lineNum":"   65","line":"AES256Decrypt::~AES256Decrypt()"},
{"lineNum":"   66","line":"{","class":"lineNoCov","hits":"0",},
{"lineNum":"   67","line":"    memset(&ctx, 0, sizeof(ctx));","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   72","line":"    AES256_decrypt(&ctx, 1, plaintext, ciphertext);","class":"lineNoCov","hits":"0",},
...
{"lineNum":"   78","line":"{","class":"lineCov","hits":"1","order":"1783",},
{"lineNum":"   79","line":"    int written = 0;","class":"lineCov","hits":"1","order":"1784",},
{"lineNum":"   80","line":"    int padsize = size % AES_BLOCKSIZE;","class":"lineCov","hits":"1","order":"1770",},
{"lineNum":"   81","line":"    unsigned char mixed[AES_BLOCKSIZE];"},
{"lineNum":"   82","line":""},
{"lineNum":"   83","line":"    if (!data || !size || !out)","class":"lineCov","hits":"1","order":"1785",},
{"lineNum":"   84","line":"        return 0;","class":"lineNoCov","hits":"0",},
{"lineNum":"   85","line":""},
{"lineNum":"   86","line":"    if (!pad && padsize != 0)","class":"lineCov","hits":"1","order":"1774",},
{"lineNum":"   87","line":"        return 0;","class":"lineNoCov","hits":"0",},
{"lineNum":"   88","line":""},
{"lineNum":"   89","line":"    memcpy(mixed, iv, AES_BLOCKSIZE);","class":"lineCov","hits":"1","order":"1786",},
{"lineNum":"   90","line":""},
{"lineNum":"   91","line":"    // Write all but the last block"},
{"lineNum":"   92","line":"    while (written + AES_BLOCKSIZE <= size) {","class":"lineCov","hits":"1","order":"1777",},
...
{"lineNum":"   98","line":"    }"},
{"lineNum":"   99","line":"    if (pad) {","class":"lineCov","hits":"1","order":"1780",},
...
{"lineNum":"  102","line":"        for (int i = 0; i != padsize; i++)","class":"lineCov","hits":"1","order":"1765",},
{"lineNum":"  103","line":"            mixed[i] ^= *data++;","class":"lineCov","hits":"1","order":"1782",},
{"lineNum":"  104","line":"        for (int i = padsize; i != AES_BLOCKSIZE; i++)","class":"lineCov","hits":"1","order":"1760",},
{"lineNum":"  105","line":"            mixed[i] ^= AES_BLOCKSIZE - padsize;","class":"lineCov","hits":"1","order":"1759",},
{"lineNum":"  106","line":"        enc.Encrypt(out + written, mixed);","class":"lineCov","hits":"1","order":"1758",},
{"lineNum":"  107","line":"        written += AES_BLOCKSIZE;","class":"lineCov","hits":"1","order":"1757",},
{"lineNum":"  108","line":"    }"},
{"lineNum":"  109","line":"    return written;","class":"lineCov","hits":"1","order":"1756",},
{"lineNum":"  110","line":"}","class":"lineCov","hits":"1","order":"1755",},
{"lineNum":"  111","line":""},
...
{"lineNum":"  115","line":"    unsigned char padsize = 0;","class":"lineNoCov","hits":"0",},
{"lineNum":"  116","line":"    int written = 0;","class":"lineNoCov","hits":"0",},
{"lineNum":"  117","line":"    bool fail = false;","class":"lineNoCov","hits":"0",},
{"lineNum":"  118","line":"    const unsigned char* prev = iv;","class":"lineNoCov","hits":"0",},
{"lineNum":"  119","line":""},
{"lineNum":"  120","line":"    if (!data || !size || !out)","class":"lineNoCov","hits":"0",},
{"lineNum":"  121","line":"        return 0;","class":"lineNoCov","hits":"0",},
{"lineNum":"  122","line":""},
{"lineNum":"  123","line":"    if (size % AES_BLOCKSIZE != 0)","class":"lineNoCov","hits":"0",},
{"lineNum":"  124","line":"        return 0;","class":"lineNoCov","hits":"0",},
{"lineNum":"  125","line":""},
{"lineNum":"  126","line":"    // Decrypt all data. Padding will be checked in the output."},
{"lineNum":"  127","line":"    while (written != size) {","class":"lineNoCov","hits":"0",},
{"lineNum":"  128","line":"        dec.Decrypt(out, data + written);","class":"lineNoCov","hits":"0",},
{"lineNum":"  129","line":"        for (int i = 0; i != AES_BLOCKSIZE; i++)","class":"lineNoCov","hits":"0",},
{"lineNum":"  130","line":"            *out++ ^= prev[i];","class":"lineNoCov","hits":"0",},
{"lineNum":"  131","line":"        prev = data + written;","class":"lineNoCov","hits":"0",},
{"lineNum":"  132","line":"        written += AES_BLOCKSIZE;","class":"lineNoCov","hits":"0",},
{"lineNum":"  133","line":"    }"},
{"lineNum":"  134","line":""},
{"lineNum":"  135","line":"    // When decrypting padding, attempt to run in constant-time"},
{"lineNum":"  136","line":"    if (pad) {","class":"lineNoCov","hits":"0",},
...
{"lineNum":"  139","line":"        padsize = *--out;","class":"lineNoCov","hits":"0",},
{"lineNum":"  140","line":"        fail = !padsize | (padsize > AES_BLOCKSIZE);","class":"lineNoCov","hits":"0",},
{"lineNum":"  141","line":""},
{"lineNum":"  142","line":"        // If not well-formed, treat it as though there\'s no padding."},
{"lineNum":"  143","line":"        padsize *= !fail;","class":"lineNoCov","hits":"0",},
{"lineNum":"  144","line":""},
{"lineNum":"  145","line":"        // All padding must equal the last byte otherwise it\'s not well-formed"},
{"lineNum":"  146","line":"        for (int i = AES_BLOCKSIZE; i != 0; i--)","class":"lineNoCov","hits":"0",},
{"lineNum":"  147","line":"            fail |= ((i > AES_BLOCKSIZE - padsize) & (*out-- != padsize));","class":"lineNoCov","hits":"0",},
{"lineNum":"  148","line":""},
{"lineNum":"  149","line":"        written -= padsize;","class":"lineNoCov","hits":"0",},
{"lineNum":"  150","line":"    }"},
{"lineNum":"  151","line":"    return written * !fail;","class":"lineNoCov","hits":"0",},
...
{"lineNum":"  155","line":"    : enc(key), pad(padIn)","class":"lineCov","hits":"1","order":"1776",},
{"lineNum":"  156","line":"{","class":"lineCov","hits":"1","order":"1767",},
{"lineNum":"  157","line":"    memcpy(iv, ivIn, AES_BLOCKSIZE);","class":"lineCov","hits":"1","order":"1778",},
{"lineNum":"  158","line":"}","class":"lineCov","hits":"1","order":"1779",},
{"lineNum":"  159","line":""},
{"lineNum":"  160","line":"int AES256CBCEncrypt::Encrypt(const unsigned char* data, int size, unsigned char* out) const"},
{"lineNum":"  161","line":"{","class":"lineCov","hits":"1","order":"1764",},
{"lineNum":"  162","line":"    return CBCEncrypt(enc, iv, data, size, pad, out);","class":"lineCov","hits":"1","order":"1781",},
{"lineNum":"  163","line":"}"},
{"lineNum":"  164","line":""},
{"lineNum":"  165","line":"AES256CBCEncrypt::~AES256CBCEncrypt()"},
{"lineNum":"  166","line":"{","class":"lineCov","hits":"1","order":"1754",},
{"lineNum":"  167","line":"    memset(iv, 0, sizeof(iv));","class":"lineCov","hits":"1","order":"1753",},
{"lineNum":"  168","line":"}","class":"lineCov","hits":"1","order":"1766",},
{"lineNum":"  169","line":""},
...
{"lineNum":"  171","line":"    : dec(key), pad(padIn)","class":"lineNoCov","hits":"0",},
{"lineNum":"  172","line":"{","class":"lineNoCov","hits":"0",},
{"lineNum":"  173","line":"    memcpy(iv, ivIn, AES_BLOCKSIZE);","class":"lineNoCov","hits":"0",},
...
{"lineNum":"  179","line":"    return CBCDecrypt(dec, iv, data, size, pad, out);","class":"lineNoCov","hits":"0",},
{"lineNum":"  180","line":"}"},
{"lineNum":"  181","line":""},
{"lineNum":"  182","line":"AES256CBCDecrypt::~AES256CBCDecrypt()"},
{"lineNum":"  183","line":"{","class":"lineNoCov","hits":"0",},
{"lineNum":"  184","line":"    memset(iv, 0, sizeof(iv));","class":"lineNoCov","hits":"0",},
...
var header = { "command" : "", "date" : "2023-08-28 11:28:35", "instrumented" : 119, "covered" : 34,};
var merged_data = [];
