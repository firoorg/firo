...
{"lineNum":"   55","line":"class LOCKABLE AnnotatedMixin : public PARENT","class":"lineCov","hits":"1","order":"973",},
{"lineNum":"   56","line":"{"},
{"lineNum":"   57","line":"public:"},
{"lineNum":"   58","line":"    void lock() EXCLUSIVE_LOCK_FUNCTION()"},
{"lineNum":"   59","line":"    {","class":"lineCov","hits":"1","order":"958",},
{"lineNum":"   60","line":"        PARENT::lock();","class":"lineCov","hits":"1","order":"957",},
{"lineNum":"   61","line":"    }","class":"lineCov","hits":"1","order":"956",},
{"lineNum":"   62","line":""},
{"lineNum":"   63","line":"    void unlock() UNLOCK_FUNCTION()"},
{"lineNum":"   64","line":"    {","class":"lineCov","hits":"1","order":"955",},
{"lineNum":"   65","line":"        PARENT::unlock();","class":"lineCov","hits":"1","order":"954",},
{"lineNum":"   66","line":"    }","class":"lineCov","hits":"1","order":"953",},
{"lineNum":"   67","line":""},
...
{"lineNum":"   81","line":"void static inline EnterCritical(const char* pszName, const char* pszFile, int nLine, void* cs, bool fTry = false) {}","class":"lineCov","hits":"1","order":"974",},
{"lineNum":"   82","line":"void static inline LeaveCritical() {}","class":"lineCov","hits":"1","order":"978",},
...
{"lineNum":"   85","line":"void static inline DeleteLock(void* cs) {}","class":"lineCov","hits":"1","order":"963",},
...
{"lineNum":"   93","line":" */"},
{"lineNum":"   94","line":"class CCriticalSection : public AnnotatedMixin<boost::recursive_mutex>","class":"lineCov","hits":"1","order":"972",},
{"lineNum":"   95","line":"{"},
{"lineNum":"   96","line":"public:"},
{"lineNum":"   97","line":"    ~CCriticalSection() {","class":"lineCov","hits":"1","order":"971",},
{"lineNum":"   98","line":"        DeleteLock((void*)this);","class":"lineCov","hits":"1","order":"968",},
{"lineNum":"   99","line":"    }","class":"lineCov","hits":"1","order":"966",},
{"lineNum":"  100","line":"};"},
{"lineNum":"  101","line":""},
...
{"lineNum":"  121","line":"    {","class":"lineCov","hits":"1","order":"975",},
{"lineNum":"  122","line":"        EnterCritical(pszName, pszFile, nLine, (void*)(lock.mutex()));","class":"lineCov","hits":"1","order":"976",},
...
{"lineNum":"  127","line":"            lock.lock();","class":"lineCov","hits":"1","order":"969",},
{"lineNum":"  128","line":"#ifdef DEBUG_LOCKCONTENTION"},
{"lineNum":"  129","line":"        }"},
{"lineNum":"  130","line":"#endif"},
{"lineNum":"  131","line":"    }","class":"lineCov","hits":"1","order":"977",},
{"lineNum":"  132","line":""},
...
{"lineNum":"  143","line":"    CMutexLock(Mutex& mutexIn, const char* pszName, const char* pszFile, int nLine, bool fTry = false) EXCLUSIVE_LOCK_FUNCTION(mutexIn) : lock(mutexIn, boost::defer_lock)","class":"lineCov","hits":"1","order":"962",},
{"lineNum":"  144","line":"    {","class":"lineCov","hits":"1","order":"964",},
{"lineNum":"  145","line":"        if (fTry)","class":"lineCov","hits":"1","order":"961",},
{"lineNum":"  146","line":"            TryEnter(pszName, pszFile, nLine);","class":"lineNoCov","hits":"0",},
{"lineNum":"  147","line":"        else"},
{"lineNum":"  148","line":"            Enter(pszName, pszFile, nLine);","class":"lineCov","hits":"1","order":"960",},
{"lineNum":"  149","line":"    }","class":"lineCov","hits":"1","order":"970",},
{"lineNum":"  150","line":""},
...
{"lineNum":"  163","line":"    {","class":"lineCov","hits":"1","order":"967",},
{"lineNum":"  164","line":"        if (lock.owns_lock())","class":"lineCov","hits":"1","order":"965",},
{"lineNum":"  165","line":"            LeaveCritical();","class":"lineCov","hits":"1","order":"959",},
...
var header = { "command" : "", "date" : "2023-08-28 11:28:35", "instrumented" : 36, "covered" : 26,};
var merged_data = [];
