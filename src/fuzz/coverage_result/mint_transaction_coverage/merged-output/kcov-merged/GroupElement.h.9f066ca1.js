...
{"lineNum":"   75","line":"  }"},
{"lineNum":"   76","line":""},
{"lineNum":"   77","line":"  static constexpr size_t memoryRequired() { return serialize_size; }","class":"lineCov","hits":"1","order":"946",},
...
{"lineNum":"   86","line":"  inline void Serialize(Stream& s) const {","class":"lineCov","hits":"1","order":"1702",},
{"lineNum":"   87","line":"        constexpr int size = memoryRequired();","class":"lineCov","hits":"1","order":"1701",},
{"lineNum":"   88","line":"        unsigned char buffer[size];"},
{"lineNum":"   89","line":"        serialize(buffer);","class":"lineCov","hits":"1","order":"1700",},
{"lineNum":"   90","line":"        char* b = (char*)buffer;","class":"lineCov","hits":"1","order":"1699",},
{"lineNum":"   91","line":"        s.write(b, size);","class":"lineCov","hits":"1","order":"1698",},
{"lineNum":"   92","line":"  }","class":"lineCov","hits":"1","order":"1697",},
{"lineNum":"   93","line":""},
{"lineNum":"   94","line":"  template<typename Stream>"},
{"lineNum":"   95","line":"  inline void Unserialize(Stream& s) {","class":"lineNoCov","hits":"0",},
{"lineNum":"   96","line":"        constexpr int size = memoryRequired();","class":"lineNoCov","hits":"0",},
{"lineNum":"   97","line":"        unsigned char buffer[size];"},
{"lineNum":"   98","line":"        char* b = (char*)buffer;","class":"lineNoCov","hits":"0",},
{"lineNum":"   99","line":"        s.read(b, size);","class":"lineNoCov","hits":"0",},
{"lineNum":"  100","line":"        deserialize(buffer);","class":"lineNoCov","hits":"0",},
...
var header = { "command" : "", "date" : "2023-08-28 11:28:35", "instrumented" : 13, "covered" : 7,};
var merged_data = [];
