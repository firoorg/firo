...
{"lineNum":"   28","line":"{","class":"lineCov","hits":"2","order":"331","possible_hits":"2",},
{"lineNum":"   29","line":"    secp256k1_ge ge;"},
{"lineNum":"   30","line":"    secp256k1_gej j(gej);","class":"lineCov","hits":"1","order":"332","possible_hits":"1",},
{"lineNum":"   31","line":"    secp256k1_ge_set_gej(&ge, &j);","class":"lineCov","hits":"1","order":"333","possible_hits":"1",},
{"lineNum":"   32","line":"    return ge;","class":"linePartCov","hits":"1","order":"400","possible_hits":"2",},
{"lineNum":"   33","line":"}"},
{"lineNum":"   34","line":""},
...
{"lineNum":"   49","line":""},
{"lineNum":"   50","line":"    secp256k1_fe_mul(&wn, &c, t); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   51","line":"    secp256k1_fe_sqr(&wd, t); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   52","line":"    secp256k1_fe_add(&wd, &b_plus_one); /* mag 2 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   53","line":"    secp256k1_fe_mul(&tmp, t, &wn); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   54","line":"    secp256k1_fe_negate(&tmp, &tmp, 1); /* mag 2 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   55","line":"    secp256k1_fe_mul(&x1n, &d, &wd); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   56","line":"    secp256k1_fe_add(&x1n, &tmp); /* mag 3 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   57","line":"    x2n = x1n; /* mag 3 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   58","line":"    secp256k1_fe_add(&x2n, &wd); /* mag 5 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   59","line":"    secp256k1_fe_negate(&x2n, &x2n, 5); /* mag 6 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   60","line":"    secp256k1_fe_mul(&x3d, &c, t); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   61","line":"    secp256k1_fe_sqr(&x3d, &x3d); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   62","line":"    secp256k1_fe_sqr(&x3n, &wd); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   63","line":"    secp256k1_fe_add(&x3n, &x3d); /* mag 2 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   64","line":"    secp256k1_fe_mul(&jinv, &x3d, &wd); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   65","line":"    secp256k1_fe_inv(&jinv, &jinv); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   66","line":"    secp256k1_fe_mul(&x1, &x1n, &x3d); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   67","line":"    secp256k1_fe_mul(&x1, &x1, &jinv); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   68","line":"    secp256k1_fe_mul(&x2, &x2n, &x3d); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   69","line":"    secp256k1_fe_mul(&x2, &x2, &jinv); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   70","line":"    secp256k1_fe_mul(&x3, &x3n, &wd); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   71","line":"    secp256k1_fe_mul(&x3, &x3, &jinv); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   72","line":""},
{"lineNum":"   73","line":"    secp256k1_fe_sqr(&alphain, &x1); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   74","line":"    secp256k1_fe_mul(&alphain, &alphain, &x1); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   75","line":"    secp256k1_fe_add(&alphain, &b); /* mag 2 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   76","line":"    secp256k1_fe_sqr(&betain, &x2); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   77","line":"    secp256k1_fe_mul(&betain, &betain, &x2); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   78","line":"    secp256k1_fe_add(&betain, &b); /* mag 2 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   79","line":"    secp256k1_fe_sqr(&gammain, &x3); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   80","line":"    secp256k1_fe_mul(&gammain, &gammain, &x3); /* mag 1 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   81","line":"    secp256k1_fe_add(&gammain, &b); /* mag 2 */","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   82","line":""},
{"lineNum":"   83","line":"    alphaquad = secp256k1_fe_sqrt(&y1, &alphain);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   84","line":"    betaquad = secp256k1_fe_sqrt(&y2, &betain);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   85","line":"    secp256k1_fe_sqrt(&y3, &gammain);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   86","line":""},
{"lineNum":"   87","line":"    secp256k1_fe_cmov(&x1, &x2, (!alphaquad) & betaquad);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   88","line":"    secp256k1_fe_cmov(&y1, &y2, (!alphaquad) & betaquad);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   89","line":"    secp256k1_fe_cmov(&x1, &x3, (!alphaquad) & !betaquad);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   90","line":"    secp256k1_fe_cmov(&y1, &y3, (!alphaquad) & !betaquad);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   91","line":""},
{"lineNum":"   92","line":"    secp256k1_ge_set_xy(ge, &x1, &y1);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   93","line":""},
...
{"lineNum":"   99","line":"    secp256k1_fe_negate(&tmp, &ge->y, 1);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  100","line":"    secp256k1_fe_cmov(&ge->y, &tmp, secp256k1_fe_is_odd(t));","class":"lineNoCov","hits":"0","possible_hits":"1",},
...
{"lineNum":"  163","line":"        : g_(new secp256k1_gej())","class":"lineCov","hits":"1","order":"68","possible_hits":"1",},
{"lineNum":"  164","line":"{","class":"lineCov","hits":"2","order":"67","possible_hits":"2",},
{"lineNum":"  165","line":"    auto g = reinterpret_cast<secp256k1_gej *>(g_);","class":"lineCov","hits":"1","order":"69","possible_hits":"1",},
{"lineNum":"  166","line":"    secp256k1_gej_clear(g);","class":"lineCov","hits":"1","order":"70","possible_hits":"1",},
{"lineNum":"  167","line":"    g->infinity = 1;","class":"lineCov","hits":"1","order":"81","possible_hits":"1",},
{"lineNum":"  168","line":"}","class":"linePartCov","hits":"1","order":"82","possible_hits":"2",},
{"lineNum":"  169","line":""},
{"lineNum":"  170","line":"GroupElement::GroupElement(const GroupElement& other)"},
{"lineNum":"  171","line":"        : g_(new secp256k1_gej(*reinterpret_cast<secp256k1_gej *>(other.g_)))","class":"lineCov","hits":"1","order":"1366","possible_hits":"1",},
{"lineNum":"  172","line":"{","class":"lineCov","hits":"2","order":"1365","possible_hits":"2",},
{"lineNum":"  173","line":"}","class":"linePartCov","hits":"1","order":"1367","possible_hits":"2",},
{"lineNum":"  174","line":""},
{"lineNum":"  175","line":"GroupElement::GroupElement(const void *g)"},
{"lineNum":"  176","line":"        : g_(new secp256k1_gej(*reinterpret_cast<const secp256k1_gej *>(g)))","class":"lineCov","hits":"1","order":"782","possible_hits":"1",},
{"lineNum":"  177","line":"{","class":"lineCov","hits":"2","order":"781","possible_hits":"2",},
{"lineNum":"  178","line":"}","class":"linePartCov","hits":"1","order":"783","possible_hits":"2",},
{"lineNum":"  179","line":""},
...
{"lineNum":"  188","line":"    std::vector<uint8_t> src(strLen, 0);","class":"linePartCov","hits":"1","order":"245","possible_hits":"4",},
{"lineNum":"  189","line":""},
...
{"lineNum":"  241","line":"{","class":"lineCov","hits":"2","order":"292","possible_hits":"2",},
{"lineNum":"  242","line":"    delete reinterpret_cast<secp256k1_gej *>(g_);","class":"lineCov","hits":"1","order":"293","possible_hits":"1",},
{"lineNum":"  243","line":"}","class":"linePartCov","hits":"1","order":"294","possible_hits":"2",},
{"lineNum":"  244","line":""},
{"lineNum":"  245","line":"GroupElement& GroupElement::operator=(const GroupElement &other)"},
{"lineNum":"  246","line":"{","class":"lineCov","hits":"2","order":"411","possible_hits":"2",},
{"lineNum":"  247","line":"    return set(other);","class":"lineCov","hits":"1","order":"412","possible_hits":"1",},
{"lineNum":"  248","line":"}"},
{"lineNum":"  249","line":""},
{"lineNum":"  250","line":"GroupElement& GroupElement::set(const GroupElement &other)"},
{"lineNum":"  251","line":"{","class":"lineCov","hits":"2","order":"413","possible_hits":"2",},
{"lineNum":"  252","line":"    *reinterpret_cast<secp256k1_gej *>(g_) = *reinterpret_cast<secp256k1_gej *>(other.g_);","class":"lineCov","hits":"1","order":"414","possible_hits":"1",},
{"lineNum":"  253","line":"    return *this;","class":"linePartCov","hits":"1","order":"415","possible_hits":"2",},
{"lineNum":"  254","line":"}"},
{"lineNum":"  255","line":""},
{"lineNum":"  256","line":"GroupElement GroupElement::operator*(const Scalar& multiplier) const"},
{"lineNum":"  257","line":"{","class":"lineCov","hits":"2","order":"586","possible_hits":"2",},
{"lineNum":"  258","line":"    secp256k1_gej result;"},
{"lineNum":"  259","line":"    secp256k1_scalar ng;"},
{"lineNum":"  260","line":"    secp256k1_scalar_set_int(&ng,0);","class":"lineCov","hits":"1","order":"587","possible_hits":"1",},
{"lineNum":"  261","line":"    secp256k1_ecmult(&ctx,&result,reinterpret_cast<secp256k1_gej *>(g_), reinterpret_cast<const secp256k1_scalar *>(multiplier.get_value()),&ng);","class":"lineCov","hits":"1","order":"588","possible_hits":"1",},
{"lineNum":"  262","line":"    return &result;","class":"lineCov","hits":"1","order":"780","possible_hits":"1",},
{"lineNum":"  263","line":"}"},
{"lineNum":"  264","line":""},
...
{"lineNum":"  275","line":"{","class":"lineCov","hits":"2","order":"786","possible_hits":"2",},
{"lineNum":"  276","line":"    secp256k1_gej result_gej;"},
{"lineNum":"  277","line":"    secp256k1_gej_add_var(&result_gej, reinterpret_cast<secp256k1_gej *>(g_), reinterpret_cast<secp256k1_gej *>(other.g_), NULL);","class":"lineCov","hits":"1","order":"787","possible_hits":"1",},
{"lineNum":"  278","line":"    return &result_gej;","class":"lineCov","hits":"1","order":"813","possible_hits":"1",},
{"lineNum":"  279","line":"}"},
{"lineNum":"  280","line":""},
...
{"lineNum":"  289","line":"{","class":"lineCov","hits":"2","order":"1556","possible_hits":"2",},
{"lineNum":"  290","line":"    secp256k1_gej result_gej;"},
{"lineNum":"  291","line":"    secp256k1_gej_neg(&result_gej,reinterpret_cast<secp256k1_gej *>(g_));","class":"lineCov","hits":"1","order":"1557","possible_hits":"1",},
{"lineNum":"  292","line":"    return &result_gej;","class":"lineCov","hits":"1","order":"1566","possible_hits":"1",},
{"lineNum":"  293","line":"}"},
{"lineNum":"  294","line":""},
...
{"lineNum":"  302","line":"{","class":"lineCov","hits":"2","order":"1579","possible_hits":"2",},
{"lineNum":"  303","line":"    auto g = reinterpret_cast<secp256k1_gej *>(g_);","class":"lineCov","hits":"1","order":"1580","possible_hits":"1",},
{"lineNum":"  304","line":"    auto og = reinterpret_cast<secp256k1_gej *>(other.g_);","class":"lineCov","hits":"1","order":"1581","possible_hits":"1",},
{"lineNum":"  305","line":""},
{"lineNum":"  306","line":"    if(g->infinity && og->infinity)","class":"lineCov","hits":"1","order":"1582","possible_hits":"1",},
{"lineNum":"  307","line":"        return true;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  308","line":"    if(g->infinity != og->infinity)","class":"lineCov","hits":"1","order":"1583","possible_hits":"1",},
{"lineNum":"  309","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  310","line":"    secp256k1_ge this_ge = gej_to_ge(*g);","class":"lineCov","hits":"1","order":"1584","possible_hits":"1",},
{"lineNum":"  311","line":"    secp256k1_ge other_ge = gej_to_ge(*og);","class":"lineCov","hits":"1","order":"1585","possible_hits":"1",},
{"lineNum":"  312","line":"    if(!secp256k1_fe_equal(&this_ge.x, &other_ge.x))","class":"lineCov","hits":"1","order":"1586","possible_hits":"1",},
{"lineNum":"  313","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  314","line":"    if(!secp256k1_fe_equal(&this_ge.y, &other_ge.y))","class":"lineCov","hits":"1","order":"1587","possible_hits":"1",},
{"lineNum":"  315","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  316","line":""},
{"lineNum":"  317","line":"    return true;","class":"lineCov","hits":"1","order":"1588","possible_hits":"1",},
{"lineNum":"  318","line":"}","class":"linePartCov","hits":"1","order":"1589","possible_hits":"2",},
{"lineNum":"  319","line":""},
{"lineNum":"  320","line":"bool GroupElement::operator!=(const  GroupElement& other) const"},
{"lineNum":"  321","line":"{","class":"lineCov","hits":"2","order":"1577","possible_hits":"2",},
{"lineNum":"  322","line":"    return !(*this == other);","class":"lineCov","hits":"1","order":"1578","possible_hits":"1",},
{"lineNum":"  323","line":"}"},
{"lineNum":"  324","line":""},
{"lineNum":"  325","line":"bool GroupElement::isMember() const"},
{"lineNum":"  326","line":"{","class":"lineCov","hits":"2","order":"329","possible_hits":"2",},
{"lineNum":"  327","line":"    secp256k1_ge v1 = gej_to_ge(*reinterpret_cast<secp256k1_gej *>(g_));","class":"lineCov","hits":"1","order":"330","possible_hits":"1",},
{"lineNum":"  328","line":"    if (secp256k1_ge_is_infinity(&v1)) {","class":"lineCov","hits":"1","order":"401","possible_hits":"1",},
{"lineNum":"  329","line":"        return true;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  330","line":"    }"},
{"lineNum":"  331","line":"    return secp256k1_ge_is_valid_var(&v1);","class":"lineCov","hits":"1","order":"404","possible_hits":"1",},
{"lineNum":"  332","line":"}","class":"linePartCov","hits":"1","order":"405","possible_hits":"2",},
{"lineNum":"  333","line":""},
{"lineNum":"  334","line":"bool GroupElement::isInfinity() const"},
{"lineNum":"  335","line":"{","class":"lineCov","hits":"2","order":"1905","possible_hits":"2",},
{"lineNum":"  336","line":"    return secp256k1_gej_is_infinity(reinterpret_cast<const secp256k1_gej *>(g_));","class":"lineCov","hits":"1","order":"1906","possible_hits":"1",},
{"lineNum":"  337","line":"}"},
{"lineNum":"  338","line":""},
{"lineNum":"  339","line":"void GroupElement::randomize() {","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  340","line":"    unsigned char temp[32] = { 0 };","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  341","line":""},
{"lineNum":"  342","line":"    do {"},
{"lineNum":"  343","line":"        if (RAND_bytes(temp, 32) != 1) {","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  344","line":"            throw \"Unable to generate random GroupElement\";","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  345","line":"        }"},
{"lineNum":"  346","line":"        generate(temp);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  347","line":"    } while (!(this->isMember()));","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  348","line":"}","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  349","line":""},
{"lineNum":"  350","line":"GroupElement& GroupElement::generate(unsigned char* seed){","class":"lineNoCov","hits":"0","possible_hits":"2",},
...
{"lineNum":"  354","line":"    secp256k1_fe t = SECP256K1_FE_CONST(0, 0, 0, 0, 0, 0, 0, 4);","class":"lineNoCov","hits":"0","possible_hits":"1",},
...
{"lineNum":"  360","line":"    secp256k1_sha256_initialize(&sha256);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  361","line":"    secp256k1_sha256_write(&sha256, prefix1, 16);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  362","line":"    secp256k1_sha256_write(&sha256, seed, 32);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  363","line":"    secp256k1_sha256_finalize(&sha256, b32);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  364","line":"    secp256k1_fe_set_b32(&t, b32);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  365","line":"    indifferent_hash(&add, &t);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  366","line":"    secp256k1_gej_set_ge(&accum, &add);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  367","line":"    secp256k1_sha256_initialize(&sha256);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  368","line":"    secp256k1_sha256_write(&sha256, prefix2, 16);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  369","line":"    secp256k1_sha256_write(&sha256, seed, 32);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  370","line":"    secp256k1_sha256_finalize(&sha256, b32);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  371","line":"    secp256k1_fe_set_b32(&t, b32);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  372","line":"    indifferent_hash(&add, &t);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  373","line":"    secp256k1_gej_add_ge(&accum, &accum, &add);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  374","line":"    secp256k1_ge_set_gej(&add, &accum);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  375","line":"    secp256k1_fe_normalize(&add.x);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  376","line":"    secp256k1_fe_get_b32(gen + 1, &add.x);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  377","line":"    gen[0] = 11 ^ secp256k1_fe_is_quad_var(&add.y);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  378","line":"    //load group element from gen;"},
{"lineNum":"  379","line":"    secp256k1_fe fe;"},
{"lineNum":"  380","line":"    secp256k1_fe_set_b32(&fe, gen + 1);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  381","line":"    secp256k1_ge ge;"},
{"lineNum":"  382","line":"    secp256k1_ge_set_xquad(&ge, &fe);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  383","line":"    if (gen[0] & 1) {","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  384","line":"        secp256k1_ge_neg(&ge, &ge);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  385","line":"    }"},
{"lineNum":"  386","line":"    secp256k1_gej_set_ge(reinterpret_cast<secp256k1_gej *>(g_), &ge);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  387","line":"    return *this;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  388","line":"}"},
{"lineNum":"  389","line":""},
...
{"lineNum":"  506","line":"}"},
{"lineNum":"  507","line":""},
{"lineNum":"  508","line":"unsigned char* GroupElement::serialize(unsigned char* buffer) const {","class":"lineCov","hits":"2","order":"1482","possible_hits":"2",},
{"lineNum":"  509","line":"    secp256k1_ge value = gej_to_ge(*reinterpret_cast<secp256k1_gej *>(g_));","class":"lineCov","hits":"1","order":"1483","possible_hits":"1",},
{"lineNum":"  510","line":"    secp256k1_fe x = value.x;","class":"lineCov","hits":"1","order":"1484","possible_hits":"1",},
{"lineNum":"  511","line":"    secp256k1_fe y = value.y;","class":"lineCov","hits":"1","order":"1485","possible_hits":"1",},
{"lineNum":"  512","line":"    secp256k1_fe_normalize(&x);","class":"lineCov","hits":"1","order":"1486","possible_hits":"1",},
{"lineNum":"  513","line":"    secp256k1_fe_normalize(&y);","class":"lineCov","hits":"1","order":"1507","possible_hits":"1",},
{"lineNum":"  514","line":"    unsigned char oddness = secp256k1_fe_is_odd(&y);","class":"lineCov","hits":"1","order":"1508","possible_hits":"1",},
{"lineNum":"  515","line":"    unsigned char infinity = value.infinity;","class":"lineCov","hits":"1","order":"1509","possible_hits":"1",},
{"lineNum":"  516","line":"    secp256k1_fe_get_b32(buffer, &x);","class":"lineCov","hits":"1","order":"1510","possible_hits":"1",},
{"lineNum":"  517","line":"    buffer[32] = oddness;","class":"lineCov","hits":"1","order":"1520","possible_hits":"1",},
{"lineNum":"  518","line":"    buffer[33] = infinity;","class":"lineCov","hits":"1","order":"1521","possible_hits":"1",},
{"lineNum":"  519","line":"    return buffer + memoryRequired();","class":"lineCov","hits":"1","order":"1522","possible_hits":"1",},
{"lineNum":"  520","line":"}"},
{"lineNum":"  521","line":""},
{"lineNum":"  522","line":"const unsigned char* GroupElement::deserialize(const unsigned char* buffer) {","class":"lineCov","hits":"2","order":"116","possible_hits":"2",},
{"lineNum":"  523","line":"    secp256k1_fe x;"},
{"lineNum":"  524","line":"    secp256k1_fe_set_b32(&x, buffer);","class":"lineCov","hits":"1","order":"117","possible_hits":"1",},
{"lineNum":"  525","line":"    unsigned char oddness = buffer[32];","class":"lineCov","hits":"1","order":"129","possible_hits":"1",},
{"lineNum":"  526","line":"    unsigned char infinity = buffer[33];","class":"lineCov","hits":"1","order":"130","possible_hits":"1",},
{"lineNum":"  527","line":"    secp256k1_ge result;"},
{"lineNum":"  528","line":"    secp256k1_ge_set_xo_var(&result, &x, (int)oddness);","class":"lineCov","hits":"1","order":"131","possible_hits":"1",},
{"lineNum":"  529","line":"    result.infinity = (int)infinity;","class":"lineCov","hits":"1","order":"243","possible_hits":"1",},
{"lineNum":"  530","line":""},
{"lineNum":"  531","line":"    secp256k1_gej_set_ge(reinterpret_cast<secp256k1_gej *>(g_), &result);","class":"lineCov","hits":"1","order":"244","possible_hits":"1",},
{"lineNum":"  532","line":""},
{"lineNum":"  533","line":"    if (!secp256k1_ge_is_valid_var(&result) && !result.infinity) {","class":"lineCov","hits":"1","order":"252","possible_hits":"1",},
{"lineNum":"  534","line":"        throw std::invalid_argument(\"GroupElement: deserialize failed\");","class":"linePartCov","hits":"1","order":"287","possible_hits":"4",},
{"lineNum":"  535","line":"    }"},
{"lineNum":"  536","line":"    return buffer + memoryRequired();","class":"lineCov","hits":"1","order":"326","possible_hits":"1",},
...
{"lineNum":"  566","line":"}"},
{"lineNum":"  567","line":""},
{"lineNum":"  568","line":"const void* GroupElement::get_value() const {","class":"lineCov","hits":"2","order":"1750","possible_hits":"2",},
{"lineNum":"  569","line":"    return g_;","class":"lineCov","hits":"1","order":"1751","possible_hits":"1",},
{"lineNum":"  570","line":"}"},
{"lineNum":"  571","line":""},
{"lineNum":"  572","line":"GroupElement& GroupElement::set_base_g() {","class":"lineCov","hits":"2","order":"417","possible_hits":"2",},
{"lineNum":"  573","line":"    secp256k1_gej_set_ge(reinterpret_cast<secp256k1_gej *>(g_), &secp256k1_ge_const_g);","class":"lineCov","hits":"1","order":"418","possible_hits":"1",},
{"lineNum":"  574","line":"    return *this;","class":"linePartCov","hits":"1","order":"419","possible_hits":"2",},
{"lineNum":"  575","line":"}"},
{"lineNum":"  576","line":""},
{"lineNum":"  577","line":"} // namespace secp_primitives"},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "mint_transaction_debug", "date" : "2023-08-28 11:27:06", "instrumented" : 343, "covered" : 82,};
var merged_data = [];
