...
{"lineNum":"    8","line":""},
{"lineNum":"    9","line":"MintTransaction::MintTransaction(","class":"lineCov","hits":"1","order":"859","possible_hits":"1",},
...
{"lineNum":"   14","line":") {","class":"lineCov","hits":"2","order":"858","possible_hits":"2",},
...
{"lineNum":"   17","line":""},
{"lineNum":"   18","line":"\tthis->params = params;","class":"lineCov","hits":"1","order":"861","possible_hits":"1",},
{"lineNum":"   19","line":"\tSchnorr schnorr(this->params->get_H());","class":"lineCov","hits":"1","order":"862","possible_hits":"1",},
{"lineNum":"   20","line":""},
{"lineNum":"   21","line":"\tstd::vector<GroupElement> value_statement;","class":"lineCov","hits":"1","order":"867","possible_hits":"1",},
{"lineNum":"   22","line":"\tstd::vector<Scalar> value_witness;","class":"lineCov","hits":"1","order":"868","possible_hits":"1",},
{"lineNum":"   23","line":""},
{"lineNum":"   24","line":"\tfor (std::size_t j = 0; j < outputs.size(); j++) {","class":"linePartCov","hits":"1","order":"869","possible_hits":"2",},
...
{"lineNum":"   56","line":"    if (generate)","class":"lineCov","hits":"1","order":"870","possible_hits":"1",},
{"lineNum":"   57","line":"\t    schnorr.prove(value_witness, value_statement, this->value_proof);","class":"lineCov","hits":"1","order":"871","possible_hits":"1",},
{"lineNum":"   58","line":"    else"},
{"lineNum":"   59","line":"        value_proof = SchnorrProof();","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   60","line":"}","class":"linePartCov","hits":"1","order":"1029","possible_hits":"6",},
{"lineNum":"   61","line":""},
{"lineNum":"   62","line":"bool MintTransaction::verify() {","class":"lineCov","hits":"2","order":"1031","possible_hits":"2",},
{"lineNum":"   63","line":"\t// Verify the value proof"},
{"lineNum":"   64","line":"\tSchnorr schnorr(this->params->get_H());","class":"lineCov","hits":"1","order":"1032","possible_hits":"1",},
{"lineNum":"   65","line":"\tstd::vector<GroupElement> value_statement;","class":"lineCov","hits":"1","order":"1033","possible_hits":"1",},
{"lineNum":"   66","line":""},
{"lineNum":"   67","line":"\tfor (std::size_t j = 0; j < this->coins.size(); j++) {","class":"linePartCov","hits":"1","order":"1034","possible_hits":"2",},
...
{"lineNum":"   69","line":"\t}"},
{"lineNum":"   70","line":""},
{"lineNum":"   71","line":"\treturn schnorr.verify(value_statement, this->value_proof);","class":"lineCov","hits":"1","order":"1035","possible_hits":"1",},
{"lineNum":"   72","line":"}","class":"linePartCov","hits":"1","order":"1227","possible_hits":"2",},
{"lineNum":"   73","line":""},
...
var header = { "command" : "mint_transaction_debug", "date" : "2023-08-28 11:27:24", "instrumented" : 74, "covered" : 30,};
var merged_data = [];
