...
{"lineNum":"   59","line":"    {","class":"lineCov","hits":"2","order":"54","possible_hits":"2",},
{"lineNum":"   60","line":"        PARENT::lock();","class":"lineCov","hits":"1","order":"55","possible_hits":"1",},
{"lineNum":"   61","line":"    }","class":"linePartCov","hits":"1","order":"56","possible_hits":"2",},
{"lineNum":"   62","line":""},
{"lineNum":"   63","line":"    void unlock() UNLOCK_FUNCTION()"},
{"lineNum":"   64","line":"    {","class":"lineCov","hits":"2","order":"444","possible_hits":"2",},
{"lineNum":"   65","line":"        PARENT::unlock();","class":"lineCov","hits":"1","order":"445","possible_hits":"1",},
{"lineNum":"   66","line":"    }","class":"linePartCov","hits":"1","order":"446","possible_hits":"2",},
{"lineNum":"   67","line":""},
...
{"lineNum":"   81","line":"void static inline EnterCritical(const char* pszName, const char* pszFile, int nLine, void* cs, bool fTry = false) {}","class":"lineCov","hits":"2","order":"52","possible_hits":"2",},
{"lineNum":"   82","line":"void static inline LeaveCritical() {}","class":"lineCov","hits":"2","order":"443","possible_hits":"2",},
...
{"lineNum":"   85","line":"void static inline DeleteLock(void* cs) {}","class":"lineCov","hits":"2","order":"1224","possible_hits":"2",},
...
{"lineNum":"   97","line":"    ~CCriticalSection() {","class":"lineCov","hits":"2","order":"1222","possible_hits":"2",},
{"lineNum":"   98","line":"        DeleteLock((void*)this);","class":"lineCov","hits":"1","order":"1223","possible_hits":"1",},
{"lineNum":"   99","line":"    }","class":"lineCov","hits":"1","order":"1225","possible_hits":"1",},
{"lineNum":"  100","line":"};"},
{"lineNum":"  101","line":""},
...
{"lineNum":"  121","line":"    {","class":"lineCov","hits":"2","order":"50","possible_hits":"2",},
{"lineNum":"  122","line":"        EnterCritical(pszName, pszFile, nLine, (void*)(lock.mutex()));","class":"lineCov","hits":"1","order":"51","possible_hits":"1",},
...
{"lineNum":"  127","line":"            lock.lock();","class":"lineCov","hits":"1","order":"53","possible_hits":"1",},
{"lineNum":"  128","line":"#ifdef DEBUG_LOCKCONTENTION"},
{"lineNum":"  129","line":"        }"},
{"lineNum":"  130","line":"#endif"},
{"lineNum":"  131","line":"    }","class":"linePartCov","hits":"1","order":"57","possible_hits":"2",},
{"lineNum":"  132","line":""},
...
{"lineNum":"  143","line":"    CMutexLock(Mutex& mutexIn, const char* pszName, const char* pszFile, int nLine, bool fTry = false) EXCLUSIVE_LOCK_FUNCTION(mutexIn) : lock(mutexIn, boost::defer_lock)","class":"lineCov","hits":"1","order":"47","possible_hits":"1",},
{"lineNum":"  144","line":"    {","class":"lineCov","hits":"2","order":"46","possible_hits":"2",},
{"lineNum":"  145","line":"        if (fTry)","class":"lineCov","hits":"1","order":"48","possible_hits":"1",},
{"lineNum":"  146","line":"            TryEnter(pszName, pszFile, nLine);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  147","line":"        else"},
{"lineNum":"  148","line":"            Enter(pszName, pszFile, nLine);","class":"lineCov","hits":"1","order":"49","possible_hits":"1",},
{"lineNum":"  149","line":"    }","class":"linePartCov","hits":"1","order":"58","possible_hits":"2",},
{"lineNum":"  150","line":""},
...
{"lineNum":"  163","line":"    {","class":"lineCov","hits":"2","order":"440","possible_hits":"2",},
{"lineNum":"  164","line":"        if (lock.owns_lock())","class":"lineCov","hits":"1","order":"441","possible_hits":"1",},
{"lineNum":"  165","line":"            LeaveCritical();","class":"lineCov","hits":"1","order":"442","possible_hits":"1",},
...
var header = { "command" : "mint_transaction_debug", "date" : "2023-08-28 11:26:46", "instrumented" : 36, "covered" : 26,};
var merged_data = [];
