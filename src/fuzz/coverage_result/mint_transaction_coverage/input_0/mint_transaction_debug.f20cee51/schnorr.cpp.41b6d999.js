...
{"lineNum":"   12","line":"        const GroupElement& A) {","class":"lineCov","hits":"2","order":"869","possible_hits":"2",},
{"lineNum":"   13","line":"    Transcript transcript(LABEL_TRANSCRIPT_SCHNORR);","class":"linePartCov","hits":"1","order":"870","possible_hits":"4",},
{"lineNum":"   14","line":"    transcript.add(\"G\", G);","class":"linePartCov","hits":"1","order":"920","possible_hits":"2",},
{"lineNum":"   15","line":"    transcript.add(\"Y\", Y);","class":"linePartCov","hits":"1","order":"970","possible_hits":"2",},
{"lineNum":"   16","line":"    transcript.add(\"A\", A);","class":"linePartCov","hits":"1","order":"977","possible_hits":"2",},
{"lineNum":"   17","line":""},
{"lineNum":"   18","line":"    return transcript.challenge(\"c\");","class":"linePartCov","hits":"1","order":"978","possible_hits":"2",},
{"lineNum":"   19","line":"}","class":"linePartCov","hits":"1","order":"1010","possible_hits":"6",},
{"lineNum":"   20","line":""},
...
{"lineNum":"   44","line":""},
{"lineNum":"   45","line":"    const Scalar c = challenge(Y, proof.A);","class":"lineCov","hits":"1","order":"868","possible_hits":"1",},
{"lineNum":"   46","line":"    Scalar c_power(c);","class":"lineCov","hits":"1","order":"1014","possible_hits":"1",},
{"lineNum":"   47","line":""},
{"lineNum":"   48","line":"    proof.t = r;","class":"lineCov","hits":"1","order":"1015","possible_hits":"1",},
{"lineNum":"   49","line":"    for (std::size_t i = 0; i < n; i++) {","class":"linePartCov","hits":"1","order":"1016","possible_hits":"2",},
...
{"lineNum":"   53","line":"}","class":"linePartCov","hits":"1","order":"1017","possible_hits":"6",},
{"lineNum":"   54","line":""},
...
{"lineNum":"   59","line":""},
{"lineNum":"   60","line":"bool Schnorr::verify(const std::vector<GroupElement>& Y, const SchnorrProof& proof) {","class":"lineCov","hits":"2","order":"1025","possible_hits":"2",},
{"lineNum":"   61","line":"    const std::size_t n = Y.size();","class":"lineCov","hits":"1","order":"1026","possible_hits":"1",},
{"lineNum":"   62","line":""},
{"lineNum":"   63","line":"    std::vector<GroupElement> points;","class":"lineCov","hits":"1","order":"1027","possible_hits":"1",},
{"lineNum":"   64","line":"    points.reserve(n + 2);","class":"lineCov","hits":"1","order":"1028","possible_hits":"1",},
{"lineNum":"   65","line":"    std::vector<Scalar> scalars;","class":"lineCov","hits":"1","order":"1029","possible_hits":"1",},
{"lineNum":"   66","line":"    scalars.reserve(n + 2);","class":"lineCov","hits":"1","order":"1030","possible_hits":"1",},
{"lineNum":"   67","line":""},
{"lineNum":"   68","line":"    points.emplace_back(G);","class":"lineCov","hits":"1","order":"1031","possible_hits":"1",},
{"lineNum":"   69","line":"    scalars.emplace_back(proof.t);","class":"lineCov","hits":"1","order":"1035","possible_hits":"1",},
{"lineNum":"   70","line":"    points.emplace_back(proof.A);","class":"lineCov","hits":"1","order":"1036","possible_hits":"1",},
{"lineNum":"   71","line":"    scalars.emplace_back(Scalar(uint64_t(1)).negate());","class":"linePartCov","hits":"1","order":"1037","possible_hits":"2",},
{"lineNum":"   72","line":""},
{"lineNum":"   73","line":"    const Scalar c = challenge(Y, proof.A);","class":"lineCov","hits":"1","order":"1043","possible_hits":"1",},
{"lineNum":"   74","line":"    Scalar c_power(c);","class":"lineCov","hits":"1","order":"1044","possible_hits":"1",},
{"lineNum":"   75","line":"    for (std::size_t i = 0; i < n; i++) {","class":"linePartCov","hits":"1","order":"1045","possible_hits":"2",},
...
{"lineNum":"   80","line":""},
{"lineNum":"   81","line":"    MultiExponent result(points, scalars);","class":"lineCov","hits":"1","order":"1046","possible_hits":"1",},
{"lineNum":"   82","line":"    return result.get_multiple().isInfinity();","class":"linePartCov","hits":"1","order":"1057","possible_hits":"2",},
{"lineNum":"   83","line":"}","class":"linePartCov","hits":"1","order":"1211","possible_hits":"4",},
{"lineNum":"   84","line":""},
{"lineNum":"   85","line":"}"},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "mint_transaction_debug", "date" : "2023-08-28 11:26:46", "instrumented" : 57, "covered" : 37,};
var merged_data = [];
