...
{"lineNum":"  171","line":"        : g_(new secp256k1_gej(*reinterpret_cast<secp256k1_gej *>(other.g_)))","class":"lineCov","hits":"1","order":"1044","possible_hits":"1",},
{"lineNum":"  172","line":"{","class":"lineCov","hits":"2","order":"1043","possible_hits":"2",},
{"lineNum":"  173","line":"}","class":"linePartCov","hits":"1","order":"1045","possible_hits":"2",},
{"lineNum":"  174","line":""},
{"lineNum":"  175","line":"GroupElement::GroupElement(const void *g)"},
{"lineNum":"  176","line":"        : g_(new secp256k1_gej(*reinterpret_cast<const secp256k1_gej *>(g)))","class":"lineCov","hits":"1","order":"793","possible_hits":"1",},
{"lineNum":"  177","line":"{","class":"lineCov","hits":"2","order":"792","possible_hits":"2",},
{"lineNum":"  178","line":"}","class":"linePartCov","hits":"1","order":"794","possible_hits":"2",},
{"lineNum":"  179","line":""},
...
{"lineNum":"  262","line":"    return &result;","class":"lineCov","hits":"1","order":"791","possible_hits":"1",},
{"lineNum":"  263","line":"}"},
{"lineNum":"  264","line":""},
...
{"lineNum":"  275","line":"{","class":"lineCov","hits":"2","order":"797","possible_hits":"2",},
{"lineNum":"  276","line":"    secp256k1_gej result_gej;"},
{"lineNum":"  277","line":"    secp256k1_gej_add_var(&result_gej, reinterpret_cast<secp256k1_gej *>(g_), reinterpret_cast<secp256k1_gej *>(other.g_), NULL);","class":"lineCov","hits":"1","order":"798","possible_hits":"1",},
{"lineNum":"  278","line":"    return &result_gej;","class":"lineCov","hits":"1","order":"824","possible_hits":"1",},
{"lineNum":"  279","line":"}"},
{"lineNum":"  280","line":""},
...
{"lineNum":"  289","line":"{","class":"linePartCov","hits":"1","possible_hits":"2",},
{"lineNum":"  290","line":"    secp256k1_gej result_gej;"},
{"lineNum":"  291","line":"    secp256k1_gej_neg(&result_gej,reinterpret_cast<secp256k1_gej *>(g_));","class":"lineCov","hits":"1","possible_hits":"1",},
{"lineNum":"  292","line":"    return &result_gej;","class":"lineCov","hits":"1","possible_hits":"1",},
{"lineNum":"  293","line":"}"},
{"lineNum":"  294","line":""},
...
{"lineNum":"  302","line":"{","class":"linePartCov","hits":"1","possible_hits":"2",},
{"lineNum":"  303","line":"    auto g = reinterpret_cast<secp256k1_gej *>(g_);","class":"lineCov","hits":"1","possible_hits":"1",},
{"lineNum":"  304","line":"    auto og = reinterpret_cast<secp256k1_gej *>(other.g_);","class":"lineCov","hits":"1","possible_hits":"1",},
{"lineNum":"  305","line":""},
{"lineNum":"  306","line":"    if(g->infinity && og->infinity)","class":"lineCov","hits":"1","possible_hits":"1",},
{"lineNum":"  307","line":"        return true;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  308","line":"    if(g->infinity != og->infinity)","class":"lineCov","hits":"1","possible_hits":"1",},
{"lineNum":"  309","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  310","line":"    secp256k1_ge this_ge = gej_to_ge(*g);","class":"lineCov","hits":"1","possible_hits":"1",},
{"lineNum":"  311","line":"    secp256k1_ge other_ge = gej_to_ge(*og);","class":"lineCov","hits":"1","possible_hits":"1",},
{"lineNum":"  312","line":"    if(!secp256k1_fe_equal(&this_ge.x, &other_ge.x))","class":"lineCov","hits":"1","possible_hits":"1",},
{"lineNum":"  313","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  314","line":"    if(!secp256k1_fe_equal(&this_ge.y, &other_ge.y))","class":"lineCov","hits":"1","possible_hits":"1",},
{"lineNum":"  315","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  316","line":""},
{"lineNum":"  317","line":"    return true;","class":"lineCov","hits":"1","possible_hits":"1",},
{"lineNum":"  318","line":"}","class":"linePartCov","hits":"1","possible_hits":"2",},
{"lineNum":"  319","line":""},
{"lineNum":"  320","line":"bool GroupElement::operator!=(const  GroupElement& other) const"},
{"lineNum":"  321","line":"{","class":"linePartCov","hits":"1","possible_hits":"2",},
{"lineNum":"  322","line":"    return !(*this == other);","class":"lineCov","hits":"1","possible_hits":"1",},
{"lineNum":"  323","line":"}"},
{"lineNum":"  324","line":""},
...
{"lineNum":"  335","line":"{","class":"lineCov","hits":"2","order":"1220","possible_hits":"2",},
{"lineNum":"  336","line":"    return secp256k1_gej_is_infinity(reinterpret_cast<const secp256k1_gej *>(g_));","class":"lineCov","hits":"1","order":"1221","possible_hits":"1",},
{"lineNum":"  337","line":"}"},
{"lineNum":"  338","line":""},
...
{"lineNum":"  506","line":"}"},
{"lineNum":"  507","line":""},
{"lineNum":"  508","line":"unsigned char* GroupElement::serialize(unsigned char* buffer) const {","class":"lineCov","hits":"2","order":"936","possible_hits":"2",},
{"lineNum":"  509","line":"    secp256k1_ge value = gej_to_ge(*reinterpret_cast<secp256k1_gej *>(g_));","class":"lineCov","hits":"1","order":"937","possible_hits":"1",},
{"lineNum":"  510","line":"    secp256k1_fe x = value.x;","class":"lineCov","hits":"1","order":"938","possible_hits":"1",},
{"lineNum":"  511","line":"    secp256k1_fe y = value.y;","class":"lineCov","hits":"1","order":"939","possible_hits":"1",},
{"lineNum":"  512","line":"    secp256k1_fe_normalize(&x);","class":"lineCov","hits":"1","order":"940","possible_hits":"1",},
{"lineNum":"  513","line":"    secp256k1_fe_normalize(&y);","class":"lineCov","hits":"1","order":"961","possible_hits":"1",},
{"lineNum":"  514","line":"    unsigned char oddness = secp256k1_fe_is_odd(&y);","class":"lineCov","hits":"1","order":"962","possible_hits":"1",},
{"lineNum":"  515","line":"    unsigned char infinity = value.infinity;","class":"lineCov","hits":"1","order":"963","possible_hits":"1",},
{"lineNum":"  516","line":"    secp256k1_fe_get_b32(buffer, &x);","class":"lineCov","hits":"1","order":"964","possible_hits":"1",},
{"lineNum":"  517","line":"    buffer[32] = oddness;","class":"lineCov","hits":"1","order":"974","possible_hits":"1",},
{"lineNum":"  518","line":"    buffer[33] = infinity;","class":"lineCov","hits":"1","order":"975","possible_hits":"1",},
{"lineNum":"  519","line":"    return buffer + memoryRequired();","class":"lineCov","hits":"1","order":"976","possible_hits":"1",},
{"lineNum":"  520","line":"}"},
{"lineNum":"  521","line":""},
...
{"lineNum":"  566","line":"}"},
{"lineNum":"  567","line":""},
{"lineNum":"  568","line":"const void* GroupElement::get_value() const {","class":"lineCov","hits":"2","order":"1065","possible_hits":"2",},
{"lineNum":"  569","line":"    return g_;","class":"lineCov","hits":"1","order":"1066","possible_hits":"1",},
{"lineNum":"  570","line":"}"},
{"lineNum":"  571","line":""},
...
var header = { "command" : "mint_transaction_debug", "date" : "2023-08-28 11:27:34", "instrumented" : 343, "covered" : 82,};
var merged_data = [];
