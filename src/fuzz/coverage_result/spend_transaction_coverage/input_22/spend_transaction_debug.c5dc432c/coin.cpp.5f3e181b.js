...
{"lineNum":"   14","line":""},
{"lineNum":"   15","line":"Coin::Coin(","class":"lineCov","hits":"1","order":"1434","possible_hits":"1",},
...
{"lineNum":"   23","line":") {","class":"lineCov","hits":"2","order":"1433","possible_hits":"2",},
{"lineNum":"   24","line":"\tthis->params = params;","class":"lineCov","hits":"1","order":"1436","possible_hits":"1",},
{"lineNum":"   25","line":"\tthis->serial_context = serial_context;","class":"lineCov","hits":"1","order":"1437","possible_hits":"1",},
{"lineNum":"   26","line":""},
{"lineNum":"   27","line":"\t// Validate the type"},
{"lineNum":"   28","line":"\tif (type != COIN_TYPE_MINT && type != COIN_TYPE_SPEND) {","class":"lineCov","hits":"1","order":"1438","possible_hits":"1",},
{"lineNum":"   29","line":"\t\tthrow std::invalid_argument(\"Bad coin type\");","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   30","line":"\t}"},
{"lineNum":"   31","line":"\tthis->type = type;","class":"lineCov","hits":"1","order":"1439","possible_hits":"1",},
{"lineNum":"   32","line":""},
{"lineNum":"   33","line":""},
{"lineNum":"   34","line":"\t//"},
...
{"lineNum":"   39","line":"\tthis->K = SparkUtils::hash_div(address.get_d())*SparkUtils::hash_k(k);","class":"linePartCov","hits":"1","order":"1440","possible_hits":"2",},
{"lineNum":"   40","line":""},
{"lineNum":"   41","line":"\t// Construct the serial commitment"},
{"lineNum":"   42","line":"\tthis->S = this->params->get_F()*SparkUtils::hash_ser(k, serial_context) + address.get_Q2();","class":"linePartCov","hits":"1","order":"1462","possible_hits":"2",},
{"lineNum":"   43","line":""},
{"lineNum":"   44","line":"\t// Construct the value commitment"},
{"lineNum":"   45","line":"\tthis->C = this->params->get_G()*Scalar(v) + this->params->get_H()*SparkUtils::hash_val(k);","class":"linePartCov","hits":"1","order":"1473","possible_hits":"2",},
{"lineNum":"   46","line":""},
{"lineNum":"   47","line":"\t// Check the memo validity, and pad if needed"},
{"lineNum":"   48","line":"\tif (memo.size() > this->params->get_memo_bytes()) {","class":"lineCov","hits":"1","order":"1488","possible_hits":"1",},
{"lineNum":"   49","line":"\t\tthrow std::invalid_argument(\"Memo is too large\");","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   50","line":"\t}"},
{"lineNum":"   51","line":"\tstd::vector<unsigned char> memo_bytes(memo.begin(), memo.end());","class":"linePartCov","hits":"1","order":"1489","possible_hits":"2",},
{"lineNum":"   52","line":"\tstd::vector<unsigned char> padded_memo(memo_bytes);","class":"lineCov","hits":"1","order":"1490","possible_hits":"1",},
{"lineNum":"   53","line":"\tpadded_memo.resize(this->params->get_memo_bytes());","class":"lineCov","hits":"1","order":"1491","possible_hits":"1",},
{"lineNum":"   54","line":""},
{"lineNum":"   55","line":"\t//"},
{"lineNum":"   56","line":"\t// Type-specific elements"},
{"lineNum":"   57","line":"\t//"},
{"lineNum":"   58","line":""},
{"lineNum":"   59","line":"\tif (this->type == COIN_TYPE_MINT) {","class":"lineCov","hits":"1","order":"1492","possible_hits":"1",},
{"lineNum":"   60","line":"\t\tthis->v = v;","class":"lineCov","hits":"1","order":"1493","possible_hits":"1",},
{"lineNum":"   61","line":""},
{"lineNum":"   62","line":"\t\t// Encrypt recipient data"},
{"lineNum":"   63","line":"\t\tMintCoinRecipientData r;","class":"lineCov","hits":"1","order":"1494","possible_hits":"1",},
{"lineNum":"   64","line":"\t\tr.d = address.get_d();","class":"lineCov","hits":"1","order":"1496","possible_hits":"1",},
{"lineNum":"   65","line":"\t\tr.k = k;","class":"lineCov","hits":"1","order":"1497","possible_hits":"1",},
{"lineNum":"   66","line":"\t\tr.memo = std::string(memo.begin(), memo.end());","class":"linePartCov","hits":"1","order":"1498","possible_hits":"2",},
{"lineNum":"   67","line":"\t\tCDataStream r_stream(SER_NETWORK, PROTOCOL_VERSION);","class":"lineCov","hits":"1","order":"1499","possible_hits":"1",},
{"lineNum":"   68","line":"\t\tr_stream << r;","class":"lineCov","hits":"1","order":"1500","possible_hits":"1",},
{"lineNum":"   69","line":"\t\tthis->r_ = AEAD::encrypt(address.get_Q1()*SparkUtils::hash_k(k), \"Mint coin data\", r_stream);","class":"linePartCov","hits":"1","order":"1517","possible_hits":"2",},
{"lineNum":"   70","line":"\t} else {","class":"linePartCov","hits":"1","order":"1600","possible_hits":"2",},
...
{"lineNum":"   81","line":"}","class":"linePartCov","hits":"1","order":"1601","possible_hits":"11",},
{"lineNum":"   82","line":""},
...
var header = { "command" : "spend_transaction_debug", "date" : "2023-08-30 10:04:34", "instrumented" : 103, "covered" : 24,};
var merged_data = [];
