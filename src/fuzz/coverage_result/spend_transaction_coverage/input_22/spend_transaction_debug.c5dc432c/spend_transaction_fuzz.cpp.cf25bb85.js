...
{"lineNum":"    5","line":""},
{"lineNum":"    6","line":"extern \"C\" int LLVMFuzzerTestOneInput(uint8_t *buf, size_t len) {","class":"lineCov","hits":"2","order":"142","possible_hits":"2",},
{"lineNum":"    7","line":"    FuzzedDataProvider fdp(buf, len);","class":"lineCov","hits":"1","order":"143","possible_hits":"1",},
{"lineNum":"    8","line":"    FuzzedSecp256k1Object fsp(&fdp);","class":"lineCov","hits":"1","order":"145","possible_hits":"1",},
{"lineNum":"    9","line":""},
{"lineNum":"   10","line":"    const spark::Params* params;"},
{"lineNum":"   11","line":"    params = spark::Params::get_default();","class":"lineCov","hits":"1","order":"149","possible_hits":"1",},
{"lineNum":"   12","line":"    const std::string memo = fdp.ConsumeBytesAsString(len);","class":"lineCov","hits":"1","order":"555","possible_hits":"1",},
{"lineNum":"   13","line":""},
{"lineNum":"   14","line":"    spark::SpendKey spend_key(params);","class":"lineCov","hits":"1","order":"568","possible_hits":"1",},
{"lineNum":"   15","line":"    spark::FullViewKey full_view_key(spend_key);","class":"lineCov","hits":"1","order":"638","possible_hits":"1",},
{"lineNum":"   16","line":"    spark::IncomingViewKey incoming_view_key(full_view_key);","class":"lineCov","hits":"1","order":"889","possible_hits":"1",},
{"lineNum":"   17","line":""},
{"lineNum":"   18","line":"    spark::Address address(incoming_view_key, fdp.ConsumeIntegral<uint64_t>());","class":"lineCov","hits":"1","order":"901","possible_hits":"1",},
{"lineNum":"   19","line":""},
{"lineNum":"   20","line":"    size_t N = (size_t) pow(params->get_n_grootle(), params->get_m_grootle());","class":"lineCov","hits":"1","order":"1406","possible_hits":"1",},
{"lineNum":"   21","line":""},
{"lineNum":"   22","line":"    bool exception_thrown = false;","class":"lineCov","hits":"1","order":"1411","possible_hits":"1",},
{"lineNum":"   23","line":"    if (memo.size() > params->get_memo_bytes()) {","class":"lineCov","hits":"1","order":"1412","possible_hits":"1",},
{"lineNum":"   24","line":"        try{"},
...
{"lineNum":"   34","line":"    }"},
{"lineNum":"   35","line":""},
{"lineNum":"   36","line":"    std::vector<spark::Coin> in_coins;","class":"lineCov","hits":"1","order":"1415","possible_hits":"1",},
{"lineNum":"   37","line":"    for (size_t i = 0; i < N; i ++) {","class":"lineCov","hits":"2","order":"1416","possible_hits":"2",},
{"lineNum":"   38","line":"        secp_primitives::Scalar k = fsp.GetScalar();","class":"lineCov","hits":"1","order":"1417","possible_hits":"1",},
{"lineNum":"   39","line":""},
{"lineNum":"   40","line":"        uint64_t v = fdp.ConsumeIntegral<uint64_t>();","class":"lineCov","hits":"1","order":"1423","possible_hits":"1",},
{"lineNum":"   41","line":""},
{"lineNum":"   42","line":"        in_coins.emplace_back(spark::Coin(params, spark::COIN_TYPE_MINT, k, address, v, memo, fdp.ConsumeBytes<unsigned char>(spark::SCALAR_ENCODING)));","class":"linePartCov","hits":"1","order":"1424","possible_hits":"2",},
{"lineNum":"   43","line":"    }","class":"linePartCov","hits":"1","order":"1606","possible_hits":"2",},
{"lineNum":"   44","line":""},
{"lineNum":"   45","line":"    uint64_t f = 0;","class":"lineCov","hits":"1","order":"1607","possible_hits":"1",},
{"lineNum":"   46","line":""},
{"lineNum":"   47","line":"    std::vector<uint8_t> spend_indices = fdp.ConsumeBytes<uint8_t>(len);","class":"lineCov","hits":"1","order":"1608","possible_hits":"1",},
{"lineNum":"   48","line":"    std::vector<spark::InputCoinData> spend_coin_data;","class":"lineCov","hits":"1","order":"1609","possible_hits":"1",},
{"lineNum":"   49","line":"    std::unordered_map<uint64_t, spark::CoverSetData> cover_set_data;","class":"lineCov","hits":"1","order":"1610","possible_hits":"1",},
{"lineNum":"   50","line":"    const size_t w = spend_indices.size();","class":"lineCov","hits":"1","order":"1611","possible_hits":"1",},
{"lineNum":"   51","line":"    for (size_t u = 0; u < w; u++) {","class":"linePartCov","hits":"1","order":"1612","possible_hits":"2",},
...
{"lineNum":"   71","line":""},
{"lineNum":"   72","line":"    const size_t t = fdp.ConsumeIntegral<uint8_t>();","class":"lineCov","hits":"1","order":"1613","possible_hits":"1",},
{"lineNum":"   73","line":"    std::vector<spark::OutputCoinData> out_coin_data;","class":"lineCov","hits":"1","order":"1615","possible_hits":"1",},
{"lineNum":"   74","line":"    for (size_t j = 0; j < t; j++) {","class":"linePartCov","hits":"1","order":"1616","possible_hits":"2",},
...
{"lineNum":"   81","line":"    }"},
{"lineNum":"   82","line":""},
{"lineNum":"   83","line":"    uint64_t fee_test = f;","class":"lineCov","hits":"1","order":"1617","possible_hits":"1",},
{"lineNum":"   84","line":"    for (size_t j = 0; j < t; j++) {","class":"linePartCov","hits":"1","order":"1618","possible_hits":"2",},
{"lineNum":"   85","line":"        fee_test += out_coin_data[j].v;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   86","line":"    }"},
{"lineNum":"   87","line":""},
{"lineNum":"   88","line":"    for (size_t j = 0; j < t; j++) {","class":"linePartCov","hits":"1","order":"1619","possible_hits":"2",},
{"lineNum":"   89","line":"        fee_test -= spend_coin_data[j].v;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   90","line":"    }"},
{"lineNum":"   91","line":"    assert(fee_test == 0);","class":"lineCov","hits":"1","order":"1620","possible_hits":"1",},
{"lineNum":"   92","line":""},
{"lineNum":"   93","line":"    spark::SpendTransaction transaction(params, full_view_key, spend_key, spend_coin_data, cover_set_data, f, 0, out_coin_data);","class":"lineCov","hits":"1","order":"1621","possible_hits":"1",},
{"lineNum":"   94","line":""},
...
var header = { "command" : "spend_transaction_debug", "date" : "2023-08-30 10:04:34", "instrumented" : 72, "covered" : 32,};
var merged_data = [];
