...
{"lineNum":"    6","line":"AEADEncryptedData AEAD::encrypt(const GroupElement& prekey, const std::string additional_data, CDataStream& data) {","class":"lineCov","hits":"2","order":"1516","possible_hits":"2",},
{"lineNum":"    7","line":"\t// Set up the result structure"},
{"lineNum":"    8","line":"\tAEADEncryptedData result;","class":"lineCov","hits":"1","order":"1517","possible_hits":"1",},
{"lineNum":"    9","line":""},
{"lineNum":"   10","line":"\t// Derive the key and commitment"},
{"lineNum":"   11","line":"\tstd::vector<unsigned char> key = SparkUtils::kdf_aead(prekey);","class":"lineCov","hits":"1","order":"1518","possible_hits":"1",},
{"lineNum":"   12","line":"\tresult.key_commitment = SparkUtils::commit_aead(prekey);","class":"lineCov","hits":"1","order":"1573","possible_hits":"1",},
{"lineNum":"   13","line":""},
...
{"lineNum":"   18","line":"\tstd::vector<unsigned char> iv;","class":"lineCov","hits":"1","order":"1581","possible_hits":"1",},
{"lineNum":"   19","line":"\tiv.resize(AEAD_IV_SIZE);","class":"lineCov","hits":"1","order":"1582","possible_hits":"1",},
{"lineNum":"   20","line":""},
{"lineNum":"   21","line":"\t// Set up the cipher"},
{"lineNum":"   22","line":"\tEVP_CIPHER_CTX* ctx;","class":"lineCov","hits":"1","order":"1583","possible_hits":"1",},
{"lineNum":"   23","line":"\tctx = EVP_CIPHER_CTX_new();","class":"lineCov","hits":"1","order":"1584","possible_hits":"1",},
{"lineNum":"   24","line":"\tEVP_EncryptInit_ex(ctx, EVP_chacha20_poly1305(), NULL, key.data(), iv.data());","class":"lineCov","hits":"1","order":"1585","possible_hits":"1",},
{"lineNum":"   25","line":""},
{"lineNum":"   26","line":"\t// Include the associated data"},
{"lineNum":"   27","line":"\tstd::vector<unsigned char> additional_data_bytes(additional_data.begin(), additional_data.end());","class":"linePartCov","hits":"1","order":"1586","possible_hits":"2",},
{"lineNum":"   28","line":"\tEVP_EncryptUpdate(ctx, NULL, &TEMP, additional_data_bytes.data(), additional_data_bytes.size());","class":"lineCov","hits":"1","order":"1587","possible_hits":"1",},
{"lineNum":"   29","line":""},
{"lineNum":"   30","line":"\t// Encrypt the plaintext"},
{"lineNum":"   31","line":"\tresult.ciphertext.resize(data.size());","class":"lineCov","hits":"1","order":"1588","possible_hits":"1",},
{"lineNum":"   32","line":"\tEVP_EncryptUpdate(ctx, result.ciphertext.data(), &TEMP, reinterpret_cast<unsigned char *>(data.data()), data.size());","class":"lineCov","hits":"1","order":"1589","possible_hits":"1",},
{"lineNum":"   33","line":"\tEVP_EncryptFinal_ex(ctx, NULL, &TEMP);","class":"lineCov","hits":"1","order":"1590","possible_hits":"1",},
{"lineNum":"   34","line":""},
{"lineNum":"   35","line":"\t// Get the tag"},
{"lineNum":"   36","line":"\tresult.tag.resize(AEAD_TAG_SIZE);","class":"lineCov","hits":"1","order":"1591","possible_hits":"1",},
{"lineNum":"   37","line":"\tEVP_CIPHER_CTX_ctrl(ctx, EVP_CTRL_AEAD_GET_TAG, AEAD_TAG_SIZE, result.tag.data());","class":"lineCov","hits":"1","order":"1592","possible_hits":"1",},
{"lineNum":"   38","line":""},
{"lineNum":"   39","line":"\t// Clean up"},
{"lineNum":"   40","line":"\tEVP_CIPHER_CTX_free(ctx);","class":"lineCov","hits":"1","order":"1593","possible_hits":"1",},
{"lineNum":"   41","line":""},
{"lineNum":"   42","line":"\treturn result;","class":"lineCov","hits":"1","order":"1594","possible_hits":"1",},
{"lineNum":"   43","line":"}","class":"linePartCov","hits":"1","order":"1595","possible_hits":"2",},
{"lineNum":"   44","line":""},
...
var header = { "command" : "spend_transaction_debug", "date" : "2023-08-30 10:00:56", "instrumented" : 41, "covered" : 19,};
var merged_data = [];
