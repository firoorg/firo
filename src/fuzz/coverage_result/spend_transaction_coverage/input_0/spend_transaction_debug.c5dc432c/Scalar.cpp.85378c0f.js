...
{"lineNum":"   22","line":"   : value_(new secp256k1_scalar()) {","class":"lineCov","hits":"2","order":"570","possible_hits":"2",},
{"lineNum":"   23","line":"    secp256k1_scalar_clear(reinterpret_cast<secp256k1_scalar *>(value_));","class":"lineCov","hits":"1","order":"571","possible_hits":"1",},
{"lineNum":"   24","line":"}","class":"linePartCov","hits":"1","order":"578","possible_hits":"2",},
{"lineNum":"   25","line":""},
{"lineNum":"   26","line":"Scalar::Scalar(uint64_t value)"},
{"lineNum":"   27","line":"   : value_(new secp256k1_scalar()) {","class":"lineCov","hits":"2","order":"31","possible_hits":"2",},
{"lineNum":"   28","line":"    unsigned char b32[32];"},
{"lineNum":"   29","line":"    for(int i = 0; i < 24; i++)","class":"lineCov","hits":"2","order":"32","possible_hits":"2",},
{"lineNum":"   30","line":"        b32[i] = 0;","class":"lineCov","hits":"1","order":"33","possible_hits":"1",},
{"lineNum":"   31","line":"    b32[24] = value >> 56;","class":"lineCov","hits":"1","order":"34","possible_hits":"1",},
{"lineNum":"   32","line":"    b32[25] = value >> 48;","class":"lineCov","hits":"1","order":"35","possible_hits":"1",},
{"lineNum":"   33","line":"    b32[26] = value >> 40;","class":"lineCov","hits":"1","order":"36","possible_hits":"1",},
{"lineNum":"   34","line":"    b32[27] = value >> 32;","class":"lineCov","hits":"1","order":"37","possible_hits":"1",},
{"lineNum":"   35","line":"    b32[28] = value >> 24;","class":"lineCov","hits":"1","order":"38","possible_hits":"1",},
{"lineNum":"   36","line":"    b32[29] = value >> 16;","class":"lineCov","hits":"1","order":"39","possible_hits":"1",},
{"lineNum":"   37","line":"    b32[30] = value >> 8;","class":"lineCov","hits":"1","order":"40","possible_hits":"1",},
{"lineNum":"   38","line":"    b32[31] = value;","class":"lineCov","hits":"1","order":"41","possible_hits":"1",},
{"lineNum":"   39","line":"    secp256k1_scalar_set_b32(reinterpret_cast<secp256k1_scalar *>(value_), b32, 0);","class":"lineCov","hits":"1","order":"42","possible_hits":"1",},
{"lineNum":"   40","line":"}","class":"linePartCov","hits":"1","order":"72","possible_hits":"2",},
{"lineNum":"   41","line":""},
...
{"lineNum":"   53","line":"   : value_(new secp256k1_scalar(*reinterpret_cast<const secp256k1_scalar *>(other.value_))) {","class":"lineCov","hits":"2","order":"613","possible_hits":"2",},
{"lineNum":"   54","line":""},
{"lineNum":"   55","line":"}","class":"linePartCov","hits":"1","order":"614","possible_hits":"2",},
{"lineNum":"   56","line":""},
{"lineNum":"   57","line":"Scalar::~Scalar() {","class":"lineCov","hits":"2","order":"627","possible_hits":"2",},
{"lineNum":"   58","line":"    delete reinterpret_cast<secp256k1_scalar *>(value_);","class":"lineCov","hits":"1","order":"628","possible_hits":"1",},
{"lineNum":"   59","line":"}","class":"linePartCov","hits":"1","order":"629","possible_hits":"2",},
{"lineNum":"   60","line":""},
{"lineNum":"   61","line":"Scalar& Scalar::operator=(const Scalar& other) {","class":"lineCov","hits":"2","order":"646","possible_hits":"2",},
{"lineNum":"   62","line":"    return set(other);","class":"lineCov","hits":"1","order":"647","possible_hits":"1",},
{"lineNum":"   63","line":"}"},
{"lineNum":"   64","line":""},
...
{"lineNum":"   73","line":"}"},
{"lineNum":"   74","line":""},
{"lineNum":"   75","line":"Scalar& Scalar::set(const Scalar& other) {","class":"lineCov","hits":"2","order":"648","possible_hits":"2",},
{"lineNum":"   76","line":"    *reinterpret_cast<secp256k1_scalar *>(value_) = *reinterpret_cast<const secp256k1_scalar *>(other.value_);","class":"lineCov","hits":"1","order":"649","possible_hits":"1",},
{"lineNum":"   77","line":"    return *this;","class":"linePartCov","hits":"1","order":"650","possible_hits":"2",},
{"lineNum":"   78","line":"}"},
{"lineNum":"   79","line":""},
...
{"lineNum":"   84","line":"}"},
{"lineNum":"   85","line":""},
{"lineNum":"   86","line":"Scalar& Scalar::operator*=(const Scalar& other) {","class":"lineCov","hits":"2","order":"1698","possible_hits":"2",},
{"lineNum":"   87","line":"    secp256k1_scalar result;"},
{"lineNum":"   88","line":""},
{"lineNum":"   89","line":"    secp256k1_scalar_mul(&result, reinterpret_cast<const secp256k1_scalar *>(value_), reinterpret_cast<const secp256k1_scalar *>(other.value_));","class":"lineCov","hits":"1","order":"1699","possible_hits":"1",},
{"lineNum":"   90","line":"    *reinterpret_cast<secp256k1_scalar *>(value_) = result;","class":"lineCov","hits":"1","order":"1718","possible_hits":"1",},
{"lineNum":"   91","line":""},
{"lineNum":"   92","line":"    return *this;","class":"linePartCov","hits":"1","order":"1719","possible_hits":"2",},
{"lineNum":"   93","line":"}"},
{"lineNum":"   94","line":""},
...
{"lineNum":"  117","line":"}"},
{"lineNum":"  118","line":""},
{"lineNum":"  119","line":"Scalar& Scalar::operator-=(const Scalar& other) {","class":"lineCov","hits":"2","order":"1722","possible_hits":"2",},
{"lineNum":"  120","line":"    secp256k1_scalar negated, result;"},
{"lineNum":"  121","line":""},
{"lineNum":"  122","line":"    secp256k1_scalar_negate(&negated, reinterpret_cast<const secp256k1_scalar *>(other.value_));","class":"lineCov","hits":"1","order":"1723","possible_hits":"1",},
{"lineNum":"  123","line":"    secp256k1_scalar_add(&result, reinterpret_cast<const secp256k1_scalar *>(value_), &negated);","class":"lineCov","hits":"1","order":"1724","possible_hits":"1",},
{"lineNum":"  124","line":"    *reinterpret_cast<secp256k1_scalar *>(value_) = result;","class":"lineCov","hits":"1","order":"1725","possible_hits":"1",},
{"lineNum":"  125","line":""},
{"lineNum":"  126","line":"    return *this;","class":"linePartCov","hits":"1","order":"1726","possible_hits":"2",},
{"lineNum":"  127","line":"}"},
{"lineNum":"  128","line":""},
{"lineNum":"  129","line":"bool Scalar::operator==(const Scalar& other) const {","class":"lineCov","hits":"2","order":"622","possible_hits":"2",},
{"lineNum":"  130","line":"    return secp256k1_scalar_eq(reinterpret_cast<const secp256k1_scalar *>(value_), reinterpret_cast<const secp256k1_scalar *>(other.value_));","class":"lineCov","hits":"1","order":"623","possible_hits":"1",},
{"lineNum":"  131","line":"}"},
{"lineNum":"  132","line":""},
...
{"lineNum":"  135","line":"}"},
{"lineNum":"  136","line":""},
{"lineNum":"  137","line":"const void * Scalar::get_value() const {","class":"lineCov","hits":"2","order":"663","possible_hits":"2",},
{"lineNum":"  138","line":"    return value_;","class":"lineCov","hits":"1","order":"664","possible_hits":"1",},
{"lineNum":"  139","line":"}"},
{"lineNum":"  140","line":""},
...
{"lineNum":"  188","line":""},
{"lineNum":"  189","line":"bool Scalar::isMember() const {","class":"lineCov","hits":"2","order":"611","possible_hits":"2",},
{"lineNum":"  190","line":"    Scalar temp(*this);","class":"lineCov","hits":"1","order":"612","possible_hits":"1",},
{"lineNum":"  191","line":"    temp.mod_p();","class":"lineCov","hits":"1","order":"615","possible_hits":"1",},
{"lineNum":"  192","line":"    return *this == temp;","class":"lineCov","hits":"1","order":"621","possible_hits":"1",},
{"lineNum":"  193","line":"}","class":"lineCov","hits":"1","order":"626","possible_hits":"1",},
{"lineNum":"  194","line":""},
{"lineNum":"  195","line":"bool Scalar::isZero() const {","class":"lineCov","hits":"2","order":"630","possible_hits":"2",},
{"lineNum":"  196","line":"    return secp256k1_scalar_is_zero(reinterpret_cast<const secp256k1_scalar *>(value_));","class":"lineCov","hits":"1","order":"631","possible_hits":"1",},
{"lineNum":"  197","line":"}"},
{"lineNum":"  198","line":""},
...
{"lineNum":"  211","line":""},
{"lineNum":"  212","line":"Scalar& Scalar::randomize() {","class":"lineCov","hits":"2","order":"581","possible_hits":"2",},
{"lineNum":"  213","line":"    unsigned char temp[32] = { 0 };","class":"lineCov","hits":"1","order":"582","possible_hits":"1",},
{"lineNum":"  214","line":""},
{"lineNum":"  215","line":"    do {"},
{"lineNum":"  216","line":"        if (RAND_bytes(temp, 32) != 1) {","class":"lineCov","hits":"1","order":"583","possible_hits":"1",},
{"lineNum":"  217","line":"            throw \"Unable to generate random Scalar\";","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  218","line":"        }"},
{"lineNum":"  219","line":"        generate(temp);","class":"lineCov","hits":"1","order":"584","possible_hits":"1",},
{"lineNum":"  220","line":"    } while (!this->isMember() || this->isZero()); // we need to ensure, generated value is valid and non 0","class":"lineCov","hits":"1","order":"610","possible_hits":"1",},
{"lineNum":"  221","line":""},
{"lineNum":"  222","line":"    return *this;","class":"linePartCov","hits":"1","order":"634","possible_hits":"2",},
{"lineNum":"  223","line":"}"},
{"lineNum":"  224","line":""},
{"lineNum":"  225","line":"Scalar& Scalar::generate(unsigned char* buff) {","class":"lineCov","hits":"2","order":"585","possible_hits":"2",},
{"lineNum":"  226","line":"    secp256k1_scalar zero, result;"},
{"lineNum":"  227","line":""},
{"lineNum":"  228","line":"    secp256k1_scalar_set_b32(reinterpret_cast<secp256k1_scalar *>(value_), buff, nullptr);","class":"lineCov","hits":"1","order":"586","possible_hits":"1",},
{"lineNum":"  229","line":"    secp256k1_scalar_set_int(&zero, 0);","class":"lineCov","hits":"1","order":"587","possible_hits":"1",},
{"lineNum":"  230","line":""},
{"lineNum":"  231","line":"    secp256k1_scalar_add(&result, reinterpret_cast<const secp256k1_scalar *>(value_), &zero);","class":"lineCov","hits":"1","order":"594","possible_hits":"1",},
{"lineNum":"  232","line":"    *reinterpret_cast<secp256k1_scalar *>(value_) = result;","class":"lineCov","hits":"1","order":"608","possible_hits":"1",},
{"lineNum":"  233","line":""},
{"lineNum":"  234","line":"    return *this;","class":"linePartCov","hits":"1","order":"609","possible_hits":"2",},
{"lineNum":"  235","line":"}"},
{"lineNum":"  236","line":""},
{"lineNum":"  237","line":"Scalar& Scalar::mod_p() {","class":"lineCov","hits":"2","order":"616","possible_hits":"2",},
{"lineNum":"  238","line":"    secp256k1_scalar zero, result;"},
{"lineNum":"  239","line":""},
{"lineNum":"  240","line":"    secp256k1_scalar_clear(&zero);","class":"lineCov","hits":"1","order":"617","possible_hits":"1",},
{"lineNum":"  241","line":"    secp256k1_scalar_add(&result, reinterpret_cast<const secp256k1_scalar *>(value_), &zero);","class":"lineCov","hits":"1","order":"618","possible_hits":"1",},
{"lineNum":"  242","line":"    *reinterpret_cast<secp256k1_scalar *>(value_) = result;","class":"lineCov","hits":"1","order":"619","possible_hits":"1",},
{"lineNum":"  243","line":""},
{"lineNum":"  244","line":"    return *this;","class":"lineCov","hits":"2","order":"620","possible_hits":"2",},
{"lineNum":"  245","line":"}"},
{"lineNum":"  246","line":""},
...
{"lineNum":"  287","line":"}"},
{"lineNum":"  288","line":""},
{"lineNum":"  289","line":"unsigned const char* Scalar::deserialize(unsigned const char* buffer) {","class":"lineCov","hits":"2","order":"1400","possible_hits":"2",},
{"lineNum":"  290","line":"    int overflow = 0;","class":"lineCov","hits":"1","order":"1401","possible_hits":"1",},
{"lineNum":"  291","line":""},
{"lineNum":"  292","line":"    secp256k1_scalar_set_b32(reinterpret_cast<secp256k1_scalar *>(value_), buffer, &overflow);","class":"lineCov","hits":"1","order":"1402","possible_hits":"1",},
{"lineNum":"  293","line":""},
{"lineNum":"  294","line":"    if (overflow) {","class":"lineCov","hits":"1","order":"1404","possible_hits":"1",},
{"lineNum":"  295","line":"        throw \"Scalar: decoding overflowed\";","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  296","line":"    }"},
{"lineNum":"  297","line":""},
{"lineNum":"  298","line":"    return buffer + 32;","class":"lineCov","hits":"1","order":"1405","possible_hits":"1",},
{"lineNum":"  299","line":"}"},
{"lineNum":"  300","line":""},
...
var header = { "command" : "spend_transaction_debug", "date" : "2023-08-30 09:54:25", "instrumented" : 187, "covered" : 71,};
var merged_data = [];
