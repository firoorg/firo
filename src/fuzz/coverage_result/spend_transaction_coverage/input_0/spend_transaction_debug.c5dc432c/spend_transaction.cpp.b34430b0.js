...
{"lineNum":"   10","line":""},
{"lineNum":"   11","line":"SpendTransaction::SpendTransaction(","class":"lineCov","hits":"1","order":"1618","possible_hits":"1",},
...
{"lineNum":"   20","line":") {","class":"lineCov","hits":"2","order":"1617","possible_hits":"2",},
{"lineNum":"   21","line":"\tthis->params = params;","class":"lineCov","hits":"1","order":"1622","possible_hits":"1",},
{"lineNum":"   22","line":""},
{"lineNum":"   23","line":"\t// Size parameters"},
{"lineNum":"   24","line":"\tconst std::size_t w = inputs.size(); // number of consumed coins","class":"lineCov","hits":"1","order":"1623","possible_hits":"1",},
{"lineNum":"   25","line":"\tconst std::size_t t = outputs.size(); // number of generated coins","class":"lineCov","hits":"1","order":"1624","possible_hits":"1",},
{"lineNum":"   26","line":"\tconst std::size_t N = (std::size_t) std::pow(params->get_n_grootle(), params->get_m_grootle()); // size of cover sets","class":"lineCov","hits":"1","order":"1625","possible_hits":"1",},
{"lineNum":"   27","line":""},
{"lineNum":"   28","line":"\t// Prepare input-related vectors"},
{"lineNum":"   29","line":"\tthis->cover_set_ids.reserve(w); // cover set data and metadata","class":"lineCov","hits":"1","order":"1626","possible_hits":"1",},
{"lineNum":"   30","line":"    this->setCoverSets(cover_set_data);","class":"lineCov","hits":"1","order":"1627","possible_hits":"1",},
{"lineNum":"   31","line":"\tthis->S1.reserve(w); // serial commitment offsets","class":"lineCov","hits":"1","order":"1631","possible_hits":"1",},
{"lineNum":"   32","line":"\tthis->C1.reserve(w); // value commitment offsets","class":"lineCov","hits":"1","order":"1632","possible_hits":"1",},
{"lineNum":"   33","line":"\tthis->grootle_proofs.reserve(w); // Grootle one-of-many proofs","class":"lineCov","hits":"1","order":"1633","possible_hits":"1",},
{"lineNum":"   34","line":"\tthis->T.reserve(w); // linking tags","class":"lineCov","hits":"1","order":"1634","possible_hits":"1",},
{"lineNum":"   35","line":""},
{"lineNum":"   36","line":"\tthis->f = f; // fee","class":"lineCov","hits":"1","order":"1635","possible_hits":"1",},
{"lineNum":"   37","line":"    this->vout = vout; // transparent output value","class":"lineCov","hits":"1","order":"1636","possible_hits":"1",},
{"lineNum":"   38","line":""},
{"lineNum":"   39","line":"\t// Prepare Chaum vectors"},
{"lineNum":"   40","line":"\tstd::vector<Scalar> chaum_x, chaum_y, chaum_z;","class":"lineCov","hits":"1","order":"1637","possible_hits":"1",},
{"lineNum":"   41","line":""},
{"lineNum":"   42","line":"\t// Prepare output vector"},
{"lineNum":"   43","line":"\tthis->out_coins.reserve(t); // coins","class":"lineCov","hits":"1","order":"1638","possible_hits":"1",},
{"lineNum":"   44","line":"\tstd::vector<Scalar> k; // nonces","class":"lineCov","hits":"1","order":"1639","possible_hits":"1",},
{"lineNum":"   45","line":""},
{"lineNum":"   46","line":"\t// Prepare inputs"},
{"lineNum":"   47","line":"\tGrootle grootle(","class":"lineCov","hits":"1","order":"1649","possible_hits":"1",},
{"lineNum":"   48","line":"\t\tthis->params->get_H(),","class":"lineCov","hits":"1","order":"1640","possible_hits":"1",},
{"lineNum":"   49","line":"\t\tthis->params->get_G_grootle(),","class":"lineCov","hits":"1","order":"1641","possible_hits":"1",},
{"lineNum":"   50","line":"\t\tthis->params->get_H_grootle(),","class":"lineCov","hits":"1","order":"1644","possible_hits":"1",},
{"lineNum":"   51","line":"\t\tthis->params->get_n_grootle(),","class":"lineCov","hits":"1","order":"1647","possible_hits":"1",},
{"lineNum":"   52","line":"\t\tthis->params->get_m_grootle()","class":"lineCov","hits":"1","order":"1648","possible_hits":"1",},
{"lineNum":"   53","line":"\t);"},
{"lineNum":"   54","line":"\tfor (std::size_t u = 0; u < w; u++) {","class":"linePartCov","hits":"1","order":"1659","possible_hits":"2",},
...
{"lineNum":"  112","line":"\tstd::vector<Scalar> range_v;","class":"lineCov","hits":"1","order":"1660","possible_hits":"1",},
{"lineNum":"  113","line":"\tstd::vector<Scalar> range_r;","class":"lineCov","hits":"1","order":"1661","possible_hits":"1",},
{"lineNum":"  114","line":"\tstd::vector<GroupElement> range_C;","class":"lineCov","hits":"1","order":"1662","possible_hits":"1",},
{"lineNum":"  115","line":""},
...
{"lineNum":"  117","line":"    CDataStream serial_context(SER_NETWORK, PROTOCOL_VERSION);","class":"lineCov","hits":"1","order":"1663","possible_hits":"1",},
{"lineNum":"  118","line":"\tserial_context << this->T;","class":"lineCov","hits":"1","order":"1664","possible_hits":"1",},
{"lineNum":"  119","line":""},
{"lineNum":"  120","line":"\tfor (std::size_t j = 0; j < t; j++) {","class":"linePartCov","hits":"1","order":"1669","possible_hits":"2",},
...
{"lineNum":"  144","line":"\tBPPlus range(","class":"lineCov","hits":"2","order":"1670","possible_hits":"2",},
{"lineNum":"  145","line":"\t\tthis->params->get_G(),","class":"lineCov","hits":"1","order":"1671","possible_hits":"1",},
{"lineNum":"  146","line":"\t\tthis->params->get_H(),","class":"lineCov","hits":"1","order":"1672","possible_hits":"1",},
{"lineNum":"  147","line":"\t\tthis->params->get_G_range(),","class":"lineCov","hits":"1","order":"1673","possible_hits":"1",},
{"lineNum":"  148","line":"\t\tthis->params->get_H_range(),","class":"lineCov","hits":"1","order":"1676","possible_hits":"1",},
{"lineNum":"  149","line":"\t\t64"},
{"lineNum":"  150","line":"\t);"},
{"lineNum":"  151","line":"\trange.prove(","class":"lineCov","hits":"1","order":"1729","possible_hits":"1",},
{"lineNum":"  152","line":"\t\trange_v,"},
{"lineNum":"  153","line":"\t\trange_r,"},
{"lineNum":"  154","line":"\t\trange_C,"},
{"lineNum":"  155","line":"\t\tthis->range_proof","class":"lineCov","hits":"1","order":"1728","possible_hits":"1",},
{"lineNum":"  156","line":"\t);"},
{"lineNum":"  157","line":""},
...
var header = { "command" : "spend_transaction_debug", "date" : "2023-08-30 09:54:25", "instrumented" : 258, "covered" : 37,};
var merged_data = [];
