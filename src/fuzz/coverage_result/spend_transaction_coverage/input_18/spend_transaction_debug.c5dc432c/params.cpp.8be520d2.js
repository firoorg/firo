...
{"lineNum":"    6","line":""},
{"lineNum":"    7","line":"    CCriticalSection Params::cs_instance;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"    8","line":"    std::unique_ptr<Params> Params::instance;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"    9","line":""},
{"lineNum":"   10","line":"// Protocol parameters for deployment"},
{"lineNum":"   11","line":"Params const* Params::get_default() {","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   12","line":"    if (instance) {","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   13","line":"        return instance.get();","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   14","line":"    } else {"},
{"lineNum":"   15","line":"        LOCK(cs_instance);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   16","line":"        if (instance) {","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   17","line":"            return instance.get();","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   18","line":"        }"},
{"lineNum":"   19","line":""},
{"lineNum":"   20","line":"        std::size_t memo_bytes = 32;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   21","line":"        std::size_t max_M_range = 16;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   22","line":"        std::size_t n_grootle = 16;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   23","line":"        std::size_t m_grootle = 4;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   24","line":""},
{"lineNum":"   25","line":"        instance.reset(new Params(memo_bytes, max_M_range, n_grootle, m_grootle));","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   26","line":"        return instance.get();","class":"lineNoCov","hits":"0","possible_hits":"1",},
...
{"lineNum":"   49","line":""},
{"lineNum":"   50","line":"Params::Params(","class":"lineNoCov","hits":"0","possible_hits":"1",},
...
{"lineNum":"   58","line":"    this->F = SparkUtils::hash_generator(LABEL_GENERATOR_F);","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   59","line":"    this->G.set_base_g();","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   60","line":"    this->H = SparkUtils::hash_generator(LABEL_GENERATOR_H);","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   61","line":"    this->U = SparkUtils::hash_generator(LABEL_GENERATOR_U);","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   62","line":""},
{"lineNum":"   63","line":"    // Coin parameters"},
{"lineNum":"   64","line":"    this->memo_bytes = memo_bytes;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   65","line":""},
{"lineNum":"   66","line":"    // Range proof parameters"},
{"lineNum":"   67","line":"    this->max_M_range = max_M_range;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   68","line":"    this->G_range.resize(64*max_M_range);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   69","line":"    this->H_range.resize(64*max_M_range);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   70","line":"    for (std::size_t i = 0; i < 64*max_M_range; i++) {","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   71","line":"        this->G_range[i] = SparkUtils::hash_generator(LABEL_GENERATOR_G_RANGE + \" \" + std::to_string(i));","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   72","line":"        this->H_range[i] = SparkUtils::hash_generator(LABEL_GENERATOR_H_RANGE + \" \" + std::to_string(i));","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   73","line":"    }"},
{"lineNum":"   74","line":""},
{"lineNum":"   75","line":"    // One-of-many parameters"},
{"lineNum":"   76","line":"    if (n_grootle < 2 || m_grootle < 3) {","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   77","line":"        throw std::invalid_argument(\"Bad Grootle parameteres\");","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   78","line":"    }"},
{"lineNum":"   79","line":"    this->n_grootle = n_grootle;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   80","line":"    this->m_grootle = m_grootle;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   81","line":"    this->G_grootle.resize(n_grootle * m_grootle);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   82","line":"    this->H_grootle.resize(n_grootle * m_grootle);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   83","line":"    for (std::size_t i = 0; i < n_grootle * m_grootle; i++) {","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   84","line":"        this->G_grootle[i] = SparkUtils::hash_generator(LABEL_GENERATOR_G_GROOTLE + \" \" + std::to_string(i));","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   85","line":"        this->H_grootle[i] = SparkUtils::hash_generator(LABEL_GENERATOR_H_GROOTLE + \" \" + std::to_string(i));","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   86","line":"    }"},
{"lineNum":"   87","line":"}","class":"lineNoCov","hits":"0","possible_hits":"9",},
{"lineNum":"   88","line":""},
{"lineNum":"   89","line":"const GroupElement& Params::get_F() const {","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   90","line":"    return this->F;","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   91","line":"}"},
{"lineNum":"   92","line":""},
{"lineNum":"   93","line":"const GroupElement& Params::get_G() const {","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   94","line":"    return this->G;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   95","line":"}"},
{"lineNum":"   96","line":""},
{"lineNum":"   97","line":"const GroupElement& Params::get_H() const {","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   98","line":"    return this->H;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   99","line":"}"},
{"lineNum":"  100","line":""},
...
var header = { "command" : "spend_transaction_debug", "date" : "2023-08-30 10:01:23", "instrumented" : 77, "covered" : 0,};
var merged_data = [];
