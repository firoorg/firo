...
{"lineNum":"   46","line":"{","class":"lineCov","hits":"1","order":"1374",},
{"lineNum":"   47","line":"    AES256_init(&ctx, key);","class":"lineCov","hits":"1","order":"1375",},
{"lineNum":"   48","line":"}","class":"lineCov","hits":"1","order":"1369",},
{"lineNum":"   49","line":""},
{"lineNum":"   50","line":"AES256Encrypt::~AES256Encrypt()"},
{"lineNum":"   51","line":"{","class":"lineCov","hits":"1","order":"1377",},
{"lineNum":"   52","line":"    memset(&ctx, 0, sizeof(ctx));","class":"lineCov","hits":"1","order":"1378",},
{"lineNum":"   53","line":"}","class":"lineCov","hits":"1","order":"1368",},
{"lineNum":"   54","line":""},
{"lineNum":"   55","line":"void AES256Encrypt::Encrypt(unsigned char ciphertext[16], const unsigned char plaintext[16]) const"},
{"lineNum":"   56","line":"{","class":"lineCov","hits":"1","order":"1379",},
{"lineNum":"   57","line":"    AES256_encrypt(&ctx, 1, ciphertext, plaintext);","class":"lineCov","hits":"1","order":"1381",},
{"lineNum":"   58","line":"}","class":"lineCov","hits":"1","order":"1367",},
{"lineNum":"   59","line":""},
...
{"lineNum":"   78","line":"{","class":"lineCov","hits":"1","order":"1389",},
{"lineNum":"   79","line":"    int written = 0;","class":"lineCov","hits":"1","order":"1390",},
{"lineNum":"   80","line":"    int padsize = size % AES_BLOCKSIZE;","class":"lineCov","hits":"1","order":"1376",},
{"lineNum":"   81","line":"    unsigned char mixed[AES_BLOCKSIZE];"},
{"lineNum":"   82","line":""},
{"lineNum":"   83","line":"    if (!data || !size || !out)","class":"lineCov","hits":"1","order":"1391",},
{"lineNum":"   84","line":"        return 0;","class":"lineNoCov","hits":"0",},
{"lineNum":"   85","line":""},
{"lineNum":"   86","line":"    if (!pad && padsize != 0)","class":"lineCov","hits":"1","order":"1380",},
{"lineNum":"   87","line":"        return 0;","class":"lineNoCov","hits":"0",},
{"lineNum":"   88","line":""},
{"lineNum":"   89","line":"    memcpy(mixed, iv, AES_BLOCKSIZE);","class":"lineCov","hits":"1","order":"1392",},
{"lineNum":"   90","line":""},
{"lineNum":"   91","line":"    // Write all but the last block"},
{"lineNum":"   92","line":"    while (written + AES_BLOCKSIZE <= size) {","class":"lineCov","hits":"1","order":"1383",},
...
{"lineNum":"   98","line":"    }"},
{"lineNum":"   99","line":"    if (pad) {","class":"lineCov","hits":"1","order":"1386",},
...
{"lineNum":"  102","line":"        for (int i = 0; i != padsize; i++)","class":"lineCov","hits":"1","order":"1371",},
{"lineNum":"  103","line":"            mixed[i] ^= *data++;","class":"lineCov","hits":"1","order":"1388",},
{"lineNum":"  104","line":"        for (int i = padsize; i != AES_BLOCKSIZE; i++)","class":"lineCov","hits":"1","order":"1366",},
{"lineNum":"  105","line":"            mixed[i] ^= AES_BLOCKSIZE - padsize;","class":"lineCov","hits":"1","order":"1365",},
{"lineNum":"  106","line":"        enc.Encrypt(out + written, mixed);","class":"lineCov","hits":"1","order":"1364",},
{"lineNum":"  107","line":"        written += AES_BLOCKSIZE;","class":"lineCov","hits":"1","order":"1363",},
{"lineNum":"  108","line":"    }"},
{"lineNum":"  109","line":"    return written;","class":"lineCov","hits":"1","order":"1362",},
{"lineNum":"  110","line":"}","class":"lineCov","hits":"1","order":"1361",},
{"lineNum":"  111","line":""},
...
{"lineNum":"  155","line":"    : enc(key), pad(padIn)","class":"lineCov","hits":"1","order":"1382",},
{"lineNum":"  156","line":"{","class":"lineCov","hits":"1","order":"1373",},
{"lineNum":"  157","line":"    memcpy(iv, ivIn, AES_BLOCKSIZE);","class":"lineCov","hits":"1","order":"1384",},
{"lineNum":"  158","line":"}","class":"lineCov","hits":"1","order":"1385",},
{"lineNum":"  159","line":""},
{"lineNum":"  160","line":"int AES256CBCEncrypt::Encrypt(const unsigned char* data, int size, unsigned char* out) const"},
{"lineNum":"  161","line":"{","class":"lineCov","hits":"1","order":"1370",},
{"lineNum":"  162","line":"    return CBCEncrypt(enc, iv, data, size, pad, out);","class":"lineCov","hits":"1","order":"1387",},
{"lineNum":"  163","line":"}"},
{"lineNum":"  164","line":""},
{"lineNum":"  165","line":"AES256CBCEncrypt::~AES256CBCEncrypt()"},
{"lineNum":"  166","line":"{","class":"lineCov","hits":"1","order":"1360",},
{"lineNum":"  167","line":"    memset(iv, 0, sizeof(iv));","class":"lineCov","hits":"1","order":"1359",},
{"lineNum":"  168","line":"}","class":"lineCov","hits":"1","order":"1372",},
{"lineNum":"  169","line":""},
...
var header = { "command" : "", "date" : "2023-08-30 10:04:36", "instrumented" : 119, "covered" : 34,};
var merged_data = [];
