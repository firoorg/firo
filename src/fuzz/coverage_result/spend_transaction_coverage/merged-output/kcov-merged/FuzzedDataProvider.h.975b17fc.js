...
{"lineNum":"   36","line":"      : data_ptr_(data), remaining_bytes_(size) {}","class":"lineCov","hits":"1","order":"1354",},
...
{"lineNum":"  108","line":"std::vector<T> FuzzedDataProvider::ConsumeBytes(size_t num_bytes) {","class":"lineCov","hits":"1","order":"1343",},
{"lineNum":"  109","line":"  num_bytes = std::min(num_bytes, remaining_bytes_);","class":"lineCov","hits":"1","order":"1341",},
{"lineNum":"  110","line":"  return ConsumeBytes<T>(num_bytes, num_bytes);","class":"lineCov","hits":"1","order":"1347",},
{"lineNum":"  111","line":"}"},
{"lineNum":"  112","line":""},
...
{"lineNum":"  136","line":"inline std::string FuzzedDataProvider::ConsumeBytesAsString(size_t num_bytes) {","class":"lineCov","hits":"1","order":"1339",},
...
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"  num_bytes = std::min(num_bytes, remaining_bytes_);","class":"lineCov","hits":"1","order":"1345",},
{"lineNum":"  141","line":"  std::string result(","class":"lineCov","hits":"1","order":"1342",},
{"lineNum":"  142","line":"      reinterpret_cast<const std::string::value_type *>(data_ptr_), num_bytes);","class":"lineCov","hits":"1","order":"1340",},
{"lineNum":"  143","line":"  Advance(num_bytes);","class":"lineCov","hits":"1","order":"1336",},
{"lineNum":"  144","line":"  return result;","class":"lineCov","hits":"1","order":"1334",},
{"lineNum":"  145","line":"}","class":"lineCov","hits":"1","order":"1350",},
{"lineNum":"  146","line":""},
...
{"lineNum":"  194","line":"template <typename T> T FuzzedDataProvider::ConsumeIntegral() {","class":"lineCov","hits":"1","order":"1337",},
{"lineNum":"  195","line":"  return ConsumeIntegralInRange(std::numeric_limits<T>::min(),","class":"lineCov","hits":"1","order":"1338",},
{"lineNum":"  196","line":"                                std::numeric_limits<T>::max());","class":"lineCov","hits":"1","order":"1331",},
{"lineNum":"  197","line":"}"},
{"lineNum":"  198","line":""},
...
{"lineNum":"  204","line":"T FuzzedDataProvider::ConsumeIntegralInRange(T min, T max) {","class":"lineCov","hits":"1","order":"1351",},
...
{"lineNum":"  207","line":""},
{"lineNum":"  208","line":"  if (min > max)","class":"lineCov","hits":"1","order":"1352",},
...
{"lineNum":"  212","line":"  uint64_t range = static_cast<uint64_t>(max) - min;","class":"lineCov","hits":"1","order":"1353",},
{"lineNum":"  213","line":"  uint64_t result = 0;","class":"lineCov","hits":"1","order":"1355",},
{"lineNum":"  214","line":"  size_t offset = 0;","class":"lineCov","hits":"1","order":"1356",},
{"lineNum":"  215","line":""},
{"lineNum":"  216","line":"  while (offset < sizeof(T) * CHAR_BIT && (range >> offset) > 0 &&","class":"lineCov","hits":"1","order":"1357",},
{"lineNum":"  217","line":"         remaining_bytes_ != 0) {","class":"lineCov","hits":"1","order":"1358",},
...
{"lineNum":"  230","line":"  if (range != std::numeric_limits<decltype(range)>::max())","class":"lineCov","hits":"1","order":"1332",},
{"lineNum":"  231","line":"    result = result % (range + 1);","class":"lineCov","hits":"1","order":"1348",},
{"lineNum":"  232","line":""},
{"lineNum":"  233","line":"  return static_cast<T>(min + result);","class":"lineCov","hits":"1","order":"1330",},
{"lineNum":"  234","line":"}"},
{"lineNum":"  235","line":""},
...
{"lineNum":"  341","line":"}","class":"lineCov","hits":"1","order":"1324",},
{"lineNum":"  342","line":""},
{"lineNum":"  343","line":"inline void FuzzedDataProvider::Advance(size_t num_bytes) {","class":"lineCov","hits":"1","order":"1346",},
{"lineNum":"  344","line":"  if (num_bytes > remaining_bytes_)","class":"lineCov","hits":"1","order":"1344",},
{"lineNum":"  345","line":"    abort();","class":"lineNoCov","hits":"0",},
{"lineNum":"  346","line":""},
{"lineNum":"  347","line":"  data_ptr_ += num_bytes;","class":"lineCov","hits":"1","order":"1335",},
{"lineNum":"  348","line":"  remaining_bytes_ -= num_bytes;","class":"lineCov","hits":"1","order":"1333",},
{"lineNum":"  349","line":"}","class":"lineCov","hits":"1","order":"1349",},
{"lineNum":"  350","line":""},
{"lineNum":"  351","line":"template <typename T>"},
{"lineNum":"  352","line":"std::vector<T> FuzzedDataProvider::ConsumeBytes(size_t size, size_t num_bytes) {","class":"lineCov","hits":"1","order":"1329",},
...
{"lineNum":"  361","line":"  std::vector<T> result(size);","class":"lineCov","hits":"1","order":"1328",},
{"lineNum":"  362","line":"  if (size == 0) {","class":"lineCov","hits":"1","order":"1327",},
{"lineNum":"  363","line":"    if (num_bytes != 0)","class":"lineCov","hits":"1","order":"1326",},
{"lineNum":"  364","line":"      abort();","class":"lineNoCov","hits":"0",},
{"lineNum":"  365","line":"    return result;","class":"lineCov","hits":"1","order":"1325",},
{"lineNum":"  366","line":"  }"},
{"lineNum":"  367","line":""},
...
var header = { "command" : "", "date" : "2023-08-30 10:04:36", "instrumented" : 48, "covered" : 35,};
var merged_data = [];
