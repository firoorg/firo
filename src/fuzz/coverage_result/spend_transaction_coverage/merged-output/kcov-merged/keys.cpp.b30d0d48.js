...
{"lineNum":"    7","line":""},
{"lineNum":"    8","line":"SpendKey::SpendKey(const Params* params) {","class":"lineCov","hits":"1","order":"1704",},
{"lineNum":"    9","line":"\tthis->params = params;","class":"lineCov","hits":"1","order":"1700",},
{"lineNum":"   10","line":"\tthis->s1.randomize();","class":"lineCov","hits":"1","order":"1698",},
{"lineNum":"   11","line":"\tthis->s2.randomize();","class":"lineCov","hits":"1","order":"1697",},
{"lineNum":"   12","line":"\tthis->r.randomize();","class":"lineCov","hits":"1","order":"1696",},
{"lineNum":"   13","line":"}","class":"lineCov","hits":"1","order":"1695",},
{"lineNum":"   14","line":""},
...
{"lineNum":"   41","line":""},
{"lineNum":"   42","line":"const Params* SpendKey::get_params() const {","class":"lineCov","hits":"1","order":"1690",},
{"lineNum":"   43","line":"\treturn this->params;","class":"lineCov","hits":"1","order":"1688",},
{"lineNum":"   44","line":"}"},
{"lineNum":"   45","line":""},
{"lineNum":"   46","line":"const Scalar& SpendKey::get_s1() const {","class":"lineCov","hits":"1","order":"1687",},
{"lineNum":"   47","line":"\treturn this->s1;","class":"lineCov","hits":"1","order":"1686",},
{"lineNum":"   48","line":"}"},
{"lineNum":"   49","line":""},
{"lineNum":"   50","line":"const Scalar& SpendKey::get_s2() const {","class":"lineCov","hits":"1","order":"1685",},
{"lineNum":"   51","line":"\treturn this->s2;","class":"lineCov","hits":"1","order":"1684",},
{"lineNum":"   52","line":"}"},
{"lineNum":"   53","line":""},
{"lineNum":"   54","line":"const Scalar& SpendKey::get_r() const {","class":"lineCov","hits":"1","order":"1683",},
{"lineNum":"   55","line":"\treturn this->r;","class":"lineCov","hits":"1","order":"1682",},
{"lineNum":"   56","line":"}"},
{"lineNum":"   57","line":""},
...
{"lineNum":"   77","line":"FullViewKey::FullViewKey(const SpendKey& spend_key) {","class":"lineCov","hits":"1","order":"1694",},
{"lineNum":"   78","line":"\tthis->params = spend_key.get_params();","class":"lineCov","hits":"1","order":"1693",},
{"lineNum":"   79","line":"\tthis->s1 = spend_key.get_s1();","class":"lineCov","hits":"1","order":"1692",},
{"lineNum":"   80","line":"\tthis->s2 = spend_key.get_s2();","class":"lineCov","hits":"1","order":"1702",},
{"lineNum":"   81","line":"\tthis->D = this->params->get_G()*spend_key.get_r();","class":"lineCov","hits":"1","order":"1681",},
{"lineNum":"   82","line":"\tthis->P2 = this->params->get_F()*this->s2 + this->D;","class":"lineCov","hits":"1","order":"1705",},
{"lineNum":"   83","line":"}","class":"lineCov","hits":"1","order":"1713",},
{"lineNum":"   84","line":""},
{"lineNum":"   85","line":"const Params* FullViewKey::get_params() const {","class":"lineCov","hits":"1","order":"1714",},
{"lineNum":"   86","line":"\treturn this->params;","class":"lineCov","hits":"1","order":"1715",},
{"lineNum":"   87","line":"}"},
{"lineNum":"   88","line":""},
{"lineNum":"   89","line":"const Scalar& FullViewKey::get_s1() const {","class":"lineCov","hits":"1","order":"1716",},
{"lineNum":"   90","line":"\treturn this->s1;","class":"lineCov","hits":"1","order":"1717",},
{"lineNum":"   91","line":"}"},
{"lineNum":"   92","line":""},
...
{"lineNum":"   99","line":"}"},
{"lineNum":"  100","line":""},
{"lineNum":"  101","line":"const GroupElement& FullViewKey::get_P2() const {","class":"lineCov","hits":"1","order":"1718",},
{"lineNum":"  102","line":"\treturn this->P2;","class":"lineCov","hits":"1","order":"1719",},
{"lineNum":"  103","line":"}"},
{"lineNum":"  104","line":""},
...
{"lineNum":"  110","line":""},
{"lineNum":"  111","line":"IncomingViewKey::IncomingViewKey(const FullViewKey& full_view_key) {","class":"lineCov","hits":"1","order":"1720",},
{"lineNum":"  112","line":"\tthis->params = full_view_key.get_params();","class":"lineCov","hits":"1","order":"1721",},
{"lineNum":"  113","line":"\tthis->s1 = full_view_key.get_s1();","class":"lineCov","hits":"1","order":"1722",},
{"lineNum":"  114","line":"\tthis->P2 = full_view_key.get_P2();","class":"lineCov","hits":"1","order":"1723",},
{"lineNum":"  115","line":"}","class":"lineCov","hits":"1","order":"1724",},
{"lineNum":"  116","line":""},
{"lineNum":"  117","line":"const Params* IncomingViewKey::get_params() const {","class":"lineCov","hits":"1","order":"1725",},
{"lineNum":"  118","line":"\treturn this->params;","class":"lineCov","hits":"1","order":"1726",},
{"lineNum":"  119","line":"}"},
{"lineNum":"  120","line":""},
{"lineNum":"  121","line":"const Scalar& IncomingViewKey::get_s1() const {","class":"lineCov","hits":"1","order":"1727",},
{"lineNum":"  122","line":"\treturn this->s1;","class":"lineCov","hits":"1","order":"1728",},
{"lineNum":"  123","line":"}"},
{"lineNum":"  124","line":""},
{"lineNum":"  125","line":"const GroupElement& IncomingViewKey::get_P2() const {","class":"lineCov","hits":"1","order":"1729",},
{"lineNum":"  126","line":"\treturn this->P2;","class":"lineCov","hits":"1","order":"1730",},
{"lineNum":"  127","line":"}"},
{"lineNum":"  128","line":""},
...
{"lineNum":"  147","line":""},
{"lineNum":"  148","line":"Address::Address(const IncomingViewKey& incoming_view_key, const uint64_t i) {","class":"lineCov","hits":"1","order":"1703",},
{"lineNum":"  149","line":"\t// Encrypt the diversifier"},
{"lineNum":"  150","line":"\tstd::vector<unsigned char> key = SparkUtils::kdf_diversifier(incoming_view_key.get_s1());","class":"lineCov","hits":"1","order":"1706",},
{"lineNum":"  151","line":"\tthis->params = incoming_view_key.get_params();","class":"lineCov","hits":"1","order":"1707",},
{"lineNum":"  152","line":"\tthis->d = SparkUtils::diversifier_encrypt(key, i);","class":"lineCov","hits":"1","order":"1708",},
{"lineNum":"  153","line":"\tthis->Q1 = SparkUtils::hash_div(this->d)*incoming_view_key.get_s1();","class":"lineCov","hits":"1","order":"1709",},
{"lineNum":"  154","line":"\tthis->Q2 = this->params->get_F()*SparkUtils::hash_Q2(incoming_view_key.get_s1(), i) + incoming_view_key.get_P2();","class":"lineCov","hits":"1","order":"1710",},
{"lineNum":"  155","line":"}","class":"lineCov","hits":"1","order":"1711",},
{"lineNum":"  156","line":""},
...
{"lineNum":"  159","line":"}"},
{"lineNum":"  160","line":""},
{"lineNum":"  161","line":"const std::vector<unsigned char>& Address::get_d() const {","class":"lineCov","hits":"1","order":"1731",},
{"lineNum":"  162","line":"\treturn this->d;","class":"lineCov","hits":"1","order":"1712",},
{"lineNum":"  163","line":"}"},
{"lineNum":"  164","line":""},
{"lineNum":"  165","line":"const GroupElement& Address::get_Q1() const {","class":"lineCov","hits":"1","order":"1701",},
{"lineNum":"  166","line":"\treturn this->Q1;","class":"lineCov","hits":"1","order":"1699",},
{"lineNum":"  167","line":"}"},
{"lineNum":"  168","line":""},
{"lineNum":"  169","line":"const GroupElement& Address::get_Q2() const {","class":"lineCov","hits":"1","order":"1691",},
{"lineNum":"  170","line":"\treturn this->Q2;","class":"lineCov","hits":"1","order":"1689",},
{"lineNum":"  171","line":"}"},
{"lineNum":"  172","line":""},
...
var header = { "command" : "", "date" : "2023-08-30 10:04:36", "instrumented" : 188, "covered" : 51,};
var merged_data = [];
