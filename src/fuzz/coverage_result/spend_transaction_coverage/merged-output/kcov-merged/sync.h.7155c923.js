...
{"lineNum":"   55","line":"class LOCKABLE AnnotatedMixin : public PARENT","class":"lineCov","hits":"1","order":"1115",},
{"lineNum":"   56","line":"{"},
{"lineNum":"   57","line":"public:"},
{"lineNum":"   58","line":"    void lock() EXCLUSIVE_LOCK_FUNCTION()"},
{"lineNum":"   59","line":"    {","class":"lineCov","hits":"1","order":"1104",},
{"lineNum":"   60","line":"        PARENT::lock();","class":"lineCov","hits":"1","order":"1103",},
{"lineNum":"   61","line":"    }","class":"lineCov","hits":"1","order":"1102",},
{"lineNum":"   62","line":""},
{"lineNum":"   63","line":"    void unlock() UNLOCK_FUNCTION()"},
{"lineNum":"   64","line":"    {","class":"lineCov","hits":"1","order":"1101",},
{"lineNum":"   65","line":"        PARENT::unlock();","class":"lineCov","hits":"1","order":"1100",},
{"lineNum":"   66","line":"    }","class":"lineCov","hits":"1","order":"1099",},
{"lineNum":"   67","line":""},
{"lineNum":"   68","line":"    bool try_lock() EXCLUSIVE_TRYLOCK_FUNCTION(true)"},
{"lineNum":"   69","line":"    {","class":"lineNoCov","hits":"0",},
{"lineNum":"   70","line":"        return PARENT::try_lock();","class":"lineNoCov","hits":"0",},
{"lineNum":"   71","line":"    }"},
{"lineNum":"   72","line":"};"},
...
{"lineNum":"   81","line":"void static inline EnterCritical(const char* pszName, const char* pszFile, int nLine, void* cs, bool fTry = false) {}","class":"lineCov","hits":"1","order":"1116",},
{"lineNum":"   82","line":"void static inline LeaveCritical() {}","class":"lineCov","hits":"1","order":"1120",},
...
{"lineNum":"   85","line":"void static inline DeleteLock(void* cs) {}","class":"lineCov","hits":"1","order":"1756",},
...
{"lineNum":"   93","line":" */"},
{"lineNum":"   94","line":"class CCriticalSection : public AnnotatedMixin<boost::recursive_mutex>","class":"lineCov","hits":"1","order":"1114",},
{"lineNum":"   95","line":"{"},
{"lineNum":"   96","line":"public:"},
{"lineNum":"   97","line":"    ~CCriticalSection() {","class":"lineCov","hits":"1","order":"1759",},
{"lineNum":"   98","line":"        DeleteLock((void*)this);","class":"lineCov","hits":"1","order":"1758",},
{"lineNum":"   99","line":"    }","class":"lineCov","hits":"1","order":"1757",},
{"lineNum":"  100","line":"};"},
{"lineNum":"  101","line":""},
...
{"lineNum":"  121","line":"    {","class":"lineCov","hits":"1","order":"1117",},
{"lineNum":"  122","line":"        EnterCritical(pszName, pszFile, nLine, (void*)(lock.mutex()));","class":"lineCov","hits":"1","order":"1118",},
...
{"lineNum":"  127","line":"            lock.lock();","class":"lineCov","hits":"1","order":"1112",},
{"lineNum":"  128","line":"#ifdef DEBUG_LOCKCONTENTION"},
{"lineNum":"  129","line":"        }"},
{"lineNum":"  130","line":"#endif"},
{"lineNum":"  131","line":"    }","class":"lineCov","hits":"1","order":"1119",},
{"lineNum":"  132","line":""},
{"lineNum":"  133","line":"    bool TryEnter(const char* pszName, const char* pszFile, int nLine)"},
{"lineNum":"  134","line":"    {","class":"lineNoCov","hits":"0",},
{"lineNum":"  135","line":"        EnterCritical(pszName, pszFile, nLine, (void*)(lock.mutex()), true);","class":"lineNoCov","hits":"0",},
{"lineNum":"  136","line":"        lock.try_lock();","class":"lineNoCov","hits":"0",},
{"lineNum":"  137","line":"        if (!lock.owns_lock())","class":"lineNoCov","hits":"0",},
{"lineNum":"  138","line":"            LeaveCritical();","class":"lineNoCov","hits":"0",},
{"lineNum":"  139","line":"        return lock.owns_lock();","class":"lineNoCov","hits":"0",},
{"lineNum":"  140","line":"    }"},
{"lineNum":"  141","line":""},
{"lineNum":"  142","line":"public:"},
{"lineNum":"  143","line":"    CMutexLock(Mutex& mutexIn, const char* pszName, const char* pszFile, int nLine, bool fTry = false) EXCLUSIVE_LOCK_FUNCTION(mutexIn) : lock(mutexIn, boost::defer_lock)","class":"lineCov","hits":"1","order":"1108",},
{"lineNum":"  144","line":"    {","class":"lineCov","hits":"1","order":"1109",},
{"lineNum":"  145","line":"        if (fTry)","class":"lineCov","hits":"1","order":"1107",},
{"lineNum":"  146","line":"            TryEnter(pszName, pszFile, nLine);","class":"lineNoCov","hits":"0",},
{"lineNum":"  147","line":"        else"},
{"lineNum":"  148","line":"            Enter(pszName, pszFile, nLine);","class":"lineCov","hits":"1","order":"1106",},
{"lineNum":"  149","line":"    }","class":"lineCov","hits":"1","order":"1113",},
{"lineNum":"  150","line":""},
...
{"lineNum":"  163","line":"    {","class":"lineCov","hits":"1","order":"1111",},
{"lineNum":"  164","line":"        if (lock.owns_lock())","class":"lineCov","hits":"1","order":"1110",},
{"lineNum":"  165","line":"            LeaveCritical();","class":"lineCov","hits":"1","order":"1105",},
...
var header = { "command" : "", "date" : "2023-08-30 10:04:36", "instrumented" : 36, "covered" : 26,};
var merged_data = [];
