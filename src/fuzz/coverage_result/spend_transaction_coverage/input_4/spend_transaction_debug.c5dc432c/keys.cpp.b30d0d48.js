...
{"lineNum":"    7","line":""},
{"lineNum":"    8","line":"SpendKey::SpendKey(const Params* params) {","class":"lineCov","hits":"2","order":"569","possible_hits":"2",},
{"lineNum":"    9","line":"\tthis->params = params;","class":"lineCov","hits":"1","order":"579","possible_hits":"1",},
{"lineNum":"   10","line":"\tthis->s1.randomize();","class":"lineCov","hits":"1","order":"580","possible_hits":"1",},
{"lineNum":"   11","line":"\tthis->s2.randomize();","class":"lineCov","hits":"1","order":"635","possible_hits":"1",},
{"lineNum":"   12","line":"\tthis->r.randomize();","class":"lineCov","hits":"1","order":"636","possible_hits":"1",},
{"lineNum":"   13","line":"}","class":"lineCov","hits":"1","order":"637","possible_hits":"1",},
{"lineNum":"   14","line":""},
...
{"lineNum":"   41","line":""},
{"lineNum":"   42","line":"const Params* SpendKey::get_params() const {","class":"lineCov","hits":"2","order":"641","possible_hits":"2",},
{"lineNum":"   43","line":"\treturn this->params;","class":"lineCov","hits":"1","order":"642","possible_hits":"1",},
{"lineNum":"   44","line":"}"},
{"lineNum":"   45","line":""},
{"lineNum":"   46","line":"const Scalar& SpendKey::get_s1() const {","class":"lineCov","hits":"2","order":"644","possible_hits":"2",},
{"lineNum":"   47","line":"\treturn this->s1;","class":"lineCov","hits":"1","order":"645","possible_hits":"1",},
{"lineNum":"   48","line":"}"},
{"lineNum":"   49","line":""},
{"lineNum":"   50","line":"const Scalar& SpendKey::get_s2() const {","class":"lineCov","hits":"2","order":"652","possible_hits":"2",},
{"lineNum":"   51","line":"\treturn this->s2;","class":"lineCov","hits":"1","order":"653","possible_hits":"1",},
{"lineNum":"   52","line":"}"},
{"lineNum":"   53","line":""},
{"lineNum":"   54","line":"const Scalar& SpendKey::get_r() const {","class":"lineCov","hits":"2","order":"658","possible_hits":"2",},
{"lineNum":"   55","line":"\treturn this->r;","class":"lineCov","hits":"1","order":"659","possible_hits":"1",},
{"lineNum":"   56","line":"}"},
{"lineNum":"   57","line":""},
...
{"lineNum":"   77","line":"FullViewKey::FullViewKey(const SpendKey& spend_key) {","class":"lineCov","hits":"2","order":"639","possible_hits":"2",},
{"lineNum":"   78","line":"\tthis->params = spend_key.get_params();","class":"lineCov","hits":"1","order":"640","possible_hits":"1",},
{"lineNum":"   79","line":"\tthis->s1 = spend_key.get_s1();","class":"lineCov","hits":"1","order":"643","possible_hits":"1",},
{"lineNum":"   80","line":"\tthis->s2 = spend_key.get_s2();","class":"lineCov","hits":"1","order":"651","possible_hits":"1",},
{"lineNum":"   81","line":"\tthis->D = this->params->get_G()*spend_key.get_r();","class":"linePartCov","hits":"1","order":"654","possible_hits":"2",},
{"lineNum":"   82","line":"\tthis->P2 = this->params->get_F()*this->s2 + this->D;","class":"linePartCov","hits":"1","order":"869","possible_hits":"2",},
{"lineNum":"   83","line":"}","class":"linePartCov","hits":"1","order":"899","possible_hits":"3",},
{"lineNum":"   84","line":""},
{"lineNum":"   85","line":"const Params* FullViewKey::get_params() const {","class":"lineCov","hits":"2","order":"903","possible_hits":"2",},
{"lineNum":"   86","line":"\treturn this->params;","class":"lineCov","hits":"1","order":"904","possible_hits":"1",},
{"lineNum":"   87","line":"}"},
{"lineNum":"   88","line":""},
{"lineNum":"   89","line":"const Scalar& FullViewKey::get_s1() const {","class":"lineCov","hits":"2","order":"906","possible_hits":"2",},
{"lineNum":"   90","line":"\treturn this->s1;","class":"lineCov","hits":"1","order":"907","possible_hits":"1",},
{"lineNum":"   91","line":"}"},
{"lineNum":"   92","line":""},
...
{"lineNum":"   99","line":"}"},
{"lineNum":"  100","line":""},
{"lineNum":"  101","line":"const GroupElement& FullViewKey::get_P2() const {","class":"lineCov","hits":"2","order":"909","possible_hits":"2",},
{"lineNum":"  102","line":"\treturn this->P2;","class":"lineCov","hits":"1","order":"910","possible_hits":"1",},
{"lineNum":"  103","line":"}"},
{"lineNum":"  104","line":""},
...
{"lineNum":"  110","line":""},
{"lineNum":"  111","line":"IncomingViewKey::IncomingViewKey(const FullViewKey& full_view_key) {","class":"lineCov","hits":"2","order":"901","possible_hits":"2",},
{"lineNum":"  112","line":"\tthis->params = full_view_key.get_params();","class":"lineCov","hits":"1","order":"902","possible_hits":"1",},
{"lineNum":"  113","line":"\tthis->s1 = full_view_key.get_s1();","class":"lineCov","hits":"1","order":"905","possible_hits":"1",},
{"lineNum":"  114","line":"\tthis->P2 = full_view_key.get_P2();","class":"lineCov","hits":"1","order":"908","possible_hits":"1",},
{"lineNum":"  115","line":"}","class":"lineCov","hits":"1","order":"911","possible_hits":"1",},
{"lineNum":"  116","line":""},
{"lineNum":"  117","line":"const Params* IncomingViewKey::get_params() const {","class":"lineCov","hits":"2","order":"1019","possible_hits":"2",},
{"lineNum":"  118","line":"\treturn this->params;","class":"lineCov","hits":"1","order":"1020","possible_hits":"1",},
{"lineNum":"  119","line":"}"},
{"lineNum":"  120","line":""},
{"lineNum":"  121","line":"const Scalar& IncomingViewKey::get_s1() const {","class":"lineCov","hits":"2","order":"928","possible_hits":"2",},
{"lineNum":"  122","line":"\treturn this->s1;","class":"lineCov","hits":"1","order":"929","possible_hits":"1",},
{"lineNum":"  123","line":"}"},
{"lineNum":"  124","line":""},
{"lineNum":"  125","line":"const GroupElement& IncomingViewKey::get_P2() const {","class":"lineCov","hits":"2","order":"1411","possible_hits":"2",},
{"lineNum":"  126","line":"\treturn this->P2;","class":"lineCov","hits":"1","order":"1412","possible_hits":"1",},
{"lineNum":"  127","line":"}"},
{"lineNum":"  128","line":""},
...
{"lineNum":"  147","line":""},
{"lineNum":"  148","line":"Address::Address(const IncomingViewKey& incoming_view_key, const uint64_t i) {","class":"lineCov","hits":"3","order":"925","possible_hits":"3",},
{"lineNum":"  149","line":"\t// Encrypt the diversifier"},
{"lineNum":"  150","line":"\tstd::vector<unsigned char> key = SparkUtils::kdf_diversifier(incoming_view_key.get_s1());","class":"lineCov","hits":"1","order":"927","possible_hits":"1",},
{"lineNum":"  151","line":"\tthis->params = incoming_view_key.get_params();","class":"lineCov","hits":"1","order":"1018","possible_hits":"1",},
{"lineNum":"  152","line":"\tthis->d = SparkUtils::diversifier_encrypt(key, i);","class":"lineCov","hits":"1","order":"1021","possible_hits":"1",},
{"lineNum":"  153","line":"\tthis->Q1 = SparkUtils::hash_div(this->d)*incoming_view_key.get_s1();","class":"linePartCov","hits":"1","order":"1299","possible_hits":"2",},
{"lineNum":"  154","line":"\tthis->Q2 = this->params->get_F()*SparkUtils::hash_Q2(incoming_view_key.get_s1(), i) + incoming_view_key.get_P2();","class":"linePartCov","hits":"1","order":"1374","possible_hits":"2",},
{"lineNum":"  155","line":"}","class":"linePartCov","hits":"1","order":"1413","possible_hits":"3",},
{"lineNum":"  156","line":""},
...
{"lineNum":"  159","line":"}"},
{"lineNum":"  160","line":""},
{"lineNum":"  161","line":"const std::vector<unsigned char>& Address::get_d() const {","class":"lineCov","hits":"2","order":"1449","possible_hits":"2",},
{"lineNum":"  162","line":"\treturn this->d;","class":"lineCov","hits":"1","order":"1450","possible_hits":"1",},
{"lineNum":"  163","line":"}"},
{"lineNum":"  164","line":""},
{"lineNum":"  165","line":"const GroupElement& Address::get_Q1() const {","class":"lineCov","hits":"2","order":"1514","possible_hits":"2",},
{"lineNum":"  166","line":"\treturn this->Q1;","class":"lineCov","hits":"1","order":"1515","possible_hits":"1",},
{"lineNum":"  167","line":"}"},
{"lineNum":"  168","line":""},
{"lineNum":"  169","line":"const GroupElement& Address::get_Q2() const {","class":"lineCov","hits":"2","order":"1467","possible_hits":"2",},
{"lineNum":"  170","line":"\treturn this->Q2;","class":"lineCov","hits":"1","order":"1468","possible_hits":"1",},
{"lineNum":"  171","line":"}"},
{"lineNum":"  172","line":""},
...
var header = { "command" : "spend_transaction_debug", "date" : "2023-08-30 10:00:38", "instrumented" : 188, "covered" : 51,};
var merged_data = [];
