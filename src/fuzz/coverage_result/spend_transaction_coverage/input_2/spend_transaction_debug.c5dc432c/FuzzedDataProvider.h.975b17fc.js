...
{"lineNum":"   36","line":"      : data_ptr_(data), remaining_bytes_(size) {}","class":"lineCov","hits":"2","order":"144","possible_hits":"2",},
...
{"lineNum":"  108","line":"std::vector<T> FuzzedDataProvider::ConsumeBytes(size_t num_bytes) {","class":"lineCov","hits":"2","order":"1433","possible_hits":"2",},
{"lineNum":"  109","line":"  num_bytes = std::min(num_bytes, remaining_bytes_);","class":"lineCov","hits":"1","order":"1434","possible_hits":"1",},
{"lineNum":"  110","line":"  return ConsumeBytes<T>(num_bytes, num_bytes);","class":"lineCov","hits":"1","order":"1435","possible_hits":"1",},
{"lineNum":"  111","line":"}"},
{"lineNum":"  112","line":""},
...
{"lineNum":"  136","line":"inline std::string FuzzedDataProvider::ConsumeBytesAsString(size_t num_bytes) {","class":"lineCov","hits":"2","order":"556","possible_hits":"2",},
...
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"  num_bytes = std::min(num_bytes, remaining_bytes_);","class":"lineCov","hits":"1","order":"557","possible_hits":"1",},
{"lineNum":"  141","line":"  std::string result(","class":"linePartCov","hits":"2","order":"558","possible_hits":"5",},
{"lineNum":"  142","line":"      reinterpret_cast<const std::string::value_type *>(data_ptr_), num_bytes);","class":"lineCov","hits":"1","order":"559","possible_hits":"1",},
{"lineNum":"  143","line":"  Advance(num_bytes);","class":"lineCov","hits":"1","order":"560","possible_hits":"1",},
{"lineNum":"  144","line":"  return result;","class":"lineCov","hits":"1","order":"566","possible_hits":"1",},
{"lineNum":"  145","line":"}","class":"linePartCov","hits":"1","order":"567","possible_hits":"2",},
{"lineNum":"  146","line":""},
...
{"lineNum":"  194","line":"template <typename T> T FuzzedDataProvider::ConsumeIntegral() {","class":"linePartCov","hits":"4","order":"914","possible_hits":"6",},
{"lineNum":"  195","line":"  return ConsumeIntegralInRange(std::numeric_limits<T>::min(),","class":"linePartCov","hits":"4","order":"915","possible_hits":"6",},
{"lineNum":"  196","line":"                                std::numeric_limits<T>::max());","class":"linePartCov","hits":"2","order":"916","possible_hits":"3",},
{"lineNum":"  197","line":"}"},
{"lineNum":"  198","line":""},
...
{"lineNum":"  204","line":"T FuzzedDataProvider::ConsumeIntegralInRange(T min, T max) {","class":"linePartCov","hits":"4","order":"917","possible_hits":"6",},
...
{"lineNum":"  207","line":""},
{"lineNum":"  208","line":"  if (min > max)","class":"linePartCov","hits":"2","order":"918","possible_hits":"3",},
...
{"lineNum":"  212","line":"  uint64_t range = static_cast<uint64_t>(max) - min;","class":"linePartCov","hits":"2","order":"919","possible_hits":"3",},
{"lineNum":"  213","line":"  uint64_t result = 0;","class":"linePartCov","hits":"2","order":"920","possible_hits":"3",},
{"lineNum":"  214","line":"  size_t offset = 0;","class":"linePartCov","hits":"2","order":"921","possible_hits":"3",},
{"lineNum":"  215","line":""},
{"lineNum":"  216","line":"  while (offset < sizeof(T) * CHAR_BIT && (range >> offset) > 0 &&","class":"linePartCov","hits":"4","order":"922","possible_hits":"9",},
{"lineNum":"  217","line":"         remaining_bytes_ != 0) {","class":"linePartCov","hits":"2","order":"923","possible_hits":"3",},
...
{"lineNum":"  230","line":"  if (range != std::numeric_limits<decltype(range)>::max())","class":"linePartCov","hits":"2","order":"924","possible_hits":"3",},
{"lineNum":"  231","line":"    result = result % (range + 1);","class":"linePartCov","hits":"1","order":"1610","possible_hits":"3",},
{"lineNum":"  232","line":""},
{"lineNum":"  233","line":"  return static_cast<T>(min + result);","class":"linePartCov","hits":"2","order":"925","possible_hits":"3",},
{"lineNum":"  234","line":"}"},
{"lineNum":"  235","line":""},
...
{"lineNum":"  341","line":"}","class":"linePartCov","hits":"1","order":"200","possible_hits":"2",},
{"lineNum":"  342","line":""},
{"lineNum":"  343","line":"inline void FuzzedDataProvider::Advance(size_t num_bytes) {","class":"lineCov","hits":"2","order":"561","possible_hits":"2",},
{"lineNum":"  344","line":"  if (num_bytes > remaining_bytes_)","class":"lineCov","hits":"1","order":"562","possible_hits":"1",},
{"lineNum":"  345","line":"    abort();","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  346","line":""},
{"lineNum":"  347","line":"  data_ptr_ += num_bytes;","class":"lineCov","hits":"1","order":"563","possible_hits":"1",},
{"lineNum":"  348","line":"  remaining_bytes_ -= num_bytes;","class":"lineCov","hits":"1","order":"564","possible_hits":"1",},
{"lineNum":"  349","line":"}","class":"linePartCov","hits":"1","order":"565","possible_hits":"2",},
{"lineNum":"  350","line":""},
{"lineNum":"  351","line":"template <typename T>"},
{"lineNum":"  352","line":"std::vector<T> FuzzedDataProvider::ConsumeBytes(size_t size, size_t num_bytes) {","class":"lineCov","hits":"2","order":"1436","possible_hits":"2",},
...
{"lineNum":"  361","line":"  std::vector<T> result(size);","class":"linePartCov","hits":"1","order":"1437","possible_hits":"4",},
{"lineNum":"  362","line":"  if (size == 0) {","class":"lineCov","hits":"1","order":"1438","possible_hits":"1",},
{"lineNum":"  363","line":"    if (num_bytes != 0)","class":"lineCov","hits":"1","order":"1439","possible_hits":"1",},
{"lineNum":"  364","line":"      abort();","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  365","line":"    return result;","class":"lineCov","hits":"1","order":"1440","possible_hits":"1",},
{"lineNum":"  366","line":"  }"},
{"lineNum":"  367","line":""},
...
var header = { "command" : "spend_transaction_debug", "date" : "2023-08-30 09:57:29", "instrumented" : 48, "covered" : 35,};
var merged_data = [];
