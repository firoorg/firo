...
{"lineNum":"   60","line":"    F1 = fsp.GetMemberGroupElement();","class":"linePartCov","hits":"1","order":"1496","possible_hits":"2",},
{"lineNum":"   61","line":"    G1 = fsp.GetMemberGroupElement();","class":"linePartCov","hits":"1","order":"1502","possible_hits":"2",},
{"lineNum":"   62","line":"    H1 = fsp.GetMemberGroupElement();","class":"linePartCov","hits":"1","order":"1503","possible_hits":"2",},
{"lineNum":"   63","line":"    U1 = fsp.GetMemberGroupElement();","class":"linePartCov","hits":"1","order":"1504","possible_hits":"2",},
{"lineNum":"   64","line":"    //F1.randomize();"},
{"lineNum":"   65","line":"    //G1.randomize();"},
{"lineNum":"   66","line":"    //H1.randomize();"},
{"lineNum":"   67","line":"    //U1.randomize();"},
{"lineNum":"   68","line":""},
{"lineNum":"   69","line":"    Scalar mu1;","class":"lineCov","hits":"1","order":"1505","possible_hits":"1",},
{"lineNum":"   70","line":"    mu1 = fsp.GetScalar();","class":"linePartCov","hits":"1","order":"1506","possible_hits":"2",},
{"lineNum":"   71","line":"    std::vector<Scalar> x1, y1, z1;","class":"lineCov","hits":"1","order":"1512","possible_hits":"1",},
{"lineNum":"   72","line":"    x1.resize(n);","class":"lineCov","hits":"1","order":"1513","possible_hits":"1",},
{"lineNum":"   73","line":"    x1 = fsp.GetScalars(n);","class":"lineCov","hits":"1","order":"1514","possible_hits":"1",},
{"lineNum":"   74","line":"    y1.resize(n);","class":"lineCov","hits":"1","order":"1522","possible_hits":"1",},
{"lineNum":"   75","line":"    y1 = fsp.GetScalars(n);","class":"lineCov","hits":"1","order":"1523","possible_hits":"1",},
{"lineNum":"   76","line":"    z1.resize(n);","class":"lineCov","hits":"1","order":"1524","possible_hits":"1",},
{"lineNum":"   77","line":"    z1 = fsp.GetScalars(n);","class":"lineCov","hits":"1","order":"1525","possible_hits":"1",},
{"lineNum":"   78","line":""},
{"lineNum":"   79","line":"    std::vector<GroupElement> S1, T1;","class":"lineCov","hits":"1","order":"1526","possible_hits":"1",},
{"lineNum":"   80","line":"    S1.resize(n);","class":"lineCov","hits":"1","order":"1527","possible_hits":"1",},
{"lineNum":"   81","line":"    T1.resize(n);","class":"lineCov","hits":"1","order":"1528","possible_hits":"1",},
{"lineNum":"   82","line":"    for (size_t i=0; i < n; i++) {","class":"lineCov","hits":"2","order":"1529","possible_hits":"2",},
{"lineNum":"   83","line":"        S1[i] = F1*x1[i] + G1*y1[i] + H1*z1[i];","class":"linePartCov","hits":"1","order":"1530","possible_hits":"2",},
{"lineNum":"   84","line":"        T1[i] = (U1 + G1*y1[i].negate())*x1[i].inverse();","class":"linePartCov","hits":"1","order":"1536","possible_hits":"2",},
{"lineNum":"   85","line":"    }"},
{"lineNum":"   86","line":""},
{"lineNum":"   87","line":"    spark::ChaumProof proof1;","class":"lineCov","hits":"1","order":"1540","possible_hits":"1",},
{"lineNum":"   88","line":""},
{"lineNum":"   89","line":"    spark::Chaum chaum1(F1, G1, H1, U1);","class":"lineCov","hits":"1","order":"1541","possible_hits":"1",},
{"lineNum":"   90","line":"    chaum1.prove(mu1, x1, y1, z1, S1, T1, proof1);","class":"lineCov","hits":"1","order":"1542","possible_hits":"1",},
{"lineNum":"   91","line":""},
...
var header = { "command" : "chaum_debug", "date" : "2023-08-29 08:16:39", "instrumented" : 152, "covered" : 61,};
var merged_data = [];
