...
{"lineNum":"   75","line":"  }"},
{"lineNum":"   76","line":""},
{"lineNum":"   77","line":"  static constexpr size_t memoryRequired() { return serialize_size; }","class":"lineCov","hits":"1","order":"1247",},
...
{"lineNum":"   86","line":"  inline void Serialize(Stream& s) const {","class":"lineCov","hits":"1","order":"1253",},
{"lineNum":"   87","line":"        constexpr int size = memoryRequired();","class":"lineCov","hits":"1","order":"1251",},
{"lineNum":"   88","line":"        unsigned char buffer[size];"},
{"lineNum":"   89","line":"        serialize(buffer);","class":"lineCov","hits":"1","order":"1249",},
{"lineNum":"   90","line":"        char* b = (char*)buffer;","class":"lineCov","hits":"1","order":"1248",},
{"lineNum":"   91","line":"        s.write(b, size);","class":"lineCov","hits":"1","order":"1246",},
{"lineNum":"   92","line":"  }","class":"lineCov","hits":"1","order":"1245",},
{"lineNum":"   93","line":""},
{"lineNum":"   94","line":"  template<typename Stream>"},
{"lineNum":"   95","line":"  inline void Unserialize(Stream& s) {","class":"lineCov","hits":"1","order":"1244",},
{"lineNum":"   96","line":"        constexpr int size = memoryRequired();","class":"lineCov","hits":"1","order":"1243",},
{"lineNum":"   97","line":"        unsigned char buffer[size];"},
{"lineNum":"   98","line":"        char* b = (char*)buffer;","class":"lineCov","hits":"1","order":"1242",},
{"lineNum":"   99","line":"        s.read(b, size);","class":"lineCov","hits":"1","order":"1252",},
{"lineNum":"  100","line":"        deserialize(buffer);","class":"lineCov","hits":"1","order":"1250",},
{"lineNum":"  101","line":"  }","class":"lineCov","hits":"1","order":"1241",},
{"lineNum":"  102","line":""},
...
var header = { "command" : "", "date" : "2023-08-29 08:17:48", "instrumented" : 13, "covered" : 13,};
var merged_data = [];
