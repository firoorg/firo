...
{"lineNum":"   36","line":"      : data_ptr_(data), remaining_bytes_(size) {}","class":"lineCov","hits":"1","order":"1450",},
...
{"lineNum":"  194","line":"template <typename T> T FuzzedDataProvider::ConsumeIntegral() {","class":"lineCov","hits":"1","order":"1448",},
{"lineNum":"  195","line":"  return ConsumeIntegralInRange(std::numeric_limits<T>::min(),","class":"lineCov","hits":"1","order":"1438",},
{"lineNum":"  196","line":"                                std::numeric_limits<T>::max());","class":"lineCov","hits":"1","order":"1445",},
{"lineNum":"  197","line":"}"},
{"lineNum":"  198","line":""},
...
{"lineNum":"  204","line":"T FuzzedDataProvider::ConsumeIntegralInRange(T min, T max) {","class":"lineCov","hits":"1","order":"1443",},
...
{"lineNum":"  207","line":""},
{"lineNum":"  208","line":"  if (min > max)","class":"lineCov","hits":"1","order":"1447",},
...
{"lineNum":"  212","line":"  uint64_t range = static_cast<uint64_t>(max) - min;","class":"lineCov","hits":"1","order":"1441",},
{"lineNum":"  213","line":"  uint64_t result = 0;","class":"lineCov","hits":"1","order":"1449",},
{"lineNum":"  214","line":"  size_t offset = 0;","class":"lineCov","hits":"1","order":"1440",},
{"lineNum":"  215","line":""},
{"lineNum":"  216","line":"  while (offset < sizeof(T) * CHAR_BIT && (range >> offset) > 0 &&","class":"lineCov","hits":"1","order":"1439",},
{"lineNum":"  217","line":"         remaining_bytes_ != 0) {","class":"lineCov","hits":"1","order":"1442",},
...
{"lineNum":"  224","line":"    --remaining_bytes_;","class":"lineCov","hits":"1","order":"1437",},
{"lineNum":"  225","line":"    result = (result << CHAR_BIT) | data_ptr_[remaining_bytes_];","class":"lineCov","hits":"1","order":"1446",},
{"lineNum":"  226","line":"    offset += CHAR_BIT;","class":"lineCov","hits":"1","order":"1451",},
{"lineNum":"  227","line":"  }"},
{"lineNum":"  228","line":""},
{"lineNum":"  229","line":"  // Avoid division by 0, in case |range + 1| results in overflow."},
{"lineNum":"  230","line":"  if (range != std::numeric_limits<decltype(range)>::max())","class":"lineCov","hits":"1","order":"1452",},
{"lineNum":"  231","line":"    result = result % (range + 1);","class":"lineNoCov","hits":"0",},
{"lineNum":"  232","line":""},
{"lineNum":"  233","line":"  return static_cast<T>(min + result);","class":"lineCov","hits":"1","order":"1444",},
{"lineNum":"  234","line":"}"},
{"lineNum":"  235","line":""},
...
var header = { "command" : "", "date" : "2023-08-29 08:17:48", "instrumented" : 41, "covered" : 16,};
var merged_data = [];
