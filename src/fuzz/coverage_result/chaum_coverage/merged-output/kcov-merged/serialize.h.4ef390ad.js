...
{"lineNum":"   70","line":"{","class":"lineCov","hits":"1","order":"41",},
{"lineNum":"   71","line":"    return const_cast<T*>(val);","class":"lineCov","hits":"1","order":"38",},
{"lineNum":"   72","line":"}"},
{"lineNum":"   73","line":""},
{"lineNum":"   74","line":"/**"},
...
{"lineNum":"  108","line":"{","class":"lineCov","hits":"1","order":"68",},
{"lineNum":"  109","line":"    s.write((char*)&obj, 1);","class":"lineCov","hits":"1","order":"70",},
{"lineNum":"  110","line":"}","class":"lineCov","hits":"1","order":"71",},
{"lineNum":"  111","line":"template<typename Stream> inline void ser_writedata16(Stream &s, uint16_t obj)"},
{"lineNum":"  112","line":"{","class":"lineCov","hits":"1","order":"1555",},
{"lineNum":"  113","line":"    obj = htole16(obj);","class":"lineCov","hits":"1","order":"1556",},
{"lineNum":"  114","line":"    s.write((char*)&obj, 2);","class":"lineCov","hits":"1","order":"1557",},
{"lineNum":"  115","line":"}","class":"lineCov","hits":"1","order":"1558",},
...
{"lineNum":"  123","line":"    obj = htole64(obj);","class":"lineNoCov","hits":"0",},
{"lineNum":"  124","line":"    s.write((char*)&obj, 8);","class":"lineNoCov","hits":"0",},
...
{"lineNum":"  134","line":"{","class":"lineCov","hits":"1","order":"23",},
{"lineNum":"  135","line":"    uint8_t obj;"},
{"lineNum":"  136","line":"    s.read((char*)&obj, 1);","class":"lineCov","hits":"1","order":"22",},
{"lineNum":"  137","line":"    return obj;","class":"lineCov","hits":"1","order":"21",},
{"lineNum":"  138","line":"}"},
{"lineNum":"  139","line":"template<typename Stream> inline uint16_t ser_readdata16(Stream &s)"},
{"lineNum":"  140","line":"{","class":"lineCov","hits":"1","order":"1546",},
{"lineNum":"  141","line":"    uint16_t obj;"},
{"lineNum":"  142","line":"    s.read((char*)&obj, 2);","class":"lineCov","hits":"1","order":"1545",},
{"lineNum":"  143","line":"    return le16toh(obj);","class":"lineCov","hits":"1","order":"1544",},
{"lineNum":"  144","line":"}"},
...
{"lineNum":"  222","line":"    }"},
{"lineNum":"  223","line":""},
{"lineNum":"  224","line":"template<typename Stream> inline void Serialize(Stream& s, char a    ) { ser_writedata8(s, a); } // TODO Get rid of bare char"},
...
{"lineNum":"  232","line":"template<typename Stream> inline void Serialize(Stream& s, uint64_t a) { ser_writedata64(s, a); }"},
...
{"lineNum":"  244","line":"template<typename Stream> inline void Unserialize(Stream& s, uint64_t& a) { a = ser_readdata64(s); }"},
...
{"lineNum":"  263","line":"inline void Serialize(Stream &s, const ItemType (&a) [ArraySize]) { s.write((const char *)&a, sizeof(a)); }"},
{"lineNum":"  264","line":""},
...
{"lineNum":"  293","line":"{","class":"lineCov","hits":"1","order":"58",},
{"lineNum":"  294","line":"    if (nSize < 253)","class":"lineCov","hits":"1","order":"63",},
{"lineNum":"  295","line":"    {"},
{"lineNum":"  296","line":"        ser_writedata8(os, nSize);","class":"lineCov","hits":"1","order":"49",},
{"lineNum":"  297","line":"    }","class":"lineCov","hits":"1","order":"46",},
{"lineNum":"  298","line":"    else if (nSize <= std::numeric_limits<unsigned short>::max())","class":"lineCov","hits":"1","order":"1552",},
{"lineNum":"  299","line":"    {"},
{"lineNum":"  300","line":"        ser_writedata8(os, 253);","class":"lineCov","hits":"1","order":"1551",},
{"lineNum":"  301","line":"        ser_writedata16(os, nSize);","class":"lineCov","hits":"1","order":"1554",},
{"lineNum":"  302","line":"    }","class":"lineCov","hits":"1","order":"1553",},
...
{"lineNum":"  312","line":"    }"},
{"lineNum":"  313","line":"    return;","class":"lineCov","hits":"1","order":"67",},
{"lineNum":"  314","line":"}"},
{"lineNum":"  315","line":""},
{"lineNum":"  316","line":"template<typename Stream>"},
{"lineNum":"  317","line":"uint64_t ReadCompactSize(Stream& is)"},
{"lineNum":"  318","line":"{","class":"lineCov","hits":"1","order":"77",},
{"lineNum":"  319","line":"    uint8_t chSize = ser_readdata8(is);","class":"lineCov","hits":"1","order":"42",},
{"lineNum":"  320","line":"    uint64_t nSizeRet = 0;","class":"lineCov","hits":"1","order":"35",},
{"lineNum":"  321","line":"    if (chSize < 253)","class":"lineCov","hits":"1","order":"33",},
{"lineNum":"  322","line":"    {"},
{"lineNum":"  323","line":"        nSizeRet = chSize;","class":"lineCov","hits":"1","order":"31",},
{"lineNum":"  324","line":"    }","class":"lineCov","hits":"1","order":"39",},
{"lineNum":"  325","line":"    else if (chSize == 253)","class":"lineCov","hits":"1","order":"1550",},
{"lineNum":"  326","line":"    {"},
{"lineNum":"  327","line":"        nSizeRet = ser_readdata16(is);","class":"lineCov","hits":"1","order":"1549",},
{"lineNum":"  328","line":"        if (nSizeRet < 253)","class":"lineCov","hits":"1","order":"1548",},
{"lineNum":"  329","line":"            throw std::ios_base::failure(\"non-canonical ReadCompactSize()\");","class":"lineCov","hits":"1","order":"26",},
{"lineNum":"  330","line":"    }","class":"lineCov","hits":"1","order":"1547",},
...
{"lineNum":"  342","line":"    }"},
{"lineNum":"  343","line":"    if (nSizeRet > (uint64_t)MAX_SIZE)","class":"lineCov","hits":"1","order":"25",},
{"lineNum":"  344","line":"        throw std::ios_base::failure(\"ReadCompactSize(): size too large\");","class":"lineNoCov","hits":"0",},
{"lineNum":"  345","line":"    return nSizeRet;","class":"lineCov","hits":"1","order":"24",},
...
{"lineNum":"  803","line":"{","class":"lineCov","hits":"1","order":"65",},
{"lineNum":"  804","line":"    a.Serialize(os);","class":"lineCov","hits":"1","order":"50",},
{"lineNum":"  805","line":"}","class":"lineCov","hits":"1","order":"47",},
{"lineNum":"  806","line":""},
...
{"lineNum":"  809","line":"{","class":"lineCov","hits":"1","order":"60",},
{"lineNum":"  810","line":"    a.Unserialize(is);","class":"lineCov","hits":"1","order":"55",},
{"lineNum":"  811","line":"}","class":"lineCov","hits":"1","order":"61",},
{"lineNum":"  812","line":""},
{"lineNum":"  813","line":""},
{"lineNum":"  814","line":""},
{"lineNum":"  815","line":""},
...
{"lineNum":"  822","line":"{"},
{"lineNum":"  823","line":"    WriteCompactSize(os, str.size());"},
{"lineNum":"  824","line":"    if (!str.empty())"},
{"lineNum":"  825","line":"        os.write((char*)&str[0], str.size() * sizeof(str[0]));"},
{"lineNum":"  826","line":"}"},
{"lineNum":"  827","line":""},
{"lineNum":"  828","line":"template<typename Stream, typename C>"},
{"lineNum":"  829","line":"void Unserialize(Stream& is, std::basic_string<C>& str)"},
{"lineNum":"  830","line":"{"},
{"lineNum":"  831","line":"    unsigned int nSize = ReadCompactSize(is);"},
{"lineNum":"  832","line":"    str.resize(nSize);"},
{"lineNum":"  833","line":"    if (nSize != 0)"},
{"lineNum":"  834","line":"        is.read((char*)&str[0], nSize * sizeof(str[0]));"},
{"lineNum":"  835","line":"}"},
{"lineNum":"  836","line":""},
{"lineNum":"  837","line":""},
{"lineNum":"  838","line":""},
...
{"lineNum":"  912","line":"{"},
{"lineNum":"  913","line":"    WriteCompactSize(os, v.size());"},
{"lineNum":"  914","line":"    if (!v.empty())"},
{"lineNum":"  915","line":"        os.write((char*)&v[0], v.size() * sizeof(T));"},
{"lineNum":"  916","line":"}"},
{"lineNum":"  917","line":""},
...
{"lineNum":"  920","line":"{","class":"lineCov","hits":"1","order":"52",},
{"lineNum":"  921","line":"    WriteCompactSize(os, v.size());","class":"lineCov","hits":"1","order":"51",},
{"lineNum":"  922","line":"    for (typename std::vector<T, A>::const_iterator vi = v.begin(); vi != v.end(); ++vi)","class":"lineCov","hits":"1","order":"48",},
{"lineNum":"  923","line":"        ::Serialize(os, (*vi));","class":"lineCov","hits":"1","order":"45",},
{"lineNum":"  924","line":"}","class":"lineCov","hits":"1","order":"44",},
{"lineNum":"  925","line":""},
...
{"lineNum":"  928","line":"{","class":"lineCov","hits":"1","order":"57",},
{"lineNum":"  929","line":"    Serialize_impl(os, v, T());","class":"lineCov","hits":"1","order":"62",},
{"lineNum":"  930","line":"}","class":"lineCov","hits":"1","order":"66",},
{"lineNum":"  931","line":""},
{"lineNum":"  932","line":""},
...
{"lineNum":"  937","line":"    v.clear();"},
{"lineNum":"  938","line":"    unsigned int nSize = ReadCompactSize(is);"},
{"lineNum":"  939","line":"    unsigned int i = 0;"},
{"lineNum":"  940","line":"    while (i < nSize)"},
{"lineNum":"  941","line":"    {"},
{"lineNum":"  942","line":"        unsigned int blk = std::min(nSize - i, (unsigned int)(1 + 4999999 / sizeof(T)));"},
{"lineNum":"  943","line":"        v.resize(i + blk);"},
{"lineNum":"  944","line":"        is.read((char*)&v[i], blk * sizeof(T));"},
{"lineNum":"  945","line":"        i += blk;"},
{"lineNum":"  946","line":"    }"},
{"lineNum":"  947","line":"}"},
{"lineNum":"  948","line":""},
...
{"lineNum":"  951","line":"{","class":"lineCov","hits":"1","order":"53",},
{"lineNum":"  952","line":"    v.clear();","class":"lineCov","hits":"1","order":"56",},
{"lineNum":"  953","line":"    unsigned int nSize = ReadCompactSize(is);","class":"lineCov","hits":"1","order":"78",},
{"lineNum":"  954","line":"    unsigned int i = 0;","class":"lineCov","hits":"1","order":"43",},
{"lineNum":"  955","line":"    unsigned int nMid = 0;","class":"lineCov","hits":"1","order":"36",},
{"lineNum":"  956","line":"    while (nMid < nSize)","class":"lineCov","hits":"1","order":"34",},
{"lineNum":"  957","line":"    {"},
{"lineNum":"  958","line":"        nMid += 5000000 / sizeof(T);","class":"lineCov","hits":"1","order":"32",},
{"lineNum":"  959","line":"        if (nMid > nSize)","class":"lineCov","hits":"1","order":"40",},
{"lineNum":"  960","line":"            nMid = nSize;","class":"lineCov","hits":"1","order":"37",},
{"lineNum":"  961","line":"        v.resize(nMid);","class":"lineCov","hits":"1","order":"30",},
{"lineNum":"  962","line":"        for (; i < nMid; i++)","class":"lineCov","hits":"1","order":"29",},
{"lineNum":"  963","line":"            Unserialize(is, v[i]);","class":"lineCov","hits":"1","order":"28",},
{"lineNum":"  964","line":"    }"},
{"lineNum":"  965","line":"}","class":"lineCov","hits":"1","order":"27",},
{"lineNum":"  966","line":""},
...
{"lineNum":"  969","line":"{","class":"lineCov","hits":"1","order":"74",},
{"lineNum":"  970","line":"    Unserialize_impl(is, v, T());","class":"lineCov","hits":"1","order":"75",},
{"lineNum":"  971","line":"}","class":"lineCov","hits":"1","order":"76",},
{"lineNum":"  972","line":""},
{"lineNum":"  973","line":""},
{"lineNum":"  974","line":""},
{"lineNum":"  975","line":"/**"},
...
{"lineNum":" 1162","line":"{","class":"lineCov","hits":"1","order":"64",},
{"lineNum":" 1163","line":"    ::Serialize(s, obj);","class":"lineCov","hits":"1","order":"59",},
{"lineNum":" 1164","line":"}","class":"lineCov","hits":"1","order":"54",},
{"lineNum":" 1165","line":""},
...
{"lineNum":" 1168","line":"{","class":"lineCov","hits":"1","order":"72",},
{"lineNum":" 1169","line":"    ::Unserialize(s, obj);","class":"lineCov","hits":"1","order":"73",},
{"lineNum":" 1170","line":"}","class":"lineCov","hits":"1","order":"69",},
{"lineNum":" 1171","line":""},
{"lineNum":" 1172","line":""},
{"lineNum":" 1173","line":""},
{"lineNum":" 1174","line":""},
...
var header = { "command" : "", "date" : "2023-08-29 08:17:48", "instrumented" : 103, "covered" : 73,};
var merged_data = [];
