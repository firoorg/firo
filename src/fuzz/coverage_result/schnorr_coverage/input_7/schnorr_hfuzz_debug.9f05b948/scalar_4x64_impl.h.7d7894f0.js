...
{"lineNum":"   26","line":""},
{"lineNum":"   27","line":"SECP256K1_INLINE static void secp256k1_scalar_clear(secp256k1_scalar *r) {","class":"linePartCov","hits":"2","order":"597","possible_hits":"4",},
{"lineNum":"   28","line":"    r->d[0] = 0;","class":"linePartCov","hits":"1","order":"598","possible_hits":"2",},
{"lineNum":"   29","line":"    r->d[1] = 0;","class":"linePartCov","hits":"1","order":"599","possible_hits":"2",},
{"lineNum":"   30","line":"    r->d[2] = 0;","class":"linePartCov","hits":"1","order":"600","possible_hits":"2",},
{"lineNum":"   31","line":"    r->d[3] = 0;","class":"linePartCov","hits":"1","order":"601","possible_hits":"2",},
{"lineNum":"   32","line":"}","class":"linePartCov","hits":"1","order":"602","possible_hits":"4",},
{"lineNum":"   33","line":""},
{"lineNum":"   34","line":"SECP256K1_INLINE static void secp256k1_scalar_set_int(secp256k1_scalar *r, unsigned int v) {","class":"linePartCov","hits":"4","order":"679","possible_hits":"6",},
{"lineNum":"   35","line":"    r->d[0] = v;","class":"linePartCov","hits":"2","order":"680","possible_hits":"3",},
{"lineNum":"   36","line":"    r->d[1] = 0;","class":"linePartCov","hits":"2","order":"681","possible_hits":"3",},
{"lineNum":"   37","line":"    r->d[2] = 0;","class":"linePartCov","hits":"2","order":"682","possible_hits":"3",},
{"lineNum":"   38","line":"    r->d[3] = 0;","class":"linePartCov","hits":"2","order":"683","possible_hits":"3",},
{"lineNum":"   39","line":"}","class":"linePartCov","hits":"2","order":"684","possible_hits":"6",},
{"lineNum":"   40","line":""},
{"lineNum":"   41","line":"SECP256K1_INLINE static unsigned int secp256k1_scalar_get_bits(const secp256k1_scalar *a, unsigned int offset, unsigned int count) {","class":"lineCov","hits":"4","order":"718","possible_hits":"4",},
{"lineNum":"   42","line":"    VERIFY_CHECK((offset + count - 1) >> 6 == offset >> 6);","class":"lineCov","hits":"2","order":"719","possible_hits":"2",},
{"lineNum":"   43","line":"    return (a->d[offset >> 6] >> (offset & 0x3F)) & ((((uint64_t)1) << count) - 1);","class":"lineCov","hits":"2","order":"720","possible_hits":"2",},
{"lineNum":"   44","line":"}"},
{"lineNum":"   45","line":""},
{"lineNum":"   46","line":"SECP256K1_INLINE static unsigned int secp256k1_scalar_get_bits_var(const secp256k1_scalar *a, unsigned int offset, unsigned int count) {","class":"lineCov","hits":"4","order":"824","possible_hits":"4",},
{"lineNum":"   47","line":"    VERIFY_CHECK(count < 32);","class":"lineCov","hits":"2","order":"825","possible_hits":"2",},
{"lineNum":"   48","line":"    VERIFY_CHECK(offset + count <= 256);","class":"lineCov","hits":"2","order":"826","possible_hits":"2",},
{"lineNum":"   49","line":"    if ((offset + count - 1) >> 6 == offset >> 6) {","class":"lineCov","hits":"2","order":"827","possible_hits":"2",},
{"lineNum":"   50","line":"        return secp256k1_scalar_get_bits(a, offset, count);","class":"lineCov","hits":"2","order":"828","possible_hits":"2",},
{"lineNum":"   51","line":"    } else {"},
{"lineNum":"   52","line":"        VERIFY_CHECK((offset >> 6) + 1 < 4);","class":"lineCov","hits":"2","order":"835","possible_hits":"2",},
{"lineNum":"   53","line":"        return ((a->d[offset >> 6] >> (offset & 0x3F)) | (a->d[(offset >> 6) + 1] << (64 - (offset & 0x3F)))) & ((((uint64_t)1) << count) - 1);","class":"lineCov","hits":"2","order":"836","possible_hits":"2",},
{"lineNum":"   54","line":"    }"},
{"lineNum":"   55","line":"}","class":"linePartCov","hits":"2","order":"829","possible_hits":"4",},
{"lineNum":"   56","line":""},
{"lineNum":"   57","line":"SECP256K1_INLINE static int secp256k1_scalar_check_overflow(const secp256k1_scalar *a) {","class":"lineCov","hits":"2","order":"642","possible_hits":"2",},
{"lineNum":"   58","line":"    int yes = 0;","class":"lineCov","hits":"1","order":"643","possible_hits":"1",},
{"lineNum":"   59","line":"    int no = 0;","class":"lineCov","hits":"1","order":"644","possible_hits":"1",},
{"lineNum":"   60","line":"    no |= (a->d[3] < SECP256K1_N_3); /* No need for a > check. */","class":"lineCov","hits":"1","order":"645","possible_hits":"1",},
{"lineNum":"   61","line":"    no |= (a->d[2] < SECP256K1_N_2);","class":"lineCov","hits":"1","order":"646","possible_hits":"1",},
{"lineNum":"   62","line":"    yes |= (a->d[2] > SECP256K1_N_2) & ~no;","class":"lineCov","hits":"1","order":"647","possible_hits":"1",},
{"lineNum":"   63","line":"    no |= (a->d[1] < SECP256K1_N_1);","class":"lineCov","hits":"1","order":"648","possible_hits":"1",},
{"lineNum":"   64","line":"    yes |= (a->d[1] > SECP256K1_N_1) & ~no;","class":"lineCov","hits":"1","order":"649","possible_hits":"1",},
{"lineNum":"   65","line":"    yes |= (a->d[0] >= SECP256K1_N_0) & ~no;","class":"lineCov","hits":"1","order":"650","possible_hits":"1",},
{"lineNum":"   66","line":"    return yes;","class":"lineCov","hits":"1","order":"651","possible_hits":"1",},
{"lineNum":"   67","line":"}"},
{"lineNum":"   68","line":""},
{"lineNum":"   69","line":"SECP256K1_INLINE static int secp256k1_scalar_reduce(secp256k1_scalar *r, unsigned int overflow) {","class":"lineCov","hits":"2","order":"652","possible_hits":"2",},
{"lineNum":"   70","line":"    uint128_t t;"},
{"lineNum":"   71","line":"    VERIFY_CHECK(overflow <= 1);","class":"lineCov","hits":"1","order":"653","possible_hits":"1",},
{"lineNum":"   72","line":"    t = (uint128_t)r->d[0] + overflow * SECP256K1_N_C_0;","class":"lineCov","hits":"1","order":"654","possible_hits":"1",},
{"lineNum":"   73","line":"    r->d[0] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"655","possible_hits":"1",},
{"lineNum":"   74","line":"    t += (uint128_t)r->d[1] + overflow * SECP256K1_N_C_1;","class":"lineCov","hits":"1","order":"656","possible_hits":"1",},
{"lineNum":"   75","line":"    r->d[1] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"657","possible_hits":"1",},
{"lineNum":"   76","line":"    t += (uint128_t)r->d[2] + overflow * SECP256K1_N_C_2;","class":"lineCov","hits":"1","order":"658","possible_hits":"1",},
{"lineNum":"   77","line":"    r->d[2] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"659","possible_hits":"1",},
{"lineNum":"   78","line":"    t += (uint64_t)r->d[3];","class":"lineCov","hits":"1","order":"660","possible_hits":"1",},
{"lineNum":"   79","line":"    r->d[3] = t & 0xFFFFFFFFFFFFFFFFULL;","class":"lineCov","hits":"1","order":"661","possible_hits":"1",},
{"lineNum":"   80","line":"    return overflow;","class":"lineCov","hits":"1","order":"662","possible_hits":"1",},
{"lineNum":"   81","line":"}"},
{"lineNum":"   82","line":""},
{"lineNum":"   83","line":"static int secp256k1_scalar_add(secp256k1_scalar *r, const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"2","order":"782","possible_hits":"2",},
{"lineNum":"   84","line":"    int overflow;"},
{"lineNum":"   85","line":"    uint128_t t = (uint128_t)a->d[0] + b->d[0];","class":"lineCov","hits":"1","order":"783","possible_hits":"1",},
{"lineNum":"   86","line":"    r->d[0] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"784","possible_hits":"1",},
{"lineNum":"   87","line":"    t += (uint128_t)a->d[1] + b->d[1];","class":"lineCov","hits":"1","order":"785","possible_hits":"1",},
{"lineNum":"   88","line":"    r->d[1] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"786","possible_hits":"1",},
{"lineNum":"   89","line":"    t += (uint128_t)a->d[2] + b->d[2];","class":"lineCov","hits":"1","order":"787","possible_hits":"1",},
{"lineNum":"   90","line":"    r->d[2] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"788","possible_hits":"1",},
{"lineNum":"   91","line":"    t += (uint128_t)a->d[3] + b->d[3];","class":"lineCov","hits":"1","order":"789","possible_hits":"1",},
{"lineNum":"   92","line":"    r->d[3] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"790","possible_hits":"1",},
{"lineNum":"   93","line":"    overflow = t + secp256k1_scalar_check_overflow(r);","class":"lineCov","hits":"1","order":"791","possible_hits":"1",},
{"lineNum":"   94","line":"    VERIFY_CHECK(overflow == 0 || overflow == 1);","class":"lineCov","hits":"1","order":"792","possible_hits":"1",},
{"lineNum":"   95","line":"    secp256k1_scalar_reduce(r, overflow);","class":"lineCov","hits":"1","order":"793","possible_hits":"1",},
{"lineNum":"   96","line":"    return overflow;","class":"lineCov","hits":"1","order":"794","possible_hits":"1",},
{"lineNum":"   97","line":"}"},
{"lineNum":"   98","line":""},
...
{"lineNum":"  115","line":"}"},
{"lineNum":"  116","line":""},
{"lineNum":"  117","line":"static void secp256k1_scalar_set_b32(secp256k1_scalar *r, const unsigned char *b32, int *overflow) {","class":"lineCov","hits":"2","order":"636","possible_hits":"2",},
{"lineNum":"  118","line":"    int over;"},
{"lineNum":"  119","line":"    r->d[0] = (uint64_t)b32[31] | (uint64_t)b32[30] << 8 | (uint64_t)b32[29] << 16 | (uint64_t)b32[28] << 24 | (uint64_t)b32[27] << 32 | (uint64_t)b32[26] << 40 | (uint64_t)b32[25] << 48 | (uint64_t)b32[24] << 56;","class":"lineCov","hits":"1","order":"637","possible_hits":"1",},
{"lineNum":"  120","line":"    r->d[1] = (uint64_t)b32[23] | (uint64_t)b32[22] << 8 | (uint64_t)b32[21] << 16 | (uint64_t)b32[20] << 24 | (uint64_t)b32[19] << 32 | (uint64_t)b32[18] << 40 | (uint64_t)b32[17] << 48 | (uint64_t)b32[16] << 56;","class":"lineCov","hits":"1","order":"638","possible_hits":"1",},
{"lineNum":"  121","line":"    r->d[2] = (uint64_t)b32[15] | (uint64_t)b32[14] << 8 | (uint64_t)b32[13] << 16 | (uint64_t)b32[12] << 24 | (uint64_t)b32[11] << 32 | (uint64_t)b32[10] << 40 | (uint64_t)b32[9] << 48 | (uint64_t)b32[8] << 56;","class":"lineCov","hits":"1","order":"639","possible_hits":"1",},
{"lineNum":"  122","line":"    r->d[3] = (uint64_t)b32[7] | (uint64_t)b32[6] << 8 | (uint64_t)b32[5] << 16 | (uint64_t)b32[4] << 24 | (uint64_t)b32[3] << 32 | (uint64_t)b32[2] << 40 | (uint64_t)b32[1] << 48 | (uint64_t)b32[0] << 56;","class":"lineCov","hits":"1","order":"640","possible_hits":"1",},
{"lineNum":"  123","line":"    over = secp256k1_scalar_reduce(r, secp256k1_scalar_check_overflow(r));","class":"lineCov","hits":"1","order":"641","possible_hits":"1",},
{"lineNum":"  124","line":"    if (overflow) {","class":"lineCov","hits":"1","order":"663","possible_hits":"1",},
{"lineNum":"  125","line":"        *overflow = over;","class":"lineCov","hits":"1","order":"1050","possible_hits":"1",},
{"lineNum":"  126","line":"    }"},
{"lineNum":"  127","line":"}","class":"linePartCov","hits":"1","order":"664","possible_hits":"2",},
{"lineNum":"  128","line":""},
...
{"lineNum":"  135","line":""},
{"lineNum":"  136","line":"SECP256K1_INLINE static int secp256k1_scalar_is_zero(const secp256k1_scalar *a) {","class":"lineCov","hits":"6","order":"700","possible_hits":"6",},
{"lineNum":"  137","line":"    return (a->d[0] | a->d[1] | a->d[2] | a->d[3]) == 0;","class":"lineCov","hits":"3","order":"701","possible_hits":"3",},
{"lineNum":"  138","line":"}"},
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"static void secp256k1_scalar_negate(secp256k1_scalar *r, const secp256k1_scalar *a) {","class":"linePartCov","hits":"4","order":"1068","possible_hits":"6",},
{"lineNum":"  141","line":"    uint64_t nonzero = 0xFFFFFFFFFFFFFFFFULL * (secp256k1_scalar_is_zero(a) == 0);","class":"linePartCov","hits":"2","order":"1069","possible_hits":"3",},
{"lineNum":"  142","line":"    uint128_t t = (uint128_t)(~a->d[0]) + SECP256K1_N_0 + 1;","class":"linePartCov","hits":"2","order":"1070","possible_hits":"3",},
{"lineNum":"  143","line":"    r->d[0] = t & nonzero; t >>= 64;","class":"linePartCov","hits":"2","order":"1071","possible_hits":"3",},
{"lineNum":"  144","line":"    t += (uint128_t)(~a->d[1]) + SECP256K1_N_1;","class":"linePartCov","hits":"2","order":"1072","possible_hits":"3",},
{"lineNum":"  145","line":"    r->d[1] = t & nonzero; t >>= 64;","class":"linePartCov","hits":"2","order":"1073","possible_hits":"3",},
{"lineNum":"  146","line":"    t += (uint128_t)(~a->d[2]) + SECP256K1_N_2;","class":"linePartCov","hits":"2","order":"1074","possible_hits":"3",},
{"lineNum":"  147","line":"    r->d[2] = t & nonzero; t >>= 64;","class":"linePartCov","hits":"2","order":"1075","possible_hits":"3",},
{"lineNum":"  148","line":"    t += (uint128_t)(~a->d[3]) + SECP256K1_N_3;","class":"linePartCov","hits":"2","order":"1076","possible_hits":"3",},
{"lineNum":"  149","line":"    r->d[3] = t & nonzero;","class":"linePartCov","hits":"2","order":"1077","possible_hits":"3",},
{"lineNum":"  150","line":"}","class":"linePartCov","hits":"4","order":"823","possible_hits":"6",},
{"lineNum":"  151","line":""},
...
{"lineNum":"  268","line":"}"},
{"lineNum":"  269","line":""},
{"lineNum":"  270","line":"static void secp256k1_scalar_reduce_512(secp256k1_scalar *r, const uint64_t *l) {","class":"lineCov","hits":"2","order":"1091","possible_hits":"2",},
...
{"lineNum":"  276","line":""},
{"lineNum":"  277","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"1093","possible_hits":"1",},
...
{"lineNum":"  379","line":"    : \"S\"(l), \"n\"(SECP256K1_N_C_0), \"n\"(SECP256K1_N_C_1)","class":"lineCov","hits":"1","order":"1092","possible_hits":"1",},
{"lineNum":"  380","line":"    : \"rax\", \"rdx\", \"r8\", \"r9\", \"r10\", \"r11\", \"r12\", \"r13\", \"r14\", \"cc\");"},
{"lineNum":"  381","line":""},
{"lineNum":"  382","line":"    /* Reduce 385 bits into 258. */"},
{"lineNum":"  383","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"1095","possible_hits":"1",},
...
{"lineNum":"  458","line":"    : \"g\"(m0), \"g\"(m1), \"g\"(m2), \"g\"(m3), \"g\"(m4), \"g\"(m5), \"g\"(m6), \"n\"(SECP256K1_N_C_0), \"n\"(SECP256K1_N_C_1)","class":"lineCov","hits":"1","order":"1094","possible_hits":"1",},
{"lineNum":"  459","line":"    : \"rax\", \"rdx\", \"r8\", \"r9\", \"r10\", \"r11\", \"r12\", \"r13\", \"cc\");"},
{"lineNum":"  460","line":""},
{"lineNum":"  461","line":"    /* Reduce 258 bits into 256. */"},
{"lineNum":"  462","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"1097","possible_hits":"1",},
...
{"lineNum":"  504","line":"    : \"g\"(p0), \"g\"(p1), \"g\"(p2), \"g\"(p3), \"g\"(p4), \"D\"(r), \"n\"(SECP256K1_N_C_0), \"n\"(SECP256K1_N_C_1)","class":"lineCov","hits":"1","order":"1096","possible_hits":"1",},
...
{"lineNum":"  576","line":"    secp256k1_scalar_reduce(r, c + secp256k1_scalar_check_overflow(r));","class":"lineCov","hits":"1","order":"1098","possible_hits":"1",},
{"lineNum":"  577","line":"}","class":"linePartCov","hits":"1","order":"1099","possible_hits":"2",},
{"lineNum":"  578","line":""},
{"lineNum":"  579","line":"static void secp256k1_scalar_mul_512(uint64_t l[8], const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"2","order":"1085","possible_hits":"2",},
{"lineNum":"  580","line":"#ifdef USE_ASM_X86_64"},
{"lineNum":"  581","line":"    const uint64_t *pb = b->d;","class":"lineCov","hits":"1","order":"1086","possible_hits":"1",},
{"lineNum":"  582","line":"    __asm__ __volatile__(","class":"lineCov","hits":"2","order":"1087","possible_hits":"2",},
...
{"lineNum":"  710","line":"    : \"S\"(l), \"D\"(a->d)","class":"lineCov","hits":"1","order":"1088","possible_hits":"1",},
...
{"lineNum":"  744","line":"}","class":"linePartCov","hits":"1","order":"1089","possible_hits":"2",},
{"lineNum":"  745","line":""},
...
{"lineNum":"  890","line":""},
{"lineNum":"  891","line":"static void secp256k1_scalar_mul(secp256k1_scalar *r, const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"2","order":"1083","possible_hits":"2",},
{"lineNum":"  892","line":"    uint64_t l[8];"},
{"lineNum":"  893","line":"    secp256k1_scalar_mul_512(l, a, b);","class":"lineCov","hits":"1","order":"1084","possible_hits":"1",},
{"lineNum":"  894","line":"    secp256k1_scalar_reduce_512(r, l);","class":"lineCov","hits":"1","order":"1090","possible_hits":"1",},
{"lineNum":"  895","line":"}","class":"linePartCov","hits":"1","order":"1100","possible_hits":"2",},
{"lineNum":"  896","line":""},
...
{"lineNum":"  927","line":""},
{"lineNum":"  928","line":"SECP256K1_INLINE static int secp256k1_scalar_eq(const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"2","order":"809","possible_hits":"2",},
{"lineNum":"  929","line":"    return ((a->d[0] ^ b->d[0]) | (a->d[1] ^ b->d[1]) | (a->d[2] ^ b->d[2]) | (a->d[3] ^ b->d[3])) == 0;","class":"lineCov","hits":"1","order":"810","possible_hits":"1",},
{"lineNum":"  930","line":"}"},
{"lineNum":"  931","line":""},
...
var header = { "command" : "schnorr_hfuzz_debug", "date" : "2023-08-14 14:03:36", "instrumented" : 122, "covered" : 105,};
var merged_data = [];
