...
{"lineNum":"   75","line":"  }"},
{"lineNum":"   76","line":""},
{"lineNum":"   77","line":"  static constexpr size_t memoryRequired() { return serialize_size; }","class":"lineCov","hits":"1","order":"1181",},
...
{"lineNum":"   86","line":"  inline void Serialize(Stream& s) const {","class":"lineCov","hits":"1","order":"1187",},
{"lineNum":"   87","line":"        constexpr int size = memoryRequired();","class":"lineCov","hits":"1","order":"1185",},
{"lineNum":"   88","line":"        unsigned char buffer[size];"},
{"lineNum":"   89","line":"        serialize(buffer);","class":"lineCov","hits":"1","order":"1183",},
{"lineNum":"   90","line":"        char* b = (char*)buffer;","class":"lineCov","hits":"1","order":"1182",},
{"lineNum":"   91","line":"        s.write(b, size);","class":"lineCov","hits":"1","order":"1180",},
{"lineNum":"   92","line":"  }","class":"lineCov","hits":"1","order":"1179",},
{"lineNum":"   93","line":""},
{"lineNum":"   94","line":"  template<typename Stream>"},
{"lineNum":"   95","line":"  inline void Unserialize(Stream& s) {","class":"lineCov","hits":"1","order":"1178",},
{"lineNum":"   96","line":"        constexpr int size = memoryRequired();","class":"lineCov","hits":"1","order":"1177",},
{"lineNum":"   97","line":"        unsigned char buffer[size];"},
{"lineNum":"   98","line":"        char* b = (char*)buffer;","class":"lineCov","hits":"1","order":"1176",},
{"lineNum":"   99","line":"        s.read(b, size);","class":"lineCov","hits":"1","order":"1186",},
{"lineNum":"  100","line":"        deserialize(buffer);","class":"lineCov","hits":"1","order":"1184",},
{"lineNum":"  101","line":"  }","class":"lineCov","hits":"1","order":"1175",},
{"lineNum":"  102","line":""},
...
var header = { "command" : "", "date" : "2023-08-14 14:08:26", "instrumented" : 13, "covered" : 13,};
var merged_data = [];
