...
{"lineNum":"   26","line":""},
{"lineNum":"   27","line":"SECP256K1_INLINE static void secp256k1_scalar_clear(secp256k1_scalar *r) {","class":"lineCov","hits":"1","order":"504",},
{"lineNum":"   28","line":"    r->d[0] = 0;","class":"lineCov","hits":"1","order":"507",},
{"lineNum":"   29","line":"    r->d[1] = 0;","class":"lineCov","hits":"1","order":"510",},
{"lineNum":"   30","line":"    r->d[2] = 0;","class":"lineCov","hits":"1","order":"532",},
{"lineNum":"   31","line":"    r->d[3] = 0;","class":"lineCov","hits":"1","order":"517",},
{"lineNum":"   32","line":"}","class":"lineCov","hits":"1","order":"524",},
{"lineNum":"   33","line":""},
{"lineNum":"   34","line":"SECP256K1_INLINE static void secp256k1_scalar_set_int(secp256k1_scalar *r, unsigned int v) {","class":"lineCov","hits":"1","order":"514",},
{"lineNum":"   35","line":"    r->d[0] = v;","class":"lineCov","hits":"1","order":"520",},
{"lineNum":"   36","line":"    r->d[1] = 0;","class":"lineCov","hits":"1","order":"528",},
{"lineNum":"   37","line":"    r->d[2] = 0;","class":"lineCov","hits":"1","order":"536",},
{"lineNum":"   38","line":"    r->d[3] = 0;","class":"lineCov","hits":"1","order":"499",},
{"lineNum":"   39","line":"}","class":"lineCov","hits":"1","order":"543",},
{"lineNum":"   40","line":""},
{"lineNum":"   41","line":"SECP256K1_INLINE static unsigned int secp256k1_scalar_get_bits(const secp256k1_scalar *a, unsigned int offset, unsigned int count) {","class":"lineCov","hits":"1","order":"453",},
{"lineNum":"   42","line":"    VERIFY_CHECK((offset + count - 1) >> 6 == offset >> 6);","class":"lineCov","hits":"1","order":"452",},
{"lineNum":"   43","line":"    return (a->d[offset >> 6] >> (offset & 0x3F)) & ((((uint64_t)1) << count) - 1);","class":"lineCov","hits":"1","order":"451",},
{"lineNum":"   44","line":"}"},
{"lineNum":"   45","line":""},
{"lineNum":"   46","line":"SECP256K1_INLINE static unsigned int secp256k1_scalar_get_bits_var(const secp256k1_scalar *a, unsigned int offset, unsigned int count) {","class":"lineCov","hits":"1","order":"450",},
{"lineNum":"   47","line":"    VERIFY_CHECK(count < 32);","class":"lineCov","hits":"1","order":"449",},
{"lineNum":"   48","line":"    VERIFY_CHECK(offset + count <= 256);","class":"lineCov","hits":"1","order":"448",},
{"lineNum":"   49","line":"    if ((offset + count - 1) >> 6 == offset >> 6) {","class":"lineCov","hits":"1","order":"447",},
{"lineNum":"   50","line":"        return secp256k1_scalar_get_bits(a, offset, count);","class":"lineCov","hits":"1","order":"446",},
{"lineNum":"   51","line":"    } else {"},
{"lineNum":"   52","line":"        VERIFY_CHECK((offset >> 6) + 1 < 4);","class":"lineCov","hits":"1","order":"445",},
{"lineNum":"   53","line":"        return ((a->d[offset >> 6] >> (offset & 0x3F)) | (a->d[(offset >> 6) + 1] << (64 - (offset & 0x3F)))) & ((((uint64_t)1) << count) - 1);","class":"lineCov","hits":"1","order":"444",},
{"lineNum":"   54","line":"    }"},
{"lineNum":"   55","line":"}","class":"lineCov","hits":"1","order":"443",},
{"lineNum":"   56","line":""},
{"lineNum":"   57","line":"SECP256K1_INLINE static int secp256k1_scalar_check_overflow(const secp256k1_scalar *a) {","class":"lineCov","hits":"1","order":"466",},
{"lineNum":"   58","line":"    int yes = 0;","class":"lineCov","hits":"1","order":"465",},
{"lineNum":"   59","line":"    int no = 0;","class":"lineCov","hits":"1","order":"464",},
{"lineNum":"   60","line":"    no |= (a->d[3] < SECP256K1_N_3); /* No need for a > check. */","class":"lineCov","hits":"1","order":"463",},
{"lineNum":"   61","line":"    no |= (a->d[2] < SECP256K1_N_2);","class":"lineCov","hits":"1","order":"462",},
{"lineNum":"   62","line":"    yes |= (a->d[2] > SECP256K1_N_2) & ~no;","class":"lineCov","hits":"1","order":"461",},
{"lineNum":"   63","line":"    no |= (a->d[1] < SECP256K1_N_1);","class":"lineCov","hits":"1","order":"460",},
{"lineNum":"   64","line":"    yes |= (a->d[1] > SECP256K1_N_1) & ~no;","class":"lineCov","hits":"1","order":"459",},
{"lineNum":"   65","line":"    yes |= (a->d[0] >= SECP256K1_N_0) & ~no;","class":"lineCov","hits":"1","order":"458",},
{"lineNum":"   66","line":"    return yes;","class":"lineCov","hits":"1","order":"457",},
{"lineNum":"   67","line":"}"},
{"lineNum":"   68","line":""},
{"lineNum":"   69","line":"SECP256K1_INLINE static int secp256k1_scalar_reduce(secp256k1_scalar *r, unsigned int overflow) {","class":"lineCov","hits":"1","order":"483",},
{"lineNum":"   70","line":"    uint128_t t;"},
{"lineNum":"   71","line":"    VERIFY_CHECK(overflow <= 1);","class":"lineCov","hits":"1","order":"481",},
{"lineNum":"   72","line":"    t = (uint128_t)r->d[0] + overflow * SECP256K1_N_C_0;","class":"lineCov","hits":"1","order":"479",},
{"lineNum":"   73","line":"    r->d[0] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"478",},
{"lineNum":"   74","line":"    t += (uint128_t)r->d[1] + overflow * SECP256K1_N_C_1;","class":"lineCov","hits":"1","order":"476",},
{"lineNum":"   75","line":"    r->d[1] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"474",},
{"lineNum":"   76","line":"    t += (uint128_t)r->d[2] + overflow * SECP256K1_N_C_2;","class":"lineCov","hits":"1","order":"472",},
{"lineNum":"   77","line":"    r->d[2] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"471",},
{"lineNum":"   78","line":"    t += (uint64_t)r->d[3];","class":"lineCov","hits":"1","order":"469",},
{"lineNum":"   79","line":"    r->d[3] = t & 0xFFFFFFFFFFFFFFFFULL;","class":"lineCov","hits":"1","order":"468",},
{"lineNum":"   80","line":"    return overflow;","class":"lineCov","hits":"1","order":"467",},
{"lineNum":"   81","line":"}"},
{"lineNum":"   82","line":""},
{"lineNum":"   83","line":"static int secp256k1_scalar_add(secp256k1_scalar *r, const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"1","order":"486",},
{"lineNum":"   84","line":"    int overflow;"},
{"lineNum":"   85","line":"    uint128_t t = (uint128_t)a->d[0] + b->d[0];","class":"lineCov","hits":"1","order":"502",},
{"lineNum":"   86","line":"    r->d[0] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"505",},
{"lineNum":"   87","line":"    t += (uint128_t)a->d[1] + b->d[1];","class":"lineCov","hits":"1","order":"508",},
{"lineNum":"   88","line":"    r->d[1] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"511",},
{"lineNum":"   89","line":"    t += (uint128_t)a->d[2] + b->d[2];","class":"lineCov","hits":"1","order":"533",},
{"lineNum":"   90","line":"    r->d[2] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"518",},
{"lineNum":"   91","line":"    t += (uint128_t)a->d[3] + b->d[3];","class":"lineCov","hits":"1","order":"525",},
{"lineNum":"   92","line":"    r->d[3] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"538",},
{"lineNum":"   93","line":"    overflow = t + secp256k1_scalar_check_overflow(r);","class":"lineCov","hits":"1","order":"515",},
{"lineNum":"   94","line":"    VERIFY_CHECK(overflow == 0 || overflow == 1);","class":"lineCov","hits":"1","order":"521",},
{"lineNum":"   95","line":"    secp256k1_scalar_reduce(r, overflow);","class":"lineCov","hits":"1","order":"529",},
{"lineNum":"   96","line":"    return overflow;","class":"lineCov","hits":"1","order":"537",},
{"lineNum":"   97","line":"}"},
{"lineNum":"   98","line":""},
...
{"lineNum":"  115","line":"}"},
{"lineNum":"  116","line":""},
{"lineNum":"  117","line":"static void secp256k1_scalar_set_b32(secp256k1_scalar *r, const unsigned char *b32, int *overflow) {","class":"lineCov","hits":"1","order":"535",},
{"lineNum":"  118","line":"    int over;"},
{"lineNum":"  119","line":"    r->d[0] = (uint64_t)b32[31] | (uint64_t)b32[30] << 8 | (uint64_t)b32[29] << 16 | (uint64_t)b32[28] << 24 | (uint64_t)b32[27] << 32 | (uint64_t)b32[26] << 40 | (uint64_t)b32[25] << 48 | (uint64_t)b32[24] << 56;","class":"lineCov","hits":"1","order":"523",},
{"lineNum":"  120","line":"    r->d[1] = (uint64_t)b32[23] | (uint64_t)b32[22] << 8 | (uint64_t)b32[21] << 16 | (uint64_t)b32[20] << 24 | (uint64_t)b32[19] << 32 | (uint64_t)b32[18] << 40 | (uint64_t)b32[17] << 48 | (uint64_t)b32[16] << 56;","class":"lineCov","hits":"1","order":"513",},
{"lineNum":"  121","line":"    r->d[2] = (uint64_t)b32[15] | (uint64_t)b32[14] << 8 | (uint64_t)b32[13] << 16 | (uint64_t)b32[12] << 24 | (uint64_t)b32[11] << 32 | (uint64_t)b32[10] << 40 | (uint64_t)b32[9] << 48 | (uint64_t)b32[8] << 56;","class":"lineCov","hits":"1","order":"516",},
{"lineNum":"  122","line":"    r->d[3] = (uint64_t)b32[7] | (uint64_t)b32[6] << 8 | (uint64_t)b32[5] << 16 | (uint64_t)b32[4] << 24 | (uint64_t)b32[3] << 32 | (uint64_t)b32[2] << 40 | (uint64_t)b32[1] << 48 | (uint64_t)b32[0] << 56;","class":"lineCov","hits":"1","order":"522",},
{"lineNum":"  123","line":"    over = secp256k1_scalar_reduce(r, secp256k1_scalar_check_overflow(r));","class":"lineCov","hits":"1","order":"531",},
{"lineNum":"  124","line":"    if (overflow) {","class":"lineCov","hits":"1","order":"498",},
{"lineNum":"  125","line":"        *overflow = over;","class":"lineCov","hits":"1","order":"501",},
{"lineNum":"  126","line":"    }"},
{"lineNum":"  127","line":"}","class":"lineCov","hits":"1","order":"492",},
{"lineNum":"  128","line":""},
{"lineNum":"  129","line":"static void secp256k1_scalar_get_b32(unsigned char *bin, const secp256k1_scalar* a) {","class":"lineCov","hits":"1","order":"496",},
{"lineNum":"  130","line":"    bin[0] = a->d[3] >> 56; bin[1] = a->d[3] >> 48; bin[2] = a->d[3] >> 40; bin[3] = a->d[3] >> 32; bin[4] = a->d[3] >> 24; bin[5] = a->d[3] >> 16; bin[6] = a->d[3] >> 8; bin[7] = a->d[3];","class":"lineCov","hits":"1","order":"485",},
{"lineNum":"  131","line":"    bin[8] = a->d[2] >> 56; bin[9] = a->d[2] >> 48; bin[10] = a->d[2] >> 40; bin[11] = a->d[2] >> 32; bin[12] = a->d[2] >> 24; bin[13] = a->d[2] >> 16; bin[14] = a->d[2] >> 8; bin[15] = a->d[2];","class":"lineCov","hits":"1","order":"493",},
{"lineNum":"  132","line":"    bin[16] = a->d[1] >> 56; bin[17] = a->d[1] >> 48; bin[18] = a->d[1] >> 40; bin[19] = a->d[1] >> 32; bin[20] = a->d[1] >> 24; bin[21] = a->d[1] >> 16; bin[22] = a->d[1] >> 8; bin[23] = a->d[1];","class":"lineCov","hits":"1","order":"490",},
{"lineNum":"  133","line":"    bin[24] = a->d[0] >> 56; bin[25] = a->d[0] >> 48; bin[26] = a->d[0] >> 40; bin[27] = a->d[0] >> 32; bin[28] = a->d[0] >> 24; bin[29] = a->d[0] >> 16; bin[30] = a->d[0] >> 8; bin[31] = a->d[0];","class":"lineCov","hits":"1","order":"488",},
{"lineNum":"  134","line":"}","class":"lineCov","hits":"1","order":"484",},
{"lineNum":"  135","line":""},
{"lineNum":"  136","line":"SECP256K1_INLINE static int secp256k1_scalar_is_zero(const secp256k1_scalar *a) {","class":"lineCov","hits":"1","order":"546",},
{"lineNum":"  137","line":"    return (a->d[0] | a->d[1] | a->d[2] | a->d[3]) == 0;","class":"lineCov","hits":"1","order":"547",},
{"lineNum":"  138","line":"}"},
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"static void secp256k1_scalar_negate(secp256k1_scalar *r, const secp256k1_scalar *a) {","class":"lineCov","hits":"1","order":"539",},
{"lineNum":"  141","line":"    uint64_t nonzero = 0xFFFFFFFFFFFFFFFFULL * (secp256k1_scalar_is_zero(a) == 0);","class":"lineCov","hits":"1","order":"540",},
{"lineNum":"  142","line":"    uint128_t t = (uint128_t)(~a->d[0]) + SECP256K1_N_0 + 1;","class":"lineCov","hits":"1","order":"487",},
{"lineNum":"  143","line":"    r->d[0] = t & nonzero; t >>= 64;","class":"lineCov","hits":"1","order":"542",},
{"lineNum":"  144","line":"    t += (uint128_t)(~a->d[1]) + SECP256K1_N_1;","class":"lineCov","hits":"1","order":"503",},
{"lineNum":"  145","line":"    r->d[1] = t & nonzero; t >>= 64;","class":"lineCov","hits":"1","order":"506",},
{"lineNum":"  146","line":"    t += (uint128_t)(~a->d[2]) + SECP256K1_N_2;","class":"lineCov","hits":"1","order":"509",},
{"lineNum":"  147","line":"    r->d[2] = t & nonzero; t >>= 64;","class":"lineCov","hits":"1","order":"512",},
{"lineNum":"  148","line":"    t += (uint128_t)(~a->d[3]) + SECP256K1_N_3;","class":"lineCov","hits":"1","order":"534",},
{"lineNum":"  149","line":"    r->d[3] = t & nonzero;","class":"lineCov","hits":"1","order":"519",},
{"lineNum":"  150","line":"}","class":"lineCov","hits":"1","order":"527",},
{"lineNum":"  151","line":""},
...
{"lineNum":"  268","line":"}"},
{"lineNum":"  269","line":""},
{"lineNum":"  270","line":"static void secp256k1_scalar_reduce_512(secp256k1_scalar *r, const uint64_t *l) {","class":"lineCov","hits":"1","order":"541",},
...
{"lineNum":"  276","line":""},
{"lineNum":"  277","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"526",},
...
{"lineNum":"  379","line":"    : \"S\"(l), \"n\"(SECP256K1_N_C_0), \"n\"(SECP256K1_N_C_1)","class":"lineCov","hits":"1","order":"500",},
{"lineNum":"  380","line":"    : \"rax\", \"rdx\", \"r8\", \"r9\", \"r10\", \"r11\", \"r12\", \"r13\", \"r14\", \"cc\");"},
{"lineNum":"  381","line":""},
{"lineNum":"  382","line":"    /* Reduce 385 bits into 258. */"},
{"lineNum":"  383","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"495",},
...
{"lineNum":"  458","line":"    : \"g\"(m0), \"g\"(m1), \"g\"(m2), \"g\"(m3), \"g\"(m4), \"g\"(m5), \"g\"(m6), \"n\"(SECP256K1_N_C_0), \"n\"(SECP256K1_N_C_1)","class":"lineCov","hits":"1","order":"470",},
{"lineNum":"  459","line":"    : \"rax\", \"rdx\", \"r8\", \"r9\", \"r10\", \"r11\", \"r12\", \"r13\", \"cc\");"},
{"lineNum":"  460","line":""},
{"lineNum":"  461","line":"    /* Reduce 258 bits into 256. */"},
{"lineNum":"  462","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"455",},
...
{"lineNum":"  504","line":"    : \"g\"(p0), \"g\"(p1), \"g\"(p2), \"g\"(p3), \"g\"(p4), \"D\"(r), \"n\"(SECP256K1_N_C_0), \"n\"(SECP256K1_N_C_1)","class":"lineCov","hits":"1","order":"530",},
...
{"lineNum":"  576","line":"    secp256k1_scalar_reduce(r, c + secp256k1_scalar_check_overflow(r));","class":"lineCov","hits":"1","order":"454",},
{"lineNum":"  577","line":"}","class":"lineCov","hits":"1","order":"482",},
{"lineNum":"  578","line":""},
{"lineNum":"  579","line":"static void secp256k1_scalar_mul_512(uint64_t l[8], const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"1","order":"480",},
{"lineNum":"  580","line":"#ifdef USE_ASM_X86_64"},
{"lineNum":"  581","line":"    const uint64_t *pb = b->d;","class":"lineCov","hits":"1","order":"477",},
{"lineNum":"  582","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"475",},
...
{"lineNum":"  710","line":"    : \"S\"(l), \"D\"(a->d)","class":"lineCov","hits":"1","order":"473",},
...
{"lineNum":"  744","line":"}","class":"lineCov","hits":"1","order":"456",},
{"lineNum":"  745","line":""},
...
{"lineNum":"  890","line":""},
{"lineNum":"  891","line":"static void secp256k1_scalar_mul(secp256k1_scalar *r, const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"1","order":"497",},
{"lineNum":"  892","line":"    uint64_t l[8];"},
{"lineNum":"  893","line":"    secp256k1_scalar_mul_512(l, a, b);","class":"lineCov","hits":"1","order":"494",},
{"lineNum":"  894","line":"    secp256k1_scalar_reduce_512(r, l);","class":"lineCov","hits":"1","order":"491",},
{"lineNum":"  895","line":"}","class":"lineCov","hits":"1","order":"489",},
{"lineNum":"  896","line":""},
...
{"lineNum":"  927","line":""},
{"lineNum":"  928","line":"SECP256K1_INLINE static int secp256k1_scalar_eq(const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"1","order":"544",},
{"lineNum":"  929","line":"    return ((a->d[0] ^ b->d[0]) | (a->d[1] ^ b->d[1]) | (a->d[2] ^ b->d[2]) | (a->d[3] ^ b->d[3])) == 0;","class":"lineCov","hits":"1","order":"545",},
{"lineNum":"  930","line":"}"},
{"lineNum":"  931","line":""},
...
var header = { "command" : "", "date" : "2023-08-14 14:08:26", "instrumented" : 122, "covered" : 105,};
var merged_data = [];
