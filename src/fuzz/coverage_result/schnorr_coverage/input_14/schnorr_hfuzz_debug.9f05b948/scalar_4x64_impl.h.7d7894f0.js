...
{"lineNum":"   40","line":""},
{"lineNum":"   41","line":"SECP256K1_INLINE static unsigned int secp256k1_scalar_get_bits(const secp256k1_scalar *a, unsigned int offset, unsigned int count) {","class":"lineCov","hits":"4","order":"717","possible_hits":"4",},
{"lineNum":"   42","line":"    VERIFY_CHECK((offset + count - 1) >> 6 == offset >> 6);","class":"lineCov","hits":"2","order":"718","possible_hits":"2",},
{"lineNum":"   43","line":"    return (a->d[offset >> 6] >> (offset & 0x3F)) & ((((uint64_t)1) << count) - 1);","class":"lineCov","hits":"2","order":"719","possible_hits":"2",},
{"lineNum":"   44","line":"}"},
{"lineNum":"   45","line":""},
{"lineNum":"   46","line":"SECP256K1_INLINE static unsigned int secp256k1_scalar_get_bits_var(const secp256k1_scalar *a, unsigned int offset, unsigned int count) {","class":"lineCov","hits":"4","order":"728","possible_hits":"4",},
{"lineNum":"   47","line":"    VERIFY_CHECK(count < 32);","class":"lineCov","hits":"2","order":"729","possible_hits":"2",},
{"lineNum":"   48","line":"    VERIFY_CHECK(offset + count <= 256);","class":"lineCov","hits":"2","order":"730","possible_hits":"2",},
{"lineNum":"   49","line":"    if ((offset + count - 1) >> 6 == offset >> 6) {","class":"lineCov","hits":"2","order":"731","possible_hits":"2",},
{"lineNum":"   50","line":"        return secp256k1_scalar_get_bits(a, offset, count);","class":"lineCov","hits":"2","order":"732","possible_hits":"2",},
{"lineNum":"   51","line":"    } else {"},
{"lineNum":"   52","line":"        VERIFY_CHECK((offset >> 6) + 1 < 4);","class":"lineCov","hits":"2","order":"959","possible_hits":"2",},
{"lineNum":"   53","line":"        return ((a->d[offset >> 6] >> (offset & 0x3F)) | (a->d[(offset >> 6) + 1] << (64 - (offset & 0x3F)))) & ((((uint64_t)1) << count) - 1);","class":"lineCov","hits":"2","order":"960","possible_hits":"2",},
{"lineNum":"   54","line":"    }"},
{"lineNum":"   55","line":"}","class":"linePartCov","hits":"2","order":"733","possible_hits":"4",},
{"lineNum":"   56","line":""},
...
{"lineNum":"   81","line":"}"},
{"lineNum":"   82","line":""},
{"lineNum":"   83","line":"static int secp256k1_scalar_add(secp256k1_scalar *r, const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"2","order":"913","possible_hits":"2",},
{"lineNum":"   84","line":"    int overflow;"},
{"lineNum":"   85","line":"    uint128_t t = (uint128_t)a->d[0] + b->d[0];","class":"lineCov","hits":"1","order":"914","possible_hits":"1",},
{"lineNum":"   86","line":"    r->d[0] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"915","possible_hits":"1",},
{"lineNum":"   87","line":"    t += (uint128_t)a->d[1] + b->d[1];","class":"lineCov","hits":"1","order":"916","possible_hits":"1",},
{"lineNum":"   88","line":"    r->d[1] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"917","possible_hits":"1",},
{"lineNum":"   89","line":"    t += (uint128_t)a->d[2] + b->d[2];","class":"lineCov","hits":"1","order":"918","possible_hits":"1",},
{"lineNum":"   90","line":"    r->d[2] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"919","possible_hits":"1",},
{"lineNum":"   91","line":"    t += (uint128_t)a->d[3] + b->d[3];","class":"lineCov","hits":"1","order":"920","possible_hits":"1",},
{"lineNum":"   92","line":"    r->d[3] = t & 0xFFFFFFFFFFFFFFFFULL; t >>= 64;","class":"lineCov","hits":"1","order":"921","possible_hits":"1",},
{"lineNum":"   93","line":"    overflow = t + secp256k1_scalar_check_overflow(r);","class":"lineCov","hits":"1","order":"922","possible_hits":"1",},
{"lineNum":"   94","line":"    VERIFY_CHECK(overflow == 0 || overflow == 1);","class":"lineCov","hits":"1","order":"923","possible_hits":"1",},
{"lineNum":"   95","line":"    secp256k1_scalar_reduce(r, overflow);","class":"lineCov","hits":"1","order":"924","possible_hits":"1",},
{"lineNum":"   96","line":"    return overflow;","class":"lineCov","hits":"1","order":"925","possible_hits":"1",},
{"lineNum":"   97","line":"}"},
{"lineNum":"   98","line":""},
...
{"lineNum":"  125","line":"        *overflow = over;","class":"lineCov","hits":"1","order":"1065","possible_hits":"1",},
{"lineNum":"  126","line":"    }"},
{"lineNum":"  127","line":"}","class":"linePartCov","hits":"1","order":"664","possible_hits":"2",},
{"lineNum":"  128","line":""},
{"lineNum":"  129","line":"static void secp256k1_scalar_get_b32(unsigned char *bin, const secp256k1_scalar* a) {","class":"lineCov","hits":"2","order":"993","possible_hits":"2",},
{"lineNum":"  130","line":"    bin[0] = a->d[3] >> 56; bin[1] = a->d[3] >> 48; bin[2] = a->d[3] >> 40; bin[3] = a->d[3] >> 32; bin[4] = a->d[3] >> 24; bin[5] = a->d[3] >> 16; bin[6] = a->d[3] >> 8; bin[7] = a->d[3];","class":"lineCov","hits":"1","order":"994","possible_hits":"1",},
{"lineNum":"  131","line":"    bin[8] = a->d[2] >> 56; bin[9] = a->d[2] >> 48; bin[10] = a->d[2] >> 40; bin[11] = a->d[2] >> 32; bin[12] = a->d[2] >> 24; bin[13] = a->d[2] >> 16; bin[14] = a->d[2] >> 8; bin[15] = a->d[2];","class":"lineCov","hits":"1","order":"995","possible_hits":"1",},
{"lineNum":"  132","line":"    bin[16] = a->d[1] >> 56; bin[17] = a->d[1] >> 48; bin[18] = a->d[1] >> 40; bin[19] = a->d[1] >> 32; bin[20] = a->d[1] >> 24; bin[21] = a->d[1] >> 16; bin[22] = a->d[1] >> 8; bin[23] = a->d[1];","class":"lineCov","hits":"1","order":"996","possible_hits":"1",},
{"lineNum":"  133","line":"    bin[24] = a->d[0] >> 56; bin[25] = a->d[0] >> 48; bin[26] = a->d[0] >> 40; bin[27] = a->d[0] >> 32; bin[28] = a->d[0] >> 24; bin[29] = a->d[0] >> 16; bin[30] = a->d[0] >> 8; bin[31] = a->d[0];","class":"lineCov","hits":"1","order":"997","possible_hits":"1",},
{"lineNum":"  134","line":"}","class":"linePartCov","hits":"1","order":"998","possible_hits":"2",},
{"lineNum":"  135","line":""},
...
{"lineNum":"  138","line":"}"},
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"static void secp256k1_scalar_negate(secp256k1_scalar *r, const secp256k1_scalar *a) {","class":"lineCov","hits":"6","order":"948","possible_hits":"6",},
{"lineNum":"  141","line":"    uint64_t nonzero = 0xFFFFFFFFFFFFFFFFULL * (secp256k1_scalar_is_zero(a) == 0);","class":"lineCov","hits":"3","order":"949","possible_hits":"3",},
{"lineNum":"  142","line":"    uint128_t t = (uint128_t)(~a->d[0]) + SECP256K1_N_0 + 1;","class":"lineCov","hits":"3","order":"950","possible_hits":"3",},
{"lineNum":"  143","line":"    r->d[0] = t & nonzero; t >>= 64;","class":"lineCov","hits":"3","order":"951","possible_hits":"3",},
{"lineNum":"  144","line":"    t += (uint128_t)(~a->d[1]) + SECP256K1_N_1;","class":"lineCov","hits":"3","order":"952","possible_hits":"3",},
{"lineNum":"  145","line":"    r->d[1] = t & nonzero; t >>= 64;","class":"lineCov","hits":"3","order":"953","possible_hits":"3",},
{"lineNum":"  146","line":"    t += (uint128_t)(~a->d[2]) + SECP256K1_N_2;","class":"lineCov","hits":"3","order":"954","possible_hits":"3",},
{"lineNum":"  147","line":"    r->d[2] = t & nonzero; t >>= 64;","class":"lineCov","hits":"3","order":"955","possible_hits":"3",},
{"lineNum":"  148","line":"    t += (uint128_t)(~a->d[3]) + SECP256K1_N_3;","class":"lineCov","hits":"3","order":"956","possible_hits":"3",},
{"lineNum":"  149","line":"    r->d[3] = t & nonzero;","class":"lineCov","hits":"3","order":"957","possible_hits":"3",},
{"lineNum":"  150","line":"}","class":"linePartCov","hits":"5","order":"727","possible_hits":"6",},
{"lineNum":"  151","line":""},
...
{"lineNum":"  268","line":"}"},
{"lineNum":"  269","line":""},
{"lineNum":"  270","line":"static void secp256k1_scalar_reduce_512(secp256k1_scalar *r, const uint64_t *l) {","class":"lineCov","hits":"2","order":"1096","possible_hits":"2",},
...
{"lineNum":"  276","line":""},
{"lineNum":"  277","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"1098","possible_hits":"1",},
...
{"lineNum":"  379","line":"    : \"S\"(l), \"n\"(SECP256K1_N_C_0), \"n\"(SECP256K1_N_C_1)","class":"lineCov","hits":"1","order":"1097","possible_hits":"1",},
{"lineNum":"  380","line":"    : \"rax\", \"rdx\", \"r8\", \"r9\", \"r10\", \"r11\", \"r12\", \"r13\", \"r14\", \"cc\");"},
{"lineNum":"  381","line":""},
{"lineNum":"  382","line":"    /* Reduce 385 bits into 258. */"},
{"lineNum":"  383","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"1100","possible_hits":"1",},
...
{"lineNum":"  458","line":"    : \"g\"(m0), \"g\"(m1), \"g\"(m2), \"g\"(m3), \"g\"(m4), \"g\"(m5), \"g\"(m6), \"n\"(SECP256K1_N_C_0), \"n\"(SECP256K1_N_C_1)","class":"lineCov","hits":"1","order":"1099","possible_hits":"1",},
{"lineNum":"  459","line":"    : \"rax\", \"rdx\", \"r8\", \"r9\", \"r10\", \"r11\", \"r12\", \"r13\", \"cc\");"},
{"lineNum":"  460","line":""},
{"lineNum":"  461","line":"    /* Reduce 258 bits into 256. */"},
{"lineNum":"  462","line":"    __asm__ __volatile__(","class":"lineCov","hits":"1","order":"1102","possible_hits":"1",},
...
{"lineNum":"  504","line":"    : \"g\"(p0), \"g\"(p1), \"g\"(p2), \"g\"(p3), \"g\"(p4), \"D\"(r), \"n\"(SECP256K1_N_C_0), \"n\"(SECP256K1_N_C_1)","class":"lineCov","hits":"1","order":"1101","possible_hits":"1",},
...
{"lineNum":"  576","line":"    secp256k1_scalar_reduce(r, c + secp256k1_scalar_check_overflow(r));","class":"lineCov","hits":"1","order":"1103","possible_hits":"1",},
{"lineNum":"  577","line":"}","class":"linePartCov","hits":"1","order":"1104","possible_hits":"2",},
{"lineNum":"  578","line":""},
{"lineNum":"  579","line":"static void secp256k1_scalar_mul_512(uint64_t l[8], const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"2","order":"1090","possible_hits":"2",},
{"lineNum":"  580","line":"#ifdef USE_ASM_X86_64"},
{"lineNum":"  581","line":"    const uint64_t *pb = b->d;","class":"lineCov","hits":"1","order":"1091","possible_hits":"1",},
{"lineNum":"  582","line":"    __asm__ __volatile__(","class":"lineCov","hits":"2","order":"1092","possible_hits":"2",},
...
{"lineNum":"  710","line":"    : \"S\"(l), \"D\"(a->d)","class":"lineCov","hits":"1","order":"1093","possible_hits":"1",},
...
{"lineNum":"  744","line":"}","class":"linePartCov","hits":"1","order":"1094","possible_hits":"2",},
{"lineNum":"  745","line":""},
...
{"lineNum":"  890","line":""},
{"lineNum":"  891","line":"static void secp256k1_scalar_mul(secp256k1_scalar *r, const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"2","order":"1088","possible_hits":"2",},
{"lineNum":"  892","line":"    uint64_t l[8];"},
{"lineNum":"  893","line":"    secp256k1_scalar_mul_512(l, a, b);","class":"lineCov","hits":"1","order":"1089","possible_hits":"1",},
{"lineNum":"  894","line":"    secp256k1_scalar_reduce_512(r, l);","class":"lineCov","hits":"1","order":"1095","possible_hits":"1",},
{"lineNum":"  895","line":"}","class":"linePartCov","hits":"1","order":"1105","possible_hits":"2",},
{"lineNum":"  896","line":""},
...
{"lineNum":"  927","line":""},
{"lineNum":"  928","line":"SECP256K1_INLINE static int secp256k1_scalar_eq(const secp256k1_scalar *a, const secp256k1_scalar *b) {","class":"lineCov","hits":"2","order":"940","possible_hits":"2",},
{"lineNum":"  929","line":"    return ((a->d[0] ^ b->d[0]) | (a->d[1] ^ b->d[1]) | (a->d[2] ^ b->d[2]) | (a->d[3] ^ b->d[3])) == 0;","class":"lineCov","hits":"1","order":"941","possible_hits":"1",},
{"lineNum":"  930","line":"}"},
{"lineNum":"  931","line":""},
...
var header = { "command" : "schnorr_hfuzz_debug", "date" : "2023-08-14 14:04:11", "instrumented" : 122, "covered" : 105,};
var merged_data = [];
