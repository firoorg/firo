...
{"lineNum":"  171","line":"        : g_(new secp256k1_gej(*reinterpret_cast<secp256k1_gej *>(other.g_)))","class":"lineCov","hits":"1","order":"752","possible_hits":"1",},
{"lineNum":"  172","line":"{","class":"lineCov","hits":"2","order":"751","possible_hits":"2",},
{"lineNum":"  173","line":"}","class":"linePartCov","hits":"1","order":"753","possible_hits":"2",},
{"lineNum":"  174","line":""},
{"lineNum":"  175","line":"GroupElement::GroupElement(const void *g)"},
{"lineNum":"  176","line":"        : g_(new secp256k1_gej(*reinterpret_cast<const secp256k1_gej *>(g)))","class":"lineCov","hits":"1","order":"738","possible_hits":"1",},
{"lineNum":"  177","line":"{","class":"lineCov","hits":"2","order":"737","possible_hits":"2",},
{"lineNum":"  178","line":"}","class":"linePartCov","hits":"1","order":"739","possible_hits":"2",},
{"lineNum":"  179","line":""},
...
{"lineNum":"  257","line":"{","class":"lineCov","hits":"2","order":"674","possible_hits":"2",},
{"lineNum":"  258","line":"    secp256k1_gej result;"},
{"lineNum":"  259","line":"    secp256k1_scalar ng;"},
{"lineNum":"  260","line":"    secp256k1_scalar_set_int(&ng,0);","class":"lineCov","hits":"1","order":"675","possible_hits":"1",},
{"lineNum":"  261","line":"    secp256k1_ecmult(&ctx,&result,reinterpret_cast<secp256k1_gej *>(g_), reinterpret_cast<const secp256k1_scalar *>(multiplier.get_value()),&ng);","class":"lineCov","hits":"1","order":"682","possible_hits":"1",},
{"lineNum":"  262","line":"    return &result;","class":"lineCov","hits":"1","order":"736","possible_hits":"1",},
{"lineNum":"  263","line":"}"},
{"lineNum":"  264","line":""},
...
{"lineNum":"  302","line":"{","class":"lineCov","hits":"2","order":"762","possible_hits":"2",},
{"lineNum":"  303","line":"    auto g = reinterpret_cast<secp256k1_gej *>(g_);","class":"lineCov","hits":"1","order":"763","possible_hits":"1",},
{"lineNum":"  304","line":"    auto og = reinterpret_cast<secp256k1_gej *>(other.g_);","class":"lineCov","hits":"1","order":"764","possible_hits":"1",},
{"lineNum":"  305","line":""},
{"lineNum":"  306","line":"    if(g->infinity && og->infinity)","class":"lineCov","hits":"1","order":"765","possible_hits":"1",},
{"lineNum":"  307","line":"        return true;","class":"lineCov","hits":"1","order":"766","possible_hits":"1",},
{"lineNum":"  308","line":"    if(g->infinity != og->infinity)","class":"lineCov","hits":"1","order":"1228","possible_hits":"1",},
{"lineNum":"  309","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  310","line":"    secp256k1_ge this_ge = gej_to_ge(*g);","class":"lineCov","hits":"1","order":"1229","possible_hits":"1",},
{"lineNum":"  311","line":"    secp256k1_ge other_ge = gej_to_ge(*og);","class":"lineCov","hits":"1","order":"1230","possible_hits":"1",},
{"lineNum":"  312","line":"    if(!secp256k1_fe_equal(&this_ge.x, &other_ge.x))","class":"lineCov","hits":"1","order":"1231","possible_hits":"1",},
{"lineNum":"  313","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  314","line":"    if(!secp256k1_fe_equal(&this_ge.y, &other_ge.y))","class":"lineCov","hits":"1","order":"1232","possible_hits":"1",},
{"lineNum":"  315","line":"        return false;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  316","line":""},
{"lineNum":"  317","line":"    return true;","class":"lineCov","hits":"1","order":"1233","possible_hits":"1",},
{"lineNum":"  318","line":"}","class":"linePartCov","hits":"1","order":"767","possible_hits":"2",},
{"lineNum":"  319","line":""},
{"lineNum":"  320","line":"bool GroupElement::operator!=(const  GroupElement& other) const"},
{"lineNum":"  321","line":"{","class":"lineCov","hits":"2","order":"760","possible_hits":"2",},
{"lineNum":"  322","line":"    return !(*this == other);","class":"lineCov","hits":"1","order":"761","possible_hits":"1",},
{"lineNum":"  323","line":"}"},
{"lineNum":"  324","line":""},
...
{"lineNum":"  335","line":"{","class":"lineCov","hits":"2","order":"1422","possible_hits":"2",},
{"lineNum":"  336","line":"    return secp256k1_gej_is_infinity(reinterpret_cast<const secp256k1_gej *>(g_));","class":"lineCov","hits":"1","order":"1423","possible_hits":"1",},
{"lineNum":"  337","line":"}"},
{"lineNum":"  338","line":""},
...
{"lineNum":"  384","line":"        secp256k1_ge_neg(&ge, &ge);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  385","line":"    }"},
...
{"lineNum":"  506","line":"}"},
{"lineNum":"  507","line":""},
{"lineNum":"  508","line":"unsigned char* GroupElement::serialize(unsigned char* buffer) const {","class":"lineCov","hits":"2","order":"1005","possible_hits":"2",},
{"lineNum":"  509","line":"    secp256k1_ge value = gej_to_ge(*reinterpret_cast<secp256k1_gej *>(g_));","class":"lineCov","hits":"1","order":"1006","possible_hits":"1",},
{"lineNum":"  510","line":"    secp256k1_fe x = value.x;","class":"lineCov","hits":"1","order":"1007","possible_hits":"1",},
{"lineNum":"  511","line":"    secp256k1_fe y = value.y;","class":"lineCov","hits":"1","order":"1008","possible_hits":"1",},
{"lineNum":"  512","line":"    secp256k1_fe_normalize(&x);","class":"lineCov","hits":"1","order":"1009","possible_hits":"1",},
{"lineNum":"  513","line":"    secp256k1_fe_normalize(&y);","class":"lineCov","hits":"1","order":"1010","possible_hits":"1",},
{"lineNum":"  514","line":"    unsigned char oddness = secp256k1_fe_is_odd(&y);","class":"lineCov","hits":"1","order":"1011","possible_hits":"1",},
{"lineNum":"  515","line":"    unsigned char infinity = value.infinity;","class":"lineCov","hits":"1","order":"1012","possible_hits":"1",},
{"lineNum":"  516","line":"    secp256k1_fe_get_b32(buffer, &x);","class":"lineCov","hits":"1","order":"1013","possible_hits":"1",},
{"lineNum":"  517","line":"    buffer[32] = oddness;","class":"lineCov","hits":"1","order":"1014","possible_hits":"1",},
{"lineNum":"  518","line":"    buffer[33] = infinity;","class":"lineCov","hits":"1","order":"1015","possible_hits":"1",},
{"lineNum":"  519","line":"    return buffer + memoryRequired();","class":"lineCov","hits":"1","order":"1016","possible_hits":"1",},
{"lineNum":"  520","line":"}"},
{"lineNum":"  521","line":""},
{"lineNum":"  522","line":"const unsigned char* GroupElement::deserialize(const unsigned char* buffer) {","class":"lineCov","hits":"2","order":"1184","possible_hits":"2",},
{"lineNum":"  523","line":"    secp256k1_fe x;"},
{"lineNum":"  524","line":"    secp256k1_fe_set_b32(&x, buffer);","class":"lineCov","hits":"1","order":"1185","possible_hits":"1",},
{"lineNum":"  525","line":"    unsigned char oddness = buffer[32];","class":"lineCov","hits":"1","order":"1186","possible_hits":"1",},
{"lineNum":"  526","line":"    unsigned char infinity = buffer[33];","class":"lineCov","hits":"1","order":"1187","possible_hits":"1",},
{"lineNum":"  527","line":"    secp256k1_ge result;"},
{"lineNum":"  528","line":"    secp256k1_ge_set_xo_var(&result, &x, (int)oddness);","class":"lineCov","hits":"1","order":"1188","possible_hits":"1",},
{"lineNum":"  529","line":"    result.infinity = (int)infinity;","class":"lineCov","hits":"1","order":"1209","possible_hits":"1",},
{"lineNum":"  530","line":""},
{"lineNum":"  531","line":"    secp256k1_gej_set_ge(reinterpret_cast<secp256k1_gej *>(g_), &result);","class":"lineCov","hits":"1","order":"1210","possible_hits":"1",},
{"lineNum":"  532","line":""},
{"lineNum":"  533","line":"    if (!secp256k1_ge_is_valid_var(&result) && !result.infinity) {","class":"lineCov","hits":"1","order":"1211","possible_hits":"1",},
{"lineNum":"  534","line":"        throw std::invalid_argument(\"GroupElement: deserialize failed\");","class":"lineNoCov","hits":"0","possible_hits":"4",},
{"lineNum":"  535","line":"    }"},
{"lineNum":"  536","line":"    return buffer + memoryRequired();","class":"lineCov","hits":"1","order":"1212","possible_hits":"1",},
...
var header = { "command" : "schnorr_hfuzz_debug", "date" : "2023-08-14 14:03:04", "instrumented" : 343, "covered" : 147,};
var merged_data = [];
