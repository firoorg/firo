...
{"lineNum":"   27","line":"   : value_(new secp256k1_scalar()) {","class":"lineCov","hits":"2","order":"621","possible_hits":"2",},
{"lineNum":"   28","line":"    unsigned char b32[32];"},
{"lineNum":"   29","line":"    for(int i = 0; i < 24; i++)","class":"lineCov","hits":"2","order":"622","possible_hits":"2",},
{"lineNum":"   30","line":"        b32[i] = 0;","class":"lineCov","hits":"1","order":"623","possible_hits":"1",},
{"lineNum":"   31","line":"    b32[24] = value >> 56;","class":"lineCov","hits":"1","order":"624","possible_hits":"1",},
{"lineNum":"   32","line":"    b32[25] = value >> 48;","class":"lineCov","hits":"1","order":"625","possible_hits":"1",},
{"lineNum":"   33","line":"    b32[26] = value >> 40;","class":"lineCov","hits":"1","order":"626","possible_hits":"1",},
{"lineNum":"   34","line":"    b32[27] = value >> 32;","class":"lineCov","hits":"1","order":"627","possible_hits":"1",},
{"lineNum":"   35","line":"    b32[28] = value >> 24;","class":"lineCov","hits":"1","order":"628","possible_hits":"1",},
{"lineNum":"   36","line":"    b32[29] = value >> 16;","class":"lineCov","hits":"1","order":"629","possible_hits":"1",},
{"lineNum":"   37","line":"    b32[30] = value >> 8;","class":"lineCov","hits":"1","order":"630","possible_hits":"1",},
{"lineNum":"   38","line":"    b32[31] = value;","class":"lineCov","hits":"1","order":"631","possible_hits":"1",},
{"lineNum":"   39","line":"    secp256k1_scalar_set_b32(reinterpret_cast<secp256k1_scalar *>(value_), b32, 0);","class":"lineCov","hits":"1","order":"632","possible_hits":"1",},
{"lineNum":"   40","line":"}","class":"linePartCov","hits":"1","order":"662","possible_hits":"2",},
{"lineNum":"   41","line":""},
...
{"lineNum":"   48","line":"   : value_(new secp256k1_scalar(*reinterpret_cast<const secp256k1_scalar *>(value))) {","class":"lineCov","hits":"2","order":"1078","possible_hits":"2",},
{"lineNum":"   49","line":""},
{"lineNum":"   50","line":"}","class":"linePartCov","hits":"1","order":"1079","possible_hits":"2",},
{"lineNum":"   51","line":""},
{"lineNum":"   52","line":"Scalar::Scalar(const Scalar& other)"},
{"lineNum":"   53","line":"   : value_(new secp256k1_scalar(*reinterpret_cast<const secp256k1_scalar *>(other.value_))) {","class":"lineCov","hits":"2","order":"748","possible_hits":"2",},
{"lineNum":"   54","line":""},
{"lineNum":"   55","line":"}","class":"linePartCov","hits":"1","order":"749","possible_hits":"2",},
{"lineNum":"   56","line":""},
{"lineNum":"   57","line":"Scalar::~Scalar() {","class":"lineCov","hits":"2","order":"670","possible_hits":"2",},
{"lineNum":"   58","line":"    delete reinterpret_cast<secp256k1_scalar *>(value_);","class":"lineCov","hits":"1","order":"671","possible_hits":"1",},
{"lineNum":"   59","line":"}","class":"linePartCov","hits":"1","order":"672","possible_hits":"2",},
{"lineNum":"   60","line":""},
{"lineNum":"   61","line":"Scalar& Scalar::operator=(const Scalar& other) {","class":"lineCov","hits":"2","order":"665","possible_hits":"2",},
{"lineNum":"   62","line":"    return set(other);","class":"lineCov","hits":"1","order":"666","possible_hits":"1",},
{"lineNum":"   63","line":"}"},
{"lineNum":"   64","line":""},
...
{"lineNum":"   73","line":"}"},
{"lineNum":"   74","line":""},
{"lineNum":"   75","line":"Scalar& Scalar::set(const Scalar& other) {","class":"lineCov","hits":"2","order":"667","possible_hits":"2",},
{"lineNum":"   76","line":"    *reinterpret_cast<secp256k1_scalar *>(value_) = *reinterpret_cast<const secp256k1_scalar *>(other.value_);","class":"lineCov","hits":"1","order":"668","possible_hits":"1",},
{"lineNum":"   77","line":"    return *this;","class":"linePartCov","hits":"1","order":"669","possible_hits":"2",},
{"lineNum":"   78","line":"}"},
{"lineNum":"   79","line":""},
{"lineNum":"   80","line":"Scalar Scalar::operator*(const Scalar& other) const {","class":"lineCov","hits":"2","order":"1080","possible_hits":"2",},
{"lineNum":"   81","line":"    secp256k1_scalar result;"},
{"lineNum":"   82","line":"    secp256k1_scalar_mul(&result, reinterpret_cast<const secp256k1_scalar *>(value_), reinterpret_cast<const secp256k1_scalar *>(other.value_));","class":"lineCov","hits":"1","order":"1081","possible_hits":"1",},
{"lineNum":"   83","line":"    return &result;","class":"lineCov","hits":"1","order":"1100","possible_hits":"1",},
{"lineNum":"   84","line":"}"},
{"lineNum":"   85","line":""},
{"lineNum":"   86","line":"Scalar& Scalar::operator*=(const Scalar& other) {","class":"lineCov","hits":"2","order":"1106","possible_hits":"2",},
{"lineNum":"   87","line":"    secp256k1_scalar result;"},
{"lineNum":"   88","line":""},
{"lineNum":"   89","line":"    secp256k1_scalar_mul(&result, reinterpret_cast<const secp256k1_scalar *>(value_), reinterpret_cast<const secp256k1_scalar *>(other.value_));","class":"lineCov","hits":"1","order":"1107","possible_hits":"1",},
{"lineNum":"   90","line":"    *reinterpret_cast<secp256k1_scalar *>(value_) = result;","class":"lineCov","hits":"1","order":"1108","possible_hits":"1",},
{"lineNum":"   91","line":""},
{"lineNum":"   92","line":"    return *this;","class":"linePartCov","hits":"1","order":"1109","possible_hits":"2",},
{"lineNum":"   93","line":"}"},
{"lineNum":"   94","line":""},
...
{"lineNum":"   99","line":"}"},
{"lineNum":"  100","line":""},
{"lineNum":"  101","line":"Scalar& Scalar::operator+=(const Scalar& other) {","class":"lineCov","hits":"2","order":"1101","possible_hits":"2",},
{"lineNum":"  102","line":"    secp256k1_scalar result;"},
{"lineNum":"  103","line":""},
{"lineNum":"  104","line":"    secp256k1_scalar_add(&result, reinterpret_cast<const secp256k1_scalar *>(value_), reinterpret_cast<const secp256k1_scalar *>(other.value_));","class":"lineCov","hits":"1","order":"1102","possible_hits":"1",},
{"lineNum":"  105","line":"    *reinterpret_cast<secp256k1_scalar *>(value_) = result;","class":"lineCov","hits":"1","order":"1103","possible_hits":"1",},
{"lineNum":"  106","line":""},
{"lineNum":"  107","line":"    return *this;","class":"linePartCov","hits":"1","order":"1104","possible_hits":"2",},
{"lineNum":"  108","line":"}"},
{"lineNum":"  109","line":""},
...
{"lineNum":"  127","line":"}"},
{"lineNum":"  128","line":""},
{"lineNum":"  129","line":"bool Scalar::operator==(const Scalar& other) const {","class":"lineCov","hits":"2","order":"804","possible_hits":"2",},
{"lineNum":"  130","line":"    return secp256k1_scalar_eq(reinterpret_cast<const secp256k1_scalar *>(value_), reinterpret_cast<const secp256k1_scalar *>(other.value_));","class":"lineCov","hits":"1","order":"805","possible_hits":"1",},
{"lineNum":"  131","line":"}"},
{"lineNum":"  132","line":""},
...
{"lineNum":"  135","line":"}"},
{"lineNum":"  136","line":""},
{"lineNum":"  137","line":"const void * Scalar::get_value() const {","class":"lineCov","hits":"2","order":"683","possible_hits":"2",},
{"lineNum":"  138","line":"    return value_;","class":"lineCov","hits":"1","order":"684","possible_hits":"1",},
{"lineNum":"  139","line":"}"},
{"lineNum":"  140","line":""},
...
{"lineNum":"  145","line":"}"},
{"lineNum":"  146","line":""},
{"lineNum":"  147","line":"Scalar Scalar::negate() const {","class":"lineCov","hits":"2","order":"1075","possible_hits":"2",},
{"lineNum":"  148","line":"    secp256k1_scalar result;"},
{"lineNum":"  149","line":"    secp256k1_scalar_negate(&result, reinterpret_cast<const secp256k1_scalar *>(value_));","class":"lineCov","hits":"1","order":"1076","possible_hits":"1",},
{"lineNum":"  150","line":"    return &result;","class":"lineCov","hits":"1","order":"1077","possible_hits":"1",},
{"lineNum":"  151","line":"}"},
{"lineNum":"  152","line":""},
...
{"lineNum":"  188","line":""},
{"lineNum":"  189","line":"bool Scalar::isMember() const {","class":"lineCov","hits":"2","order":"795","possible_hits":"2",},
{"lineNum":"  190","line":"    Scalar temp(*this);","class":"lineCov","hits":"1","order":"796","possible_hits":"1",},
{"lineNum":"  191","line":"    temp.mod_p();","class":"lineCov","hits":"1","order":"797","possible_hits":"1",},
{"lineNum":"  192","line":"    return *this == temp;","class":"lineCov","hits":"1","order":"803","possible_hits":"1",},
{"lineNum":"  193","line":"}","class":"lineCov","hits":"1","order":"808","possible_hits":"1",},
{"lineNum":"  194","line":""},
{"lineNum":"  195","line":"bool Scalar::isZero() const {","class":"lineCov","hits":"2","order":"809","possible_hits":"2",},
{"lineNum":"  196","line":"    return secp256k1_scalar_is_zero(reinterpret_cast<const secp256k1_scalar *>(value_));","class":"lineCov","hits":"1","order":"810","possible_hits":"1",},
{"lineNum":"  197","line":"}"},
{"lineNum":"  198","line":""},
...
{"lineNum":"  211","line":""},
{"lineNum":"  212","line":"Scalar& Scalar::randomize() {","class":"lineCov","hits":"2","order":"771","possible_hits":"2",},
{"lineNum":"  213","line":"    unsigned char temp[32] = { 0 };","class":"lineCov","hits":"1","order":"772","possible_hits":"1",},
{"lineNum":"  214","line":""},
{"lineNum":"  215","line":"    do {"},
{"lineNum":"  216","line":"        if (RAND_bytes(temp, 32) != 1) {","class":"lineCov","hits":"1","order":"773","possible_hits":"1",},
{"lineNum":"  217","line":"            throw \"Unable to generate random Scalar\";","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  218","line":"        }"},
{"lineNum":"  219","line":"        generate(temp);","class":"lineCov","hits":"1","order":"774","possible_hits":"1",},
{"lineNum":"  220","line":"    } while (!this->isMember() || this->isZero()); // we need to ensure, generated value is valid and non 0","class":"lineCov","hits":"1","order":"794","possible_hits":"1",},
{"lineNum":"  221","line":""},
{"lineNum":"  222","line":"    return *this;","class":"linePartCov","hits":"1","order":"811","possible_hits":"2",},
{"lineNum":"  223","line":"}"},
{"lineNum":"  224","line":""},
{"lineNum":"  225","line":"Scalar& Scalar::generate(unsigned char* buff) {","class":"lineCov","hits":"2","order":"775","possible_hits":"2",},
{"lineNum":"  226","line":"    secp256k1_scalar zero, result;"},
{"lineNum":"  227","line":""},
{"lineNum":"  228","line":"    secp256k1_scalar_set_b32(reinterpret_cast<secp256k1_scalar *>(value_), buff, nullptr);","class":"lineCov","hits":"1","order":"776","possible_hits":"1",},
{"lineNum":"  229","line":"    secp256k1_scalar_set_int(&zero, 0);","class":"lineCov","hits":"1","order":"777","possible_hits":"1",},
{"lineNum":"  230","line":""},
{"lineNum":"  231","line":"    secp256k1_scalar_add(&result, reinterpret_cast<const secp256k1_scalar *>(value_), &zero);","class":"lineCov","hits":"1","order":"778","possible_hits":"1",},
{"lineNum":"  232","line":"    *reinterpret_cast<secp256k1_scalar *>(value_) = result;","class":"lineCov","hits":"1","order":"792","possible_hits":"1",},
{"lineNum":"  233","line":""},
{"lineNum":"  234","line":"    return *this;","class":"linePartCov","hits":"1","order":"793","possible_hits":"2",},
{"lineNum":"  235","line":"}"},
{"lineNum":"  236","line":""},
{"lineNum":"  237","line":"Scalar& Scalar::mod_p() {","class":"lineCov","hits":"2","order":"798","possible_hits":"2",},
{"lineNum":"  238","line":"    secp256k1_scalar zero, result;"},
{"lineNum":"  239","line":""},
{"lineNum":"  240","line":"    secp256k1_scalar_clear(&zero);","class":"lineCov","hits":"1","order":"799","possible_hits":"1",},
{"lineNum":"  241","line":"    secp256k1_scalar_add(&result, reinterpret_cast<const secp256k1_scalar *>(value_), &zero);","class":"lineCov","hits":"1","order":"800","possible_hits":"1",},
{"lineNum":"  242","line":"    *reinterpret_cast<secp256k1_scalar *>(value_) = result;","class":"lineCov","hits":"1","order":"801","possible_hits":"1",},
{"lineNum":"  243","line":""},
{"lineNum":"  244","line":"    return *this;","class":"lineCov","hits":"2","order":"802","possible_hits":"2",},
{"lineNum":"  245","line":"}"},
{"lineNum":"  246","line":""},
...
{"lineNum":"  283","line":""},
{"lineNum":"  284","line":"unsigned char* Scalar::serialize(unsigned char* buffer) const {","class":"lineCov","hits":"2","order":"985","possible_hits":"2",},
{"lineNum":"  285","line":"    secp256k1_scalar_get_b32(buffer, reinterpret_cast<const secp256k1_scalar *>(value_));","class":"lineCov","hits":"1","order":"986","possible_hits":"1",},
{"lineNum":"  286","line":"    return buffer + 32;","class":"lineCov","hits":"1","order":"993","possible_hits":"1",},
{"lineNum":"  287","line":"}"},
{"lineNum":"  288","line":""},
{"lineNum":"  289","line":"unsigned const char* Scalar::deserialize(unsigned const char* buffer) {","class":"lineCov","hits":"2","order":"1056","possible_hits":"2",},
{"lineNum":"  290","line":"    int overflow = 0;","class":"lineCov","hits":"1","order":"1057","possible_hits":"1",},
{"lineNum":"  291","line":""},
{"lineNum":"  292","line":"    secp256k1_scalar_set_b32(reinterpret_cast<secp256k1_scalar *>(value_), buffer, &overflow);","class":"lineCov","hits":"1","order":"1058","possible_hits":"1",},
{"lineNum":"  293","line":""},
{"lineNum":"  294","line":"    if (overflow) {","class":"lineCov","hits":"1","order":"1060","possible_hits":"1",},
{"lineNum":"  295","line":"        throw \"Scalar: decoding overflowed\";","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  296","line":"    }"},
{"lineNum":"  297","line":""},
{"lineNum":"  298","line":"    return buffer + 32;","class":"lineCov","hits":"1","order":"1061","possible_hits":"1",},
{"lineNum":"  299","line":"}"},
{"lineNum":"  300","line":""},
...
var header = { "command" : "schnorr_hfuzz_debug", "date" : "2023-08-14 14:03:04", "instrumented" : 187, "covered" : 78,};
var merged_data = [];
