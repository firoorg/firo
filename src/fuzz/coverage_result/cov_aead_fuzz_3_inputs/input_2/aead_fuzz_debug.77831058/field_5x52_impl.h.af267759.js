...
{"lineNum":"  258","line":"}"},
{"lineNum":"  259","line":""},
{"lineNum":"  260","line":"SECP256K1_INLINE static void secp256k1_fe_clear(secp256k1_fe *a) {","class":"lineCov","hits":"2","order":"66","possible_hits":"2",},
...
{"lineNum":"  266","line":"    for (i=0; i<5; i++) {","class":"lineCov","hits":"2","order":"67","possible_hits":"2",},
{"lineNum":"  267","line":"        a->n[i] = 0;","class":"lineCov","hits":"1","order":"68","possible_hits":"1",},
{"lineNum":"  268","line":"    }"},
{"lineNum":"  269","line":"}","class":"linePartCov","hits":"1","order":"69","possible_hits":"2",},
{"lineNum":"  270","line":""},
...
{"lineNum":"  288","line":"}"},
{"lineNum":"  289","line":""},
{"lineNum":"  290","line":"static int secp256k1_fe_set_b32(secp256k1_fe *r, const unsigned char *a) {","class":"lineCov","hits":"2","order":"92","possible_hits":"2",},
{"lineNum":"  291","line":"    int i;"},
{"lineNum":"  292","line":"    r->n[0] = r->n[1] = r->n[2] = r->n[3] = r->n[4] = 0;","class":"lineCov","hits":"1","order":"93","possible_hits":"1",},
{"lineNum":"  293","line":"    for (i=0; i<32; i++) {","class":"lineCov","hits":"2","order":"94","possible_hits":"2",},
{"lineNum":"  294","line":"        int j;"},
{"lineNum":"  295","line":"        for (j=0; j<2; j++) {","class":"lineCov","hits":"2","order":"95","possible_hits":"2",},
{"lineNum":"  296","line":"            int limb = (8*i+4*j)/52;","class":"lineCov","hits":"1","order":"96","possible_hits":"1",},
{"lineNum":"  297","line":"            int shift = (8*i+4*j)%52;","class":"lineCov","hits":"1","order":"97","possible_hits":"1",},
{"lineNum":"  298","line":"            r->n[limb] |= (uint64_t)((a[31-i] >> (4*j)) & 0xF) << shift;","class":"lineCov","hits":"1","order":"98","possible_hits":"1",},
{"lineNum":"  299","line":"        }"},
{"lineNum":"  300","line":"    }","class":"lineCov","hits":"1","order":"99","possible_hits":"1",},
{"lineNum":"  301","line":"    if (r->n[4] == 0x0FFFFFFFFFFFFULL && (r->n[3] & r->n[2] & r->n[1]) == 0xFFFFFFFFFFFFFULL && r->n[0] >= 0xFFFFEFFFFFC2FULL) {","class":"lineCov","hits":"1","order":"100","possible_hits":"1",},
...
{"lineNum":"  309","line":"    return 1;","class":"lineCov","hits":"1","order":"101","possible_hits":"1",},
{"lineNum":"  310","line":"}","class":"linePartCov","hits":"1","order":"102","possible_hits":"2",},
{"lineNum":"  311","line":""},
...
var header = { "command" : "aead_fuzz_debug", "date" : "2023-07-31 08:20:46", "instrumented" : 161, "covered" : 15,};
var merged_data = [];
