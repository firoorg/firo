...
{"lineNum":"  145","line":" */"},
{"lineNum":"  146","line":"class CDataStream","class":"lineCov","hits":"1","order":"417",},
{"lineNum":"  147","line":"{"},
...
{"lineNum":"  166","line":""},
{"lineNum":"  167","line":"    explicit CDataStream(int nTypeIn, int nVersionIn)","class":"lineCov","hits":"1","order":"410",},
{"lineNum":"  168","line":"    {","class":"lineCov","hits":"1","order":"405",},
{"lineNum":"  169","line":"        Init(nTypeIn, nVersionIn);","class":"lineCov","hits":"1","order":"413",},
{"lineNum":"  170","line":"    }","class":"lineCov","hits":"1","order":"409",},
{"lineNum":"  171","line":""},
...
{"lineNum":"  205","line":"    {","class":"lineCov","hits":"1","order":"416",},
{"lineNum":"  206","line":"        nReadPos = 0;","class":"lineCov","hits":"1","order":"415",},
{"lineNum":"  207","line":"        nType = nTypeIn;","class":"lineCov","hits":"1","order":"421",},
{"lineNum":"  208","line":"        nVersion = nVersionIn;","class":"lineCov","hits":"1","order":"425",},
{"lineNum":"  209","line":"    }","class":"lineCov","hits":"1","order":"419",},
{"lineNum":"  210","line":""},
...
{"lineNum":"  237","line":"    size_type size() const                           { return vch.size() - nReadPos; }","class":"lineCov","hits":"1","order":"423",},
{"lineNum":"  238","line":"    bool empty() const                               { return vch.size() == nReadPos; }"},
{"lineNum":"  239","line":"    void resize(size_type n, value_type c=0)         { vch.resize(n + nReadPos, c); }","class":"lineCov","hits":"1","order":"400",},
...
{"lineNum":"  246","line":"    value_type* data()                               { return vch.data() + nReadPos; }","class":"lineCov","hits":"1","order":"399",},
...
{"lineNum":"  344","line":"        if (nSize == 0) return;","class":"lineCov","hits":"1","order":"411",},
{"lineNum":"  345","line":""},
{"lineNum":"  346","line":"        // Read from the beginning of the buffer"},
{"lineNum":"  347","line":"        unsigned int nReadPosNext = nReadPos + nSize;","class":"lineCov","hits":"1","order":"408",},
{"lineNum":"  348","line":"        if (nReadPosNext >= vch.size())","class":"lineCov","hits":"1","order":"429",},
{"lineNum":"  349","line":"        {"},
{"lineNum":"  350","line":"            if (nReadPosNext > vch.size())","class":"lineCov","hits":"1","order":"403",},
{"lineNum":"  351","line":"            {"},
{"lineNum":"  352","line":"                throw std::ios_base::failure(\"CDataStream::read(): end of data\");","class":"lineNoCov","hits":"0",},
{"lineNum":"  353","line":"            }"},
{"lineNum":"  354","line":"            memcpy(pch, &vch[nReadPos], nSize);","class":"lineCov","hits":"1","order":"420",},
{"lineNum":"  355","line":"            nReadPos = 0;","class":"lineCov","hits":"1","order":"424",},
{"lineNum":"  356","line":"            vch.clear();","class":"lineCov","hits":"1","order":"427",},
{"lineNum":"  357","line":"            return;","class":"lineCov","hits":"1","order":"401",},
{"lineNum":"  358","line":"        }"},
...
{"lineNum":"  361","line":"    }","class":"lineCov","hits":"1","order":"430",},
{"lineNum":"  362","line":""},
...
{"lineNum":"  382","line":"    {","class":"lineCov","hits":"1","order":"418",},
{"lineNum":"  383","line":"        // Write to the end of the buffer"},
{"lineNum":"  384","line":"        vch.insert(vch.end(), pch, pch + nSize);","class":"lineCov","hits":"1","order":"422",},
{"lineNum":"  385","line":"    }","class":"lineCov","hits":"1","order":"426",},
{"lineNum":"  386","line":""},
...
{"lineNum":"  397","line":"    {","class":"lineCov","hits":"1","order":"407",},
{"lineNum":"  398","line":"        // Serialize to this stream"},
{"lineNum":"  399","line":"        ::Serialize(*this, obj);","class":"lineCov","hits":"1","order":"406",},
{"lineNum":"  400","line":"        return (*this);","class":"lineCov","hits":"1","order":"404",},
{"lineNum":"  401","line":"    }"},
{"lineNum":"  402","line":""},
{"lineNum":"  403","line":"    template<typename T>"},
{"lineNum":"  404","line":"    CDataStream& operator>>(T& obj)"},
{"lineNum":"  405","line":"    {","class":"lineCov","hits":"1","order":"412",},
{"lineNum":"  406","line":"        // Unserialize from this stream"},
{"lineNum":"  407","line":"        ::Unserialize(*this, obj);","class":"lineCov","hits":"1","order":"428",},
{"lineNum":"  408","line":"        return (*this);","class":"lineCov","hits":"1","order":"402",},
{"lineNum":"  409","line":"    }"},
{"lineNum":"  410","line":""},
...
var header = { "command" : "", "date" : "2023-07-31 08:21:49", "instrumented" : 35, "covered" : 32,};
var merged_data = [];
