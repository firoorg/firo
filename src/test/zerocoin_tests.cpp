...
BOOST_AUTO_TEST_CASE(zerocoin_mintspend)
{
    ...
    for(int i = 0; i < 5; i++)
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            BOOST_CHECK_MESSAGE(!pwalletMain->CreateZerocoinSpendModel(stringError, "", denomination.c_str(), false), "Spend succeeded although not confirmed by 6 blocks");
        ...
        BOOST_CHECK_MESSAGE(!pwalletMain->CreateZerocoinSpendModel(stringError, "", denomination.c_str(), false), "Spend succeeded although not at least two mints");
        BOOST_CHECK_MESSAGE(stringError == "No zerocoin mints to spend, spending sigma mints disabled. At least 2 mints with at least 6 confirmations are required to spend a coin.", stringError + " - Incorrect error message");
        ...
        BOOST_CHECK_MESSAGE(pwalletMain->CreateZerocoinSpendModel(stringError, "", denomination.c_str(), false), "Spend failed");
       ...
       //Verify spend got into mempool
        ...
        BOOST_CHECK_MESSAGE(pwalletMain->CreateZerocoinSpendModel(stringError, "", denomination.c_str(), false), stringError + " - Spend failed");
