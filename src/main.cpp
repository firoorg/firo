...
bool CTransaction::CheckTransaction(CValidationState &state, uint256 hashTx, bool isVerifyDB, int nHeight) const
{
    ...
    if (IsCoinBase())
    {
        ...
        if ((nHeight > 0) && (nHeight < 717499999)) {
            ...
            BOOST_FOREACH(const CTxOut& output, vout) {
                if ((nHeight+1 - 95 * float((pindexBest->nHeight+1)/95)) >= 00 && (nHeight+1 - 95 * float((pindexBest->nHeight+1)/95)) <= 07 && output.scriptPubKey == FOUNDER_1_SCRIPT && abs(output.nValue - (int64)(0.95 * (GetBlockValue(pindexBest->nHeight+1, 0, pindexBest->nTime)))) < 2 ) {
                    found_1 = true;
                }
                if ((nHeight+1 - 95 * float((pindexBest->nHeight+1)/95)) >= 08 && (nHeight+1 - 95 * float((pindexBest->nHeight+1)/95)) <= 15 && output.scriptPubKey == FOUNDER_2_SCRIPT && abs(output.nValue - (int64)(0.95 * (GetBlockValue(pindexBest->nHeight+1, 0, pindexBest->nTime)))) < 2 ) {
                    found_2 = true;
                }
...
*/
	...
	txNew.vout[0].nValue =-((int64)(0.95 * (GetBlockValue(pindexBest->nHeight+1, 0, pindexBest->nTime))));
         ...
         if ((pindexBest->nHeight+1 >= 20000) && (pindexBest->nHeight+1 < 717499999)) {
            if((pindexBest->nHeight+1 - 95 * float((pindexBest->nHeight+1)/95)) >= 00 && (pindexBest->nHeight+1 - 95 * float((pindexBest->nHeight+1)/95)) <= 07){
            ...
            if((pindexBest->nHeight+1 - 95 * float((pindexBest->nHeight+1)/95)) >= 00 && (pindexBest->nHeight+1 - 95 * float((pindexBest->nHeight+1)/95)) <= 15){
            ...
            if((pindexBest->nHeight+1 - 95 * float((pindexBest->nHeight+1)/95)) >= 00 && (pindexBest->nHeight+1 - 95 * float((pindexBest->nHeight+1)/95)) <= 23){
            ...
            if((pindexBest->nHeight+1 - 95 * float((pindexBest->nHeight+1)/95)) >= 00 && (pindexBest->nHeight+1 - 95 * float((pindexBest->nHeight+1)/95)) <= 38){
            ...
            if((pindexBest->nHeight+1 - 95 * float((pindexBest->nHeight+1)/95)) >= 00 && (pindexBest->nHeight+1 - 95 * float((pindexBest->nHeight+1)/95)) <= 94){
