...
public:
    CMainParams() {
       ...
       `  * a large 32-bit integer with any alignment.
        ...
        // an exodus sigma related value.
        consensus.nExodusSigmaStartBlock = SIGMA_EXODUS_STARTING_BLOCK;
...
//        vSeeds.push_back(CDNSSeedData("bitcoin.schildbach.de", "testnet-seed.bitcoin.schildbach.de"));
        ...
        // an exodus sigma related value.
        consensus.nExodusSigmaStartBlock = SIGMA_EXODUS_TESTNET_STARTING_BLOCK;
...
//        std::cout << "zcoin regtest hashMerkleRoot hash: " << genesis.hashMerkleRoot.ToString() << std::endl;
        ...
        // an exodus sigma related value.
        consensus.nExodusSigmaStartBlock = 500;
