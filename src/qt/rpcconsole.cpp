...
bool RPCConsole::RPCParseCommandLine(std::string &strResult, const std::string &strCommand, const bool fExecute, std::string * const pstrFilteredOut)
{
    ...
    for (chpos = 0; chpos < strCommandTerminated.size(); ++chpos)
    {
        ...
        switch(state)
        {
            case STATE_COMMAND_EXECUTED_INNER:     [[fallthrough]];
            ...
            case STATE_ARGUMENT:                    [[fallthrough]];// In or after argument 
            case STATE_EATING_SPACES_IN_ARG:        [[fallthrough]];
            case STATE_EATING_SPACES_IN_BRACKETS:   [[fallthrough]];
