...
static bool getDisclaimerDialogResult()
{
    ...
    "The protocol and transaction processing rules for the Exodus are still under "
    "active development and are subject to change in future.\n\n"
    "Exodus should be considered an alpha-level product, and you use it at your "
    "own risk. Neither the Zcoin Foundation nor the Zcoin developers assumes "
    "any responsibility for funds misplaced, mishandled, lost, or misallocated.\n\n"
    "Further, please note that this installation of Exodus should be viewed as "
    ...
    "PLEASE DO NOT use wallet(s) with significant amounts of zcoins or Exodus "
...
static bool showDisclaimer()
{
    ...
    return settings.value("Exodus/fShowDisclaimer", true).toBool();
}
...
bool AskUserToAcknowledgeRisks()
{
    ...
    settings.setValue("Exodus/fShowDisclaimer", !fAccepted);
