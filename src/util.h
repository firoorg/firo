...
static std::pair<bool,std::string> ReadBinaryFileTor(const std::string &filename, size_t maxsize=std::numeric_limits<size_t>::max())
{
 ...
 */
static bool WriteBinaryFileTor(const std::string &filename, const std::string &data)
{
