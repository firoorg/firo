...
SECP256K1_INLINE static int secp256k1_scalar_reduce(struct secp256k1_scalar *r, uint32_t overflow) {
    uint64_t t;
...
static void secp256k1_scalar_reduce_512(struct secp256k1_scalar *r, const uint32_t *l) {
    uint64_t c;
...
static void secp256k1_scalar_mul_512(uint32_t *l, const struct secp256k1_scalar *a, const struct secp256k1_scalar *b) {
    /* 96 bit accumulator. */
...
static void secp256k1_scalar_sqr_512(uint32_t *l, const struct secp256k1_scalar *a) {
    /* 96 bit accumulator. */
    uint32_t c0 = 0, c1 = 0, c2 = 0;
