...
SECP256K1_INLINE static void secp256k1_scalar_clear(struct secp256k1_scalar *r) {
    r->d[0] = 0;
    r->d[1] = 0;
    r->d[2] = 0;
    r->d[3] = 0;
...
SECP256K1_INLINE static void secp256k1_scalar_set_int(struct secp256k1_scalar *r, unsigned int v) {
    r->d[0] = v;
    r->d[1] = 0;
    r->d[2] = 0;
    r->d[3] = 0;
...
SECP256K1_INLINE static int secp256k1_scalar_check_overflow(const struct secp256k1_scalar *a) {
    int yes = 0;
    int no = 0;
...
SECP256K1_INLINE static int secp256k1_scalar_reduce(struct secp256k1_scalar *r, unsigned int overflow) {
    uint128_t t;
...
static void secp256k1_scalar_reduce_512(struct secp256k1_scalar *r, const uint64_t *l) {
...
static void secp256k1_scalar_mul_512(uint64_t l[8], const struct secp256k1_scalar *a, const struct secp256k1_scalar *b) {
#ifdef USE_ASM_X86_64
...
static void secp256k1_scalar_sqr_512(uint64_t l[8], const struct secp256k1_scalar *a) {
#ifdef USE_ASM_X86_64
    __asm__ __volatile__(
    /* Preload */
    "movq 0(%%rdi), %%r11\n"
...
SECP256K1_INLINE static void secp256k1_scalar_mul_shift_var(struct secp256k1_scalar *r, const struct secp256k1_scalar *a, const struct secp256k1_scalar *b, unsigned int shift) {
    uint64_t l[8];
