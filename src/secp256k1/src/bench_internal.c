...
typedef struct {
    struct secp256k1_scalar scalar_x, scalar_y;
    struct secp256k1_fe fe_x, fe_y;
    struct secp256k1_ge ge_x, ge_y;
    struct secp256k1_gej gej_x, gej_y;
