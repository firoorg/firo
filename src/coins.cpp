...
static const size_t MAX_OUTPUTS_PER_BLOCK = MAX_BLOCK_SERIALIZED_SIZE /  ::GetSerializeSize(CTxOut(), SER_NETWORK, PROTOCOL_VERSION); // TODO: merge with similar definition in undo.h.
