...
public:
    ...
    bool SavePaymentChannels(std::string paymentCode, const std::vector<bip47::CPaymentChannel>& channels);
    ...
    //bip47 data
    void ListBIP47PaymentChannels(std::map <string, std::vector<bip47::CPaymentChannel>> &mPchannels);
