...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 3 || params.size() > 6)
        throw runtime_error(
            ...
            "2. \"tobitcoinaddress\"  (string, required) The zcoin address to send funds to.\n"
...
//btzc: zerocoin section
// zerocoin section

//UniValue mintzerocoin(const Array& params, bool fHelp)
//{
//
//    if (fHelp || params.size() > 1)
//        throw runtime_error(
...
//}
//
//UniValue spendzerocoin(const Array& params, bool fHelp)
//{
//
//    if (fHelp || params.size() > 1)
//        throw runtime_error(
...
//    { "wallet",             "mintzerocoin",             &mintzerocoin,             true  },
//    { "wallet",             "spendzerocoin",            &spendzerocoin,            true  },
//    { "wallet",             "resetmintzerocoin",        &resetmintzerocoin,        true  },
};
