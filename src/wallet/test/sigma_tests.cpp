...
[[maybe_unused]] static void AddSigmaCoin(const sigma::PrivateCoin& coin, const sigma::CoinDenomination denomination)
{
...
[[maybe_unused]] static bool CheckDenominationCoins(
