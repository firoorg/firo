...
UniValue exodus_sendissuancecrowdsale(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 14)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("exodus_sendissuancecrowdsale", "\"3JYd75REX3HXn1vAU83YuGfmiPXW7BpYXo\" 2 1 0 \"Companies\" \"Bitcoin Mining\" \"Quantum Miner\" \"\" \"\" 2 \"100\" 1483228800 30 2")
            + HelpExampleRpc("exodus_sendissuancecrowdsale", "\"3JYd75REX3HXn1vAU83YuGfmiPXW7BpYXo\", 2, 1, 0, \"Companies\", \"Bitcoin Mining\", \"Quantum Miner\", \"\", \"\", 2, \"100\", 1483228800, 30, 2")
        );
...
UniValue exodus_sendissuancefixed(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 10)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("exodus_sendissuancefixed", "\"3Ck2kEGLJtZw9ENj2tameMCtS3HB7uRar3\" 2 1 0 \"Companies\" \"Bitcoin Mining\" \"Quantum Miner\" \"\" \"\" \"1000000\"")
            + HelpExampleRpc("exodus_sendissuancefixed", "\"3Ck2kEGLJtZw9ENj2tameMCtS3HB7uRar3\", 2, 1, 0, \"Companies\", \"Bitcoin Mining\", \"Quantum Miner\", \"\", \"\", \"1000000\"")
        );
...
UniValue exodus_sendissuancemanaged(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 9)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("exodus_sendissuancemanaged", "\"3HsJvhr9qzgRe3ss97b1QHs38rmaLExLcH\" 2 1 0 \"Companies\" \"Bitcoin Mining\" \"Quantum Miner\" \"\" \"\"")
            + HelpExampleRpc("exodus_sendissuancemanaged", "\"3HsJvhr9qzgRe3ss97b1QHs38rmaLExLcH\", 2, 1, 0, \"Companies\", \"Bitcoin Mining\", \"Quantum Miner\", \"\", \"\"")
        );
...
{ //  category                             name                            actor (function)               okSafeMode
  //  ------------------------------------ ------------------------------- ------------------------------ ----------
    ...
    { "exodus (transaction creation)", "exodus_senddexsell",             &exodus_senddexsell,             false },
    { "exodus (transaction creation)", "exodus_senddexaccept",           &exodus_senddexaccept,           false },
    { "exodus (transaction creation)", "exodus_sendissuancecrowdsale",   &exodus_sendissuancecrowdsale,   false },
    ...
    { "exodus (transaction creation)", "exodus_sendclosecrowdsale",      &exodus_sendclosecrowdsale,      false },
    ...
    { "exodus (transaction creation)", "exodus_sendenablefreezing",      &exodus_sendenablefreezing,      false },
    { "exodus (transaction creation)", "exodus_senddisablefreezing",     &exodus_senddisablefreezing,     false },
    { "exodus (transaction creation)", "exodus_sendfreeze",              &exodus_sendfreeze,              false },
    { "exodus (transaction creation)", "exodus_sendunfreeze",            &exodus_sendunfreeze,            false },
