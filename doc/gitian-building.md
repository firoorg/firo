...
*Setup instructions for a Gitian build of Verticalcoin Core using a Debian VM or physical system.*
...
- [Building Verticalcoin Core](#building-bitcoin-core)
...
Building Verticalcoin Core
----------------

To build Verticalcoin Core (for Linux, OS X and Windows) just follow the steps under 'perform
