...
static const char qt_meta_stringdata_AddressBookPage[] = {
    ...
    "on_zerocoinMintButton_clicked()\0"
    "on_zerocoinSpendButton_clicked()\0"
...
void AddressBookPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 14: _t->on_zerocoinMintButton_clicked(); break;
        case 15: _t->on_zerocoinSpendButton_clicked(); break;
        case 16: _t->selectionChanged(); break;
        case 17: _t->contextualMenu((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        case 18: _t->selectNewAddress((*reinterpret_cast< const QModelIndex(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        default: ;
        }
    }
}
