...
class HDMintMempoolZap1Test(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert len(sigma_mints2) == len(sigma_mints1), \
            'The amount of mints should be same as before unconfirmed mint after restart with ["-zapwallettxes=1"].'
        ...
        assert len(sigma_mints3) == len(sigma_mints1), \
            'The amount of mints should be same as before unconfirmed spend after restart with ["-zapwallettxes=1"].'

        # 12. mint
        # Minting after restart with '-["-zapwallettxes=1"]'
        ...
        # Mints count should pass even after restart with '-["-zapwallettxes=1"]'
