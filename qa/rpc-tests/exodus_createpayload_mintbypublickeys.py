...
class ExodusCreatePayloadMintByPublicKeysTests(ExodusTestFramework):
    def run_test(self):
        super().run_test()
        super().ensure_reach_sigmaactivated_block()

        sigma_propid = super().create_default_property("Sigma", sigma = True, amount = "1000000")
        self.nodes[0].exodus_sendcreatedenomination(self.addrs[0], sigma_propid, "1")
        self.nodes[0].generate(10)
        self.nodes[0].exodus_sendcreatedenomination(self.addrs[0], sigma_propid, "2")
        self.nodes[0].generate(10)
        ...
        assert_raises_message(
            ...
            self.nodes[0].exodus_createpayload_mintbypublickeys, nonsigma_propid, valid_mints
        )
        ...
        assert_raises_message(
            ...
            self.nodes[0].exodus_createpayload_mintbypublickeys, 99, valid_mints
        )
        ...
        assert_raises_message(
            ...
            self.nodes[0].exodus_createpayload_mintbypublickeys, sigma_propid, [{"id": "0", "denomination": 0}]
        )
        ...
        assert_raises_message(
            ...
            self.nodes[0].exodus_createpayload_mintbypublickeys,
            sigma_propid,
        ...
        payload = self.nodes[0].exodus_createpayload_mintbypublickeys(sigma_propid, valid_mints)
...
if __name__ == '__main__':
    ExodusCreatePayloadMintByPublicKeysTests().main()
