...
# 7. restart with `-zapwallettxes=2`
# 8. check listunspentmints - should be as on step 5 (cause -zapwallettxes=2 clean mempool)
# 9. spend and not confirm
# 10. restart with `-zapwallettxes=2`
# 11. check listunspentmints - should be as on step 5 (cause -zapwallettxes=2 clean mempool)
# 12. mint
# 13. generate blocks
...
class HDMintMempoolZap1Test(BitcoinTestFramework):
    def __init__(self):
        super().__init__()
        self.num_nodes = 4
    ...
    def run_test(self):
        ...
        assert len(sigma_mints2) == len(sigma_mints1), \
            'The amount of mints should be same as before unconfirmed mint after restart with ["-zapwallettxes=2"].'
        ...
        assert len(sigma_mints3) == len(sigma_mints1), \
            'The amount of mints should be same as before unconfirmed spend after restart with ["-zapwallettxes=2"].'

        # 12. mint
        # Minting after restart with '-["-zapwallettxes=2"]'
        ...
        # Mints count should pass even after restart with '-["-zapwallettxes=2"]'
        assert len(sigma_mints4) == len(sigma_mints1) + 1, \
            'After restart with ["-zapwallettxes=2"] mint does not work.'
