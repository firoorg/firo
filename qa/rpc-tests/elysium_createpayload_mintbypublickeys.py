...
class ElysiumCreatePayloadMintByPublicKeysTests(ElysiumTestFramework):
    def run_test(self):
        super().run_test()
        super().generate_until_sigma_activated(0)

        sigma_propid = super().create_default_property("Sigma", 0, self.addrs[0], sigma = True, amount = "1000000")
        ...
        nonsigma_propid = super().create_default_property("Non Sigma", 0, self.addrs[0], sigma = False, amount = "1000000")
